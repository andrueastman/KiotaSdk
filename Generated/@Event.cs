    ...
    public class @Event {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"attendees", (o,n) => { (o as @Event).Attendees = n.GetCollectionOfPrimitiveValues<Attendee>().ToList(); } },
                ...
                {"importance", (o,n) => { (o as @Event).Importance = n.GetObjectValue<Importance>(); } },
                ...
                {"locations", (o,n) => { (o as @Event).Locations = n.GetCollectionOfPrimitiveValues<Location>().ToList(); } },
                ...
                {"onlineMeetingProvider", (o,n) => { (o as @Event).OnlineMeetingProvider = n.GetObjectValue<OnlineMeetingProviderType>(); } },
                ...
                {"sensitivity", (o,n) => { (o as @Event).Sensitivity = n.GetObjectValue<Sensitivity>(); } },
                {"seriesMasterId", (o,n) => { (o as @Event).SeriesMasterId = n.GetStringValue(); } },
                {"showAs", (o,n) => { (o as @Event).ShowAs = n.GetObjectValue<FreeBusyStatus>(); } },
                ...
                {"type", (o,n) => { (o as @Event).Type = n.GetObjectValue<EventType>(); } },
