using GraphSdk.Admin.ServiceAnnouncement.HealthOverviews.Item.Issues.Item.IncidentReport;
...
namespace GraphSdk.Admin.ServiceAnnouncement.HealthOverviews.Item.Issues.Item {
    ...
    public class ServiceHealthIssueRequestBuilder {
        ...
        public ServiceHealthIssueRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/admin/serviceAnnouncement/healthOverviews/{serviceHealth_id}/issues/{serviceHealthIssue_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ServiceHealthIssueRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
