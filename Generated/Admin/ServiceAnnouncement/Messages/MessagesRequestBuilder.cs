using GraphSdk.Admin.ServiceAnnouncement.Messages.Archive;
using GraphSdk.Admin.ServiceAnnouncement.Messages.Favorite;
using GraphSdk.Admin.ServiceAnnouncement.Messages.Item;
using GraphSdk.Admin.ServiceAnnouncement.Messages.MarkRead;
using GraphSdk.Admin.ServiceAnnouncement.Messages.MarkUnread;
using GraphSdk.Admin.ServiceAnnouncement.Messages.Unarchive;
using GraphSdk.Admin.ServiceAnnouncement.Messages.Unfavorite;
...
namespace GraphSdk.Admin.ServiceAnnouncement.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.admin.serviceAnnouncement.messages.item collection</summary>
        ...
        public MessagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/admin/serviceAnnouncement/messages{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
