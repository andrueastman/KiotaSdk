using GraphSdk.Agreements.Item.Files.Item.Versions;
...
namespace GraphSdk.Agreements.Item.Files.Item {
    ...
    public class AgreementFileLocalizationRequestBuilder {
        ...
        public AgreementFileLocalizationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/agreements/{agreement_id}/files/{agreementFileLocalization_id}{?select,expand}";
