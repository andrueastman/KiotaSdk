using GraphServiceClient.AgreementAcceptances;
using GraphServiceClient.Agreements;
using GraphServiceClient.AppCatalogs;
using GraphServiceClient.Applications;
using GraphServiceClient.ApplicationTemplates;
using GraphServiceClient.AuditLogs;
using GraphServiceClient.AuthenticationMethodConfigurations;
using GraphServiceClient.AuthenticationMethodsPolicy;
using GraphServiceClient.Branding;
using GraphServiceClient.CertificateBasedAuthConfiguration;
using GraphServiceClient.Chats;
using GraphServiceClient.Communications;
using GraphServiceClient.Connections;
using GraphServiceClient.Contacts;
using GraphServiceClient.Contracts;
using GraphServiceClient.DataPolicyOperations;
using GraphServiceClient.DeviceAppManagement;
using GraphServiceClient.DeviceManagement;
using GraphServiceClient.Devices;
using GraphServiceClient.Directory;
using GraphServiceClient.DirectoryObjects;
using GraphServiceClient.DirectoryRoles;
using GraphServiceClient.DirectoryRoleTemplates;
using GraphServiceClient.DomainDnsRecords;
using GraphServiceClient.Domains;
using GraphServiceClient.Drive;
using GraphServiceClient.Drives;
using GraphServiceClient.Education;
using GraphServiceClient.External;
using GraphServiceClient.GroupLifecyclePolicies;
using GraphServiceClient.Groups;
using GraphServiceClient.GroupSettings;
using GraphServiceClient.GroupSettingTemplates;
using GraphServiceClient.Identity;
using GraphServiceClient.IdentityGovernance;
using GraphServiceClient.IdentityProviders;
using GraphServiceClient.InformationProtection;
using GraphServiceClient.Invitations;
using GraphServiceClient.Localizations;
using GraphServiceClient.Me;
using GraphServiceClient.Oauth2PermissionGrants;
using GraphServiceClient.Organization;
using GraphServiceClient.PermissionGrants;
using GraphServiceClient.Places;
using GraphServiceClient.Planner;
using GraphServiceClient.Policies;
using GraphServiceClient.Print;
using GraphServiceClient.Reports;
using GraphServiceClient.RoleManagement;
using GraphServiceClient.SchemaExtensions;
using GraphServiceClient.ScopedRoleMemberships;
using GraphServiceClient.Search;
using GraphServiceClient.Security;
using GraphServiceClient.ServicePrincipals;
using GraphServiceClient.Shares;
using GraphServiceClient.Sites;
using GraphServiceClient.SubscribedSkus;
using GraphServiceClient.Subscriptions;
using GraphServiceClient.Teams;
using GraphServiceClient.TeamsTemplates;
using GraphServiceClient.Teamwork;
using GraphServiceClient.Users;
using GraphServiceClient.Workbooks;
