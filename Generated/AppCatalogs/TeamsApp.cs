    ...
    public class TeamsApp : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"distributionMethod", (o,n) => { (o as TeamsApp).DistributionMethod = n.GetObjectValue<TeamsAppDistributionMethod>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<TeamsAppDistributionMethod>("distributionMethod", DistributionMethod);
