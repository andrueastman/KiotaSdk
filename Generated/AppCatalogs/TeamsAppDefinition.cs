    ...
    public class TeamsAppDefinition : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"publishingState", (o,n) => { (o as TeamsAppDefinition).PublishingState = n.GetObjectValue<TeamsAppPublishingState>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<TeamsAppPublishingState>("publishingState", PublishingState);
