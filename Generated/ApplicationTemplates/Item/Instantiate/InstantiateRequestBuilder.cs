...
namespace ApiSdk.ApplicationTemplates.Item.Instantiate {
    ...
    public class InstantiateRequestBuilder {
        ...
        /// </summary>
        public InstantiateRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(InstantiateRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
        ...
        /// </summary>
        public async Task<InstantiateResponse> PostAsync(InstantiateRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await HttpCore.SendAsync<InstantiateResponse>(requestInfo, responseHandler);
        }
