...
namespace GraphServiceClient.Applications.Logo {
    /// <summary>Builds and executes requests for operations under \applications\{application-id}\logo</summary>
    public class LogoRequestBuilder {
        ...
        /// </summary>
        public LogoRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
