...
namespace GraphServiceClient.AuditLogs {
    ...
    public class AuditLogsRequestBuilder {
        ...
        public DirectoryAuditsRequestBuilder DirectoryAudits { get =>
            new DirectoryAuditsRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        ...
        public ProvisioningRequestBuilder Provisioning { get =>
            new ProvisioningRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        public RestrictedSignInsRequestBuilder RestrictedSignIns { get =>
            new RestrictedSignInsRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        public SignInsRequestBuilder SignIns { get =>
            new SignInsRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        /// <summary>
        ...
        /// </summary>
        public AuditLogsRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<AuditLogRoot> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<AuditLogRoot>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Update auditLogs
        /// <param name="body"></param>
