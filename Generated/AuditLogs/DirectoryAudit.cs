    ...
    public class DirectoryAudit : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"result", (o,n) => { (o as DirectoryAudit).Result = n.GetObjectValue<OperationResult>(); } },
                {"resultReason", (o,n) => { (o as DirectoryAudit).ResultReason = n.GetStringValue(); } },
                {"targetResources", (o,n) => { (o as DirectoryAudit).TargetResources = n.GetCollectionOfPrimitiveValues<TargetResource>().ToList(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<OperationResult>("result", Result);
            writer.WriteStringValue("resultReason", ResultReason);
            writer.WriteCollectionOfPrimitiveValues<TargetResource>("targetResources", TargetResources);
        }
    }
}
