    ...
    public class ProvisioningObjectSummary : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"modifiedProperties", (o,n) => { (o as ProvisioningObjectSummary).ModifiedProperties = n.GetCollectionOfPrimitiveValues<ModifiedProperty>().ToList(); } },
                {"provisioningAction", (o,n) => { (o as ProvisioningObjectSummary).ProvisioningAction = n.GetObjectValue<ProvisioningAction>(); } },
                {"provisioningStatusInfo", (o,n) => { (o as ProvisioningObjectSummary).ProvisioningStatusInfo = n.GetObjectValue<ProvisioningStatusInfo>(); } },
                {"provisioningSteps", (o,n) => { (o as ProvisioningObjectSummary).ProvisioningSteps = n.GetCollectionOfPrimitiveValues<ProvisioningStep>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<ModifiedProperty>("modifiedProperties", ModifiedProperties);
            writer.WriteObjectValue<ProvisioningAction>("provisioningAction", ProvisioningAction);
            writer.WriteObjectValue<ProvisioningStatusInfo>("provisioningStatusInfo", ProvisioningStatusInfo);
            writer.WriteCollectionOfPrimitiveValues<ProvisioningStep>("provisioningSteps", ProvisioningSteps);
