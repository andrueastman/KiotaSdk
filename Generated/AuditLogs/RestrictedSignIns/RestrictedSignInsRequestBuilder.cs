...
namespace ApiSdk.AuditLogs.RestrictedSignIns {
    ...
    public class RestrictedSignInsRequestBuilder {
        ...
        public RestrictedSignInRequestBuilder this[string position] { get {
            return new RestrictedSignInRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public RestrictedSignInsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
