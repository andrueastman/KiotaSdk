...
namespace GraphServiceClient.AuditLogs {
    public class SignIn : Entity, IParsable {
        ...
        /// <summary>The device information from where the sign-in occurred. Includes information such as deviceId, OS, and browser. Supports $filter (eq and startsWith operators only) on browser and operatingSytem properties.</summary>
        ...
        /// <summary>Indicates whether a sign-in is interactive or not.</summary>
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"appliedConditionalAccessPolicies", (o,n) => { (o as SignIn).AppliedConditionalAccessPolicies = n.GetCollectionOfPrimitiveValues<AppliedConditionalAccessPolicy>().ToList(); } },
                {"clientAppUsed", (o,n) => { (o as SignIn).ClientAppUsed = n.GetStringValue(); } },
                {"conditionalAccessStatus", (o,n) => { (o as SignIn).ConditionalAccessStatus = n.GetObjectValue<ConditionalAccessStatus>(); } },
                ...
                {"riskDetail", (o,n) => { (o as SignIn).RiskDetail = n.GetObjectValue<RiskDetail>(); } },
                {"riskEventTypes", (o,n) => { (o as SignIn).RiskEventTypes = n.GetCollectionOfPrimitiveValues<RiskEventType>().ToList(); } },
                {"riskEventTypes_v2", (o,n) => { (o as SignIn).RiskEventTypes_v2 = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"riskLevelAggregated", (o,n) => { (o as SignIn).RiskLevelAggregated = n.GetObjectValue<RiskLevel>(); } },
                {"riskLevelDuringSignIn", (o,n) => { (o as SignIn).RiskLevelDuringSignIn = n.GetObjectValue<RiskLevel>(); } },
                {"riskState", (o,n) => { (o as SignIn).RiskState = n.GetObjectValue<RiskState>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<AppliedConditionalAccessPolicy>("appliedConditionalAccessPolicies", AppliedConditionalAccessPolicies);
            writer.WriteStringValue("clientAppUsed", ClientAppUsed);
            writer.WriteObjectValue<ConditionalAccessStatus>("conditionalAccessStatus", ConditionalAccessStatus);
            ...
            writer.WriteObjectValue<RiskDetail>("riskDetail", RiskDetail);
            writer.WriteCollectionOfPrimitiveValues<RiskEventType>("riskEventTypes", RiskEventTypes);
            writer.WriteCollectionOfPrimitiveValues<string>("riskEventTypes_v2", RiskEventTypes_v2);
            writer.WriteObjectValue<RiskLevel>("riskLevelAggregated", RiskLevelAggregated);
            writer.WriteObjectValue<RiskLevel>("riskLevelDuringSignIn", RiskLevelDuringSignIn);
            writer.WriteObjectValue<RiskState>("riskState", RiskState);
