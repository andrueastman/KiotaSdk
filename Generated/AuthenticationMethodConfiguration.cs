    ...
    public class AuthenticationMethodConfiguration : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"state", (o,n) => { (o as AuthenticationMethodConfiguration).State = n.GetObjectValue<AuthenticationMethodState>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AuthenticationMethodState>("state", State);
        }
    }
}
