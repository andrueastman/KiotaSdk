...
namespace GraphServiceClient.Branding {
    public class Branding : OrganizationalBrandingProperties, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"localizations", (o,n) => { (o as Branding).Localizations = n.GetCollectionOfObjectValues<OrganizationalBrandingLocalization>().ToList(); } },
            };
        }
        /// <summary>
