    ...
    public class CalendarPermission : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"allowedRoles", (o,n) => { (o as CalendarPermission).AllowedRoles = n.GetCollectionOfPrimitiveValues<CalendarRoleType>().ToList(); } },
                ...
                {"role", (o,n) => { (o as CalendarPermission).Role = n.GetObjectValue<CalendarRoleType>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<CalendarRoleType>("allowedRoles", AllowedRoles);
            ...
            writer.WriteObjectValue<CalendarRoleType>("role", Role);
        }
    }
}
