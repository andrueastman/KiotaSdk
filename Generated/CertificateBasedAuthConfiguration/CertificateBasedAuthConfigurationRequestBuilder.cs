...
namespace GraphSdk.CertificateBasedAuthConfiguration {
    ...
    public class CertificateBasedAuthConfigurationRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.certificateBasedAuthConfiguration.item collection</summary>
        public CertificateBasedAuthConfigurationRequestBuilder this[string position] { get {
            ...
            return new CertificateBasedAuthConfigurationRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public CertificateBasedAuthConfigurationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/certificateBasedAuthConfiguration{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GraphSdk.Models.Microsoft.Graph.CertificateBasedAuthConfiguration body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<GraphSdk.Models.Microsoft.Graph.CertificateBasedAuthConfiguration> PostAsync(GraphSdk.Models.Microsoft.Graph.CertificateBasedAuthConfiguration body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
