    ...
    public class ChatMessage : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"attachments", (o,n) => { (o as ChatMessage).Attachments = n.GetCollectionOfPrimitiveValues<ChatMessageAttachment>().ToList(); } },
                ...
                {"importance", (o,n) => { (o as ChatMessage).Importance = n.GetObjectValue<ChatMessageImportance>(); } },
                ...
                {"mentions", (o,n) => { (o as ChatMessage).Mentions = n.GetCollectionOfPrimitiveValues<ChatMessageMention>().ToList(); } },
                {"messageType", (o,n) => { (o as ChatMessage).MessageType = n.GetObjectValue<ChatMessageType>(); } },
                {"policyViolation", (o,n) => { (o as ChatMessage).PolicyViolation = n.GetObjectValue<ChatMessagePolicyViolation>(); } },
                {"reactions", (o,n) => { (o as ChatMessage).Reactions = n.GetCollectionOfPrimitiveValues<ChatMessageReaction>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<ChatMessageAttachment>("attachments", Attachments);
            ...
            writer.WriteObjectValue<ChatMessageImportance>("importance", Importance);
            writer.WriteDateTimeOffsetValue("lastEditedDateTime", LastEditedDateTime);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteStringValue("locale", Locale);
            writer.WriteCollectionOfPrimitiveValues<ChatMessageMention>("mentions", Mentions);
            writer.WriteObjectValue<ChatMessageType>("messageType", MessageType);
            writer.WriteObjectValue<ChatMessagePolicyViolation>("policyViolation", PolicyViolation);
            writer.WriteCollectionOfPrimitiveValues<ChatMessageReaction>("reactions", Reactions);
