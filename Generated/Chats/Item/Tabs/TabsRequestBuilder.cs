using GraphSdk.Chats.Item.Tabs.Item;
...
namespace GraphSdk.Chats.Item.Tabs {
    ...
    public class TabsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.chats.item.tabs.item collection</summary>
        ...
        public TabsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/chats/{chat_id}/tabs{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
