    ...
    public class Call : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"callRoutes", (o,n) => { (o as Call).CallRoutes = n.GetCollectionOfPrimitiveValues<CallRoute>().ToList(); } },
                {"chatInfo", (o,n) => { (o as Call).ChatInfo = n.GetObjectValue<ChatInfo>(); } },
                {"direction", (o,n) => { (o as Call).Direction = n.GetObjectValue<CallDirection>(); } },
                ...
                {"requestedModalities", (o,n) => { (o as Call).RequestedModalities = n.GetCollectionOfPrimitiveValues<Modality>().ToList(); } },
                ...
                {"state", (o,n) => { (o as Call).State = n.GetObjectValue<CallState>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<CallRoute>("callRoutes", CallRoutes);
            writer.WriteObjectValue<ChatInfo>("chatInfo", ChatInfo);
            writer.WriteObjectValue<CallDirection>("direction", Direction);
            ...
            writer.WriteCollectionOfPrimitiveValues<Modality>("requestedModalities", RequestedModalities);
            writer.WriteObjectValue<ResultInfo>("resultInfo", ResultInfo);
            writer.WriteObjectValue<ParticipantInfo>("source", Source);
            writer.WriteObjectValue<CallState>("state", State);
