    ...
    public class CallRecord : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"modalities", (o,n) => { (o as CallRecord).Modalities = n.GetCollectionOfPrimitiveValues<Modality>().ToList(); } },
                ...
                {"type", (o,n) => { (o as CallRecord).Type = n.GetObjectValue<CallType>(); } },
                {"version", (o,n) => { (o as CallRecord).Version = n.GetObjectValue<Int64>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<Modality>("modalities", Modalities);
            ...
            writer.WriteObjectValue<CallType>("type", Type);
            writer.WriteObjectValue<Int64>("version", Version);
        }
    }
}
