...
namespace ApiSdk.Communications.CallRecords.Item.Sessions.Item {
    ...
    public class SessionRequestBuilder {
        ...
        public SegmentsRequestBuilder Segments { get =>
            new SegmentsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        /// <summary>
        ...
        /// </summary>
        public SessionRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
