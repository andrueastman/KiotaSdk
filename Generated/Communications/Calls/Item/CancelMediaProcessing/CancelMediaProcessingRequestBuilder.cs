...
namespace ApiSdk.Communications.Calls.Item.CancelMediaProcessing {
    ...
    public class CancelMediaProcessingRequestBuilder {
        ...
        /// </summary>
        public CancelMediaProcessingRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CancelMediaProcessingRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
        ...
        /// </summary>
        public async Task<CancelMediaProcessingResponse> PostAsync(CancelMediaProcessingRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await HttpCore.SendAsync<CancelMediaProcessingResponse>(requestInfo, responseHandler);
        }
