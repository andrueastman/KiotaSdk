...
namespace GraphSdk.Communications.Calls.Item.CancelMediaProcessing {
    ...
    public class CancelMediaProcessingRequestBuilder {
        ...
        public CancelMediaProcessingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/communications/calls/{call_id}/microsoft.graph.cancelMediaProcessing";
        ...
        /// </summary>
        public async Task<CancelMediaProcessingResponse> PostAsync(CancelMediaProcessingRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendAsync<CancelMediaProcessingResponse>(requestInfo, responseHandler);
        }
