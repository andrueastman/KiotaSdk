...
namespace GraphSdk.Communications.Calls.Item.KeepAlive {
    ...
    public class KeepAliveRequestBuilder {
        ...
        public KeepAliveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/communications/calls/{call_id}/microsoft.graph.keepAlive";
