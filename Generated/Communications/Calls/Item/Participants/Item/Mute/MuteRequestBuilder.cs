...
namespace ApiSdk.Communications.Calls.Item.Participants.Item.Mute {
    ...
    public class MuteRequestBuilder {
        ...
        /// </summary>
        public MuteRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MuteRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
        ...
        /// </summary>
        public async Task<MuteResponse> PostAsync(MuteRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await HttpCore.SendAsync<MuteResponse>(requestInfo, responseHandler);
        }
