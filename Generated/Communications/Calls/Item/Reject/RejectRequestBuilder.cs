...
namespace GraphSdk.Communications.Calls.Item.Reject {
    ...
    public class RejectRequestBuilder {
        ...
        public RejectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/communications/calls/{call_id}/microsoft.graph.reject";
        ...
        /// </summary>
        public async Task PostAsync(RejectRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
