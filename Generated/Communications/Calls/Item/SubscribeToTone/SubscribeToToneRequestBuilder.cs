...
namespace ApiSdk.Communications.Calls.Item.SubscribeToTone {
    ...
    public class SubscribeToToneRequestBuilder {
        ...
        /// </summary>
        public SubscribeToToneRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SubscribeToToneRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
        ...
        /// </summary>
        public async Task<SubscribeToToneResponse> PostAsync(SubscribeToToneRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await HttpCore.SendAsync<SubscribeToToneResponse>(requestInfo, responseHandler);
        }
