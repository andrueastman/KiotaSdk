...
namespace ApiSdk.Communications.Calls.Item.Unmute {
    ...
    public class UnmuteRequestBuilder {
        ...
        /// </summary>
        public UnmuteRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(UnmuteRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
        ...
        /// </summary>
        public async Task<UnmuteResponse> PostAsync(UnmuteRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await HttpCore.SendAsync<UnmuteResponse>(requestInfo, responseHandler);
        }
