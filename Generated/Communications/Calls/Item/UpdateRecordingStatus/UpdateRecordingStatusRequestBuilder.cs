...
namespace GraphSdk.Communications.Calls.Item.UpdateRecordingStatus {
    ...
    public class UpdateRecordingStatusRequestBuilder {
        ...
        public UpdateRecordingStatusRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/communications/calls/{call_id}/microsoft.graph.updateRecordingStatus";
        ...
        /// </summary>
        public async Task<UpdateRecordingStatusResponse> PostAsync(UpdateRecordingStatusRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
