...
namespace GraphServiceClient.Communications.Calls.Microsoft.Graph.Redirect {
    ...
    public class Microsoft.graph.redirectRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Microsoft.graph.redirectResponse body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
