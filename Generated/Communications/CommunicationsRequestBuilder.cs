...
namespace GraphServiceClient.Communications {
    ...
    public class CommunicationsRequestBuilder {
        public CallRecordsRequestBuilder CallRecords { get =>
            new CallRecordsRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        public CallsRequestBuilder Calls { get =>
            new CallsRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        ...
        public PresencesRequestBuilder Presences { get =>
            new PresencesRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        /// <summary>
        ...
        /// </summary>
        public CommunicationsRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<CloudCommunications> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<CloudCommunications>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Update communications
        /// <param name="body"></param>
