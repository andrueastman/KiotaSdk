using GraphSdk.Communications.OnlineMeetings.Item.AttendeeReport;
...
namespace GraphSdk.Communications.OnlineMeetings.Item {
    ...
    public class OnlineMeetingRequestBuilder {
        ...
        public OnlineMeetingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/communications/onlineMeetings/{onlineMeeting_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(OnlineMeeting body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
