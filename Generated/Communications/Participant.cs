    ...
    public class Participant : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"mediaStreams", (o,n) => { (o as Participant).MediaStreams = n.GetCollectionOfPrimitiveValues<MediaStream>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<MediaStream>("mediaStreams", MediaStreams);
