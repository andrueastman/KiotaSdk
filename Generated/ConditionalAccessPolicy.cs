    ...
    public class ConditionalAccessPolicy : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"state", (o,n) => { (o as ConditionalAccessPolicy).State = n.GetObjectValue<ConditionalAccessPolicyState>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ConditionalAccessPolicyState>("state", State);
        }
    }
}
