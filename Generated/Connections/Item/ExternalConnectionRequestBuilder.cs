...
namespace ApiSdk.Connections.Item {
    ...
    public class ExternalConnectionRequestBuilder {
        ...
        public SchemaRequestBuilder Schema { get =>
            new SchemaRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        /// <summary>
        ...
        /// </summary>
        public ExternalConnectionRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
