using GraphSdk.Contacts.Item.TransitiveMemberOf.Ref;
...
namespace GraphSdk.Contacts.Item.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        public TransitiveMemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/contacts/{orgContact_id}/transitiveMemberOf{?top,skip,search,filter,count,orderby,select,expand}";
