...
using GraphSdk.Contracts.Item;
using GraphSdk.Contracts.ValidateProperties;
...
namespace GraphSdk.Contracts {
    ...
    public class ContractsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.contracts.item collection</summary>
        ...
        public ContractsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/contracts{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
