    ...
    public class DataPolicyOperation : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"progress", (o,n) => { (o as DataPolicyOperation).Progress = n.GetObjectValue<Double>(); } },
                {"status", (o,n) => { (o as DataPolicyOperation).Status = n.GetObjectValue<DataPolicyOperationStatus>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Double>("progress", Progress);
            writer.WriteObjectValue<DataPolicyOperationStatus>("status", Status);
