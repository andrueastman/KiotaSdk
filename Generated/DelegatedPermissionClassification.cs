    ...
    public class DelegatedPermissionClassification : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"classification", (o,n) => { (o as DelegatedPermissionClassification).Classification = n.GetObjectValue<PermissionClassificationType>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<PermissionClassificationType>("classification", Classification);
