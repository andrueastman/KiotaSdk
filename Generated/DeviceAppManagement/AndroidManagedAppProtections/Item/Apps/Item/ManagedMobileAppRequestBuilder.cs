...
namespace GraphSdk.DeviceAppManagement.AndroidManagedAppProtections.Item.Apps.Item {
    ...
    public class ManagedMobileAppRequestBuilder {
        ...
        public ManagedMobileAppRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection_id}/apps/{managedMobileApp_id}{?select,expand}";
