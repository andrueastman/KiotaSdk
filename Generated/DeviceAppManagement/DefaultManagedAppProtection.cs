    ...
    public class DefaultManagedAppProtection : ManagedAppProtection, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"appDataEncryptionType", (o,n) => { (o as DefaultManagedAppProtection).AppDataEncryptionType = n.GetObjectValue<ManagedAppDataEncryptionType>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ManagedAppDataEncryptionType>("appDataEncryptionType", AppDataEncryptionType);
