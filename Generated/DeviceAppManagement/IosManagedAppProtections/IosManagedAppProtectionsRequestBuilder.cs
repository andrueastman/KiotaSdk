...
namespace ApiSdk.DeviceAppManagement.IosManagedAppProtections {
    ...
    public class IosManagedAppProtectionsRequestBuilder {
        ...
        public IosManagedAppProtectionRequestBuilder this[string position] { get {
            return new IosManagedAppProtectionRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public IosManagedAppProtectionsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
