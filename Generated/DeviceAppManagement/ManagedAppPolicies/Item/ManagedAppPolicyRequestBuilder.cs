using GraphSdk.DeviceAppManagement.ManagedAppPolicies.Item.ManagedAppProtection;
using GraphSdk.DeviceAppManagement.ManagedAppPolicies.Item.TargetApps;
using GraphSdk.DeviceAppManagement.ManagedAppPolicies.Item.TargetedManagedAppProtection;
using GraphSdk.DeviceAppManagement.ManagedAppPolicies.Item.WindowsInformationProtection;
...
namespace GraphSdk.DeviceAppManagement.ManagedAppPolicies.Item {
    ...
    public class ManagedAppPolicyRequestBuilder {
        ...
        public ManagedAppPolicyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceAppManagement/managedAppPolicies/{managedAppPolicy_id}{?select,expand}";
