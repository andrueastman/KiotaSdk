    ...
    public class ManagedAppProtection : ManagedAppPolicy, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"allowedDataStorageLocations", (o,n) => { (o as ManagedAppProtection).AllowedDataStorageLocations = n.GetCollectionOfPrimitiveValues<ManagedAppDataStorageLocation>().ToList(); } },
                {"allowedInboundDataTransferSources", (o,n) => { (o as ManagedAppProtection).AllowedInboundDataTransferSources = n.GetObjectValue<ManagedAppDataTransferLevel>(); } },
                {"allowedOutboundClipboardSharingLevel", (o,n) => { (o as ManagedAppProtection).AllowedOutboundClipboardSharingLevel = n.GetObjectValue<ManagedAppClipboardSharingLevel>(); } },
                {"allowedOutboundDataTransferDestinations", (o,n) => { (o as ManagedAppProtection).AllowedOutboundDataTransferDestinations = n.GetObjectValue<ManagedAppDataTransferLevel>(); } },
                ...
                {"managedBrowser", (o,n) => { (o as ManagedAppProtection).ManagedBrowser = n.GetObjectValue<ManagedBrowserType>(); } },
                ...
                {"pinCharacterSet", (o,n) => { (o as ManagedAppProtection).PinCharacterSet = n.GetObjectValue<ManagedAppPinCharacterSet>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<ManagedAppDataStorageLocation>("allowedDataStorageLocations", AllowedDataStorageLocations);
            writer.WriteObjectValue<ManagedAppDataTransferLevel>("allowedInboundDataTransferSources", AllowedInboundDataTransferSources);
            writer.WriteObjectValue<ManagedAppClipboardSharingLevel>("allowedOutboundClipboardSharingLevel", AllowedOutboundClipboardSharingLevel);
            writer.WriteObjectValue<ManagedAppDataTransferLevel>("allowedOutboundDataTransferDestinations", AllowedOutboundDataTransferDestinations);
            ...
            writer.WriteObjectValue<ManagedBrowserType>("managedBrowser", ManagedBrowser);
            ...
            writer.WriteObjectValue<ManagedAppPinCharacterSet>("pinCharacterSet", PinCharacterSet);
