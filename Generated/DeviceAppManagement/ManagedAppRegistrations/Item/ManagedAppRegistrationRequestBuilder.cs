...
namespace GraphServiceClient.DeviceAppManagement.ManagedAppRegistrations.Item {
    ...
    public class ManagedAppRegistrationRequestBuilder {
        public AppliedPoliciesRequestBuilder AppliedPolicies { get =>
            new AppliedPoliciesRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        ...
        public IntendedPoliciesRequestBuilder IntendedPolicies { get =>
            new IntendedPoliciesRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        ...
        /// </summary>
        public ManagedAppRegistrationRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ManagedAppRegistration body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ManagedAppRegistration> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<ManagedAppRegistration>(requestInfo, responseHandler);
        }
        /// <summary>
        /// The managed app registrations.
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ManagedAppRegistration body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
