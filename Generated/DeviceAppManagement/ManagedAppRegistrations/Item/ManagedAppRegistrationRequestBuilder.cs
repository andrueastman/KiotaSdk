...
namespace ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item {
    ...
    public class ManagedAppRegistrationRequestBuilder {
        public AppliedPoliciesRequestBuilder AppliedPolicies { get =>
            new AppliedPoliciesRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        /// <summary>Current path for the request</summary>
        private string CurrentPath { get; set; }
        public IntendedPoliciesRequestBuilder IntendedPolicies { get =>
            new IntendedPoliciesRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        /// </summary>
        public ManagedAppRegistrationRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
