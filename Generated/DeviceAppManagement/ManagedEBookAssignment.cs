    ...
    public class ManagedEBookAssignment : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"installIntent", (o,n) => { (o as ManagedEBookAssignment).InstallIntent = n.GetObjectValue<InstallIntent>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<InstallIntent>("installIntent", InstallIntent);
