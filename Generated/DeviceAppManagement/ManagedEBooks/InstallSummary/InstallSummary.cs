...
namespace GraphServiceClient.DeviceAppManagement.ManagedEBooks.InstallSummary {
    public class InstallSummary : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"failedDeviceCount", (o,n) => { (o as InstallSummary).FailedDeviceCount = n.GetIntValue(); } },
                {"failedUserCount", (o,n) => { (o as InstallSummary).FailedUserCount = n.GetIntValue(); } },
                {"installedDeviceCount", (o,n) => { (o as InstallSummary).InstalledDeviceCount = n.GetIntValue(); } },
                {"installedUserCount", (o,n) => { (o as InstallSummary).InstalledUserCount = n.GetIntValue(); } },
                {"notInstalledDeviceCount", (o,n) => { (o as InstallSummary).NotInstalledDeviceCount = n.GetIntValue(); } },
                {"notInstalledUserCount", (o,n) => { (o as InstallSummary).NotInstalledUserCount = n.GetIntValue(); } },
            };
        }
        /// <summary>
