...
using System.Linq;
namespace GraphServiceClient.DeviceAppManagement.ManagedEBooks.Microsoft.Graph.Assign {
    public class Microsoft.graph.assignResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"managedEBookAssignments", (o,n) => { (o as Microsoft.graph.assignResponse).ManagedEBookAssignments = n.GetCollectionOfObjectValues<ManagedEBookAssignment>().ToList(); } },
            };
        }
        /// <summary>
