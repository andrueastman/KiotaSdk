    ...
    public class MobileApp : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"publishingState", (o,n) => { (o as MobileApp).PublishingState = n.GetObjectValue<MobileAppPublishingState>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MobileAppPublishingState>("publishingState", PublishingState);
        }
    }
}
