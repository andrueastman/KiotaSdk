...
using System.Linq;
namespace GraphServiceClient.DeviceAppManagement.MobileApps.Microsoft.Graph.Assign {
    public class Microsoft.graph.assignResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"mobileAppAssignments", (o,n) => { (o as Microsoft.graph.assignResponse).MobileAppAssignments = n.GetCollectionOfObjectValues<MobileAppAssignment>().ToList(); } },
            };
        }
        /// <summary>
