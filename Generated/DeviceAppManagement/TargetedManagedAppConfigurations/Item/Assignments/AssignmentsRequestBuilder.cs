using GraphSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.Assignments.Item;
...
namespace GraphSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.deviceAppManagement.targetedManagedAppConfigurations.item.assignments.item collection</summary>
        ...
        public AssignmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration_id}/assignments{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TargetedManagedAppPolicyAssignment> PostAsync(TargetedManagedAppPolicyAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendAsync<TargetedManagedAppPolicyAssignment>(requestInfo, responseHandler);
        }
