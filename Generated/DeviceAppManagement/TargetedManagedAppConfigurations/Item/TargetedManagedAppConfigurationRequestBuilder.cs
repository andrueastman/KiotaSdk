...
namespace ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item {
    ...
    public class TargetedManagedAppConfigurationRequestBuilder {
        public AppsRequestBuilder Apps { get =>
            new AppsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        public DeploymentSummaryRequestBuilder DeploymentSummary { get =>
            new DeploymentSummaryRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        /// </summary>
        public TargetedManagedAppConfigurationRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
