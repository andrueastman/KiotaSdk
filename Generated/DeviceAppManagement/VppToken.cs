    ...
    public class VppToken : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"lastSyncStatus", (o,n) => { (o as VppToken).LastSyncStatus = n.GetObjectValue<VppTokenSyncStatus>(); } },
                {"organizationName", (o,n) => { (o as VppToken).OrganizationName = n.GetStringValue(); } },
                {"state", (o,n) => { (o as VppToken).State = n.GetObjectValue<VppTokenState>(); } },
                {"token", (o,n) => { (o as VppToken).Token = n.GetStringValue(); } },
                {"vppTokenAccountType", (o,n) => { (o as VppToken).VppTokenAccountType = n.GetObjectValue<VppTokenAccountType>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<VppTokenSyncStatus>("lastSyncStatus", LastSyncStatus);
            writer.WriteStringValue("organizationName", OrganizationName);
            writer.WriteObjectValue<VppTokenState>("state", State);
            writer.WriteStringValue("token", Token);
            writer.WriteObjectValue<VppTokenAccountType>("vppTokenAccountType", VppTokenAccountType);
        }
    }
}
