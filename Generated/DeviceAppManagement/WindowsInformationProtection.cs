    ...
    public class WindowsInformationProtection : ManagedAppPolicy, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"enforcementLevel", (o,n) => { (o as WindowsInformationProtection).EnforcementLevel = n.GetObjectValue<WindowsInformationProtectionEnforcementLevel>(); } },
                {"enterpriseDomain", (o,n) => { (o as WindowsInformationProtection).EnterpriseDomain = n.GetStringValue(); } },
                {"enterpriseInternalProxyServers", (o,n) => { (o as WindowsInformationProtection).EnterpriseInternalProxyServers = n.GetCollectionOfPrimitiveValues<WindowsInformationProtectionResourceCollection>().ToList(); } },
                {"enterpriseIPRanges", (o,n) => { (o as WindowsInformationProtection).EnterpriseIPRanges = n.GetCollectionOfPrimitiveValues<WindowsInformationProtectionIPRangeCollection>().ToList(); } },
                ...
                {"enterpriseNetworkDomainNames", (o,n) => { (o as WindowsInformationProtection).EnterpriseNetworkDomainNames = n.GetCollectionOfPrimitiveValues<WindowsInformationProtectionResourceCollection>().ToList(); } },
                {"enterpriseProtectedDomainNames", (o,n) => { (o as WindowsInformationProtection).EnterpriseProtectedDomainNames = n.GetCollectionOfPrimitiveValues<WindowsInformationProtectionResourceCollection>().ToList(); } },
                {"enterpriseProxiedDomains", (o,n) => { (o as WindowsInformationProtection).EnterpriseProxiedDomains = n.GetCollectionOfPrimitiveValues<WindowsInformationProtectionProxiedDomainCollection>().ToList(); } },
                {"enterpriseProxyServers", (o,n) => { (o as WindowsInformationProtection).EnterpriseProxyServers = n.GetCollectionOfPrimitiveValues<WindowsInformationProtectionResourceCollection>().ToList(); } },
                ...
                {"exemptApps", (o,n) => { (o as WindowsInformationProtection).ExemptApps = n.GetCollectionOfPrimitiveValues<WindowsInformationProtectionApp>().ToList(); } },
                ...
                {"neutralDomainResources", (o,n) => { (o as WindowsInformationProtection).NeutralDomainResources = n.GetCollectionOfPrimitiveValues<WindowsInformationProtectionResourceCollection>().ToList(); } },
                ...
                {"protectedApps", (o,n) => { (o as WindowsInformationProtection).ProtectedApps = n.GetCollectionOfPrimitiveValues<WindowsInformationProtectionApp>().ToList(); } },
                ...
                {"smbAutoEncryptedFileExtensions", (o,n) => { (o as WindowsInformationProtection).SmbAutoEncryptedFileExtensions = n.GetCollectionOfPrimitiveValues<WindowsInformationProtectionResourceCollection>().ToList(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<WindowsInformationProtectionEnforcementLevel>("enforcementLevel", EnforcementLevel);
            writer.WriteStringValue("enterpriseDomain", EnterpriseDomain);
            writer.WriteCollectionOfPrimitiveValues<WindowsInformationProtectionResourceCollection>("enterpriseInternalProxyServers", EnterpriseInternalProxyServers);
            writer.WriteCollectionOfPrimitiveValues<WindowsInformationProtectionIPRangeCollection>("enterpriseIPRanges", EnterpriseIPRanges);
            writer.WriteBoolValue("enterpriseIPRangesAreAuthoritative", EnterpriseIPRangesAreAuthoritative);
            writer.WriteCollectionOfPrimitiveValues<WindowsInformationProtectionResourceCollection>("enterpriseNetworkDomainNames", EnterpriseNetworkDomainNames);
            writer.WriteCollectionOfPrimitiveValues<WindowsInformationProtectionResourceCollection>("enterpriseProtectedDomainNames", EnterpriseProtectedDomainNames);
            writer.WriteCollectionOfPrimitiveValues<WindowsInformationProtectionProxiedDomainCollection>("enterpriseProxiedDomains", EnterpriseProxiedDomains);
            writer.WriteCollectionOfPrimitiveValues<WindowsInformationProtectionResourceCollection>("enterpriseProxyServers", EnterpriseProxyServers);
            ...
            writer.WriteCollectionOfPrimitiveValues<WindowsInformationProtectionApp>("exemptApps", ExemptApps);
            ...
            writer.WriteCollectionOfPrimitiveValues<WindowsInformationProtectionResourceCollection>("neutralDomainResources", NeutralDomainResources);
            ...
            writer.WriteCollectionOfPrimitiveValues<WindowsInformationProtectionApp>("protectedApps", ProtectedApps);
            ...
            writer.WriteCollectionOfPrimitiveValues<WindowsInformationProtectionResourceCollection>("smbAutoEncryptedFileExtensions", SmbAutoEncryptedFileExtensions);
        }
    }
}
