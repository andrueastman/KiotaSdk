    ...
    public class WindowsInformationProtectionPolicy : WindowsInformationProtection, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"pinLowercaseLetters", (o,n) => { (o as WindowsInformationProtectionPolicy).PinLowercaseLetters = n.GetObjectValue<WindowsInformationProtectionPinCharacterRequirements>(); } },
                {"pinMinimumLength", (o,n) => { (o as WindowsInformationProtectionPolicy).PinMinimumLength = n.GetIntValue(); } },
                {"pinSpecialCharacters", (o,n) => { (o as WindowsInformationProtectionPolicy).PinSpecialCharacters = n.GetObjectValue<WindowsInformationProtectionPinCharacterRequirements>(); } },
                {"pinUppercaseLetters", (o,n) => { (o as WindowsInformationProtectionPolicy).PinUppercaseLetters = n.GetObjectValue<WindowsInformationProtectionPinCharacterRequirements>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<WindowsInformationProtectionPinCharacterRequirements>("pinLowercaseLetters", PinLowercaseLetters);
            writer.WriteIntValue("pinMinimumLength", PinMinimumLength);
            writer.WriteObjectValue<WindowsInformationProtectionPinCharacterRequirements>("pinSpecialCharacters", PinSpecialCharacters);
            writer.WriteObjectValue<WindowsInformationProtectionPinCharacterRequirements>("pinUppercaseLetters", PinUppercaseLetters);
