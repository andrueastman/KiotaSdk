    ...
    public class ComplianceManagementPartner : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"androidEnrollmentAssignments", (o,n) => { (o as ComplianceManagementPartner).AndroidEnrollmentAssignments = n.GetCollectionOfPrimitiveValues<ComplianceManagementPartnerAssignment>().ToList(); } },
                ...
                {"iosEnrollmentAssignments", (o,n) => { (o as ComplianceManagementPartner).IosEnrollmentAssignments = n.GetCollectionOfPrimitiveValues<ComplianceManagementPartnerAssignment>().ToList(); } },
                ...
                {"macOsEnrollmentAssignments", (o,n) => { (o as ComplianceManagementPartner).MacOsEnrollmentAssignments = n.GetCollectionOfPrimitiveValues<ComplianceManagementPartnerAssignment>().ToList(); } },
                {"macOsOnboarded", (o,n) => { (o as ComplianceManagementPartner).MacOsOnboarded = n.GetBoolValue(); } },
                {"partnerState", (o,n) => { (o as ComplianceManagementPartner).PartnerState = n.GetObjectValue<DeviceManagementPartnerTenantState>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<ComplianceManagementPartnerAssignment>("androidEnrollmentAssignments", AndroidEnrollmentAssignments);
            writer.WriteBoolValue("androidOnboarded", AndroidOnboarded);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteCollectionOfPrimitiveValues<ComplianceManagementPartnerAssignment>("iosEnrollmentAssignments", IosEnrollmentAssignments);
            ...
            writer.WriteCollectionOfPrimitiveValues<ComplianceManagementPartnerAssignment>("macOsEnrollmentAssignments", MacOsEnrollmentAssignments);
            writer.WriteBoolValue("macOsOnboarded", MacOsOnboarded);
            writer.WriteObjectValue<DeviceManagementPartnerTenantState>("partnerState", PartnerState);
        }
    }
}
