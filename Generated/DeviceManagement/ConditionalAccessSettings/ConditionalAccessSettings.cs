...
using System.Linq;
namespace GraphServiceClient.DeviceManagement.ConditionalAccessSettings {
    public class ConditionalAccessSettings : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"enabled", (o,n) => { (o as ConditionalAccessSettings).Enabled = n.GetBoolValue(); } },
                {"excludedGroups", (o,n) => { (o as ConditionalAccessSettings).ExcludedGroups = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"includedGroups", (o,n) => { (o as ConditionalAccessSettings).IncludedGroups = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"overrideDefaultRule", (o,n) => { (o as ConditionalAccessSettings).OverrideDefaultRule = n.GetBoolValue(); } },
            };
        }
        /// <summary>
