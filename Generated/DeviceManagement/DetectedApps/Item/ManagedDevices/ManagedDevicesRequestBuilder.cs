using GraphSdk.DeviceManagement.DetectedApps.Item.ManagedDevices.Ref;
...
namespace GraphSdk.DeviceManagement.DetectedApps.Item.ManagedDevices {
    ...
    public class ManagedDevicesRequestBuilder {
        ...
        public ManagedDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceManagement/detectedApps/{detectedApp_id}/managedDevices{?top,skip,search,filter,count,orderby,select,expand}";
