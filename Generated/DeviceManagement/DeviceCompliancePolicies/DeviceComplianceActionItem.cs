    ...
    public class DeviceComplianceActionItem : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"actionType", (o,n) => { (o as DeviceComplianceActionItem).ActionType = n.GetObjectValue<DeviceComplianceActionType>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<DeviceComplianceActionType>("actionType", ActionType);
