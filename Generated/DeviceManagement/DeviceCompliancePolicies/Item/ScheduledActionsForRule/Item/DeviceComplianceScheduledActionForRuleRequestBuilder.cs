...
namespace ApiSdk.DeviceManagement.DeviceCompliancePolicies.Item.ScheduledActionsForRule.Item {
    ...
    public class DeviceComplianceScheduledActionForRuleRequestBuilder {
        ...
        public ScheduledActionConfigurationsRequestBuilder ScheduledActionConfigurations { get =>
            new ScheduledActionConfigurationsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        /// <summary>
        ...
        /// </summary>
        public DeviceComplianceScheduledActionForRuleRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
