...
namespace ApiSdk.DeviceManagement.DeviceCompliancePolicies.Item.ScheduledActionsForRule.Item.ScheduledActionConfigurations {
    ...
    public class ScheduledActionConfigurationsRequestBuilder {
        ...
        public DeviceComplianceActionItemRequestBuilder this[string position] { get {
            return new DeviceComplianceActionItemRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public ScheduledActionConfigurationsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
