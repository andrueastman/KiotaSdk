    ...
    public class DeviceCompliancePolicyState : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"platformType", (o,n) => { (o as DeviceCompliancePolicyState).PlatformType = n.GetObjectValue<PolicyPlatformType>(); } },
                {"settingCount", (o,n) => { (o as DeviceCompliancePolicyState).SettingCount = n.GetIntValue(); } },
                {"settingStates", (o,n) => { (o as DeviceCompliancePolicyState).SettingStates = n.GetCollectionOfPrimitiveValues<DeviceCompliancePolicySettingState>().ToList(); } },
                {"state", (o,n) => { (o as DeviceCompliancePolicyState).State = n.GetObjectValue<ComplianceStatus>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<PolicyPlatformType>("platformType", PlatformType);
            writer.WriteIntValue("settingCount", SettingCount);
            writer.WriteCollectionOfPrimitiveValues<DeviceCompliancePolicySettingState>("settingStates", SettingStates);
            writer.WriteObjectValue<ComplianceStatus>("state", State);
