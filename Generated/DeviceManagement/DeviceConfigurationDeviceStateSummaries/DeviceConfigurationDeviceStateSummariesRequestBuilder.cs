...
namespace ApiSdk.DeviceManagement.DeviceConfigurationDeviceStateSummaries {
    ...
    public class DeviceConfigurationDeviceStateSummariesRequestBuilder {
        ...
        /// </summary>
        public DeviceConfigurationDeviceStateSummariesRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceConfigurationDeviceStateSummary> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<DeviceConfigurationDeviceStateSummary>(requestInfo, responseHandler);
        }
        /// <summary>
        /// The device configuration device state summary for this account.
        /// <param name="body"></param>
