    ...
    public class DeviceConfigurationState : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"platformType", (o,n) => { (o as DeviceConfigurationState).PlatformType = n.GetObjectValue<PolicyPlatformType>(); } },
                {"settingCount", (o,n) => { (o as DeviceConfigurationState).SettingCount = n.GetIntValue(); } },
                {"settingStates", (o,n) => { (o as DeviceConfigurationState).SettingStates = n.GetCollectionOfPrimitiveValues<DeviceConfigurationSettingState>().ToList(); } },
                {"state", (o,n) => { (o as DeviceConfigurationState).State = n.GetObjectValue<ComplianceStatus>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<DeviceConfigurationSettingState>("settingStates", SettingStates);
