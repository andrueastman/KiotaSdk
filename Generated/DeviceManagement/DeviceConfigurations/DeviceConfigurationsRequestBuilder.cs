...
namespace ApiSdk.DeviceManagement.DeviceConfigurations {
    ...
    public class DeviceConfigurationsRequestBuilder {
        ...
        public DeviceConfigurationRequestBuilder this[string position] { get {
            return new DeviceConfigurationRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public DeviceConfigurationsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
