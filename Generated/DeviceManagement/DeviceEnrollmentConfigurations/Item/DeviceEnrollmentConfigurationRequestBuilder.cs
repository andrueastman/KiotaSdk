...
namespace ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item {
    ...
    public class DeviceEnrollmentConfigurationRequestBuilder {
        ...
        public SetPriorityRequestBuilder SetPriority { get =>
            new SetPriorityRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        /// <summary>
        ...
        /// </summary>
        public DeviceEnrollmentConfigurationRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
