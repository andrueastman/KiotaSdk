    ...
    public class DeviceManagementExchangeConnector : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"exchangeConnectorType", (o,n) => { (o as DeviceManagementExchangeConnector).ExchangeConnectorType = n.GetObjectValue<DeviceManagementExchangeConnectorType>(); } },
                ...
                {"status", (o,n) => { (o as DeviceManagementExchangeConnector).Status = n.GetObjectValue<DeviceManagementExchangeConnectorStatus>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<DeviceManagementExchangeConnectorType>("exchangeConnectorType", ExchangeConnectorType);
            ...
            writer.WriteObjectValue<DeviceManagementExchangeConnectorStatus>("status", Status);
