    ...
    public class DeviceManagementPartner : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"partnerAppType", (o,n) => { (o as DeviceManagementPartner).PartnerAppType = n.GetObjectValue<DeviceManagementPartnerAppType>(); } },
                {"partnerState", (o,n) => { (o as DeviceManagementPartner).PartnerState = n.GetObjectValue<DeviceManagementPartnerTenantState>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<DeviceManagementPartnerAppType>("partnerAppType", PartnerAppType);
