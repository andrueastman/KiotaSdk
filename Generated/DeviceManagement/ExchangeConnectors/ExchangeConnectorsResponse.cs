...
namespace GraphServiceClient.DeviceManagement.ExchangeConnectors {
    public class ExchangeConnectorsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ExchangeConnectorsResponse).Value = n.GetCollectionOfObjectValues<DeviceManagementExchangeConnector>().ToList(); } },
            };
        }
        /// <summary>
