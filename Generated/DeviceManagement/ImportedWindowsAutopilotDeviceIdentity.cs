    ...
    public class ImportedWindowsAutopilotDeviceIdentity : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"hardwareIdentifier", (o,n) => { (o as ImportedWindowsAutopilotDeviceIdentity).HardwareIdentifier = n.GetObjectValue<Byte[]>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Byte[]>("hardwareIdentifier", HardwareIdentifier);
