    ...
    public class IosUpdateDeviceStatus : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"installStatus", (o,n) => { (o as IosUpdateDeviceStatus).InstallStatus = n.GetObjectValue<IosUpdatesInstallStatus>(); } },
                ...
                {"status", (o,n) => { (o as IosUpdateDeviceStatus).Status = n.GetObjectValue<ComplianceStatus>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<IosUpdatesInstallStatus>("installStatus", InstallStatus);
            writer.WriteDateTimeOffsetValue("lastReportedDateTime", LastReportedDateTime);
            writer.WriteStringValue("osVersion", OsVersion);
            writer.WriteObjectValue<ComplianceStatus>("status", Status);
