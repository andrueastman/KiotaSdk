...
namespace GraphServiceClient.DeviceManagement.IosUpdateStatuses {
    public class IosUpdateStatusesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as IosUpdateStatusesResponse).Value = n.GetCollectionOfObjectValues<IosUpdateDeviceStatus>().ToList(); } },
            };
        }
        /// <summary>
