...
namespace GraphSdk.DeviceManagement.ManagedDevices.Item.RebootNow {
    ...
    public class RebootNowRequestBuilder {
        ...
        public RebootNowRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceManagement/managedDevices/{managedDevice_id}/microsoft.graph.rebootNow";
