...
namespace GraphSdk.DeviceManagement.ManagedDevices.Item.SyncDevice {
    ...
    public class SyncDeviceRequestBuilder {
        ...
        public SyncDeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceManagement/managedDevices/{managedDevice_id}/microsoft.graph.syncDevice";
