...
namespace GraphSdk.DeviceManagement.ManagedDevices.Item.WindowsDefenderUpdateSignatures {
    ...
    public class WindowsDefenderUpdateSignaturesRequestBuilder {
        ...
        public WindowsDefenderUpdateSignaturesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceManagement/managedDevices/{managedDevice_id}/microsoft.graph.windowsDefenderUpdateSignatures";
