...
namespace GraphServiceClient.DeviceManagement.Microsoft.Graph.VerifyWindowsEnrollmentAutoDiscovery(domainName='{domainName}') {
    ...
    public class Microsoft.graph.verifyWindowsEnrollmentAutoDiscoveryRequestBuilder {
        ...
        /// </summary>
        public Microsoft.graph.verifyWindowsEnrollmentAutoDiscoveryRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
