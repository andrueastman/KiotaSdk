    ...
    public class MobileThreatDefenseConnector : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"partnerState", (o,n) => { (o as MobileThreatDefenseConnector).PartnerState = n.GetObjectValue<MobileThreatPartnerTenantState>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MobileThreatPartnerTenantState>("partnerState", PartnerState);
