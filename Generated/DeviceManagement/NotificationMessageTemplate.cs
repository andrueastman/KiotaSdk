    ...
    public class NotificationMessageTemplate : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"brandingOptions", (o,n) => { (o as NotificationMessageTemplate).BrandingOptions = n.GetObjectValue<NotificationTemplateBrandingOptions>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<NotificationTemplateBrandingOptions>("brandingOptions", BrandingOptions);
