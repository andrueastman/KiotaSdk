...
namespace ApiSdk.DeviceManagement.NotificationMessageTemplates.Item {
    ...
    public class NotificationMessageTemplateRequestBuilder {
        ...
        public LocalizedNotificationMessagesRequestBuilder LocalizedNotificationMessages { get =>
            new LocalizedNotificationMessagesRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        public SendTestMessageRequestBuilder SendTestMessage { get =>
            new SendTestMessageRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        /// <summary>
        ...
        /// </summary>
        public NotificationMessageTemplateRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
