...
namespace GraphServiceClient.DeviceManagement.NotificationMessageTemplates.Microsoft.Graph.SendTestMessage {
    ...
    public class Microsoft.graph.sendTestMessageRequestBuilder {
        ...
        /// </summary>
        public Microsoft.graph.sendTestMessageRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
            if(string.IsNullOrEmpty(currentPath)) throw new ArgumentNullException(nameof(currentPath));
            _ = httpCore ?? throw new ArgumentNullException(nameof(httpCore));
            PathSegment = "/microsoft.graph.sendTestMessage";
            HttpCore = httpCore;
