...
namespace GraphServiceClient.DeviceManagement.NotificationMessageTemplates {
    public class NotificationMessageTemplatesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as NotificationMessageTemplatesResponse).Value = n.GetCollectionOfObjectValues<NotificationMessageTemplate>().ToList(); } },
            };
        }
        /// <summary>
