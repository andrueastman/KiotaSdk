...
namespace GraphServiceClient.DeviceManagement.RemoteAssistancePartners.Microsoft.Graph.Disconnect {
    ...
    public class Microsoft.graph.disconnectRequestBuilder {
        ...
        /// </summary>
        public Microsoft.graph.disconnectRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
            if(string.IsNullOrEmpty(currentPath)) throw new ArgumentNullException(nameof(currentPath));
            _ = httpCore ?? throw new ArgumentNullException(nameof(httpCore));
            PathSegment = "/microsoft.graph.disconnect";
            HttpCore = httpCore;
