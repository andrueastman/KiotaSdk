...
namespace ApiSdk.DeviceManagement.RoleAssignments {
    ...
    public class RoleAssignmentsRequestBuilder {
        ...
        public DeviceAndAppManagementRoleAssignmentRequestBuilder this[string position] { get {
            return new DeviceAndAppManagementRoleAssignmentRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public RoleAssignmentsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
