...
namespace ApiSdk.DeviceManagement.RoleDefinitions.Item.RoleAssignments.Item {
    ...
    public class RoleAssignmentRequestBuilder {
        ...
        public RoleDefinitionRequestBuilder RoleDefinition { get =>
            new RoleDefinitionRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        /// <summary>
        ...
        /// </summary>
        public RoleAssignmentRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
