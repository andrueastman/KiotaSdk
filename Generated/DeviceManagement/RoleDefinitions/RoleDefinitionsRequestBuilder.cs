using GraphSdk.DeviceManagement.RoleDefinitions.Item;
...
namespace GraphSdk.DeviceManagement.RoleDefinitions {
    ...
    public class RoleDefinitionsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.deviceManagement.roleDefinitions.item collection</summary>
        ...
        public RoleDefinitionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceManagement/roleDefinitions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GraphSdk.Models.Microsoft.Graph.RoleDefinition body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
