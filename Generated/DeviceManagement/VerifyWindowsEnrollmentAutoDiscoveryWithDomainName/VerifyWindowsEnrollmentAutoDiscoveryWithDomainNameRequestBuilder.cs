...
namespace ApiSdk.DeviceManagement.VerifyWindowsEnrollmentAutoDiscoveryWithDomainName {
    ...
    public class VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameRequestBuilder {
        ...
        /// </summary>
        public VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string domainName = default, bool isRawUrl = true) {
