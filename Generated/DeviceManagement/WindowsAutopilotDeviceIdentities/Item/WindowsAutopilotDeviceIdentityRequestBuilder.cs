...
namespace ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item {
    ...
    public class WindowsAutopilotDeviceIdentityRequestBuilder {
        public AssignUserToDeviceRequestBuilder AssignUserToDevice { get =>
            new AssignUserToDeviceRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        public UnassignUserFromDeviceRequestBuilder UnassignUserFromDevice { get =>
            new UnassignUserFromDeviceRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        public UpdateDevicePropertiesRequestBuilder UpdateDeviceProperties { get =>
            new UpdateDevicePropertiesRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        /// <summary>
        ...
        /// </summary>
        public WindowsAutopilotDeviceIdentityRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
