...
namespace GraphServiceClient.DeviceManagement.WindowsAutopilotDeviceIdentities.Microsoft.Graph.UnassignUserFromDevice {
    ...
    public class Microsoft.graph.unassignUserFromDeviceRequestBuilder {
        ...
        /// <summary>
        /// Instantiates a new Microsoft.graph.unassignUserFromDeviceRequestBuilder and sets the default values.
        /// <param name="currentPath">Current path for the request</param>
        /// <param name="httpCore">The http core service to use to execute the requests.</param>
        /// <param name="isRawUrl">Whether the current path is a raw URL</param>
        /// </summary>
        public Microsoft.graph.unassignUserFromDeviceRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
