    ...
    public class WindowsInformationProtectionAppLearningSummary : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"applicationType", (o,n) => { (o as WindowsInformationProtectionAppLearningSummary).ApplicationType = n.GetObjectValue<ApplicationType>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ApplicationType>("applicationType", ApplicationType);
