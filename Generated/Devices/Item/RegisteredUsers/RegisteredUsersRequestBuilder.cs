using GraphSdk.Devices.Item.RegisteredUsers.Ref;
...
namespace GraphSdk.Devices.Item.RegisteredUsers {
    ...
    public class RegisteredUsersRequestBuilder {
        ...
        public RegisteredUsersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/devices/{device_id}/registeredUsers{?top,skip,search,filter,count,orderby,select,expand}";
        ...
        /// </summary>
        public async Task<RegisteredUsersResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<RegisteredUsersResponse>(requestInfo, responseHandler);
        }
