using GraphServiceClient.Devices.RegisteredUsers.$ref;
...
namespace GraphServiceClient.Devices.RegisteredUsers {
    ...
    public class RegisteredUsersRequestBuilder {
        ...
        /// </summary>
        public RegisteredUsersRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
            if(string.IsNullOrEmpty(currentPath)) throw new ArgumentNullException(nameof(currentPath));
            _ = httpCore ?? throw new ArgumentNullException(nameof(httpCore));
            PathSegment = "/registeredUsers";
            HttpCore = httpCore;
        ...
        /// </summary>
        public async Task<RegisteredUsersResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<RegisteredUsersResponse>(requestInfo, responseHandler);
        }
