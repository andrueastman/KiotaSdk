using GraphSdk.Directory.AdministrativeUnits.Item.Extensions.Item;
...
namespace GraphSdk.Directory.AdministrativeUnits.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.directory.administrativeUnits.item.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/directory/administrativeUnits/{administrativeUnit_id}/extensions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
