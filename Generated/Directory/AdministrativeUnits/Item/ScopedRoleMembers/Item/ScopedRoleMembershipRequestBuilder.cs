...
namespace GraphSdk.Directory.AdministrativeUnits.Item.ScopedRoleMembers.Item {
    ...
    public class ScopedRoleMembershipRequestBuilder {
        ...
        public ScopedRoleMembershipRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/directory/administrativeUnits/{administrativeUnit_id}/scopedRoleMembers/{scopedRoleMembership_id}{?select,expand}";
