...
namespace ApiSdk.DirectoryObjects {
    ...
    public class DirectoryObjectsRequestBuilder {
        ...
        /// </summary>
        public DirectoryObjectsRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
            if(string.IsNullOrEmpty(currentPath)) throw new ArgumentNullException(nameof(currentPath));
            _ = httpCore ?? throw new ArgumentNullException(nameof(httpCore));
            PathSegment = "/directoryObjects";
            HttpCore = httpCore;
        ...
        /// </summary>
        public async Task<DirectoryObjectsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<DirectoryObjectsResponse>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Add new entity to directoryObjects
        /// <param name="body"></param>
