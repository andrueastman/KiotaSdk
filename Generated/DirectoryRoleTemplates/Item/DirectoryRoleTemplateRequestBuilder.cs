using GraphServiceClient.DirectoryRoleTemplates.Microsoft.Graph.CheckMemberGroups;
using GraphServiceClient.DirectoryRoleTemplates.Microsoft.Graph.CheckMemberObjects;
using GraphServiceClient.DirectoryRoleTemplates.Microsoft.Graph.GetMemberGroups;
using GraphServiceClient.DirectoryRoleTemplates.Microsoft.Graph.GetMemberObjects;
using GraphServiceClient.DirectoryRoleTemplates.Microsoft.Graph.Restore;
...
namespace GraphServiceClient.DirectoryRoleTemplates.Item {
    ...
    public class DirectoryRoleTemplateRequestBuilder {
        ...
        /// </summary>
        public DirectoryRoleTemplateRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(DirectoryRoleTemplate body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DirectoryRoleTemplate> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<DirectoryRoleTemplate>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Represents an Azure Active Directory object. The directoryObject type is the base type for many other directory entity types.
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DirectoryRoleTemplate body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
