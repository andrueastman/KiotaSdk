...
namespace ApiSdk.DirectoryRoles {
    ...
    public class DirectoryRolesRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.directoryRoles.item collection</summary>
        public DirectoryRoleRequestBuilder this[string position] { get {
            return new DirectoryRoleRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public DirectoryRolesRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
