using GraphSdk.Domains.Item.VerificationDnsRecords.Item;
...
namespace GraphSdk.Domains.Item.VerificationDnsRecords {
    ...
    public class VerificationDnsRecordsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.domains.item.verificationDnsRecords.item collection</summary>
        ...
        public VerificationDnsRecordsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/domains/{domain_id}/verificationDnsRecords{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public async Task<VerificationDnsRecordsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<VerificationDnsRecordsResponse>(requestInfo, responseHandler);
        }
        /// <summary>
        /// DNS records that the customer adds to the DNS zone file of the domain before the customer can complete domain ownership verification with Azure AD. Read-only, Nullable
        /// <param name="body"></param>
