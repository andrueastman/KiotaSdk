...
namespace ApiSdk.Domains.Item.Verify {
    ...
    public class VerifyRequestBuilder {
        ...
        /// </summary>
        public VerifyRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<VerifyResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(h, o);
            return await HttpCore.SendAsync<VerifyResponse>(requestInfo, responseHandler);
        }
