using GraphSdk.Drive.Bundles.Item.Content;
...
namespace GraphSdk.Drive.Bundles.Item {
    /// <summary>Builds and executes requests for operations under \drive\bundles\{driveItem-id}</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/bundles/{driveItem_id}{?select,expand}";
