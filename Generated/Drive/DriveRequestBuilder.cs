using GraphServiceClient.Drive.Following;
using GraphServiceClient.Drive.Items;
using GraphServiceClient.Drive.List;
using GraphServiceClient.Drive.Root;
using GraphServiceClient.Drive.Special;
...
namespace GraphServiceClient.Drive {
    ...
    public class DriveRequestBuilder {
        ...
        public FollowingRequestBuilder Following { get =>
            new FollowingRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        ...
        public SpecialRequestBuilder Special { get =>
            new SpecialRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        /// <summary>
        ...
        /// </summary>
        public DriveRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
