using GraphSdk.Drive.Items.Item.Content;
...
namespace GraphSdk.Drive.Items.Item {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/items/{driveItem_id}{?select,expand}";
