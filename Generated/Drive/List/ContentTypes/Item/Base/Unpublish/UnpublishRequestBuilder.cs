...
namespace GraphSdk.Drive.List.ContentTypes.Item.Base.Unpublish {
    ...
    public class UnpublishRequestBuilder {
        ...
        public UnpublishRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/list/contentTypes/{contentType_id}/base/microsoft.graph.unpublish";
