using GraphSdk.Drive.List.ContentTypes.Item.AssociateWithHubSites;
using GraphSdk.Drive.List.ContentTypes.Item.Base;
using GraphSdk.Drive.List.ContentTypes.Item.BaseTypes;
using GraphSdk.Drive.List.ContentTypes.Item.ColumnLinks;
using GraphSdk.Drive.List.ContentTypes.Item.ColumnPositions;
using GraphSdk.Drive.List.ContentTypes.Item.Columns;
using GraphSdk.Drive.List.ContentTypes.Item.CopyToDefaultContentLocation;
using GraphSdk.Drive.List.ContentTypes.Item.IsPublished;
using GraphSdk.Drive.List.ContentTypes.Item.Publish;
using GraphSdk.Drive.List.ContentTypes.Item.Unpublish;
...
namespace GraphSdk.Drive.List.ContentTypes.Item {
    ...
    public class ContentTypeRequestBuilder {
        ...
        public ContentTypeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/list/contentTypes/{contentType_id}{?select,expand}";
