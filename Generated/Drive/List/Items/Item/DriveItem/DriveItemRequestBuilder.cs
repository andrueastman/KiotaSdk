using GraphSdk.Drive.List.Items.Item.DriveItem.Content;
...
namespace GraphSdk.Drive.List.Items.Item.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/list/items/{listItem_id}/driveItem{?select,expand}";
