using GraphSdk.Drive.List.Items.Item.Versions.Item.Fields;
using GraphSdk.Drive.List.Items.Item.Versions.Item.RestoreVersion;
...
namespace GraphSdk.Drive.List.Items.Item.Versions.Item {
    ...
    public class ListItemVersionRequestBuilder {
        ...
        public ListItemVersionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/list/items/{listItem_id}/versions/{listItemVersion_id}{?select,expand}";
