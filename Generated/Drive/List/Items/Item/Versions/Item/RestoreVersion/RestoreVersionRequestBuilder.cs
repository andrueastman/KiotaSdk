...
namespace GraphSdk.Drive.List.Items.Item.Versions.Item.RestoreVersion {
    ...
    public class RestoreVersionRequestBuilder {
        ...
        public RestoreVersionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/list/items/{listItem_id}/versions/{listItemVersion_id}/microsoft.graph.restoreVersion";
