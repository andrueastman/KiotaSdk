using GraphSdk.Drives.Item.Bundles.Item.Content;
...
namespace GraphSdk.Drives.Item.Bundles.Item {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\bundles\{driveItem-id}</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drives/{drive_id}/bundles/{driveItem_id}{?select,expand}";
