using GraphSdk.Drives.Item.Items.Item.Content;
...
namespace GraphSdk.Drives.Item.Items.Item {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drives/{drive_id}/items/{driveItem_id}{?select,expand}";
