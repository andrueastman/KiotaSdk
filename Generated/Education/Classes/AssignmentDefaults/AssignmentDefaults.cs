...
namespace GraphServiceClient.Education.Classes.AssignmentDefaults {
    public class AssignmentDefaults : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"addedStudentAction", (o,n) => { (o as AssignmentDefaults).AddedStudentAction = n.GetObjectValue<EducationAddedStudentAction>(); } },
                {"dueTime", (o,n) => { (o as AssignmentDefaults).DueTime = n.GetStringValue(); } },
                {"notificationChannelUrl", (o,n) => { (o as AssignmentDefaults).NotificationChannelUrl = n.GetStringValue(); } },
            };
        }
        /// <summary>
