...
using System.Linq;
namespace GraphServiceClient.Education.Classes.AssignmentSettings {
    public class AssignmentSettings : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"submissionAnimationDisabled", (o,n) => { (o as AssignmentSettings).SubmissionAnimationDisabled = n.GetBoolValue(); } },
            };
        }
        /// <summary>
