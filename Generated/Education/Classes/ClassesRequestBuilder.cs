...
namespace ApiSdk.Education.Classes {
    ...
    public class ClassesRequestBuilder {
        ...
        public EducationClassRequestBuilder this[string position] { get {
            return new EducationClassRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public ClassesRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
