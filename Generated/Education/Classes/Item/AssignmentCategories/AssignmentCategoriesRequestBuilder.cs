...
namespace ApiSdk.Education.Classes.Item.AssignmentCategories {
    ...
    public class AssignmentCategoriesRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.education.classes.item.assignmentCategories.item collection</summary>
        public EducationCategoryRequestBuilder this[string position] { get {
            return new EducationCategoryRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public AssignmentCategoriesRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
