using GraphSdk.Education.Classes.Item.Assignments.Item.Categories.Item;
...
namespace GraphSdk.Education.Classes.Item.Assignments.Item.Categories {
    ...
    public class CategoriesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.education.classes.item.assignments.item.categories.item collection</summary>
        ...
        public CategoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/education/classes/{educationClass_id}/assignments/{educationAssignment_id}/categories{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
