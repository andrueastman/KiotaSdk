...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item {
    ...
    public class EducationSubmissionRequestBuilder {
        ...
        public OutcomesRequestBuilder Outcomes { get =>
            new OutcomesRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        public ReturnRequestBuilder Return { get =>
            new ReturnRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        public SubmitRequestBuilder Submit { get =>
            new SubmitRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        public SubmittedResourcesRequestBuilder SubmittedResources { get =>
            new SubmittedResourcesRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        public UnsubmitRequestBuilder Unsubmit { get =>
            new UnsubmitRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        /// <summary>
        ...
        /// </summary>
        public EducationSubmissionRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
