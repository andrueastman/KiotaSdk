...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item {
    /// <summary>Builds and executes requests for operations under \education\classes\{educationClass-id}\assignments\{educationAssignment-id}\submissions\{educationSubmission-id}</summary>
    public class EducationSubmissionRequestBuilder {
        ...
        public OutcomesRequestBuilder Outcomes { get =>
            new OutcomesRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        ...
        public ReturnRequestBuilder Return { get =>
            new ReturnRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        public SubmitRequestBuilder Submit { get =>
            new SubmitRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        public SubmittedResourcesRequestBuilder SubmittedResources { get =>
            new SubmittedResourcesRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        public UnsubmitRequestBuilder Unsubmit { get =>
            new UnsubmitRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        /// <summary>
        ...
        /// </summary>
        public EducationSubmissionRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(EducationSubmission body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationSubmission> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<EducationSubmission>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Once published, there is a submission object for each student representing their work and grade.  Read-only. Nullable.
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(EducationSubmission body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
        ...
        public SetUpResourcesFolderRequestBuilder setUpResourcesFolder() {
            return new SetUpResourcesFolderRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
