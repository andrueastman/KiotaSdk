...
namespace GraphSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Return {
    ...
    public class ReturnRequestBuilder {
        ...
        public ReturnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/education/classes/{educationClass_id}/assignments/{educationAssignment_id}/submissions/{educationSubmission_id}/microsoft.graph.return";
        ...
        /// </summary>
        public async Task<ReturnResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(h, o);
            return await RequestAdapter.SendAsync<ReturnResponse>(requestInfo, responseHandler);
        }
