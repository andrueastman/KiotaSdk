...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.SetUpResourcesFolder {
    ...
    public class SetUpResourcesFolderRequestBuilder {
        ...
        /// </summary>
        public SetUpResourcesFolderRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<SetUpResourcesFolderResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<SetUpResourcesFolderResponse>(requestInfo, responseHandler);
        }
