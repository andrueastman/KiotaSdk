...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Submit {
    ...
    public class SubmitRequestBuilder {
        ...
        /// </summary>
        public SubmitRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<SubmitResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(h, o);
            return await HttpCore.SendAsync<SubmitResponse>(requestInfo, responseHandler);
        }
