...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Submissions {
    ...
    public class SubmissionsRequestBuilder {
        ...
        public EducationSubmissionRequestBuilder this[string position] { get {
            return new EducationSubmissionRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public SubmissionsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
