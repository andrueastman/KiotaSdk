using GraphSdk.Education.Classes.Item.Schools.Delta;
using GraphSdk.Education.Classes.Item.Schools.Ref;
...
namespace GraphSdk.Education.Classes.Item.Schools {
    ...
    public class SchoolsRequestBuilder {
        ...
        public SchoolsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/education/classes/{educationClass_id}/schools{?top,skip,search,filter,count,orderby,select,expand}";
