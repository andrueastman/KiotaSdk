    ...
    public class EducationAssignment : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"addedStudentAction", (o,n) => { (o as EducationAssignment).AddedStudentAction = n.GetObjectValue<EducationAddedStudentAction>(); } },
                ...
                {"status", (o,n) => { (o as EducationAssignment).Status = n.GetObjectValue<EducationAssignmentStatus>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<EducationAssignmentStatus>("status", Status);
