    ...
    public class EducationRubric : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"levels", (o,n) => { (o as EducationRubric).Levels = n.GetCollectionOfPrimitiveValues<RubricLevel>().ToList(); } },
                {"qualities", (o,n) => { (o as EducationRubric).Qualities = n.GetCollectionOfPrimitiveValues<RubricQuality>().ToList(); } },
            };
        }
        /// <summary>
