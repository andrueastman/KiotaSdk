    ...
    public class EducationUser : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"externalSource", (o,n) => { (o as EducationUser).ExternalSource = n.GetObjectValue<EducationExternalSource>(); } },
                ...
                {"primaryRole", (o,n) => { (o as EducationUser).PrimaryRole = n.GetObjectValue<EducationUserRole>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<EducationExternalSource>("externalSource", ExternalSource);
            ...
            writer.WriteObjectValue<EducationUserRole>("primaryRole", PrimaryRole);
