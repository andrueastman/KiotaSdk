...
using GraphServiceClient.Education.Schools.AdministrativeUnit.$ref;
...
namespace GraphServiceClient.Education.Schools.AdministrativeUnit {
    ...
    public class AdministrativeUnitRequestBuilder {
        ...
        /// </summary>
        public AdministrativeUnitRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
