using GraphSdk.Education.Schools.Item.AdministrativeUnit;
using GraphSdk.Education.Schools.Item.Classes;
using GraphSdk.Education.Schools.Item.Users;
...
namespace GraphSdk.Education.Schools.Item {
    ...
    public class EducationSchoolRequestBuilder {
        ...
        public EducationSchoolRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/education/schools/{educationSchool_id}{?select,expand}";
