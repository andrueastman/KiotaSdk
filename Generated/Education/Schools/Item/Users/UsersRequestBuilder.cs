using GraphSdk.Education.Schools.Item.Users.Delta;
using GraphSdk.Education.Schools.Item.Users.Ref;
...
namespace GraphSdk.Education.Schools.Item.Users {
    ...
    public class UsersRequestBuilder {
        ...
        public UsersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/education/schools/{educationSchool_id}/users{?top,skip,search,filter,count,orderby,select,expand}";
