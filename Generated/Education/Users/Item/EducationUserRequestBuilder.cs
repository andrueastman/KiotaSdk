...
namespace ApiSdk.Education.Users.Item {
    ...
    public class EducationUserRequestBuilder {
        ...
        public RubricsRequestBuilder Rubrics { get =>
            new RubricsRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        ...
        public TaughtClassesRequestBuilder TaughtClasses { get =>
            new TaughtClassesRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        public UserRequestBuilder User { get =>
            new UserRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        /// <summary>
        ...
        /// </summary>
        public EducationUserRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationUser> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
