using GraphSdk.Education.Users.Item.TaughtClasses.Delta;
using GraphSdk.Education.Users.Item.TaughtClasses.Ref;
...
namespace GraphSdk.Education.Users.Item.TaughtClasses {
    ...
    public class TaughtClassesRequestBuilder {
        ...
        public TaughtClassesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/education/users/{educationUser_id}/taughtClasses{?top,skip,search,filter,count,orderby,select,expand}";
