using GraphSdk.Education.Users.Item.User.Ref;
...
namespace GraphSdk.Education.Users.Item.User {
    /// <summary>Builds and executes requests for operations under \education\users\{educationUser-id}\user</summary>
    public class UserRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/education/users/{educationUser_id}/user{?select,expand}";
