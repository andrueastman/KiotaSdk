    ...
    public class Fido2AuthenticationMethod : AuthenticationMethod, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"attestationLevel", (o,n) => { (o as Fido2AuthenticationMethod).AttestationLevel = n.GetObjectValue<AttestationLevel>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AttestationLevel>("attestationLevel", AttestationLevel);
