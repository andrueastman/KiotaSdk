...
namespace ApiSdk.GroupSettingTemplates {
    ...
    public class GroupSettingTemplatesRequestBuilder {
        ...
        public GroupSettingTemplateRequestBuilder this[string position] { get {
            return new GroupSettingTemplateRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public GroupSettingTemplatesRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
