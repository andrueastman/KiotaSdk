using GraphServiceClient.GroupSettingTemplates.Microsoft.Graph.CheckMemberGroups;
using GraphServiceClient.GroupSettingTemplates.Microsoft.Graph.CheckMemberObjects;
using GraphServiceClient.GroupSettingTemplates.Microsoft.Graph.GetMemberGroups;
using GraphServiceClient.GroupSettingTemplates.Microsoft.Graph.GetMemberObjects;
using GraphServiceClient.GroupSettingTemplates.Microsoft.Graph.Restore;
...
namespace GraphServiceClient.GroupSettingTemplates.Item {
    ...
    public class GroupSettingTemplateRequestBuilder {
        ...
        /// </summary>
        public GroupSettingTemplateRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(GroupSettingTemplate body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<GroupSettingTemplate> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(GroupSettingTemplate body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
