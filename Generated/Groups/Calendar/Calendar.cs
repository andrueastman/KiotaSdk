...
using System.Linq;
namespace GraphServiceClient.Groups.Calendar {
    public class Calendar : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"allowedOnlineMeetingProviders", (o,n) => { (o as Calendar).AllowedOnlineMeetingProviders = n.GetCollectionOfPrimitiveValues<OnlineMeetingProviderType>().ToList(); } },
                ...
                {"color", (o,n) => { (o as Calendar).Color = n.GetObjectValue<CalendarColor>(); } },
                {"defaultOnlineMeetingProvider", (o,n) => { (o as Calendar).DefaultOnlineMeetingProvider = n.GetObjectValue<OnlineMeetingProviderType>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<OnlineMeetingProviderType>("allowedOnlineMeetingProviders", AllowedOnlineMeetingProviders);
            ...
            writer.WriteObjectValue<CalendarColor>("color", Color);
            writer.WriteObjectValue<OnlineMeetingProviderType>("defaultOnlineMeetingProvider", DefaultOnlineMeetingProvider);
