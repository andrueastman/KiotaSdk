using GraphServiceClient.Groups.Calendar.CalendarView.Instances.Item;
...
namespace GraphServiceClient.Groups.Calendar.CalendarView.Instances {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendar\calendarView\{event-id}\instances</summary>
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.groups.calendar.calendarView.instances collection</summary>
