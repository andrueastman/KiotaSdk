using GraphServiceClient.Groups.Calendar.CalendarView.Instances.Microsoft.Graph.Accept;
using GraphServiceClient.Groups.Calendar.CalendarView.Instances.Microsoft.Graph.Cancel;
using GraphServiceClient.Groups.Calendar.CalendarView.Instances.Microsoft.Graph.Decline;
using GraphServiceClient.Groups.Calendar.CalendarView.Instances.Microsoft.Graph.DismissReminder;
using GraphServiceClient.Groups.Calendar.CalendarView.Instances.Microsoft.Graph.Forward;
using GraphServiceClient.Groups.Calendar.CalendarView.Instances.Microsoft.Graph.SnoozeReminder;
using GraphServiceClient.Groups.Calendar.CalendarView.Instances.Microsoft.Graph.TentativelyAccept;
...
namespace GraphServiceClient.Groups.Calendar.CalendarView.Instances.Item {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendar\calendarView\{event-id}\instances\{event-id1}</summary>
