using GraphServiceClient.Groups.Calendar.CalendarView.MultiValueExtendedProperties.Item;
...
namespace GraphServiceClient.Groups.Calendar.CalendarView.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendar\calendarView\{event-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.groups.calendar.calendarView.multiValueExtendedProperties collection</summary>
