...
using System.Linq;
namespace GraphServiceClient.Groups.CalendarView.Attachments.Microsoft.Graph {
    public class AttachmentItem : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"attachmentType", (o,n) => { (o as AttachmentItem).AttachmentType = n.GetObjectValue<AttachmentType>(); } },
                ...
                {"size", (o,n) => { (o as AttachmentItem).Size = n.GetObjectValue<Int64>(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AttachmentType>("attachmentType", AttachmentType);
