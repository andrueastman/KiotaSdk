using GraphServiceClient.Groups.CalendarView.Calendar.Events.Microsoft.Graph.Accept;
using GraphServiceClient.Groups.CalendarView.Calendar.Events.Microsoft.Graph.Cancel;
using GraphServiceClient.Groups.CalendarView.Calendar.Events.Microsoft.Graph.Decline;
using GraphServiceClient.Groups.CalendarView.Calendar.Events.Microsoft.Graph.DismissReminder;
using GraphServiceClient.Groups.CalendarView.Calendar.Events.Microsoft.Graph.Forward;
using GraphServiceClient.Groups.CalendarView.Calendar.Events.Microsoft.Graph.SnoozeReminder;
using GraphServiceClient.Groups.CalendarView.Calendar.Events.Microsoft.Graph.TentativelyAccept;
...
namespace GraphServiceClient.Groups.CalendarView.Calendar.Events.Item {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendarView\{event-id}\calendar\events\{event-id1}</summary>
