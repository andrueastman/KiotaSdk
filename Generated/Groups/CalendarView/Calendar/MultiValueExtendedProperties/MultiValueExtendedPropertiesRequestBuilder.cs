using GraphServiceClient.Groups.CalendarView.Calendar.MultiValueExtendedProperties.Item;
...
namespace GraphServiceClient.Groups.CalendarView.Calendar.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendarView\{event-id}\calendar\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.groups.calendarView.calendar.multiValueExtendedProperties collection</summary>
