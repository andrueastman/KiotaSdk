using GraphServiceClient.Groups.CalendarView.Calendar.SingleValueExtendedProperties.Item;
...
namespace GraphServiceClient.Groups.CalendarView.Calendar.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendarView\{event-id}\calendar\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.groups.calendarView.calendar.singleValueExtendedProperties collection</summary>
