using GraphServiceClient.Groups.CalendarView.Item;
...
namespace GraphServiceClient.Groups.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.groups.calendarView collection</summary>
