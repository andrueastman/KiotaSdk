using GraphServiceClient.Groups.CalendarView.Instances.Item;
...
namespace GraphServiceClient.Groups.CalendarView.Instances {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendarView\{event-id}\instances</summary>
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.groups.calendarView.instances collection</summary>
