using GraphServiceClient.Groups.CalendarView.Attachments;
using GraphServiceClient.Groups.CalendarView.Calendar;
using GraphServiceClient.Groups.CalendarView.Extensions;
using GraphServiceClient.Groups.CalendarView.Instances;
using GraphServiceClient.Groups.CalendarView.Microsoft.Graph.Accept;
using GraphServiceClient.Groups.CalendarView.Microsoft.Graph.Cancel;
using GraphServiceClient.Groups.CalendarView.Microsoft.Graph.Decline;
using GraphServiceClient.Groups.CalendarView.Microsoft.Graph.DismissReminder;
using GraphServiceClient.Groups.CalendarView.Microsoft.Graph.Forward;
using GraphServiceClient.Groups.CalendarView.Microsoft.Graph.SnoozeReminder;
using GraphServiceClient.Groups.CalendarView.Microsoft.Graph.TentativelyAccept;
using GraphServiceClient.Groups.CalendarView.MultiValueExtendedProperties;
using GraphServiceClient.Groups.CalendarView.SingleValueExtendedProperties;
...
namespace GraphServiceClient.Groups.CalendarView.Item {
