using GraphServiceClient.Groups.Events.Calendar.CalendarView.Microsoft.Graph.Accept;
using GraphServiceClient.Groups.Events.Calendar.CalendarView.Microsoft.Graph.Cancel;
using GraphServiceClient.Groups.Events.Calendar.CalendarView.Microsoft.Graph.Decline;
using GraphServiceClient.Groups.Events.Calendar.CalendarView.Microsoft.Graph.DismissReminder;
using GraphServiceClient.Groups.Events.Calendar.CalendarView.Microsoft.Graph.Forward;
using GraphServiceClient.Groups.Events.Calendar.CalendarView.Microsoft.Graph.SnoozeReminder;
using GraphServiceClient.Groups.Events.Calendar.CalendarView.Microsoft.Graph.TentativelyAccept;
...
namespace GraphServiceClient.Groups.Events.Calendar.CalendarView.Item {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\events\{event-id}\calendar\calendarView\{event-id1}</summary>
