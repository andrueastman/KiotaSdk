using GraphServiceClient.Groups.Events.Calendar.MultiValueExtendedProperties.Item;
...
namespace GraphServiceClient.Groups.Events.Calendar.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\events\{event-id}\calendar\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.groups.events.calendar.multiValueExtendedProperties collection</summary>
