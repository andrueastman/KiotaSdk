using GraphServiceClient.Groups.Events.Instances.Item;
...
namespace GraphServiceClient.Groups.Events.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.groups.events.instances collection</summary>
