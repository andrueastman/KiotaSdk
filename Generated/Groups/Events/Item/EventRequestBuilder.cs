using GraphServiceClient.Groups.Events.Attachments;
using GraphServiceClient.Groups.Events.Calendar;
using GraphServiceClient.Groups.Events.Extensions;
using GraphServiceClient.Groups.Events.Instances;
using GraphServiceClient.Groups.Events.Microsoft.Graph.Accept;
using GraphServiceClient.Groups.Events.Microsoft.Graph.Cancel;
using GraphServiceClient.Groups.Events.Microsoft.Graph.Decline;
using GraphServiceClient.Groups.Events.Microsoft.Graph.DismissReminder;
using GraphServiceClient.Groups.Events.Microsoft.Graph.Forward;
using GraphServiceClient.Groups.Events.Microsoft.Graph.SnoozeReminder;
using GraphServiceClient.Groups.Events.Microsoft.Graph.TentativelyAccept;
using GraphServiceClient.Groups.Events.MultiValueExtendedProperties;
using GraphServiceClient.Groups.Events.SingleValueExtendedProperties;
...
namespace GraphServiceClient.Groups.Events.Item {
