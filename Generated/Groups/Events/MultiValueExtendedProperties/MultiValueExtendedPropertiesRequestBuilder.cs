using GraphServiceClient.Groups.Events.MultiValueExtendedProperties.Item;
...
namespace GraphServiceClient.Groups.Events.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\events\{event-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.groups.events.multiValueExtendedProperties collection</summary>
