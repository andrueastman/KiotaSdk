using GraphServiceClient.Groups.Events.SingleValueExtendedProperties.Item;
...
namespace GraphServiceClient.Groups.Events.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\events\{event-id}\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.groups.events.singleValueExtendedProperties collection</summary>
