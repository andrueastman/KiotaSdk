using GraphSdk.Groups.Item.Calendar.AllowedCalendarSharingRolesWithUser;
using GraphSdk.Groups.Item.Calendar.CalendarPermissions;
using GraphSdk.Groups.Item.Calendar.CalendarView;
using GraphSdk.Groups.Item.Calendar.Events;
using GraphSdk.Groups.Item.Calendar.GetSchedule;
using GraphSdk.Groups.Item.Calendar.MultiValueExtendedProperties;
using GraphSdk.Groups.Item.Calendar.SingleValueExtendedProperties;
...
namespace GraphSdk.Groups.Item.Calendar {
    ...
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/calendar{?select}";
