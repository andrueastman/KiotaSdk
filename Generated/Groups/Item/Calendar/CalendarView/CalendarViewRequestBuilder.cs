using GraphSdk.Groups.Item.Calendar.CalendarView.Delta;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item;
...
namespace GraphSdk.Groups.Item.Calendar.CalendarView {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendar\calendarView</summary>
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.groups.item.calendar.calendarView.item collection</summary>
        ...
        public CalendarViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/calendar/calendarView{?startDateTime,endDateTime,top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
