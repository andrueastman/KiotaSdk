...
namespace GraphSdk.Groups.Item.Calendar.CalendarView.Item.Accept {
    ...
    public class AcceptRequestBuilder {
        ...
        public AcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/calendar/calendarView/{event_id}/microsoft.graph.accept";
