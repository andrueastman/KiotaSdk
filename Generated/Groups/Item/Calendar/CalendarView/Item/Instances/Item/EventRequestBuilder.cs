using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.Accept;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.Cancel;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.Decline;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.DismissReminder;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.Forward;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.SnoozeReminder;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.TentativelyAccept;
...
namespace GraphSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/calendar/calendarView/{event_id}/instances/{event_id1}{?select}";
