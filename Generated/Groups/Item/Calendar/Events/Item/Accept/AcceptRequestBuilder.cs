...
namespace GraphSdk.Groups.Item.Calendar.Events.Item.Accept {
    ...
    public class AcceptRequestBuilder {
        ...
        public AcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/calendar/events/{event_id}/microsoft.graph.accept";
