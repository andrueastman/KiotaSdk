...
namespace GraphSdk.Groups.Item.Calendar.Events.Item.Instances.Item.Cancel {
    ...
    public class CancelRequestBuilder {
        ...
        public CancelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/calendar/events/{event_id}/instances/{event_id1}/microsoft.graph.cancel";
