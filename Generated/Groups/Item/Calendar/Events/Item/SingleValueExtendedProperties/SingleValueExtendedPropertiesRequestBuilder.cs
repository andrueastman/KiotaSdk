using ApiSdk.Groups.Item.Calendar.Events.Item.SingleValueExtendedProperties.Item;
...
namespace ApiSdk.Groups.Item.Calendar.Events.Item.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.groups.item.calendar.events.item.singleValueExtendedProperties.item collection</summary>
