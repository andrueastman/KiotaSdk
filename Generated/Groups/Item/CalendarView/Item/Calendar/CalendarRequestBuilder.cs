...
namespace ApiSdk.Groups.Item.CalendarView.Item.Calendar {
    ...
    public class CalendarRequestBuilder {
        public CalendarPermissionsRequestBuilder CalendarPermissions { get =>
            new CalendarPermissionsRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        ...
        /// </summary>
        public CalendarRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
