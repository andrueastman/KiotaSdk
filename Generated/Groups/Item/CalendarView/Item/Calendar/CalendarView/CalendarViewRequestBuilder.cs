using ApiSdk.Groups.Item.CalendarView.Item.Calendar.CalendarView.Delta;
using ApiSdk.Groups.Item.CalendarView.Item.Calendar.CalendarView.Item;
...
namespace ApiSdk.Groups.Item.CalendarView.Item.Calendar.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.groups.item.calendarView.item.calendar.calendarView.item collection</summary>
