using GraphSdk.Groups.Item.CalendarView.Item.Calendar.CalendarView.Delta;
using GraphSdk.Groups.Item.CalendarView.Item.Calendar.CalendarView.Item;
...
namespace GraphSdk.Groups.Item.CalendarView.Item.Calendar.CalendarView {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendarView\{event-id}\calendar\calendarView</summary>
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.groups.item.calendarView.item.calendar.calendarView.item collection</summary>
        ...
        public CalendarViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/calendarView/{event_id}/calendar/calendarView{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
