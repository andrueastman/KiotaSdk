...
namespace GraphSdk.Groups.Item.CalendarView.Item.Instances.Item.Forward {
    ...
    public class ForwardRequestBuilder {
        ...
        public ForwardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/calendarView/{event_id}/instances/{event_id1}/microsoft.graph.forward";
