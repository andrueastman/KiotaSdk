using ApiSdk.Groups.Item.CalendarView.Item.MultiValueExtendedProperties.Item;
...
namespace ApiSdk.Groups.Item.CalendarView.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.groups.item.calendarView.item.multiValueExtendedProperties.item collection</summary>
