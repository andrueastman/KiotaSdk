using GraphSdk.Groups.Item.Conversations.Item.Threads.Item.Posts;
using GraphSdk.Groups.Item.Conversations.Item.Threads.Item.Reply;
...
namespace GraphSdk.Groups.Item.Conversations.Item.Threads.Item {
    ...
    public class ConversationThreadRequestBuilder {
        ...
        public ConversationThreadRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/conversations/{conversation_id}/threads/{conversationThread_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ConversationThread body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
