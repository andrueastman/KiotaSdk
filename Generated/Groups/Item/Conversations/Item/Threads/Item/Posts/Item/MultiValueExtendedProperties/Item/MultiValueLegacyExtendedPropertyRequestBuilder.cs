...
namespace GraphSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.MultiValueExtendedProperties.Item {
    ...
    public class MultiValueLegacyExtendedPropertyRequestBuilder {
        ...
        public MultiValueLegacyExtendedPropertyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/conversations/{conversation_id}/threads/{conversationThread_id}/posts/{post_id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty_id}{?select,expand}";
