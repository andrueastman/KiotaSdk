...
namespace ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        public SingleValueLegacyExtendedPropertyRequestBuilder this[string position] { get {
            return new SingleValueLegacyExtendedPropertyRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public SingleValueExtendedPropertiesRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
