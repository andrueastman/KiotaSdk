using GraphSdk.Groups.Item.Drives.Item;
...
namespace GraphSdk.Groups.Item.Drives {
    ...
    public class DrivesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.groups.item.drives.item collection</summary>
        ...
        public DrivesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/drives{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
