using ApiSdk.Groups.Item.Events.Item.Calendar.CalendarView.Delta;
using ApiSdk.Groups.Item.Events.Item.Calendar.CalendarView.Item;
...
namespace ApiSdk.Groups.Item.Events.Item.Calendar.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.groups.item.events.item.calendar.calendarView.item collection</summary>
