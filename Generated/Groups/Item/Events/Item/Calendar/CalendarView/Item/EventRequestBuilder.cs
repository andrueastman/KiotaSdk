...
using GraphSdk.Groups.Item.Events.Item.Calendar.CalendarView.Item.DismissReminder;
...
namespace GraphSdk.Groups.Item.Events.Item.Calendar.CalendarView.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/events/{event_id}/calendar/calendarView/{event_id1}{?select}";
