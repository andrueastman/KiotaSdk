using ApiSdk.Groups.Item.Events.Item.Calendar.Events.Delta;
using ApiSdk.Groups.Item.Events.Item.Calendar.Events.Item;
...
namespace ApiSdk.Groups.Item.Events.Item.Calendar.Events {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\events\{event-id}\calendar\events</summary>
    public class EventsRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.groups.item.events.item.calendar.events.item collection</summary>
