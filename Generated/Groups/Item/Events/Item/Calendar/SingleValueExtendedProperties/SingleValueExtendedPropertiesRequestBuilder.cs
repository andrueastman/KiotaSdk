using ApiSdk.Groups.Item.Events.Item.Calendar.SingleValueExtendedProperties.Item;
...
namespace ApiSdk.Groups.Item.Events.Item.Calendar.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.groups.item.events.item.calendar.singleValueExtendedProperties.item collection</summary>
