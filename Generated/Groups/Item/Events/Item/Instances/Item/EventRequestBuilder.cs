using GraphSdk.Groups.Item.Events.Item.Instances.Item.Accept;
using GraphSdk.Groups.Item.Events.Item.Instances.Item.Cancel;
using GraphSdk.Groups.Item.Events.Item.Instances.Item.Decline;
using GraphSdk.Groups.Item.Events.Item.Instances.Item.DismissReminder;
using GraphSdk.Groups.Item.Events.Item.Instances.Item.Forward;
using GraphSdk.Groups.Item.Events.Item.Instances.Item.SnoozeReminder;
using GraphSdk.Groups.Item.Events.Item.Instances.Item.TentativelyAccept;
...
namespace GraphSdk.Groups.Item.Events.Item.Instances.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/events/{event_id}/instances/{event_id1}{?select}";
