using ApiSdk.Groups.Item.Events.Item.MultiValueExtendedProperties.Item;
...
namespace ApiSdk.Groups.Item.Events.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.groups.item.events.item.multiValueExtendedProperties.item collection</summary>
