using ApiSdk.Groups.Item.Events.Item.SingleValueExtendedProperties.Item;
...
namespace ApiSdk.Groups.Item.Events.Item.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.groups.item.events.item.singleValueExtendedProperties.item collection</summary>
