using GraphSdk.Groups.Item.Members.Ref;
...
namespace GraphSdk.Groups.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/members{?top,skip,search,filter,count,orderby,select,expand}";
