using GraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentNotebook;
using GraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentSectionGroup;
using GraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups;
using GraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections;
...
namespace GraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public SectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}{?select,expand}";
