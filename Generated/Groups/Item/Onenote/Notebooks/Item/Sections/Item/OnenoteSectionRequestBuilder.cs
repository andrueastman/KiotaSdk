using GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.CopyToNotebook;
using GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.CopyToSectionGroup;
using GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.Pages;
using GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.ParentNotebook;
using GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup;
...
namespace GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}{?select,expand}";
