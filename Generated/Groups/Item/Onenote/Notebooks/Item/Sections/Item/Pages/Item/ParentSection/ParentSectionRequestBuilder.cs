using GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.ParentSection.CopyToNotebook;
using GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.ParentSection.CopyToSectionGroup;
...
namespace GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.ParentSection {
    ...
    public class ParentSectionRequestBuilder {
        ...
        public ParentSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentSection{?select,expand}";
