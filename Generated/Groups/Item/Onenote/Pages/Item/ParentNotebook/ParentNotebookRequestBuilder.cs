using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentNotebook.CopyNotebook;
using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentNotebook.SectionGroups;
using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentNotebook.Sections;
...
namespace GraphSdk.Groups.Item.Onenote.Pages.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public ParentNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/pages/{onenotePage_id}/parentNotebook{?select,expand}";
