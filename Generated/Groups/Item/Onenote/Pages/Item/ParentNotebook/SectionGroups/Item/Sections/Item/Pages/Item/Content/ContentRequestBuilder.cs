...
namespace ApiSdk.Groups.Item.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item.Sections.Item.Pages.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        /// </summary>
        public ContentRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
