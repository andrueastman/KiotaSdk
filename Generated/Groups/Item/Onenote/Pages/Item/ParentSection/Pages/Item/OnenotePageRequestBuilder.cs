using ApiSdk.Groups.Item.Onenote.Pages.Item.ParentSection.Pages.Item.Content;
using ApiSdk.Groups.Item.Onenote.Pages.Item.ParentSection.Pages.Item.CopyToSection;
using ApiSdk.Groups.Item.Onenote.Pages.Item.ParentSection.Pages.Item.OnenotePatchContent;
using ApiSdk.Groups.Item.Onenote.Pages.Item.ParentSection.Pages.Item.Preview;
...
namespace ApiSdk.Groups.Item.Onenote.Pages.Item.ParentSection.Pages.Item {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\onenote\pages\{onenotePage-id}\parentSection\pages\{onenotePage-id1}</summary>
