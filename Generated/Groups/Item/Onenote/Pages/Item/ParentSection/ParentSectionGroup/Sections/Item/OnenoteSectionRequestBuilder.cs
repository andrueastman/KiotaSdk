using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.Sections.Item.CopyToNotebook;
using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.Sections.Item.CopyToSectionGroup;
...
namespace GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/pages/{onenotePage_id}/parentSection/parentSectionGroup/sections/{onenoteSection_id}{?select,expand}";
