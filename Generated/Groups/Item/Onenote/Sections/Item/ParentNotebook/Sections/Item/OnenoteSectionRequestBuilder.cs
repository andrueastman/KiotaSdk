using GraphSdk.Groups.Item.Onenote.Sections.Item.ParentNotebook.Sections.Item.CopyToNotebook;
using GraphSdk.Groups.Item.Onenote.Sections.Item.ParentNotebook.Sections.Item.CopyToSectionGroup;
...
namespace GraphSdk.Groups.Item.Onenote.Sections.Item.ParentNotebook.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/sections/{onenoteSection_id}/parentNotebook/sections/{onenoteSection_id1}{?select,expand}";
