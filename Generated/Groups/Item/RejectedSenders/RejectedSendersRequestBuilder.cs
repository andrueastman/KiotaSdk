using GraphSdk.Groups.Item.RejectedSenders.Ref;
...
namespace GraphSdk.Groups.Item.RejectedSenders {
    ...
    public class RejectedSendersRequestBuilder {
        ...
        public RejectedSendersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/rejectedSenders{?top,skip,filter,count,orderby,select}";
