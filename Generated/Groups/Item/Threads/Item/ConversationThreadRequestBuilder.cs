...
namespace ApiSdk.Groups.Item.Threads.Item {
    ...
    public class ConversationThreadRequestBuilder {
        ...
        public PostsRequestBuilder Posts { get =>
            new PostsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        /// </summary>
        public ConversationThreadRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
