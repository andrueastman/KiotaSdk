...
namespace GraphSdk.Groups.Item.Threads.Item.Posts.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public ExtensionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/threads/{conversationThread_id}/posts/{post_id}/extensions/{extension_id}{?select,expand}";
