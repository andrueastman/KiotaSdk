using ApiSdk.Groups.Item.Threads.Item.Posts.Item.MultiValueExtendedProperties.Item;
...
namespace ApiSdk.Groups.Item.Threads.Item.Posts.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.groups.item.threads.item.posts.item.multiValueExtendedProperties.item collection</summary>
