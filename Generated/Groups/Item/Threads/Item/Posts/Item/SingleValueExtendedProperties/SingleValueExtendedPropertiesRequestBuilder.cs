using ApiSdk.Groups.Item.Threads.Item.Posts.Item.SingleValueExtendedProperties.Item;
...
namespace ApiSdk.Groups.Item.Threads.Item.Posts.Item.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\threads\{conversationThread-id}\posts\{post-id}\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.groups.item.threads.item.posts.item.singleValueExtendedProperties.item collection</summary>
