using GraphSdk.Groups.Item.TransitiveMembers.Ref;
...
namespace GraphSdk.Groups.Item.TransitiveMembers {
    ...
    public class TransitiveMembersRequestBuilder {
        ...
        /// </summary>
        public TransitiveMembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/transitiveMembers{?top,skip,search,filter,count,orderby,select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public TransitiveMembersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
