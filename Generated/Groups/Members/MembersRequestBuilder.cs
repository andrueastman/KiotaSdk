using GraphServiceClient.Groups.Members.$ref;
...
namespace GraphServiceClient.Groups.Members {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\members</summary>
