...
namespace GraphServiceClient.Groups.Microsoft.Graph.ResetUnseenCount {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\microsoft.graph.resetUnseenCount</summary>
    public class Microsoft.graph.resetUnseenCountRequestBuilder {
        ...
        /// </summary>
        public Microsoft.graph.resetUnseenCountRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
            if(string.IsNullOrEmpty(currentPath)) throw new ArgumentNullException(nameof(currentPath));
            _ = httpCore ?? throw new ArgumentNullException(nameof(httpCore));
            PathSegment = "/microsoft.graph.resetUnseenCount";
            HttpCore = httpCore;
