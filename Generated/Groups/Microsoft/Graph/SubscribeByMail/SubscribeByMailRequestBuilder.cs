...
namespace GraphServiceClient.Groups.Microsoft.Graph.SubscribeByMail {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\microsoft.graph.subscribeByMail</summary>
    public class Microsoft.graph.subscribeByMailRequestBuilder {
        ...
        /// </summary>
        public Microsoft.graph.subscribeByMailRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
            if(string.IsNullOrEmpty(currentPath)) throw new ArgumentNullException(nameof(currentPath));
            _ = httpCore ?? throw new ArgumentNullException(nameof(httpCore));
            PathSegment = "/microsoft.graph.subscribeByMail";
            HttpCore = httpCore;
