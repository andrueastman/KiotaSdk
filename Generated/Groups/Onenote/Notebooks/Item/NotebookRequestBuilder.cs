using GraphServiceClient.Groups.Onenote.Notebooks.Microsoft.Graph.CopyNotebook;
using GraphServiceClient.Groups.Onenote.Notebooks.SectionGroups;
using GraphServiceClient.Groups.Onenote.Notebooks.Sections;
...
namespace GraphServiceClient.Groups.Onenote.Notebooks.Item {
    ...
    public class NotebookRequestBuilder {
        ...
        /// </summary>
        public NotebookRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
