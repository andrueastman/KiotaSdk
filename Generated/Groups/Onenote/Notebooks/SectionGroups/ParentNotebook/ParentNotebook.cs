...
namespace GraphServiceClient.Groups.Onenote.Notebooks.SectionGroups.ParentNotebook {
    public class ParentNotebook : OnenoteEntityHierarchyModel, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"isDefault", (o,n) => { (o as ParentNotebook).IsDefault = n.GetBoolValue(); } },
                {"isShared", (o,n) => { (o as ParentNotebook).IsShared = n.GetBoolValue(); } },
                {"links", (o,n) => { (o as ParentNotebook).Links = n.GetObjectValue<NotebookLinks>(); } },
                {"sectionGroups", (o,n) => { (o as ParentNotebook).SectionGroups = n.GetCollectionOfObjectValues<SectionGroup>().ToList(); } },
                {"sectionGroupsUrl", (o,n) => { (o as ParentNotebook).SectionGroupsUrl = n.GetStringValue(); } },
                {"sections", (o,n) => { (o as ParentNotebook).Sections = n.GetCollectionOfObjectValues<OnenoteSection>().ToList(); } },
                {"sectionsUrl", (o,n) => { (o as ParentNotebook).SectionsUrl = n.GetStringValue(); } },
                {"userRole", (o,n) => { (o as ParentNotebook).UserRole = n.GetObjectValue<OnenoteUserRole>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<OnenoteUserRole>("userRole", UserRole);
        }
    }
}
