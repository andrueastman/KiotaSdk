using GraphServiceClient.Groups.Onenote.Notebooks;
using GraphServiceClient.Groups.Onenote.Operations;
using GraphServiceClient.Groups.Onenote.Pages;
using GraphServiceClient.Groups.Onenote.Resources;
using GraphServiceClient.Groups.Onenote.SectionGroups;
using GraphServiceClient.Groups.Onenote.Sections;
...
namespace GraphServiceClient.Groups.Onenote {
    ...
    public class OnenoteRequestBuilder {
        ...
        public NotebooksRequestBuilder Notebooks { get =>
            new NotebooksRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        ...
        /// </summary>
        public OnenoteRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
