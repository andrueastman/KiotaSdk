using GraphServiceClient.Groups.Owners.$ref;
...
namespace GraphServiceClient.Groups.Owners {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\owners</summary>
    public class OwnersRequestBuilder {
        ...
        /// </summary>
        public OwnersRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<OwnersResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<OwnersResponse>(requestInfo, responseHandler);
        }
