using GraphServiceClient.Groups.Sites.Item;
...
namespace GraphServiceClient.Groups.Sites {
    ...
    public class SitesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.groups.sites collection</summary>
        ...
        /// </summary>
        public SitesRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<SitesResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<SitesResponse>(requestInfo, responseHandler);
        }
        /// <summary>
        /// The list of SharePoint sites in this group. Access the default site with /sites/root.
        /// <param name="body"></param>
