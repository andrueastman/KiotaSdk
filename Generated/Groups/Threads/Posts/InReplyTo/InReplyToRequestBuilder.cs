...
using GraphServiceClient.Groups.Threads.Posts.InReplyTo.Microsoft.Graph.Forward;
using GraphServiceClient.Groups.Threads.Posts.InReplyTo.Microsoft.Graph.Reply;
...
namespace GraphServiceClient.Groups.Threads.Posts.InReplyTo {
    ...
    public class InReplyToRequestBuilder {
        ...
        /// </summary>
        public InReplyToRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
            if(string.IsNullOrEmpty(currentPath)) throw new ArgumentNullException(nameof(currentPath));
            _ = httpCore ?? throw new ArgumentNullException(nameof(httpCore));
            PathSegment = "/inReplyTo";
            HttpCore = httpCore;
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(InReplyTo body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(InReplyTo body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
