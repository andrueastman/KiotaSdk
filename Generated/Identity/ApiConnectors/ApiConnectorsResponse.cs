    ...
    public class ApiConnectorsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as ApiConnectorsResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as ApiConnectorsResponse).Value = n.GetCollectionOfObjectValues<IdentityApiConnector>().ToList(); } },
            };
        }
        /// <summary>
