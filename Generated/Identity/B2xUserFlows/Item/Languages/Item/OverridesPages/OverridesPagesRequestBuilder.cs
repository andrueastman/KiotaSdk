using GraphSdk.Identity.B2xUserFlows.Item.Languages.Item.OverridesPages.Item;
...
namespace GraphSdk.Identity.B2xUserFlows.Item.Languages.Item.OverridesPages {
    ...
    public class OverridesPagesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.identity.b2xUserFlows.item.languages.item.overridesPages.item collection</summary>
        ...
        public OverridesPagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/identity/b2xUserFlows/{b2xIdentityUserFlow_id}/languages/{userFlowLanguageConfiguration_id}/overridesPages{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
