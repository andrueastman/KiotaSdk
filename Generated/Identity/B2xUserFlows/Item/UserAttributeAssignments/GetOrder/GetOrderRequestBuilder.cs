...
namespace ApiSdk.Identity.B2xUserFlows.Item.UserAttributeAssignments.GetOrder {
    ...
    public class GetOrderRequestBuilder {
        ...
        /// </summary>
        public GetOrderRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<GetOrderResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<GetOrderResponse>(requestInfo, responseHandler);
        }
