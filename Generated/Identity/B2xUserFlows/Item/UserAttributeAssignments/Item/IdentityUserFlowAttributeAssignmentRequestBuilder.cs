...
namespace ApiSdk.Identity.B2xUserFlows.Item.UserAttributeAssignments.Item {
    ...
    public class IdentityUserFlowAttributeAssignmentRequestBuilder {
        ...
        public UserAttributeRequestBuilder UserAttribute { get =>
            new UserAttributeRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        /// <summary>
        ...
        /// </summary>
        public IdentityUserFlowAttributeAssignmentRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
