...
namespace ApiSdk.Identity.B2xUserFlows.Item.UserAttributeAssignments {
    ...
    public class UserAttributeAssignmentsRequestBuilder {
        ...
        public SetOrderRequestBuilder SetOrder { get =>
            new SetOrderRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        public IdentityUserFlowAttributeAssignmentRequestBuilder this[string position] { get {
            return new IdentityUserFlowAttributeAssignmentRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public UserAttributeAssignmentsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
