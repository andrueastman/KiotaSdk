...
namespace GraphServiceClient.Identity.ConditionalAccess {
    public class ConditionalAccess : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"namedLocations", (o,n) => { (o as ConditionalAccess).NamedLocations = n.GetCollectionOfObjectValues<NamedLocation>().ToList(); } },
                {"policies", (o,n) => { (o as ConditionalAccess).Policies = n.GetCollectionOfObjectValues<ConditionalAccessPolicy>().ToList(); } },
            };
        }
        /// <summary>
