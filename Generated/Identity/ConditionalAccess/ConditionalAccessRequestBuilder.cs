...
namespace GraphServiceClient.Identity.ConditionalAccess {
    ...
    public class ConditionalAccessRequestBuilder {
        ...
        public NamedLocationsRequestBuilder NamedLocations { get =>
            new NamedLocationsRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        /// <summary>Path segment to use to build the URL for the current request builder</summary>
        private string PathSegment { get; set; }
        public PoliciesRequestBuilder Policies { get =>
            new PoliciesRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        /// <summary>
        ...
        /// </summary>
        public ConditionalAccessRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ConditionalAccessRoot> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<ConditionalAccessRoot>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Update the navigation property conditionalAccess in identity
        /// <param name="body"></param>
