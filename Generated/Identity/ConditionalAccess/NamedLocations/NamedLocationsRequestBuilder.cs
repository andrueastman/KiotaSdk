...
namespace ApiSdk.Identity.ConditionalAccess.NamedLocations {
    ...
    public class NamedLocationsRequestBuilder {
        ...
        public NamedLocationRequestBuilder this[string position] { get {
            return new NamedLocationRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public NamedLocationsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
