using GraphSdk.Identity.ConditionalAccess.NamedLocations.Item;
...
namespace GraphSdk.Identity.ConditionalAccess.NamedLocations {
    ...
    public class NamedLocationsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.identity.conditionalAccess.namedLocations.item collection</summary>
        ...
        public NamedLocationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/identity/conditionalAccess/namedLocations{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
