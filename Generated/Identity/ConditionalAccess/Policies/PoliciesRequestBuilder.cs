using GraphSdk.Identity.ConditionalAccess.Policies.Item;
...
namespace GraphSdk.Identity.ConditionalAccess.Policies {
    ...
    public class PoliciesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.identity.conditionalAccess.policies.item collection</summary>
        ...
        public PoliciesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/identity/conditionalAccess/policies{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
