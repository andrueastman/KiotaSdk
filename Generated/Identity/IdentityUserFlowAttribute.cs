    ...
    public class IdentityUserFlowAttribute : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"dataType", (o,n) => { (o as IdentityUserFlowAttribute).DataType = n.GetObjectValue<IdentityUserFlowAttributeDataType>(); } },
                ...
                {"userFlowAttributeType", (o,n) => { (o as IdentityUserFlowAttribute).UserFlowAttributeType = n.GetObjectValue<IdentityUserFlowAttributeType>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<IdentityUserFlowAttributeDataType>("dataType", DataType);
            writer.WriteStringValue("description", Description);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteObjectValue<IdentityUserFlowAttributeType>("userFlowAttributeType", UserFlowAttributeType);
        }
    }
}
