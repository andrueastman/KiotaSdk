    ...
    public class IdentityUserFlowAttributeAssignment : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"userAttributeValues", (o,n) => { (o as IdentityUserFlowAttributeAssignment).UserAttributeValues = n.GetCollectionOfPrimitiveValues<UserAttributeValuesItem>().ToList(); } },
                {"userInputType", (o,n) => { (o as IdentityUserFlowAttributeAssignment).UserInputType = n.GetObjectValue<IdentityUserFlowAttributeInputType>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<UserAttributeValuesItem>("userAttributeValues", UserAttributeValues);
            writer.WriteObjectValue<IdentityUserFlowAttributeInputType>("userInputType", UserInputType);
        }
    }
}
