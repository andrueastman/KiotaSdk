...
namespace ApiSdk.Identity.UserFlowAttributes {
    ...
    public class UserFlowAttributesRequestBuilder {
        ...
        public IdentityUserFlowAttributeRequestBuilder this[string position] { get {
            return new IdentityUserFlowAttributeRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public UserFlowAttributesRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
