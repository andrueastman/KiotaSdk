using GraphSdk.Identity.UserFlowAttributes.Item;
...
namespace GraphSdk.Identity.UserFlowAttributes {
    ...
    public class UserFlowAttributesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.identity.userFlowAttributes.item collection</summary>
        ...
        public UserFlowAttributesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/identity/userFlowAttributes{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
