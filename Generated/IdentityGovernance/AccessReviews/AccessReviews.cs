...
namespace GraphServiceClient.IdentityGovernance.AccessReviews {
    public class AccessReviews : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"definitions", (o,n) => { (o as AccessReviews).Definitions = n.GetCollectionOfObjectValues<AccessReviewScheduleDefinition>().ToList(); } },
            };
        }
        /// <summary>
