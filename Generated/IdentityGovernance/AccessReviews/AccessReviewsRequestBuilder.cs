...
namespace GraphServiceClient.IdentityGovernance.AccessReviews {
    ...
    public class AccessReviewsRequestBuilder {
        ...
        public DefinitionsRequestBuilder Definitions { get =>
            new DefinitionsRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        ...
        /// </summary>
        public AccessReviewsRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AccessReviewSet> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<AccessReviewSet>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Update the navigation property accessReviews in identityGovernance
        /// <param name="body"></param>
