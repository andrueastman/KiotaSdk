...
namespace ApiSdk.IdentityGovernance.AccessReviews.Definitions {
    ...
    public class DefinitionsRequestBuilder {
        ...
        public AccessReviewScheduleDefinitionRequestBuilder this[string position] { get {
            return new AccessReviewScheduleDefinitionRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public DefinitionsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
