...
namespace GraphServiceClient.IdentityGovernance.AccessReviews.Definitions.Instances.Microsoft.Graph.SendReminder {
    ...
    public class Microsoft.graph.sendReminderRequestBuilder {
        ...
        /// </summary>
        public Microsoft.graph.sendReminderRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
            if(string.IsNullOrEmpty(currentPath)) throw new ArgumentNullException(nameof(currentPath));
            _ = httpCore ?? throw new ArgumentNullException(nameof(httpCore));
            PathSegment = "/microsoft.graph.sendReminder";
            HttpCore = httpCore;
