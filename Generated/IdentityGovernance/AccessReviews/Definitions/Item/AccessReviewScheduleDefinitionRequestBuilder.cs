using GraphSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances;
using GraphSdk.IdentityGovernance.AccessReviews.Definitions.Item.Stop;
...
namespace GraphSdk.IdentityGovernance.AccessReviews.Definitions.Item {
    ...
    public class AccessReviewScheduleDefinitionRequestBuilder {
        ...
        public AccessReviewScheduleDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(AccessReviewScheduleDefinition body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
