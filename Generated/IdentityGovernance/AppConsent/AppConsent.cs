...
namespace GraphServiceClient.IdentityGovernance.AppConsent {
    public class AppConsent : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"appConsentRequests", (o,n) => { (o as AppConsent).AppConsentRequests = n.GetCollectionOfObjectValues<AppConsentRequest>().ToList(); } },
            };
        }
        /// <summary>
