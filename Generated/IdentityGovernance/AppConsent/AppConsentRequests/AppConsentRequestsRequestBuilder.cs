...
namespace ApiSdk.IdentityGovernance.AppConsent.AppConsentRequests {
    ...
    public class AppConsentRequestsRequestBuilder {
        ...
        public AppConsentRequestRequestBuilder this[string position] { get {
            return new AppConsentRequestRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public AppConsentRequestsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
