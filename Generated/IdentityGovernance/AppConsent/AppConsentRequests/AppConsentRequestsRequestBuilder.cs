...
namespace ApiSdk.IdentityGovernance.AppConsent.AppConsentRequests {
    ...
    public class AppConsentRequestsRequestBuilder {
        ...
        /// </summary>
        public AppConsentRequestsRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
            if(string.IsNullOrEmpty(currentPath)) throw new ArgumentNullException(nameof(currentPath));
            _ = httpCore ?? throw new ArgumentNullException(nameof(httpCore));
            PathSegment = "/appConsentRequests";
            HttpCore = httpCore;
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AppConsentRequest body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
        ...
        /// </summary>
        public async Task<AppConsentRequestsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<AppConsentRequestsResponse>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Create new navigation property to appConsentRequests for identityGovernance
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AppConsentRequest> PostAsync(AppConsentRequest body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await HttpCore.SendAsync<AppConsentRequest>(requestInfo, responseHandler);
        }
