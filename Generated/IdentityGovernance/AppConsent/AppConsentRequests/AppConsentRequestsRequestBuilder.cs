using GraphSdk.IdentityGovernance.AppConsent.AppConsentRequests.FilterByCurrentUserWithOn;
using GraphSdk.IdentityGovernance.AppConsent.AppConsentRequests.Item;
...
namespace GraphSdk.IdentityGovernance.AppConsent.AppConsentRequests {
    ...
    public class AppConsentRequestsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.identityGovernance.appConsent.appConsentRequests.item collection</summary>
        ...
        public AppConsentRequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/identityGovernance/appConsent/appConsentRequests{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
