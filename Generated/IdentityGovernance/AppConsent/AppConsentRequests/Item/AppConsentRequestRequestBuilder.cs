...
namespace ApiSdk.IdentityGovernance.AppConsent.AppConsentRequests.Item {
    ...
    public class AppConsentRequestRequestBuilder {
        ...
        public UserConsentRequestsRequestBuilder UserConsentRequests { get =>
            new UserConsentRequestsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        /// <summary>
        ...
        /// </summary>
        public AppConsentRequestRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
