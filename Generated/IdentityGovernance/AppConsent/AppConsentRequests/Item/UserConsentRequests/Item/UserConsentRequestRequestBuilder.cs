...
namespace ApiSdk.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests.Item {
    ...
    public class UserConsentRequestRequestBuilder {
        public ApprovalRequestBuilder Approval { get =>
            new ApprovalRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        /// </summary>
        public UserConsentRequestRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
