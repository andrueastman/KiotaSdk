...
namespace ApiSdk.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests {
    ...
    public class UserConsentRequestsRequestBuilder {
        ...
        public UserConsentRequestRequestBuilder this[string position] { get {
            return new UserConsentRequestRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public UserConsentRequestsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
