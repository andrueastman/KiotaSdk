    ...
    public class AppConsentRequest : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"pendingScopes", (o,n) => { (o as AppConsentRequest).PendingScopes = n.GetCollectionOfPrimitiveValues<AppConsentRequestScope>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<AppConsentRequestScope>("pendingScopes", PendingScopes);
