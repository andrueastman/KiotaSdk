...
namespace GraphServiceClient.IdentityGovernance.EntitlementManagement.AccessPackageAssignmentApprovals {
    ...
    public class AccessPackageAssignmentApprovalsRequestBuilder {
        ...
        /// </summary>
        public AccessPackageAssignmentApprovalsRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<AccessPackageAssignmentApprovalsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<AccessPackageAssignmentApprovalsResponse>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Create new navigation property to accessPackageAssignmentApprovals for identityGovernance
        /// <param name="body"></param>
