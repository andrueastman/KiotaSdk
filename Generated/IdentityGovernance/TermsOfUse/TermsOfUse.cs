...
namespace GraphServiceClient.IdentityGovernance.TermsOfUse {
    public class TermsOfUse : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"agreementAcceptances", (o,n) => { (o as TermsOfUse).AgreementAcceptances = n.GetCollectionOfObjectValues<AgreementAcceptance>().ToList(); } },
                {"agreements", (o,n) => { (o as TermsOfUse).Agreements = n.GetCollectionOfObjectValues<Agreement>().ToList(); } },
            };
        }
        /// <summary>
