...
namespace ApiSdk.IdentityGovernance.TermsOfUse {
    ...
    public class TermsOfUseRequestBuilder {
        ...
        public AgreementsRequestBuilder Agreements { get =>
            new AgreementsRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        ...
        /// </summary>
        public TermsOfUseRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TermsOfUseContainer> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<TermsOfUseContainer>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Update the navigation property termsOfUse in identityGovernance
        /// <param name="body"></param>
