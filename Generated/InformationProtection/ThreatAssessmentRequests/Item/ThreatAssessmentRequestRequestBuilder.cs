...
namespace ApiSdk.InformationProtection.ThreatAssessmentRequests.Item {
    ...
    public class ThreatAssessmentRequestRequestBuilder {
        ...
        public ResultsRequestBuilder Results { get =>
            new ResultsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        /// <summary>
        ...
        /// </summary>
        public ThreatAssessmentRequestRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
