    ...
    public class ThreatAssessmentResult : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"resultType", (o,n) => { (o as ThreatAssessmentResult).ResultType = n.GetObjectValue<ThreatAssessmentResultType>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ThreatAssessmentResultType>("resultType", ResultType);
        }
    }
}
