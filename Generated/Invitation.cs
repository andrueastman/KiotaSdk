...
namespace GraphServiceClient {
    public class Invitation : Entity, IParsable {
        ...
        /// <summary>The userType of the user being invited. By default, this is Guest. You can invite as Member if you're are company administrator.</summary>
        ...
        /// <summary>Indicates whether an email should be sent to the user being invited or not. The default is false.</summary>
