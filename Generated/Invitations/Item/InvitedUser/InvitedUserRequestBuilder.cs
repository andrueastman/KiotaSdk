using GraphSdk.Invitations.Item.InvitedUser.Ref;
...
namespace GraphSdk.Invitations.Item.InvitedUser {
    /// <summary>Builds and executes requests for operations under \invitations\{invitation-id}\invitedUser</summary>
    public class InvitedUserRequestBuilder {
        ...
        public InvitedUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/invitations/{invitation_id}/invitedUser{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public InvitedUserRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
