using ApiSdk.Invitations.Item.InvitedUser.Ref;
...
namespace ApiSdk.Invitations.Item.InvitedUser {
    ...
    public class InvitedUserRequestBuilder {
        ...
        /// </summary>
        public InvitedUserRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
            if(string.IsNullOrEmpty(currentPath)) throw new ArgumentNullException(nameof(currentPath));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            PathSegment = "/invitedUser";
