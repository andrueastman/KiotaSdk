    ...
    public class ManagedAppRegistration : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"flaggedReasons", (o,n) => { (o as ManagedAppRegistration).FlaggedReasons = n.GetCollectionOfPrimitiveValues<ManagedAppFlaggedReason>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<ManagedAppFlaggedReason>("flaggedReasons", FlaggedReasons);
