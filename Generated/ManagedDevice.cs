using GraphServiceClient.DeviceManagement;
    ...
    public class ManagedDevice : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"complianceState", (o,n) => { (o as ManagedDevice).ComplianceState = n.GetObjectValue<ComplianceState>(); } },
                ...
                {"deviceActionResults", (o,n) => { (o as ManagedDevice).DeviceActionResults = n.GetCollectionOfPrimitiveValues<DeviceActionResult>().ToList(); } },
                ...
                {"deviceEnrollmentType", (o,n) => { (o as ManagedDevice).DeviceEnrollmentType = n.GetObjectValue<DeviceEnrollmentType>(); } },
                ...
                {"deviceRegistrationState", (o,n) => { (o as ManagedDevice).DeviceRegistrationState = n.GetObjectValue<DeviceRegistrationState>(); } },
                ...
                {"exchangeAccessState", (o,n) => { (o as ManagedDevice).ExchangeAccessState = n.GetObjectValue<DeviceManagementExchangeAccessState>(); } },
                {"exchangeAccessStateReason", (o,n) => { (o as ManagedDevice).ExchangeAccessStateReason = n.GetObjectValue<DeviceManagementExchangeAccessStateReason>(); } },
                {"exchangeLastSuccessfulSyncDateTime", (o,n) => { (o as ManagedDevice).ExchangeLastSuccessfulSyncDateTime = n.GetDateTimeOffsetValue(); } },
                {"freeStorageSpaceInBytes", (o,n) => { (o as ManagedDevice).FreeStorageSpaceInBytes = n.GetObjectValue<Int64>(); } },
                ...
                {"managedDeviceOwnerType", (o,n) => { (o as ManagedDevice).ManagedDeviceOwnerType = n.GetObjectValue<ManagedDeviceOwnerType>(); } },
                {"managementAgent", (o,n) => { (o as ManagedDevice).ManagementAgent = n.GetObjectValue<ManagementAgentType>(); } },
                ...
                {"partnerReportedThreatState", (o,n) => { (o as ManagedDevice).PartnerReportedThreatState = n.GetObjectValue<ManagedDevicePartnerReportedHealthState>(); } },
                {"phoneNumber", (o,n) => { (o as ManagedDevice).PhoneNumber = n.GetStringValue(); } },
                {"physicalMemoryInBytes", (o,n) => { (o as ManagedDevice).PhysicalMemoryInBytes = n.GetObjectValue<Int64>(); } },
                ...
                {"totalStorageSpaceInBytes", (o,n) => { (o as ManagedDevice).TotalStorageSpaceInBytes = n.GetObjectValue<Int64>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ComplianceState>("complianceState", ComplianceState);
            ...
            writer.WriteCollectionOfPrimitiveValues<DeviceActionResult>("deviceActionResults", DeviceActionResults);
            ...
            writer.WriteObjectValue<DeviceEnrollmentType>("deviceEnrollmentType", DeviceEnrollmentType);
            writer.WriteObjectValue<DeviceHealthAttestationState>("deviceHealthAttestationState", DeviceHealthAttestationState);
            writer.WriteStringValue("deviceName", DeviceName);
            writer.WriteObjectValue<DeviceRegistrationState>("deviceRegistrationState", DeviceRegistrationState);
            ...
            writer.WriteObjectValue<DeviceManagementExchangeAccessState>("exchangeAccessState", ExchangeAccessState);
            writer.WriteObjectValue<DeviceManagementExchangeAccessStateReason>("exchangeAccessStateReason", ExchangeAccessStateReason);
            writer.WriteDateTimeOffsetValue("exchangeLastSuccessfulSyncDateTime", ExchangeLastSuccessfulSyncDateTime);
            writer.WriteObjectValue<Int64>("freeStorageSpaceInBytes", FreeStorageSpaceInBytes);
            ...
            writer.WriteObjectValue<ManagedDeviceOwnerType>("managedDeviceOwnerType", ManagedDeviceOwnerType);
            writer.WriteObjectValue<ManagementAgentType>("managementAgent", ManagementAgent);
            ...
            writer.WriteObjectValue<ManagedDevicePartnerReportedHealthState>("partnerReportedThreatState", PartnerReportedThreatState);
            writer.WriteStringValue("phoneNumber", PhoneNumber);
            writer.WriteObjectValue<Int64>("physicalMemoryInBytes", PhysicalMemoryInBytes);
            ...
            writer.WriteObjectValue<Int64>("totalStorageSpaceInBytes", TotalStorageSpaceInBytes);
