...
namespace ApiSdk.Me.Activities.Item.HistoryItems {
    ...
    public class HistoryItemsRequestBuilder {
        ...
        public ActivityHistoryItemRequestBuilder this[string position] { get {
            return new ActivityHistoryItemRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public HistoryItemsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
