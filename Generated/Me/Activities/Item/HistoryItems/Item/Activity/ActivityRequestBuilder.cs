using ApiSdk.Me.Activities.Item.HistoryItems.Item.Activity.Ref;
...
namespace ApiSdk.Me.Activities.Item.HistoryItems.Item.Activity {
    ...
    public class ActivityRequestBuilder {
        ...
        /// </summary>
        public ActivityRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
