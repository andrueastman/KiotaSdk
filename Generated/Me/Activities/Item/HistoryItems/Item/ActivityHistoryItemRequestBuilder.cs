...
namespace ApiSdk.Me.Activities.Item.HistoryItems.Item {
    ...
    public class ActivityHistoryItemRequestBuilder {
        public ActivityRequestBuilder Activity { get =>
            new ActivityRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        /// </summary>
        public ActivityHistoryItemRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
