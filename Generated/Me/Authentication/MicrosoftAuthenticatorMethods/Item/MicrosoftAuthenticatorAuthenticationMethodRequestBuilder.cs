using GraphSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device;
...
namespace GraphSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item {
    ...
    public class MicrosoftAuthenticatorAuthenticationMethodRequestBuilder {
        ...
        public MicrosoftAuthenticatorAuthenticationMethodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod_id}{?select,expand}";
