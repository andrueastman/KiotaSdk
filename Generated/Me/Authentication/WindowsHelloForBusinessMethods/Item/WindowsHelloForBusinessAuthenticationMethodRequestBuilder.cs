using GraphSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device;
...
namespace GraphSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item {
    ...
    public class WindowsHelloForBusinessAuthenticationMethodRequestBuilder {
        ...
        public WindowsHelloForBusinessAuthenticationMethodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod_id}{?select,expand}";
