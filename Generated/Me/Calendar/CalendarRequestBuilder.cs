using GraphSdk.Me.Calendar.AllowedCalendarSharingRolesWithUser;
using GraphSdk.Me.Calendar.CalendarPermissions;
using GraphSdk.Me.Calendar.CalendarView;
using GraphSdk.Me.Calendar.Events;
using GraphSdk.Me.Calendar.GetSchedule;
using GraphSdk.Me.Calendar.MultiValueExtendedProperties;
using GraphSdk.Me.Calendar.SingleValueExtendedProperties;
...
namespace GraphSdk.Me.Calendar {
    ...
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendar{?select}";
