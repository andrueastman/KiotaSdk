using GraphSdk.Me.Calendar.CalendarView.Item.Calendar.AllowedCalendarSharingRolesWithUser;
using GraphSdk.Me.Calendar.CalendarView.Item.Calendar.GetSchedule;
...
namespace GraphSdk.Me.Calendar.CalendarView.Item.Calendar {
    ...
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendar/calendarView/{event_id}/calendar{?select}";
