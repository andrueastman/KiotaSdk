using GraphSdk.Me.Calendar.CalendarView.Item.Accept;
using GraphSdk.Me.Calendar.CalendarView.Item.Attachments;
using GraphSdk.Me.Calendar.CalendarView.Item.Calendar;
using GraphSdk.Me.Calendar.CalendarView.Item.Cancel;
using GraphSdk.Me.Calendar.CalendarView.Item.Decline;
using GraphSdk.Me.Calendar.CalendarView.Item.DismissReminder;
using GraphSdk.Me.Calendar.CalendarView.Item.Extensions;
using GraphSdk.Me.Calendar.CalendarView.Item.Forward;
using GraphSdk.Me.Calendar.CalendarView.Item.Instances;
using GraphSdk.Me.Calendar.CalendarView.Item.MultiValueExtendedProperties;
using GraphSdk.Me.Calendar.CalendarView.Item.SingleValueExtendedProperties;
using GraphSdk.Me.Calendar.CalendarView.Item.SnoozeReminder;
using GraphSdk.Me.Calendar.CalendarView.Item.TentativelyAccept;
...
namespace GraphSdk.Me.Calendar.CalendarView.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendar/calendarView/{event_id}{?startDateTime,endDateTime,select}";
