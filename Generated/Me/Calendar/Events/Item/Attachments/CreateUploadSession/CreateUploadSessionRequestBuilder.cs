...
namespace GraphSdk.Me.Calendar.Events.Item.Attachments.CreateUploadSession {
    ...
    public class CreateUploadSessionRequestBuilder {
        ...
        public CreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendar/events/{event_id}/attachments/microsoft.graph.createUploadSession";
