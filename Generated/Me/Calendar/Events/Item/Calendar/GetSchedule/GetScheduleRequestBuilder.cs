...
namespace ApiSdk.Me.Calendar.Events.Item.Calendar.GetSchedule {
    ...
    public class GetScheduleRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<ApiSdk.Me.Calendar.Events.Item.Calendar.GetSchedule.GetSchedule>> PostAsync(GetScheduleRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
