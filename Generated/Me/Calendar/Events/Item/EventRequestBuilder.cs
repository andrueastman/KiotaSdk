using GraphSdk.Me.Calendar.Events.Item.Accept;
using GraphSdk.Me.Calendar.Events.Item.Attachments;
using GraphSdk.Me.Calendar.Events.Item.Calendar;
using GraphSdk.Me.Calendar.Events.Item.Cancel;
using GraphSdk.Me.Calendar.Events.Item.Decline;
using GraphSdk.Me.Calendar.Events.Item.DismissReminder;
using GraphSdk.Me.Calendar.Events.Item.Extensions;
using GraphSdk.Me.Calendar.Events.Item.Forward;
using GraphSdk.Me.Calendar.Events.Item.Instances;
using GraphSdk.Me.Calendar.Events.Item.MultiValueExtendedProperties;
using GraphSdk.Me.Calendar.Events.Item.SingleValueExtendedProperties;
using GraphSdk.Me.Calendar.Events.Item.SnoozeReminder;
using GraphSdk.Me.Calendar.Events.Item.TentativelyAccept;
...
namespace GraphSdk.Me.Calendar.Events.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendar/events/{event_id}{?select}";
