using ApiSdk.Me.Calendar.Events.Item.Instances.Delta;
using ApiSdk.Me.Calendar.Events.Item.Instances.Item;
...
namespace ApiSdk.Me.Calendar.Events.Item.Instances {
    /// <summary>Builds and executes requests for operations under \me\calendar\events\{event-id}\instances</summary>
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.me.calendar.events.item.instances.item collection</summary>
