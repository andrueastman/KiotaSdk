...
namespace GraphSdk.Me.Calendar.Events.Item.Instances.Item.TentativelyAccept {
    ...
    public class TentativelyAcceptRequestBuilder {
        ...
        public TentativelyAcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendar/events/{event_id}/instances/{event_id1}/microsoft.graph.tentativelyAccept";
