using GraphServiceClient.Me.CalendarGroups.Calendars.Events.Instances.Microsoft.Graph.Accept;
using GraphServiceClient.Me.CalendarGroups.Calendars.Events.Instances.Microsoft.Graph.Cancel;
using GraphServiceClient.Me.CalendarGroups.Calendars.Events.Instances.Microsoft.Graph.Decline;
using GraphServiceClient.Me.CalendarGroups.Calendars.Events.Instances.Microsoft.Graph.DismissReminder;
using GraphServiceClient.Me.CalendarGroups.Calendars.Events.Instances.Microsoft.Graph.Forward;
using GraphServiceClient.Me.CalendarGroups.Calendars.Events.Instances.Microsoft.Graph.SnoozeReminder;
using GraphServiceClient.Me.CalendarGroups.Calendars.Events.Instances.Microsoft.Graph.TentativelyAccept;
...
namespace GraphServiceClient.Me.CalendarGroups.Calendars.Events.Instances.Item {
    /// <summary>Builds and executes requests for operations under \me\calendarGroups\{calendarGroup-id}\calendars\{calendar-id}\events\{event-id}\instances\{event-id1}</summary>
