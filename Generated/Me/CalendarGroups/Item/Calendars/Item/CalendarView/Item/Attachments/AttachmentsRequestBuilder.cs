using GraphSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Attachments.CreateUploadSession;
using GraphSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Attachments.Item;
...
namespace GraphSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.calendarGroups.item.calendars.item.calendarView.item.attachments.item collection</summary>
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/calendarView/{event_id}/attachments{?top,skip,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
