using GraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Delta;
using GraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item;
...
namespace GraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events {
    ...
    public class EventsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.calendarGroups.item.calendars.item.events.item collection</summary>
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/events{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
