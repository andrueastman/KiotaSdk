using GraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Accept;
using GraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Cancel;
using GraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Decline;
using GraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.DismissReminder;
...
namespace GraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/events/{event_id}/instances/{event_id1}{?select}";
