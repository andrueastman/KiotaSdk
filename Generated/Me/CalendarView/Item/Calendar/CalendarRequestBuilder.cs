using GraphSdk.Me.CalendarView.Item.Calendar.AllowedCalendarSharingRolesWithUser;
using GraphSdk.Me.CalendarView.Item.Calendar.CalendarPermissions;
using GraphSdk.Me.CalendarView.Item.Calendar.CalendarView;
using GraphSdk.Me.CalendarView.Item.Calendar.Events;
using GraphSdk.Me.CalendarView.Item.Calendar.GetSchedule;
using GraphSdk.Me.CalendarView.Item.Calendar.MultiValueExtendedProperties;
using GraphSdk.Me.CalendarView.Item.Calendar.SingleValueExtendedProperties;
...
namespace GraphSdk.Me.CalendarView.Item.Calendar {
    /// <summary>Builds and executes requests for operations under \me\calendarView\{event-id}\calendar</summary>
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendarView/{event_id}/calendar{?select}";
