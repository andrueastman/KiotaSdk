using GraphSdk.Me.CalendarView.Item.Calendar.CalendarView.Delta;
using GraphSdk.Me.CalendarView.Item.Calendar.CalendarView.Item;
...
namespace GraphSdk.Me.CalendarView.Item.Calendar.CalendarView {
    /// <summary>Builds and executes requests for operations under \me\calendarView\{event-id}\calendar\calendarView</summary>
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.calendarView.item.calendar.calendarView.item collection</summary>
        ...
        public CalendarViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendarView/{event_id}/calendar/calendarView{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
