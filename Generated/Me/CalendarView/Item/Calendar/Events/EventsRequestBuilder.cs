using GraphSdk.Me.CalendarView.Item.Calendar.Events.Delta;
using GraphSdk.Me.CalendarView.Item.Calendar.Events.Item;
...
namespace GraphSdk.Me.CalendarView.Item.Calendar.Events {
    ...
    public class EventsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.calendarView.item.calendar.events.item collection</summary>
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendarView/{event_id}/calendar/events{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
