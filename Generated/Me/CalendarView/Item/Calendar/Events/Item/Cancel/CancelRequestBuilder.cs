...
namespace GraphSdk.Me.CalendarView.Item.Calendar.Events.Item.Cancel {
    ...
    public class CancelRequestBuilder {
        ...
        public CancelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendarView/{event_id}/calendar/events/{event_id1}/microsoft.graph.cancel";
