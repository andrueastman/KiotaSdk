using GraphSdk.Me.CalendarView.Item.Accept;
using GraphSdk.Me.CalendarView.Item.Attachments;
using GraphSdk.Me.CalendarView.Item.Calendar;
using GraphSdk.Me.CalendarView.Item.Cancel;
using GraphSdk.Me.CalendarView.Item.Decline;
using GraphSdk.Me.CalendarView.Item.DismissReminder;
using GraphSdk.Me.CalendarView.Item.Extensions;
using GraphSdk.Me.CalendarView.Item.Forward;
using GraphSdk.Me.CalendarView.Item.Instances;
using GraphSdk.Me.CalendarView.Item.MultiValueExtendedProperties;
using GraphSdk.Me.CalendarView.Item.SingleValueExtendedProperties;
using GraphSdk.Me.CalendarView.Item.SnoozeReminder;
using GraphSdk.Me.CalendarView.Item.TentativelyAccept;
...
namespace GraphSdk.Me.CalendarView.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendarView/{event_id}{?startDateTime,endDateTime,select}";
