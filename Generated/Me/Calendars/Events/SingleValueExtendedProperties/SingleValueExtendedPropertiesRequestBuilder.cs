using GraphServiceClient.Me.Calendars.Events.SingleValueExtendedProperties.Item;
...
namespace GraphServiceClient.Me.Calendars.Events.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \me\calendars\{calendar-id}\events\{event-id}\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.me.calendars.events.singleValueExtendedProperties collection</summary>
