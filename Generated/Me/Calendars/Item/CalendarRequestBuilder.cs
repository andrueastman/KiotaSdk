using GraphSdk.Me.Calendars.Item.AllowedCalendarSharingRolesWithUser;
using GraphSdk.Me.Calendars.Item.CalendarPermissions;
using GraphSdk.Me.Calendars.Item.CalendarView;
using GraphSdk.Me.Calendars.Item.Events;
using GraphSdk.Me.Calendars.Item.GetSchedule;
using GraphSdk.Me.Calendars.Item.MultiValueExtendedProperties;
using GraphSdk.Me.Calendars.Item.SingleValueExtendedProperties;
...
namespace GraphSdk.Me.Calendars.Item {
    ...
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendars/{calendar_id}{?select}";
