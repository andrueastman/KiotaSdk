using GraphSdk.Me.Calendars.Item.CalendarView.Item.Accept;
using GraphSdk.Me.Calendars.Item.CalendarView.Item.Attachments;
using GraphSdk.Me.Calendars.Item.CalendarView.Item.Calendar;
using GraphSdk.Me.Calendars.Item.CalendarView.Item.Cancel;
using GraphSdk.Me.Calendars.Item.CalendarView.Item.Decline;
using GraphSdk.Me.Calendars.Item.CalendarView.Item.DismissReminder;
using GraphSdk.Me.Calendars.Item.CalendarView.Item.Extensions;
using GraphSdk.Me.Calendars.Item.CalendarView.Item.Forward;
using GraphSdk.Me.Calendars.Item.CalendarView.Item.Instances;
using GraphSdk.Me.Calendars.Item.CalendarView.Item.MultiValueExtendedProperties;
using GraphSdk.Me.Calendars.Item.CalendarView.Item.SingleValueExtendedProperties;
using GraphSdk.Me.Calendars.Item.CalendarView.Item.SnoozeReminder;
using GraphSdk.Me.Calendars.Item.CalendarView.Item.TentativelyAccept;
...
namespace GraphSdk.Me.Calendars.Item.CalendarView.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendars/{calendar_id}/calendarView/{event_id}{?startDateTime,endDateTime,select}";
