using ApiSdk.Me.Calendars.Item.CalendarView.Item.Instances.Delta;
using ApiSdk.Me.Calendars.Item.CalendarView.Item.Instances.Item;
...
namespace ApiSdk.Me.Calendars.Item.CalendarView.Item.Instances {
    /// <summary>Builds and executes requests for operations under \me\calendars\{calendar-id}\calendarView\{event-id}\instances</summary>
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.me.calendars.item.calendarView.item.instances.item collection</summary>
