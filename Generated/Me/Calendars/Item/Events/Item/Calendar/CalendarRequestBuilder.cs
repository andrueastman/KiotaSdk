using GraphSdk.Me.Calendars.Item.Events.Item.Calendar.AllowedCalendarSharingRolesWithUser;
using GraphSdk.Me.Calendars.Item.Events.Item.Calendar.GetSchedule;
...
namespace GraphSdk.Me.Calendars.Item.Events.Item.Calendar {
    ...
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendars/{calendar_id}/events/{event_id}/calendar{?select}";
