using GraphSdk.Me.Calendars.Item.Events.Item.Accept;
using GraphSdk.Me.Calendars.Item.Events.Item.Attachments;
using GraphSdk.Me.Calendars.Item.Events.Item.Calendar;
using GraphSdk.Me.Calendars.Item.Events.Item.Cancel;
using GraphSdk.Me.Calendars.Item.Events.Item.Decline;
using GraphSdk.Me.Calendars.Item.Events.Item.DismissReminder;
using GraphSdk.Me.Calendars.Item.Events.Item.Extensions;
using GraphSdk.Me.Calendars.Item.Events.Item.Forward;
using GraphSdk.Me.Calendars.Item.Events.Item.Instances;
using GraphSdk.Me.Calendars.Item.Events.Item.MultiValueExtendedProperties;
using GraphSdk.Me.Calendars.Item.Events.Item.SingleValueExtendedProperties;
using GraphSdk.Me.Calendars.Item.Events.Item.SnoozeReminder;
using GraphSdk.Me.Calendars.Item.Events.Item.TentativelyAccept;
...
namespace GraphSdk.Me.Calendars.Item.Events.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendars/{calendar_id}/events/{event_id}{?select}";
