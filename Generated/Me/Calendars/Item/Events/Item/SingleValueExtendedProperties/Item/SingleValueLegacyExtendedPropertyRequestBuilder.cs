...
namespace GraphSdk.Me.Calendars.Item.Events.Item.SingleValueExtendedProperties.Item {
    ...
    public class SingleValueLegacyExtendedPropertyRequestBuilder {
        ...
        public SingleValueLegacyExtendedPropertyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendars/{calendar_id}/events/{event_id}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty_id}{?select,expand}";
