...
using GraphSdk.Me.Contacts.Item.SingleValueExtendedProperties;
...
namespace GraphSdk.Me.Contacts.Item {
    ...
    public class ContactRequestBuilder {
        ...
        public ContactRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/contacts/{contact_id}{?select}";
