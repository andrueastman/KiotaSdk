using GraphSdk.Me.Contacts.Item.Photo.Value;
...
namespace GraphSdk.Me.Contacts.Item.Photo {
    ...
    public class PhotoRequestBuilder {
        ...
        public PhotoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/contacts/{contact_id}/photo{?select}";
