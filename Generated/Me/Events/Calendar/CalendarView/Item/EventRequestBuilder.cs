using GraphServiceClient.Me.Events.Calendar.CalendarView.Microsoft.Graph.Accept;
using GraphServiceClient.Me.Events.Calendar.CalendarView.Microsoft.Graph.Cancel;
using GraphServiceClient.Me.Events.Calendar.CalendarView.Microsoft.Graph.Decline;
using GraphServiceClient.Me.Events.Calendar.CalendarView.Microsoft.Graph.DismissReminder;
using GraphServiceClient.Me.Events.Calendar.CalendarView.Microsoft.Graph.Forward;
using GraphServiceClient.Me.Events.Calendar.CalendarView.Microsoft.Graph.SnoozeReminder;
using GraphServiceClient.Me.Events.Calendar.CalendarView.Microsoft.Graph.TentativelyAccept;
...
namespace GraphServiceClient.Me.Events.Calendar.CalendarView.Item {
    /// <summary>Builds and executes requests for operations under \me\events\{event-id}\calendar\calendarView\{event-id1}</summary>
