using GraphServiceClient.Me.Events.Item;
...
namespace GraphServiceClient.Me.Events {
    ...
    public class EventsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.me.events collection</summary>
