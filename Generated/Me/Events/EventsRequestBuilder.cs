using GraphSdk.Me.Events.Delta;
using GraphSdk.Me.Events.Item;
...
namespace GraphSdk.Me.Events {
    ...
    public class EventsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.events.item collection</summary>
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/events{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
