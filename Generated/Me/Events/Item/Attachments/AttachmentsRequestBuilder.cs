using GraphSdk.Me.Events.Item.Attachments.CreateUploadSession;
using GraphSdk.Me.Events.Item.Attachments.Item;
...
namespace GraphSdk.Me.Events.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.events.item.attachments.item collection</summary>
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/events/{event_id}/attachments{?top,skip,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
