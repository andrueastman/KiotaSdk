...
namespace GraphSdk.Me.Events.Item.Calendar.CalendarView.Item.Forward {
    ...
    public class ForwardRequestBuilder {
        ...
        public ForwardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/events/{event_id}/calendar/calendarView/{event_id1}/microsoft.graph.forward";
