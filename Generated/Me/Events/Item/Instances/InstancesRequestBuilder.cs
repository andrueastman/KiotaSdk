using ApiSdk.Me.Events.Item.Instances.Delta;
using ApiSdk.Me.Events.Item.Instances.Item;
...
namespace ApiSdk.Me.Events.Item.Instances {
    /// <summary>Builds and executes requests for operations under \me\events\{event-id}\instances</summary>
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.me.events.item.instances.item collection</summary>
