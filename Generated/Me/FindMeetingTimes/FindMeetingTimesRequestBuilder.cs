...
namespace ApiSdk.Me.FindMeetingTimes {
    ...
    public class FindMeetingTimesRequestBuilder {
        ...
        /// </summary>
        public FindMeetingTimesRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<FindMeetingTimesResponse> PostAsync(FindMeetingTimesRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendAsync<FindMeetingTimesResponse>(requestInfo, responseHandler);
        }
