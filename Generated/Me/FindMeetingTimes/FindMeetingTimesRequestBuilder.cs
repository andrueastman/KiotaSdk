...
namespace ApiSdk.Me.FindMeetingTimes {
    ...
    public class FindMeetingTimesRequestBuilder {
        ...
        /// </summary>
        public FindMeetingTimesRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(FindMeetingTimesRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
        ...
        /// </summary>
        public async Task<FindMeetingTimesResponse> PostAsync(FindMeetingTimesRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await HttpCore.SendAsync<FindMeetingTimesResponse>(requestInfo, responseHandler);
        }
