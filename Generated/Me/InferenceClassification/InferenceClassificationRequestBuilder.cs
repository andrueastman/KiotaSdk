...
namespace GraphServiceClient.Me.InferenceClassification {
    ...
    public class InferenceClassificationRequestBuilder {
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(InferenceClassification body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
