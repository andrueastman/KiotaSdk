...
namespace GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnsAfterWithCount {
    ...
    public class ColumnsAfterWithCountRequestBuilder {
        ...
        public ColumnsAfterWithCountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? count = default) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.workbookRange/microsoft.graph.columnsAfter(count={count})";
