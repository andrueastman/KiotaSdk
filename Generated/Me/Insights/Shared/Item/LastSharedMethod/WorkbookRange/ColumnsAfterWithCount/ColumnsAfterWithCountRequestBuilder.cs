...
namespace ApiSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnsAfterWithCount {
    ...
    public class ColumnsAfterWithCountRequestBuilder {
        ...
        /// </summary>
        public ColumnsAfterWithCountRequestBuilder(string currentPath, IRequestAdapter requestAdapter, int? count = default, bool isRawUrl = true) {
