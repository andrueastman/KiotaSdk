...
namespace GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.RowsAbove {
    ...
    public class RowsAboveRequestBuilder {
        ...
        public RowsAboveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.workbookRange/microsoft.graph.rowsAbove()";
