...
namespace ApiSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.VisibleView {
    ...
    public class VisibleViewRequestBuilder {
        ...
        /// </summary>
        public VisibleViewRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<VisibleViewResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<VisibleViewResponse>(requestInfo, responseHandler);
        }
