using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.BoundingRectWithAnotherRange;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.CellWithRowWithColumn;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.Clear;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnsAfter;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnsAfterWithCount;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnsBefore;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnsBeforeWithCount;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnWithColumn;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.Delete;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.EntireColumn;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.EntireRow;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.Insert;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.IntersectionWithAnotherRange;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.LastCell;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.LastColumn;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.LastRow;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.Merge;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ResizedRangeWithDeltaRowsWithDeltaColumns;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.RowsAbove;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.RowsAboveWithCount;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.RowsBelow;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.RowsBelowWithCount;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.RowWithRow;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.Unmerge;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.UsedRange;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.UsedRangeWithValuesOnly;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.VisibleView;
...
namespace GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange {
    ...
    public class WorkbookRangeRequestBuilder {
        ...
        public WorkbookRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.workbookRange";
