using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRangeView.Range;
...
namespace GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRangeView {
    ...
    public class WorkbookRangeViewRequestBuilder {
        ...
        public WorkbookRangeViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.workbookRangeView";
