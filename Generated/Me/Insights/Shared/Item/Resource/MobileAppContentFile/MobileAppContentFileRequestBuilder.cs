using GraphSdk.Me.Insights.Shared.Item.Resource.MobileAppContentFile.Commit;
using GraphSdk.Me.Insights.Shared.Item.Resource.MobileAppContentFile.RenewUpload;
...
namespace GraphSdk.Me.Insights.Shared.Item.Resource.MobileAppContentFile {
    ...
    public class MobileAppContentFileRequestBuilder {
        ...
        public MobileAppContentFileRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/shared/{sharedInsight_id}/resource/microsoft.graph.mobileAppContentFile";
