using ApiSdk.Me.Insights.Shared.Item.Resource.CalendarSharingMessage;
using ApiSdk.Me.Insights.Shared.Item.Resource.ManagedAppProtection;
using ApiSdk.Me.Insights.Shared.Item.Resource.MobileAppContentFile;
using ApiSdk.Me.Insights.Shared.Item.Resource.PrintDocument;
using ApiSdk.Me.Insights.Shared.Item.Resource.PrintJob;
using ApiSdk.Me.Insights.Shared.Item.Resource.Ref;
using ApiSdk.Me.Insights.Shared.Item.Resource.ScheduleChangeRequest;
using ApiSdk.Me.Insights.Shared.Item.Resource.TargetedManagedAppProtection;
using ApiSdk.Me.Insights.Shared.Item.Resource.WindowsInformationProtection;
using ApiSdk.Me.Insights.Shared.Item.Resource.WorkbookRange;
using ApiSdk.Me.Insights.Shared.Item.Resource.WorkbookRangeFill;
using ApiSdk.Me.Insights.Shared.Item.Resource.WorkbookRangeFormat;
using ApiSdk.Me.Insights.Shared.Item.Resource.WorkbookRangeSort;
using ApiSdk.Me.Insights.Shared.Item.Resource.WorkbookRangeView;
...
namespace ApiSdk.Me.Insights.Shared.Item.Resource {
