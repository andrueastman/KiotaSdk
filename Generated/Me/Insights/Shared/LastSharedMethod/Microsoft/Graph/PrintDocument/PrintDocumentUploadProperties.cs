...
using System.Linq;
namespace GraphServiceClient.Me.Insights.Shared.LastSharedMethod.Microsoft.Graph.PrintDocument.Microsoft.Graph {
    public class PrintDocumentUploadProperties : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"size", (o,n) => { (o as PrintDocumentUploadProperties).Size = n.GetObjectValue<Int64>(); } },
            };
        }
        /// <summary>
