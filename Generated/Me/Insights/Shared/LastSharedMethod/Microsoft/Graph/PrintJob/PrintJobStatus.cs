    ...
    public class PrintJobStatus : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"details", (o,n) => { (o as PrintJobStatus).Details = n.GetCollectionOfPrimitiveValues<PrintJobStateDetail>().ToList(); } },
                {"isAcquiredByPrinter", (o,n) => { (o as PrintJobStatus).IsAcquiredByPrinter = n.GetBoolValue(); } },
                {"state", (o,n) => { (o as PrintJobStatus).State = n.GetObjectValue<PrintJobProcessingState>(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<PrintJobStateDetail>("details", Details);
            writer.WriteBoolValue("isAcquiredByPrinter", IsAcquiredByPrinter);
            writer.WriteObjectValue<PrintJobProcessingState>("state", State);
