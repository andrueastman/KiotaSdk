using GraphSdk.Me.Insights.Trending.Item.Resource.PrintJob.Abort;
using GraphSdk.Me.Insights.Trending.Item.Resource.PrintJob.Cancel;
using GraphSdk.Me.Insights.Trending.Item.Resource.PrintJob.Redirect;
using GraphSdk.Me.Insights.Trending.Item.Resource.PrintJob.Start;
...
namespace GraphSdk.Me.Insights.Trending.Item.Resource.PrintJob {
    ...
    public class PrintJobRequestBuilder {
        ...
        public PrintJobRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/trending/{trending_id}/resource/microsoft.graph.printJob";
