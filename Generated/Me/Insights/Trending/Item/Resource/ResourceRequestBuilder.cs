using GraphSdk.Me.Insights.Trending.Item.Resource.CalendarSharingMessage;
using GraphSdk.Me.Insights.Trending.Item.Resource.ManagedAppProtection;
using GraphSdk.Me.Insights.Trending.Item.Resource.MobileAppContentFile;
using GraphSdk.Me.Insights.Trending.Item.Resource.PrintDocument;
using GraphSdk.Me.Insights.Trending.Item.Resource.PrintJob;
using GraphSdk.Me.Insights.Trending.Item.Resource.Ref;
using GraphSdk.Me.Insights.Trending.Item.Resource.ScheduleChangeRequest;
using GraphSdk.Me.Insights.Trending.Item.Resource.TargetedManagedAppProtection;
using GraphSdk.Me.Insights.Trending.Item.Resource.WindowsInformationProtection;
using GraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange;
using GraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRangeFill;
using GraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRangeFormat;
using GraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRangeSort;
using GraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRangeView;
...
namespace GraphSdk.Me.Insights.Trending.Item.Resource {
    ...
    public class ResourceRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/trending/{trending_id}/resource{?select,expand}";
