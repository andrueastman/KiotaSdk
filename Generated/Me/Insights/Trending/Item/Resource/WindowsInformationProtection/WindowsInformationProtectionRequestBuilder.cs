using GraphSdk.Me.Insights.Trending.Item.Resource.WindowsInformationProtection.Assign;
...
namespace GraphSdk.Me.Insights.Trending.Item.Resource.WindowsInformationProtection {
    ...
    public class WindowsInformationProtectionRequestBuilder {
        ...
        public WindowsInformationProtectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/trending/{trending_id}/resource/microsoft.graph.windowsInformationProtection";
