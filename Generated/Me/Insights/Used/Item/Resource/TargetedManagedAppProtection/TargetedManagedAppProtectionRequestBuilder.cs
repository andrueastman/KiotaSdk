using GraphSdk.Me.Insights.Used.Item.Resource.TargetedManagedAppProtection.Assign;
using GraphSdk.Me.Insights.Used.Item.Resource.TargetedManagedAppProtection.TargetApps;
...
namespace GraphSdk.Me.Insights.Used.Item.Resource.TargetedManagedAppProtection {
    ...
    public class TargetedManagedAppProtectionRequestBuilder {
        ...
        public TargetedManagedAppProtectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/used/{usedInsight_id}/resource/microsoft.graph.targetedManagedAppProtection";
