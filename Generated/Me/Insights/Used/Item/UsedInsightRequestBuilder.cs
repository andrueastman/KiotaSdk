using GraphSdk.Me.Insights.Used.Item.Resource;
...
namespace GraphSdk.Me.Insights.Used.Item {
    ...
    public class UsedInsightRequestBuilder {
        ...
        public UsedInsightRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/used/{usedInsight_id}{?select,expand}";
