...
namespace ApiSdk.Me.MailFolders.Item.Messages.Item.CreateForward {
    ...
    public class CreateForwardRequestBuilder {
        ...
        /// </summary>
        public CreateForwardRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<CreateForwardResponse> PostAsync(CreateForwardRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
