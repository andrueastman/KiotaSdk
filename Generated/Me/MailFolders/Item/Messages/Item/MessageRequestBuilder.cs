using GraphSdk.Me.MailFolders.Item.Messages.Item.Attachments;
using GraphSdk.Me.MailFolders.Item.Messages.Item.CalendarSharingMessage;
using GraphSdk.Me.MailFolders.Item.Messages.Item.Copy;
using GraphSdk.Me.MailFolders.Item.Messages.Item.CreateForward;
using GraphSdk.Me.MailFolders.Item.Messages.Item.CreateReply;
using GraphSdk.Me.MailFolders.Item.Messages.Item.CreateReplyAll;
using GraphSdk.Me.MailFolders.Item.Messages.Item.Extensions;
using GraphSdk.Me.MailFolders.Item.Messages.Item.Forward;
using GraphSdk.Me.MailFolders.Item.Messages.Item.Move;
using GraphSdk.Me.MailFolders.Item.Messages.Item.MultiValueExtendedProperties;
using GraphSdk.Me.MailFolders.Item.Messages.Item.Reply;
using GraphSdk.Me.MailFolders.Item.Messages.Item.ReplyAll;
using GraphSdk.Me.MailFolders.Item.Messages.Item.Send;
using GraphSdk.Me.MailFolders.Item.Messages.Item.SingleValueExtendedProperties;
using GraphSdk.Me.MailFolders.Item.Messages.Item.Value;
...
namespace GraphSdk.Me.MailFolders.Item.Messages.Item {
    ...
    public class MessageRequestBuilder {
        ...
        public MessageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/mailFolders/{mailFolder_id}/messages/{message_id}{?select,expand}";
