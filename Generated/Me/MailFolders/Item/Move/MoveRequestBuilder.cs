...
namespace ApiSdk.Me.MailFolders.Item.Move {
    ...
    public class MoveRequestBuilder {
        ...
        /// </summary>
        public MoveRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<MoveResponse> PostAsync(MoveRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
