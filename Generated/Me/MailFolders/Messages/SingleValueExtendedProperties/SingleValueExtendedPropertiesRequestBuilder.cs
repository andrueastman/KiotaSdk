using GraphServiceClient.Me.MailFolders.Messages.SingleValueExtendedProperties.Item;
...
namespace GraphServiceClient.Me.MailFolders.Messages.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \me\mailFolders\{mailFolder-id}\messages\{message-id}\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.me.mailFolders.messages.singleValueExtendedProperties collection</summary>
