using GraphSdk.Me.ManagedAppRegistrations.GetUserIdsWithFlaggedAppRegistration;
using GraphSdk.Me.ManagedAppRegistrations.Ref;
...
namespace GraphSdk.Me.ManagedAppRegistrations {
    ...
    public class ManagedAppRegistrationsRequestBuilder {
        ...
        public ManagedAppRegistrationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/managedAppRegistrations{?top,skip,search,filter,count,orderby,select,expand}";
