...
namespace GraphSdk.Me.ManagedDevices.Item.ShutDown {
    ...
    public class ShutDownRequestBuilder {
        ...
        public ShutDownRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/managedDevices/{managedDevice_id}/microsoft.graph.shutDown";
