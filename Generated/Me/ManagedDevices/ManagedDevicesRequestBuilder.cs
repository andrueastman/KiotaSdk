using GraphSdk.Me.ManagedDevices.Item;
...
namespace GraphSdk.Me.ManagedDevices {
    ...
    public class ManagedDevicesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.managedDevices.item collection</summary>
        ...
        public ManagedDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/managedDevices{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
