using GraphSdk.Me.Messages.Item.CalendarSharingMessage.Accept;
...
namespace GraphSdk.Me.Messages.Item.CalendarSharingMessage {
    ...
    public class CalendarSharingMessageRequestBuilder {
        ...
        public CalendarSharingMessageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/messages/{message_id}/microsoft.graph.calendarSharingMessage";
