...
using GraphSdk.Me.Messages.Item;
...
namespace GraphSdk.Me.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.messages.item collection</summary>
        ...
        public MessagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/messages{?top,skip,search,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
