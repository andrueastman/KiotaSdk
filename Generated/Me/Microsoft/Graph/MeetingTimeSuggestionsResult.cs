...
using System.Linq;
namespace GraphServiceClient.Me.Microsoft.Graph {
    public class MeetingTimeSuggestionsResult : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"meetingTimeSuggestions", (o,n) => { (o as MeetingTimeSuggestionsResult).MeetingTimeSuggestions = n.GetCollectionOfPrimitiveValues<MeetingTimeSuggestion>().ToList(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<MeetingTimeSuggestion>("meetingTimeSuggestions", MeetingTimeSuggestions);
