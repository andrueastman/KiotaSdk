using GraphSdk.Me.Onenote.Notebooks.Item.SectionGroups.Item.ParentNotebook;
using GraphSdk.Me.Onenote.Notebooks.Item.SectionGroups.Item.ParentSectionGroup;
using GraphSdk.Me.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups;
using GraphSdk.Me.Onenote.Notebooks.Item.SectionGroups.Item.Sections;
...
namespace GraphSdk.Me.Onenote.Notebooks.Item.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public SectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}{?select,expand}";
