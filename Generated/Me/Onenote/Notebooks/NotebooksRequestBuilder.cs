using GraphSdk.Me.Onenote.Notebooks.GetNotebookFromWebUrl;
using GraphSdk.Me.Onenote.Notebooks.GetRecentNotebooksWithIncludePersonalNotebooks;
using GraphSdk.Me.Onenote.Notebooks.Item;
...
namespace GraphSdk.Me.Onenote.Notebooks {
    ...
    public class NotebooksRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.onenote.notebooks.item collection</summary>
        ...
        public NotebooksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/notebooks{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
