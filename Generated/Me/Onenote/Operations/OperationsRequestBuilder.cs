...
namespace ApiSdk.Me.Onenote.Operations {
    ...
    public class OperationsRequestBuilder {
        ...
        public OnenoteOperationRequestBuilder this[string position] { get {
            return new OnenoteOperationRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OnenoteOperation> PostAsync(OnenoteOperation body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
