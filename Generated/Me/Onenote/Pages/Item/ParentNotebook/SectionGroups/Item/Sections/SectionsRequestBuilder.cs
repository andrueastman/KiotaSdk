using GraphSdk.Me.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item.Sections.Item;
...
namespace GraphSdk.Me.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.onenote.pages.item.parentNotebook.sectionGroups.item.sections.item collection</summary>
        ...
        public SectionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/sections{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
