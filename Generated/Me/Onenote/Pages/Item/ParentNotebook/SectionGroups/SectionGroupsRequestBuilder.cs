using GraphSdk.Me.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item;
...
namespace GraphSdk.Me.Onenote.Pages.Item.ParentNotebook.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.onenote.pages.item.parentNotebook.sectionGroups.item collection</summary>
        ...
        public SectionGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/pages/{onenotePage_id}/parentNotebook/sectionGroups{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
