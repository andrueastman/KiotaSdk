using GraphSdk.Me.Onenote.Pages.Item.ParentSection.ParentNotebook.CopyNotebook;
using GraphSdk.Me.Onenote.Pages.Item.ParentSection.ParentNotebook.SectionGroups;
using GraphSdk.Me.Onenote.Pages.Item.ParentSection.ParentNotebook.Sections;
...
namespace GraphSdk.Me.Onenote.Pages.Item.ParentSection.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public ParentNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/pages/{onenotePage_id}/parentSection/parentNotebook{?select,expand}";
