using GraphSdk.Me.Onenote.Pages.Item.ParentSection.ParentNotebook.Sections.Item.CopyToNotebook;
using GraphSdk.Me.Onenote.Pages.Item.ParentSection.ParentNotebook.Sections.Item.CopyToSectionGroup;
...
namespace GraphSdk.Me.Onenote.Pages.Item.ParentSection.ParentNotebook.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/pages/{onenotePage_id}/parentSection/parentNotebook/sections/{onenoteSection_id}{?select,expand}";
