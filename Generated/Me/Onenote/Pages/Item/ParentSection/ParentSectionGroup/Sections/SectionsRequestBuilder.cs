using GraphSdk.Me.Onenote.Pages.Item.ParentSection.ParentSectionGroup.Sections.Item;
...
namespace GraphSdk.Me.Onenote.Pages.Item.ParentSection.ParentSectionGroup.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.onenote.pages.item.parentSection.parentSectionGroup.sections.item collection</summary>
        ...
        public SectionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/pages/{onenotePage_id}/parentSection/parentSectionGroup/sections{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
