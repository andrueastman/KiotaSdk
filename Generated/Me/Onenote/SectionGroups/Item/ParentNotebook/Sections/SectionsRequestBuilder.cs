using GraphSdk.Me.Onenote.SectionGroups.Item.ParentNotebook.Sections.Item;
...
namespace GraphSdk.Me.Onenote.SectionGroups.Item.ParentNotebook.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.onenote.sectionGroups.item.parentNotebook.sections.item collection</summary>
        ...
        public SectionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/sectionGroups/{sectionGroup_id}/parentNotebook/sections{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
