using GraphSdk.Me.Onenote.SectionGroups.Item.ParentNotebook;
using GraphSdk.Me.Onenote.SectionGroups.Item.ParentSectionGroup;
using GraphSdk.Me.Onenote.SectionGroups.Item.SectionGroups;
using GraphSdk.Me.Onenote.SectionGroups.Item.Sections;
...
namespace GraphSdk.Me.Onenote.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public SectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/sectionGroups/{sectionGroup_id}{?select,expand}";
