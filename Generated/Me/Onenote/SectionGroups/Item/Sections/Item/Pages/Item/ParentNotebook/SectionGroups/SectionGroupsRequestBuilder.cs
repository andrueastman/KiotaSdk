using GraphSdk.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.ParentNotebook.SectionGroups.Item;
...
namespace GraphSdk.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.ParentNotebook.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.onenote.sectionGroups.item.sections.item.pages.item.parentNotebook.sectionGroups.item collection</summary>
        ...
        public SectionGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentNotebook/sectionGroups{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
