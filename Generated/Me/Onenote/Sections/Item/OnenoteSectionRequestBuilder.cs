using GraphSdk.Me.Onenote.Sections.Item.CopyToNotebook;
using GraphSdk.Me.Onenote.Sections.Item.CopyToSectionGroup;
using GraphSdk.Me.Onenote.Sections.Item.Pages;
using GraphSdk.Me.Onenote.Sections.Item.ParentNotebook;
using GraphSdk.Me.Onenote.Sections.Item.ParentSectionGroup;
...
namespace GraphSdk.Me.Onenote.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/sections/{onenoteSection_id}{?select,expand}";
