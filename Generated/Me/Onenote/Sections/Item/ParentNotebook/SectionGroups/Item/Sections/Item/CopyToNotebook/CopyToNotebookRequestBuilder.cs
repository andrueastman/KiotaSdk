...
namespace GraphSdk.Me.Onenote.Sections.Item.ParentNotebook.SectionGroups.Item.Sections.Item.CopyToNotebook {
    /// <summary>Builds and executes requests for operations under \me\onenote\sections\{onenoteSection-id}\parentNotebook\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id1}\microsoft.graph.copyToNotebook</summary>
    public class CopyToNotebookRequestBuilder {
        ...
        public CopyToNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/sections/{onenoteSection_id}/parentNotebook/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id1}/microsoft.graph.copyToNotebook";
