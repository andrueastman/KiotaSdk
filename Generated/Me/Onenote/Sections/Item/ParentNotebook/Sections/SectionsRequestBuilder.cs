using GraphSdk.Me.Onenote.Sections.Item.ParentNotebook.Sections.Item;
...
namespace GraphSdk.Me.Onenote.Sections.Item.ParentNotebook.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.onenote.sections.item.parentNotebook.sections.item collection</summary>
        ...
        public SectionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/sections/{onenoteSection_id}/parentNotebook/sections{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
