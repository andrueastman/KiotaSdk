using GraphSdk.Me.Onenote.Sections.Item.ParentSectionGroup.ParentNotebook.Sections.Item.CopyToNotebook;
using GraphSdk.Me.Onenote.Sections.Item.ParentSectionGroup.ParentNotebook.Sections.Item.CopyToSectionGroup;
...
namespace GraphSdk.Me.Onenote.Sections.Item.ParentSectionGroup.ParentNotebook.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/sections/{onenoteSection_id}/parentSectionGroup/parentNotebook/sections/{onenoteSection_id1}{?select,expand}";
