...
namespace GraphSdk.Me.OnlineMeetings.Item.AttendeeReport {
    /// <summary>Builds and executes requests for operations under \me\onlineMeetings\{onlineMeeting-id}\attendeeReport</summary>
    public class AttendeeReportRequestBuilder {
        ...
        public AttendeeReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onlineMeetings/{onlineMeeting_id}/attendeeReport";
