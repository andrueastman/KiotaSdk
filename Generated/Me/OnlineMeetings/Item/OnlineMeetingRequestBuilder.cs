using GraphSdk.Me.OnlineMeetings.Item.AttendeeReport;
...
namespace GraphSdk.Me.OnlineMeetings.Item {
    ...
    public class OnlineMeetingRequestBuilder {
        ...
        public OnlineMeetingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onlineMeetings/{onlineMeeting_id}{?select,expand}";
