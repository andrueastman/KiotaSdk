using GraphSdk.Me.Planner.Plans.Item.Buckets.Item.Tasks;
...
namespace GraphSdk.Me.Planner.Plans.Item.Buckets.Item {
    ...
    public class PlannerBucketRequestBuilder {
        ...
        public PlannerBucketRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/planner/plans/{plannerPlan_id}/buckets/{plannerBucket_id}{?select,expand}";
