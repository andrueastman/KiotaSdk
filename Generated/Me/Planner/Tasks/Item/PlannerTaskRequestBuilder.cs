using GraphSdk.Me.Planner.Tasks.Item.AssignedToTaskBoardFormat;
using GraphSdk.Me.Planner.Tasks.Item.BucketTaskBoardFormat;
using GraphSdk.Me.Planner.Tasks.Item.Details;
using GraphSdk.Me.Planner.Tasks.Item.ProgressTaskBoardFormat;
...
namespace GraphSdk.Me.Planner.Tasks.Item {
    ...
    public class PlannerTaskRequestBuilder {
        ...
        public PlannerTaskRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/planner/tasks/{plannerTask_id}{?select,expand}";
