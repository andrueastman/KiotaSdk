using GraphSdk.Me.Planner.Tasks.Item;
...
namespace GraphSdk.Me.Planner.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.planner.tasks.item collection</summary>
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/planner/tasks{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
