...
namespace ApiSdk.Me.Todo.Lists.Item.Tasks.Item {
    ...
    public class TodoTaskRequestBuilder {
        ...
        public LinkedResourcesRequestBuilder LinkedResources { get =>
            new LinkedResourcesRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        /// </summary>
        public TodoTaskRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
