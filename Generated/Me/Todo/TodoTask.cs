    ...
    public class TodoTask : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"importance", (o,n) => { (o as TodoTask).Importance = n.GetObjectValue<Importance>(); } },
                ...
                {"status", (o,n) => { (o as TodoTask).Status = n.GetObjectValue<TaskStatus>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<TaskStatus>("status", Status);
