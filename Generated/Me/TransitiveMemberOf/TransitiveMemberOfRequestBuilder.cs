using GraphSdk.Me.TransitiveMemberOf.Ref;
...
namespace GraphSdk.Me.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        public TransitiveMemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/transitiveMemberOf{?top,skip,search,filter,count,orderby,select,expand}";
