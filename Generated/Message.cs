    ...
    public class Message : OutlookItem, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"conversationIndex", (o,n) => { (o as Message).ConversationIndex = n.GetObjectValue<Byte[]>(); } },
                ...
                {"importance", (o,n) => { (o as Message).Importance = n.GetObjectValue<Importance>(); } },
                {"inferenceClassification", (o,n) => { (o as Message).InferenceClassification = n.GetObjectValue<InferenceClassificationType>(); } },
                {"internetMessageHeaders", (o,n) => { (o as Message).InternetMessageHeaders = n.GetCollectionOfPrimitiveValues<InternetMessageHeader>().ToList(); } },
