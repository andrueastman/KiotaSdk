...
namespace ApiSdk.Models.Microsoft.Graph {
    public class Device : DirectoryObject, IParsable {
        /// <summary>true if the account is enabled; otherwise, false. Default is true. Supports $filter (eq, ne, NOT, in).</summary>
        ...
        /// <summary>Operating system version of the device. Required. Supports $filter (eq, ne, NOT, ge, le, startsWith).</summary>
