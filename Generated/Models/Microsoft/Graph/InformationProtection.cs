...
namespace GraphSdk.Models.Microsoft.Graph {
    public class InformationProtection : Entity, IParsable {
        public GraphSdk.Models.Microsoft.Graph.Bitlocker Bitlocker { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"bitlocker", (o,n) => { (o as InformationProtection).Bitlocker = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.Bitlocker>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.Bitlocker>("bitlocker", Bitlocker);
