    ...
    public class MobileAppCategory : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"displayName", (o,n) => { (o as MobileAppCategory).DisplayName = n.GetStringValue(); } },
                {"lastModifiedDateTime", (o,n) => { (o as MobileAppCategory).LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
            };
        }
        /// <summary>
