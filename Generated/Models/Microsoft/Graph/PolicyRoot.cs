...
namespace GraphSdk.Models.Microsoft.Graph {
    public class PolicyRoot : Entity, IParsable {
        ...
        public GraphSdk.Models.Microsoft.Graph.AdminConsentRequestPolicy AdminConsentRequestPolicy { get; set; }
        /// <summary>The policy configuration of the self-service sign-up experience of external users.</summary>
        public GraphSdk.Models.Microsoft.Graph.AuthenticationFlowsPolicy AuthenticationFlowsPolicy { get; set; }
        ...
        public GraphSdk.Models.Microsoft.Graph.AuthenticationMethodsPolicy AuthenticationMethodsPolicy { get; set; }
        /// <summary>The policy that controls Azure AD authorization settings.</summary>
        public GraphSdk.Models.Microsoft.Graph.AuthorizationPolicy AuthorizationPolicy { get; set; }
        ...
        public GraphSdk.Models.Microsoft.Graph.IdentitySecurityDefaultsEnforcementPolicy IdentitySecurityDefaultsEnforcementPolicy { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"adminConsentRequestPolicy", (o,n) => { (o as PolicyRoot).AdminConsentRequestPolicy = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.AdminConsentRequestPolicy>(); } },
                {"authenticationFlowsPolicy", (o,n) => { (o as PolicyRoot).AuthenticationFlowsPolicy = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.AuthenticationFlowsPolicy>(); } },
                {"authenticationMethodsPolicy", (o,n) => { (o as PolicyRoot).AuthenticationMethodsPolicy = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.AuthenticationMethodsPolicy>(); } },
                {"authorizationPolicy", (o,n) => { (o as PolicyRoot).AuthorizationPolicy = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.AuthorizationPolicy>(); } },
                ...
                {"identitySecurityDefaultsEnforcementPolicy", (o,n) => { (o as PolicyRoot).IdentitySecurityDefaultsEnforcementPolicy = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.IdentitySecurityDefaultsEnforcementPolicy>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.AdminConsentRequestPolicy>("adminConsentRequestPolicy", AdminConsentRequestPolicy);
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.AuthenticationFlowsPolicy>("authenticationFlowsPolicy", AuthenticationFlowsPolicy);
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.AuthenticationMethodsPolicy>("authenticationMethodsPolicy", AuthenticationMethodsPolicy);
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.AuthorizationPolicy>("authorizationPolicy", AuthorizationPolicy);
            ...
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.IdentitySecurityDefaultsEnforcementPolicy>("identitySecurityDefaultsEnforcementPolicy", IdentitySecurityDefaultsEnforcementPolicy);
