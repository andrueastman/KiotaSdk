...
namespace GraphSdk.Models.Microsoft.Graph {
    public class RoleAssignment : Entity, IParsable {
        ...
        public GraphSdk.Models.Microsoft.Graph.RoleDefinition RoleDefinition { get; set; }
        /// <summary>
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"roleDefinition", (o,n) => { (o as RoleAssignment).RoleDefinition = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.RoleDefinition>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.RoleDefinition>("roleDefinition", RoleDefinition);
        }
    }
}
