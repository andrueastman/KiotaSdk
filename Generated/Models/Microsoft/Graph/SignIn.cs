...
namespace GraphSdk.Models.Microsoft.Graph {
    public class SignIn : Entity, IParsable {
        ...
        /// <summary>Identifies the legacy client used for sign-in activity.  Includes Browser, Exchange Active Sync, modern clients, IMAP, MAPI, SMTP, and POP. Supports $filter (eq operator only).</summary>
