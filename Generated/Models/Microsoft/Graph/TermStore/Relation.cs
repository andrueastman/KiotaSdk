...
namespace GraphSdk.Models.Microsoft.Graph.TermStore {
    public class Relation : Entity, IParsable {
        ...
        public GraphSdk.Models.Microsoft.Graph.TermStore.Set Set { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"set", (o,n) => { (o as Relation).Set = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.TermStore.Set>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.TermStore.Set>("set", Set);
