...
namespace GraphSdk.Models.Microsoft.Graph.TermStore {
    public class Store : Entity, IParsable {
        ...
        public List<GraphSdk.Models.Microsoft.Graph.Group> Groups { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"groups", (o,n) => { (o as Store).Groups = n.GetCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.Group>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.Group>("groups", Groups);
