...
namespace GraphSdk.Models.Microsoft.Graph {
    public class TermsAndConditionsAcceptanceStatus : Entity, IParsable {
        ...
        public GraphSdk.Models.Microsoft.Graph.TermsAndConditions TermsAndConditions { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"termsAndConditions", (o,n) => { (o as TermsAndConditionsAcceptanceStatus).TermsAndConditions = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.TermsAndConditions>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.TermsAndConditions>("termsAndConditions", TermsAndConditions);
