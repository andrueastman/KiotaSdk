...
namespace ApiSdk.Oauth2PermissionGrants {
    ...
    public class Oauth2PermissionGrantsRequestBuilder {
        ...
        public OAuth2PermissionGrantRequestBuilder this[string position] { get {
            return new OAuth2PermissionGrantRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public Oauth2PermissionGrantsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
