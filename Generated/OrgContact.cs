...
namespace GraphServiceClient {
    public class OrgContact : DirectoryObject, IParsable {
        ...
        /// <summary>Name of the company that this organizational contact belong to. Supports $filter (eq, ne, NOT, ge, le, in, startsWith).</summary>
        public string CompanyName { get; set; }
        /// <summary>The name for the department in which the contact works. Supports $filter (eq, ne, NOT, ge, le, in, startsWith).</summary>
        ...
        /// <summary>Display name for this organizational contact. Supports $filter (eq, ne, NOT, ge, le, in, startsWith), $search, and $orderBy.</summary>
        public string DisplayName { get; set; }
        /// <summary>First name for this organizational contact. Supports $filter (eq, ne, NOT, ge, le, in, startsWith).</summary>
        public string GivenName { get; set; }
        /// <summary>Job title for this organizational contact. Supports $filter (eq, ne, NOT, ge, le, in, startsWith).</summary>
        public string JobTitle { get; set; }
        /// <summary>The SMTP address for the contact, for example, 'jeff@contoso.onmicrosoft.com'. Supports $filter (eq, ne, NOT, ge, le, in, startsWith).</summary>
        public string Mail { get; set; }
        /// <summary>Email alias (portion of email address pre-pending the @ symbol) for this organizational contact. Supports $filter (eq, ne, NOT, ge, le, in, startsWith).</summary>
        ...
        /// <summary>true if this object is synced from an on-premises directory; false if this object was originally synced from an on-premises directory but is no longer synced and now mastered in Exchange; null if this object has never been synced from an on-premises directory (default).</summary>
        ...
        /// <summary>Last name for this organizational contact. Supports $filter (eq, ne, NOT, ge, le, in, startsWith)</summary>
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"addresses", (o,n) => { (o as OrgContact).Addresses = n.GetCollectionOfPrimitiveValues<PhysicalOfficeAddress>().ToList(); } },
                ...
                {"onPremisesProvisioningErrors", (o,n) => { (o as OrgContact).OnPremisesProvisioningErrors = n.GetCollectionOfPrimitiveValues<OnPremisesProvisioningError>().ToList(); } },
                {"onPremisesSyncEnabled", (o,n) => { (o as OrgContact).OnPremisesSyncEnabled = n.GetBoolValue(); } },
                {"phones", (o,n) => { (o as OrgContact).Phones = n.GetCollectionOfPrimitiveValues<Phone>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<PhysicalOfficeAddress>("addresses", Addresses);
            ...
            writer.WriteCollectionOfPrimitiveValues<Phone>("phones", Phones);
