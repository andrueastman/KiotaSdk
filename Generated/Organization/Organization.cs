    ...
    public class Organization : DirectoryObject, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"mobileDeviceManagementAuthority", (o,n) => { (o as Organization).MobileDeviceManagementAuthority = n.GetObjectValue<MdmAuthority>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MdmAuthority>("mobileDeviceManagementAuthority", MobileDeviceManagementAuthority);
