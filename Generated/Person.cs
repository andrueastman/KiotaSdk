    ...
    public class Person : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"phones", (o,n) => { (o as Person).Phones = n.GetCollectionOfPrimitiveValues<Phone>().ToList(); } },
                {"postalAddresses", (o,n) => { (o as Person).PostalAddresses = n.GetCollectionOfPrimitiveValues<Location>().ToList(); } },
                {"profession", (o,n) => { (o as Person).Profession = n.GetStringValue(); } },
                {"scoredEmailAddresses", (o,n) => { (o as Person).ScoredEmailAddresses = n.GetCollectionOfPrimitiveValues<ScoredEmailAddress>().ToList(); } },
                {"surname", (o,n) => { (o as Person).Surname = n.GetStringValue(); } },
                {"userPrincipalName", (o,n) => { (o as Person).UserPrincipalName = n.GetStringValue(); } },
                {"websites", (o,n) => { (o as Person).Websites = n.GetCollectionOfPrimitiveValues<Website>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<Location>("postalAddresses", PostalAddresses);
            writer.WriteStringValue("profession", Profession);
            writer.WriteCollectionOfPrimitiveValues<ScoredEmailAddress>("scoredEmailAddresses", ScoredEmailAddresses);
            writer.WriteStringValue("surname", Surname);
            writer.WriteStringValue("userPrincipalName", UserPrincipalName);
            writer.WriteCollectionOfPrimitiveValues<Website>("websites", Websites);
