...
using GraphSdk.Planner.Buckets.Item.Tasks;
...
namespace GraphSdk.Planner.Buckets.Item {
    ...
    public class PlannerBucketRequestBuilder {
        ...
        public PlannerBucketRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/planner/buckets/{plannerBucket_id}{?select,expand}";
