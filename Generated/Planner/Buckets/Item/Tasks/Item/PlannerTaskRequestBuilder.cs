...
using GraphSdk.Planner.Buckets.Item.Tasks.Item.AssignedToTaskBoardFormat;
using GraphSdk.Planner.Buckets.Item.Tasks.Item.BucketTaskBoardFormat;
using GraphSdk.Planner.Buckets.Item.Tasks.Item.Details;
using GraphSdk.Planner.Buckets.Item.Tasks.Item.ProgressTaskBoardFormat;
...
namespace GraphSdk.Planner.Buckets.Item.Tasks.Item {
    ...
    public class PlannerTaskRequestBuilder {
        ...
        public PlannerTaskRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/planner/buckets/{plannerBucket_id}/tasks/{plannerTask_id}{?select,expand}";
