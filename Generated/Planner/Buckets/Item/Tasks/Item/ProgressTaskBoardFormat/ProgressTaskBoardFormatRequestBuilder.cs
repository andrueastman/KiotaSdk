...
namespace GraphSdk.Planner.Buckets.Item.Tasks.Item.ProgressTaskBoardFormat {
    ...
    public class ProgressTaskBoardFormatRequestBuilder {
        ...
        public ProgressTaskBoardFormatRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/planner/buckets/{plannerBucket_id}/tasks/{plannerTask_id}/progressTaskBoardFormat{?select,expand}";
