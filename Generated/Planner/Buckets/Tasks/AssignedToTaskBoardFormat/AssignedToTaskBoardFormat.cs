...
namespace GraphServiceClient.Planner.Buckets.Tasks.AssignedToTaskBoardFormat {
    public class AssignedToTaskBoardFormat : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"orderHintsByAssignee", (o,n) => { (o as AssignedToTaskBoardFormat).OrderHintsByAssignee = n.GetObjectValue<PlannerOrderHintsByAssignee>(); } },
                {"unassignedOrderHint", (o,n) => { (o as AssignedToTaskBoardFormat).UnassignedOrderHint = n.GetStringValue(); } },
            };
        }
        /// <summary>
