...
namespace GraphServiceClient.Planner.Buckets.Tasks.Details {
    public class Details : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"checklist", (o,n) => { (o as Details).Checklist = n.GetObjectValue<PlannerChecklistItems>(); } },
                {"description", (o,n) => { (o as Details).Description = n.GetStringValue(); } },
                {"previewType", (o,n) => { (o as Details).PreviewType = n.GetObjectValue<PlannerPreviewType>(); } },
                {"references", (o,n) => { (o as Details).References = n.GetObjectValue<PlannerExternalReferences>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<PlannerPreviewType>("previewType", PreviewType);
