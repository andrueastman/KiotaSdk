...
using GraphSdk.Planner.Plans.Item.Tasks.Item.AssignedToTaskBoardFormat;
using GraphSdk.Planner.Plans.Item.Tasks.Item.BucketTaskBoardFormat;
using GraphSdk.Planner.Plans.Item.Tasks.Item.Details;
using GraphSdk.Planner.Plans.Item.Tasks.Item.ProgressTaskBoardFormat;
...
namespace GraphSdk.Planner.Plans.Item.Tasks.Item {
    ...
    public class PlannerTaskRequestBuilder {
        ...
        public PlannerTaskRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/planner/plans/{plannerPlan_id}/tasks/{plannerTask_id}{?select,expand}";
