...
using GraphSdk.Planner.Tasks.Item.AssignedToTaskBoardFormat;
using GraphSdk.Planner.Tasks.Item.BucketTaskBoardFormat;
using GraphSdk.Planner.Tasks.Item.Details;
using GraphSdk.Planner.Tasks.Item.ProgressTaskBoardFormat;
...
namespace GraphSdk.Planner.Tasks.Item {
    ...
    public class PlannerTaskRequestBuilder {
        ...
        public PlannerTaskRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/planner/tasks/{plannerTask_id}{?select,expand}";
