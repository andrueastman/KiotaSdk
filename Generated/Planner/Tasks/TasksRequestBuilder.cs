...
using GraphSdk.Planner.Tasks.Item;
...
namespace GraphSdk.Planner.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.planner.tasks.item collection</summary>
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/planner/tasks{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
