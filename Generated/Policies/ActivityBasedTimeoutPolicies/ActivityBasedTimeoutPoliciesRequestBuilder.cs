...
namespace GraphSdk.Policies.ActivityBasedTimeoutPolicies {
    ...
    public class ActivityBasedTimeoutPoliciesRequestBuilder {
        ...
        /// </summary>
        public async Task<ActivityBasedTimeoutPoliciesResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ActivityBasedTimeoutPolicy> PostAsync(ActivityBasedTimeoutPolicy body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
