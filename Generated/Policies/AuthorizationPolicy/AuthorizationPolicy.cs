    ...
    public class AuthorizationPolicy : PolicyBase, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"allowInvitesFrom", (o,n) => { (o as AuthorizationPolicy).AllowInvitesFrom = n.GetObjectValue<AllowInvitesFrom>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AllowInvitesFrom>("allowInvitesFrom", AllowInvitesFrom);
