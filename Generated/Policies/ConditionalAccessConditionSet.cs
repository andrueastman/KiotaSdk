    ...
    public class ConditionalAccessConditionSet : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"clientAppTypes", (o,n) => { (o as ConditionalAccessConditionSet).ClientAppTypes = n.GetCollectionOfPrimitiveValues<ConditionalAccessClientApp>().ToList(); } },
                ...
                {"signInRiskLevels", (o,n) => { (o as ConditionalAccessConditionSet).SignInRiskLevels = n.GetCollectionOfPrimitiveValues<RiskLevel>().ToList(); } },
                {"userRiskLevels", (o,n) => { (o as ConditionalAccessConditionSet).UserRiskLevels = n.GetCollectionOfPrimitiveValues<RiskLevel>().ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<ConditionalAccessClientApp>("clientAppTypes", ClientAppTypes);
            ...
            writer.WriteCollectionOfPrimitiveValues<RiskLevel>("signInRiskLevels", SignInRiskLevels);
            writer.WriteCollectionOfPrimitiveValues<RiskLevel>("userRiskLevels", UserRiskLevels);
