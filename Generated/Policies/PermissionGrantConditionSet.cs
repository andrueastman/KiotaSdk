    ...
    public class PermissionGrantConditionSet : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"permissionType", (o,n) => { (o as PermissionGrantConditionSet).PermissionType = n.GetObjectValue<PermissionType>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<PermissionType>("permissionType", PermissionType);
