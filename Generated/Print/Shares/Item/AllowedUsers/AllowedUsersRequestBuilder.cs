using GraphSdk.Print.Shares.Item.AllowedUsers.Ref;
...
namespace GraphSdk.Print.Shares.Item.AllowedUsers {
    ...
    public class AllowedUsersRequestBuilder {
        ...
        public AllowedUsersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/print/shares/{printerShare_id}/allowedUsers{?top,skip,search,filter,count,orderby,select,expand}";
