...
using GraphSdk.Print.Shares.Item.Printer.Ref;
using GraphSdk.Print.Shares.Item.Printer.RestoreFactoryDefaults;
...
namespace GraphSdk.Print.Shares.Item.Printer {
    ...
    public class PrinterRequestBuilder {
        ...
        public PrinterRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/print/shares/{printerShare_id}/printer{?select,expand}";
