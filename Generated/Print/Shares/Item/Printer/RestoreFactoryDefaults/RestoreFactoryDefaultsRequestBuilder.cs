...
namespace GraphSdk.Print.Shares.Item.Printer.RestoreFactoryDefaults {
    ...
    public class RestoreFactoryDefaultsRequestBuilder {
        ...
        public RestoreFactoryDefaultsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/print/shares/{printerShare_id}/printer/microsoft.graph.restoreFactoryDefaults";
