...
using GraphSdk.Print.Shares.Item.AllowedGroups;
using GraphSdk.Print.Shares.Item.AllowedUsers;
using GraphSdk.Print.Shares.Item.Printer;
...
namespace GraphSdk.Print.Shares.Item {
    ...
    public class PrinterShareRequestBuilder {
        ...
        public PrinterShareRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/print/shares/{printerShare_id}{?select,expand}";
