...
namespace ApiSdk.Print.Shares.Item {
    ...
    public class PrinterShareRequestBuilder {
        public AllowedGroupsRequestBuilder AllowedGroups { get =>
            new AllowedGroupsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        public AllowedUsersRequestBuilder AllowedUsers { get =>
            new AllowedUsersRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        public PrinterRequestBuilder Printer { get =>
            new PrinterRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        /// </summary>
        public PrinterShareRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PrinterShare> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(PrinterShare body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
