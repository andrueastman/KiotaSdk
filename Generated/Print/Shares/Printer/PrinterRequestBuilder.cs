using GraphServiceClient.Print.Shares.Printer.$ref;
using GraphServiceClient.Print.Shares.Printer.Microsoft.Graph.RestoreFactoryDefaults;
...
namespace GraphServiceClient.Print.Shares.Printer {
    ...
    public class PrinterRequestBuilder {
        ...
        /// </summary>
        public PrinterRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
