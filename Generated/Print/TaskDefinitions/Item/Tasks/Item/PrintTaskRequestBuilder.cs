...
namespace ApiSdk.Print.TaskDefinitions.Item.Tasks.Item {
    ...
    public class PrintTaskRequestBuilder {
        ...
        public DefinitionRequestBuilder Definition { get =>
            new DefinitionRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        public TriggerRequestBuilder Trigger { get =>
            new TriggerRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        /// <summary>
        ...
        /// </summary>
        public PrintTaskRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
