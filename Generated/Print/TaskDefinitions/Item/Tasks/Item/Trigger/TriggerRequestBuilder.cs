...
using GraphSdk.Print.TaskDefinitions.Item.Tasks.Item.Trigger.Ref;
...
namespace GraphSdk.Print.TaskDefinitions.Item.Tasks.Item.Trigger {
    ...
    public class TriggerRequestBuilder {
        ...
        public TriggerRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/print/taskDefinitions/{printTaskDefinition_id}/tasks/{printTask_id}/trigger{?select,expand}";
