...
namespace ApiSdk.Print.TaskDefinitions {
    ...
    public class TaskDefinitionsRequestBuilder {
        ...
        public PrintTaskDefinitionRequestBuilder this[string position] { get {
            return new PrintTaskDefinitionRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public TaskDefinitionsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PrintTaskDefinition> PostAsync(PrintTaskDefinition body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
