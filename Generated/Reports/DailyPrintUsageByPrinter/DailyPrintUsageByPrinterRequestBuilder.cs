...
namespace ApiSdk.Reports.DailyPrintUsageByPrinter {
    ...
    public class DailyPrintUsageByPrinterRequestBuilder {
        ...
        public PrintUsageByPrinterRequestBuilder this[string position] { get {
            return new PrintUsageByPrinterRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public DailyPrintUsageByPrinterRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
