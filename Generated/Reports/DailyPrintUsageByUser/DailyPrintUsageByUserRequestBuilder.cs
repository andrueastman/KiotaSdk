...
using GraphSdk.Reports.DailyPrintUsageByUser.Item;
...
namespace GraphSdk.Reports.DailyPrintUsageByUser {
    ...
    public class DailyPrintUsageByUserRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.reports.dailyPrintUsageByUser.item collection</summary>
        ...
        public DailyPrintUsageByUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/reports/dailyPrintUsageByUser{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
