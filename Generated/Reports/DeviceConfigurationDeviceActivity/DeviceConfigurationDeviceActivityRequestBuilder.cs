...
namespace ApiSdk.Reports.DeviceConfigurationDeviceActivity {
    ...
    public class DeviceConfigurationDeviceActivityRequestBuilder {
        ...
        /// </summary>
        public DeviceConfigurationDeviceActivityRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<DeviceConfigurationDeviceActivityResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<DeviceConfigurationDeviceActivityResponse>(requestInfo, responseHandler);
        }
