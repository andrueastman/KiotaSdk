...
namespace ApiSdk.Reports.DeviceConfigurationUserActivity {
    ...
    public class DeviceConfigurationUserActivityRequestBuilder {
        ...
        /// </summary>
        public DeviceConfigurationUserActivityRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<DeviceConfigurationUserActivityResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<DeviceConfigurationUserActivityResponse>(requestInfo, responseHandler);
        }
