...
namespace ApiSdk.Reports.GetOffice365ServicesUserCountsWithPeriod {
    ...
    public class GetOffice365ServicesUserCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetOffice365ServicesUserCountsWithPeriodRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string period = default, bool isRawUrl = true) {
