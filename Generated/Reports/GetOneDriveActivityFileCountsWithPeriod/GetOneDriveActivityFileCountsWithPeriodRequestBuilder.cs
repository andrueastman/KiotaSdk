...
namespace ApiSdk.Reports.GetOneDriveActivityFileCountsWithPeriod {
    ...
    public class GetOneDriveActivityFileCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetOneDriveActivityFileCountsWithPeriodRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string period = default, bool isRawUrl = true) {
