...
namespace ApiSdk.Reports.GetOneDriveActivityUserCountsWithPeriod {
    ...
    public class GetOneDriveActivityUserCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetOneDriveActivityUserCountsWithPeriodRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string period = default, bool isRawUrl = true) {
