...
namespace ApiSdk.Reports.GetSharePointActivityFileCountsWithPeriod {
    ...
    public class GetSharePointActivityFileCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetSharePointActivityFileCountsWithPeriodRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string period = default, bool isRawUrl = true) {
