...
namespace ApiSdk.Reports.GetSharePointActivityUserCountsWithPeriod {
    ...
    public class GetSharePointActivityUserCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetSharePointActivityUserCountsWithPeriodRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string period = default, bool isRawUrl = true) {
