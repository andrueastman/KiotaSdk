...
namespace ApiSdk.Reports.GetSharePointActivityUserDetailWithPeriod {
    ...
    public class GetSharePointActivityUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetSharePointActivityUserDetailWithPeriodRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string period = default, bool isRawUrl = true) {
