...
namespace ApiSdk.Reports.GetSkypeForBusinessDeviceUsageUserDetailWithDate {
    ...
    public class GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string date = default, bool isRawUrl = true) {
