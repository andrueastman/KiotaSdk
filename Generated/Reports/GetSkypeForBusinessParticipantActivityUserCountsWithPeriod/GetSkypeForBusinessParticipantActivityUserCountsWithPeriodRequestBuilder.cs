...
namespace ApiSdk.Reports.GetSkypeForBusinessParticipantActivityUserCountsWithPeriod {
    ...
    public class GetSkypeForBusinessParticipantActivityUserCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetSkypeForBusinessParticipantActivityUserCountsWithPeriodRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string period = default, bool isRawUrl = true) {
