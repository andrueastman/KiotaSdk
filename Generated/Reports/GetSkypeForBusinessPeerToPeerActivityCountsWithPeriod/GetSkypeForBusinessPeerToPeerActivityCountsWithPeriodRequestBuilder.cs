...
namespace ApiSdk.Reports.GetSkypeForBusinessPeerToPeerActivityCountsWithPeriod {
    ...
    public class GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string period = default, bool isRawUrl = true) {
