...
namespace ApiSdk.Reports.GetTeamsDeviceUsageUserCountsWithPeriod {
    ...
    public class GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string period = default, bool isRawUrl = true) {
