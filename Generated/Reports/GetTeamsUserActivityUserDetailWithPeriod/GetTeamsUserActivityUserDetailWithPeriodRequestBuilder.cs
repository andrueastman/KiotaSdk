...
namespace ApiSdk.Reports.GetTeamsUserActivityUserDetailWithPeriod {
    ...
    public class GetTeamsUserActivityUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetTeamsUserActivityUserDetailWithPeriodRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string period = default, bool isRawUrl = true) {
