...
namespace GraphSdk.Reports.GetTeamsUserActivityUserDetailWithPeriod {
    ...
    public class GetTeamsUserActivityUserDetailWithPeriodRequestBuilder {
        ...
        public GetTeamsUserActivityUserDetailWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/reports/microsoft.graph.getTeamsUserActivityUserDetail(period='{period}')";
