...
namespace ApiSdk.Reports.GetYammerDeviceUsageUserCountsWithPeriod {
    ...
    public class GetYammerDeviceUsageUserCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetYammerDeviceUsageUserCountsWithPeriodRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string period = default, bool isRawUrl = true) {
