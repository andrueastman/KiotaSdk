...
namespace ApiSdk.Reports.GetYammerDeviceUsageUserDetailWithPeriod {
    ...
    public class GetYammerDeviceUsageUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetYammerDeviceUsageUserDetailWithPeriodRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string period = default, bool isRawUrl = true) {
