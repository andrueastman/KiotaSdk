...
namespace ApiSdk.Reports.GetYammerGroupsActivityCountsWithPeriod {
    ...
    public class GetYammerGroupsActivityCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetYammerGroupsActivityCountsWithPeriodRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string period = default, bool isRawUrl = true) {
