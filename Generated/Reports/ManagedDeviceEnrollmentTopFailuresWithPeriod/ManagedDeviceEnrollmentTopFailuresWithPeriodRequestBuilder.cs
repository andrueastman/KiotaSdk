...
namespace ApiSdk.Reports.ManagedDeviceEnrollmentTopFailuresWithPeriod {
    ...
    public class ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder {
        ...
        /// </summary>
        public ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string period = default, bool isRawUrl = true) {
