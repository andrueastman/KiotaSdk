    ...
    public class MonthlyPrintUsageByPrinterResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as MonthlyPrintUsageByPrinterResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as MonthlyPrintUsageByPrinterResponse).Value = n.GetCollectionOfObjectValues<PrintUsageByPrinter>().ToList(); } },
            };
        }
        /// <summary>
