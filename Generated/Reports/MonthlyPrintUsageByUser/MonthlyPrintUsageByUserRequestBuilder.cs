...
namespace ApiSdk.Reports.MonthlyPrintUsageByUser {
    ...
    public class MonthlyPrintUsageByUserRequestBuilder {
        ...
        public PrintUsageByUserRequestBuilder this[string position] { get {
            return new PrintUsageByUserRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public MonthlyPrintUsageByUserRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
