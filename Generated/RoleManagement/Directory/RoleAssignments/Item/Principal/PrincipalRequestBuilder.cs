...
namespace GraphSdk.RoleManagement.Directory.RoleAssignments.Item.Principal {
    /// <summary>Builds and executes requests for operations under \roleManagement\directory\roleAssignments\{unifiedRoleAssignment-id}\principal</summary>
    public class PrincipalRequestBuilder {
        ...
        public PrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/roleManagement/directory/roleAssignments/{unifiedRoleAssignment_id}/principal{?select,expand}";
