...
using GraphSdk.RoleManagement.Directory.RoleAssignments.Item.RoleDefinition.Ref;
...
namespace GraphSdk.RoleManagement.Directory.RoleAssignments.Item.RoleDefinition {
    ...
    public class RoleDefinitionRequestBuilder {
        ...
        public RoleDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/roleManagement/directory/roleAssignments/{unifiedRoleAssignment_id}/roleDefinition{?select,expand}";
