...
namespace GraphSdk.RoleManagement.Directory.RoleDefinitions.Item.InheritsPermissionsFrom.Item {
    ...
    public class UnifiedRoleDefinitionRequestBuilder {
        ...
        public UnifiedRoleDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/roleManagement/directory/roleDefinitions/{unifiedRoleDefinition_id}/inheritsPermissionsFrom/{unifiedRoleDefinition_id1}{?select,expand}";
