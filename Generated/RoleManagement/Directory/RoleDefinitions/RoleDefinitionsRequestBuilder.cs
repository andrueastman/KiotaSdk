...
using GraphSdk.RoleManagement.Directory.RoleDefinitions.Item;
...
namespace GraphSdk.RoleManagement.Directory.RoleDefinitions {
    ...
    public class RoleDefinitionsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.roleManagement.directory.roleDefinitions.item collection</summary>
        ...
        public RoleDefinitionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/roleManagement/directory/roleDefinitions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
