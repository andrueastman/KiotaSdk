    ...
    public class ScheduleChangeRequest : ChangeTrackedEntity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"assignedTo", (o,n) => { (o as ScheduleChangeRequest).AssignedTo = n.GetObjectValue<ScheduleChangeRequestActor>(); } },
                ...
                {"state", (o,n) => { (o as ScheduleChangeRequest).State = n.GetObjectValue<ScheduleChangeState>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ScheduleChangeRequestActor>("assignedTo", AssignedTo);
            ...
            writer.WriteObjectValue<ScheduleChangeState>("state", State);
        }
    }
}
