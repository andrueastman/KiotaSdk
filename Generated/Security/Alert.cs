    ...
    public class Alert : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"alertDetections", (o,n) => { (o as Alert).AlertDetections = n.GetCollectionOfPrimitiveValues<AlertDetection>().ToList(); } },
                ...
                {"cloudAppStates", (o,n) => { (o as Alert).CloudAppStates = n.GetCollectionOfPrimitiveValues<CloudAppSecurityState>().ToList(); } },
                ...
                {"feedback", (o,n) => { (o as Alert).Feedback = n.GetObjectValue<AlertFeedback>(); } },
                {"fileStates", (o,n) => { (o as Alert).FileStates = n.GetCollectionOfPrimitiveValues<FileSecurityState>().ToList(); } },
                {"historyStates", (o,n) => { (o as Alert).HistoryStates = n.GetCollectionOfPrimitiveValues<AlertHistoryState>().ToList(); } },
                {"hostStates", (o,n) => { (o as Alert).HostStates = n.GetCollectionOfPrimitiveValues<HostSecurityState>().ToList(); } },
                {"incidentIds", (o,n) => { (o as Alert).IncidentIds = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"investigationSecurityStates", (o,n) => { (o as Alert).InvestigationSecurityStates = n.GetCollectionOfPrimitiveValues<InvestigationSecurityState>().ToList(); } },
                ...
                {"malwareStates", (o,n) => { (o as Alert).MalwareStates = n.GetCollectionOfPrimitiveValues<MalwareState>().ToList(); } },
                {"messageSecurityStates", (o,n) => { (o as Alert).MessageSecurityStates = n.GetCollectionOfPrimitiveValues<MessageSecurityState>().ToList(); } },
                {"networkConnections", (o,n) => { (o as Alert).NetworkConnections = n.GetCollectionOfPrimitiveValues<NetworkConnection>().ToList(); } },
                {"processes", (o,n) => { (o as Alert).Processes = n.GetCollectionOfPrimitiveValues<Process>().ToList(); } },
                {"recommendedActions", (o,n) => { (o as Alert).RecommendedActions = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"registryKeyStates", (o,n) => { (o as Alert).RegistryKeyStates = n.GetCollectionOfPrimitiveValues<RegistryKeyState>().ToList(); } },
                {"securityResources", (o,n) => { (o as Alert).SecurityResources = n.GetCollectionOfPrimitiveValues<SecurityResource>().ToList(); } },
                {"severity", (o,n) => { (o as Alert).Severity = n.GetObjectValue<AlertSeverity>(); } },
                {"sourceMaterials", (o,n) => { (o as Alert).SourceMaterials = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"status", (o,n) => { (o as Alert).Status = n.GetObjectValue<AlertStatus>(); } },
                {"tags", (o,n) => { (o as Alert).Tags = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"title", (o,n) => { (o as Alert).Title = n.GetStringValue(); } },
                {"triggers", (o,n) => { (o as Alert).Triggers = n.GetCollectionOfPrimitiveValues<AlertTrigger>().ToList(); } },
                {"uriClickSecurityStates", (o,n) => { (o as Alert).UriClickSecurityStates = n.GetCollectionOfPrimitiveValues<UriClickSecurityState>().ToList(); } },
                {"userStates", (o,n) => { (o as Alert).UserStates = n.GetCollectionOfPrimitiveValues<UserSecurityState>().ToList(); } },
                {"vendorInformation", (o,n) => { (o as Alert).VendorInformation = n.GetObjectValue<SecurityVendorInformation>(); } },
                {"vulnerabilityStates", (o,n) => { (o as Alert).VulnerabilityStates = n.GetCollectionOfPrimitiveValues<VulnerabilityState>().ToList(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<AlertDetection>("alertDetections", AlertDetections);
            ...
            writer.WriteCollectionOfPrimitiveValues<CloudAppSecurityState>("cloudAppStates", CloudAppStates);
            ...
            writer.WriteObjectValue<AlertFeedback>("feedback", Feedback);
            writer.WriteCollectionOfPrimitiveValues<FileSecurityState>("fileStates", FileStates);
            writer.WriteCollectionOfPrimitiveValues<AlertHistoryState>("historyStates", HistoryStates);
            writer.WriteCollectionOfPrimitiveValues<HostSecurityState>("hostStates", HostStates);
            writer.WriteCollectionOfPrimitiveValues<string>("incidentIds", IncidentIds);
            writer.WriteCollectionOfPrimitiveValues<InvestigationSecurityState>("investigationSecurityStates", InvestigationSecurityStates);
            writer.WriteDateTimeOffsetValue("lastEventDateTime", LastEventDateTime);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteCollectionOfPrimitiveValues<MalwareState>("malwareStates", MalwareStates);
            writer.WriteCollectionOfPrimitiveValues<MessageSecurityState>("messageSecurityStates", MessageSecurityStates);
            writer.WriteCollectionOfPrimitiveValues<NetworkConnection>("networkConnections", NetworkConnections);
            writer.WriteCollectionOfPrimitiveValues<Process>("processes", Processes);
            writer.WriteCollectionOfPrimitiveValues<string>("recommendedActions", RecommendedActions);
            writer.WriteCollectionOfPrimitiveValues<RegistryKeyState>("registryKeyStates", RegistryKeyStates);
            writer.WriteCollectionOfPrimitiveValues<SecurityResource>("securityResources", SecurityResources);
            writer.WriteObjectValue<AlertSeverity>("severity", Severity);
            writer.WriteCollectionOfPrimitiveValues<string>("sourceMaterials", SourceMaterials);
            writer.WriteObjectValue<AlertStatus>("status", Status);
            writer.WriteCollectionOfPrimitiveValues<string>("tags", Tags);
            writer.WriteStringValue("title", Title);
            writer.WriteCollectionOfPrimitiveValues<AlertTrigger>("triggers", Triggers);
            writer.WriteCollectionOfPrimitiveValues<UriClickSecurityState>("uriClickSecurityStates", UriClickSecurityStates);
            writer.WriteCollectionOfPrimitiveValues<UserSecurityState>("userStates", UserStates);
            writer.WriteObjectValue<SecurityVendorInformation>("vendorInformation", VendorInformation);
            writer.WriteCollectionOfPrimitiveValues<VulnerabilityState>("vulnerabilityStates", VulnerabilityStates);
        }
    }
}
