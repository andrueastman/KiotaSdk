    ...
    public class SecureScore : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"averageComparativeScores", (o,n) => { (o as SecureScore).AverageComparativeScores = n.GetCollectionOfPrimitiveValues<AverageComparativeScore>().ToList(); } },
                {"azureTenantId", (o,n) => { (o as SecureScore).AzureTenantId = n.GetStringValue(); } },
                {"controlScores", (o,n) => { (o as SecureScore).ControlScores = n.GetCollectionOfPrimitiveValues<ControlScore>().ToList(); } },
                {"createdDateTime", (o,n) => { (o as SecureScore).CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                {"currentScore", (o,n) => { (o as SecureScore).CurrentScore = n.GetObjectValue<Double>(); } },
                ...
                {"maxScore", (o,n) => { (o as SecureScore).MaxScore = n.GetObjectValue<Double>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<AverageComparativeScore>("averageComparativeScores", AverageComparativeScores);
            writer.WriteStringValue("azureTenantId", AzureTenantId);
            writer.WriteCollectionOfPrimitiveValues<ControlScore>("controlScores", ControlScores);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteObjectValue<Double>("currentScore", CurrentScore);
            ...
            writer.WriteObjectValue<Double>("maxScore", MaxScore);
