    ...
    public class SecureScoreControlProfile : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"complianceInformation", (o,n) => { (o as SecureScoreControlProfile).ComplianceInformation = n.GetCollectionOfPrimitiveValues<ComplianceInformation>().ToList(); } },
                {"controlCategory", (o,n) => { (o as SecureScoreControlProfile).ControlCategory = n.GetStringValue(); } },
                {"controlStateUpdates", (o,n) => { (o as SecureScoreControlProfile).ControlStateUpdates = n.GetCollectionOfPrimitiveValues<SecureScoreControlStateUpdate>().ToList(); } },
                ...
                {"maxScore", (o,n) => { (o as SecureScoreControlProfile).MaxScore = n.GetObjectValue<Double>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<ComplianceInformation>("complianceInformation", ComplianceInformation);
            writer.WriteStringValue("controlCategory", ControlCategory);
            writer.WriteCollectionOfPrimitiveValues<SecureScoreControlStateUpdate>("controlStateUpdates", ControlStateUpdates);
