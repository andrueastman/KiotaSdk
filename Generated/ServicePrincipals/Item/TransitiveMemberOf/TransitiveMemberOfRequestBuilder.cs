using GraphSdk.ServicePrincipals.Item.TransitiveMemberOf.Ref;
...
namespace GraphSdk.ServicePrincipals.Item.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        public TransitiveMemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/servicePrincipals/{servicePrincipal_id}/transitiveMemberOf{?top,skip,search,filter,count,orderby,select,expand}";
