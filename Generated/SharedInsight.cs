    ...
    public class SharedInsight : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"sharingHistory", (o,n) => { (o as SharedInsight).SharingHistory = n.GetCollectionOfPrimitiveValues<SharingDetail>().ToList(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<SharingDetail>("sharingHistory", SharingHistory);
        }
    }
}
