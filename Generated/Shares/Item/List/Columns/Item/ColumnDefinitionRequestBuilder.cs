...
using GraphSdk.Shares.Item.List.Columns.Item.SourceColumn;
...
namespace GraphSdk.Shares.Item.List.Columns.Item {
    ...
    public class ColumnDefinitionRequestBuilder {
        ...
        public ColumnDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/list/columns/{columnDefinition_id}{?select,expand}";
