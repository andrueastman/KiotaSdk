...
using GraphSdk.Shares.Item.List.ContentTypes.Item.Base.AssociateWithHubSites;
using GraphSdk.Shares.Item.List.ContentTypes.Item.Base.CopyToDefaultContentLocation;
using GraphSdk.Shares.Item.List.ContentTypes.Item.Base.IsPublished;
using GraphSdk.Shares.Item.List.ContentTypes.Item.Base.Publish;
using GraphSdk.Shares.Item.List.ContentTypes.Item.Base.Ref;
using GraphSdk.Shares.Item.List.ContentTypes.Item.Base.Unpublish;
...
namespace GraphSdk.Shares.Item.List.ContentTypes.Item.Base {
    ...
    public class BaseRequestBuilder {
        ...
        public BaseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/list/contentTypes/{contentType_id}/base{?select,expand}";
