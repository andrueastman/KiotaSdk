...
namespace GraphSdk.Shares.Item.List.ContentTypes.Item.BaseTypes.AddCopy {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\contentTypes\{contentType-id}\baseTypes\microsoft.graph.addCopy</summary>
    public class AddCopyRequestBuilder {
        ...
        public AddCopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/list/contentTypes/{contentType_id}/baseTypes/microsoft.graph.addCopy";
        ...
        /// </summary>
        public async Task<AddCopyResponse> PostAsync(AddCopyRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendAsync<AddCopyResponse>(requestInfo, responseHandler);
        }
