using GraphSdk.Shares.Item.List.ContentTypes.Item.BaseTypes.AddCopy;
using GraphSdk.Shares.Item.List.ContentTypes.Item.BaseTypes.Ref;
...
namespace GraphSdk.Shares.Item.List.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder {
        ...
        public BaseTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/list/contentTypes/{contentType_id}/baseTypes{?top,skip,search,filter,count,orderby,select,expand}";
