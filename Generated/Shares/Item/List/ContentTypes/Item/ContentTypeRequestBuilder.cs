...
using GraphSdk.Shares.Item.List.ContentTypes.Item.AssociateWithHubSites;
using GraphSdk.Shares.Item.List.ContentTypes.Item.Base;
using GraphSdk.Shares.Item.List.ContentTypes.Item.BaseTypes;
using GraphSdk.Shares.Item.List.ContentTypes.Item.ColumnLinks;
using GraphSdk.Shares.Item.List.ContentTypes.Item.ColumnPositions;
using GraphSdk.Shares.Item.List.ContentTypes.Item.Columns;
using GraphSdk.Shares.Item.List.ContentTypes.Item.CopyToDefaultContentLocation;
using GraphSdk.Shares.Item.List.ContentTypes.Item.IsPublished;
using GraphSdk.Shares.Item.List.ContentTypes.Item.Publish;
using GraphSdk.Shares.Item.List.ContentTypes.Item.Unpublish;
...
namespace GraphSdk.Shares.Item.List.ContentTypes.Item {
    ...
    public class ContentTypeRequestBuilder {
        ...
        public ContentTypeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/list/contentTypes/{contentType_id}{?select,expand}";
