...
using GraphSdk.Shares.Item.List.Items.Item.DriveItem.Content;
...
namespace GraphSdk.Shares.Item.List.Items.Item.DriveItem {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\items\{listItem-id}\driveItem</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/list/items/{listItem_id}/driveItem{?select,expand}";
