...
using GraphSdk.Shares.Item.ListItem.DriveItem.Content;
...
namespace GraphSdk.Shares.Item.ListItem.DriveItem {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\listItem\driveItem</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/listItem/driveItem{?select,expand}";
