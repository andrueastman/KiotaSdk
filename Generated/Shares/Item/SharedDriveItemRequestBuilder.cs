...
namespace GraphServiceClient.Shares.Item {
    ...
    public class SharedDriveItemRequestBuilder {
        ...
        public ListRequestBuilder List { get =>
            new ListRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        ...
        public PermissionRequestBuilder Permission { get =>
            new PermissionRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        public RootRequestBuilder Root { get =>
            new RootRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        public SiteRequestBuilder Site { get =>
            new SiteRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        /// <summary>
        ...
        /// </summary>
        public SharedDriveItemRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(SharedDriveItem body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SharedDriveItem> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SharedDriveItem body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
