using GraphServiceClient.Shares.List.Items.Analytics;
using GraphServiceClient.Shares.List.Items.DriveItem;
using GraphServiceClient.Shares.List.Items.Fields;
using GraphServiceClient.Shares.List.Items.Versions;
...
namespace GraphServiceClient.Shares.List.Items.Item {
