using GraphServiceClient.Shares.List.Columns;
using GraphServiceClient.Shares.List.ContentTypes;
using GraphServiceClient.Shares.List.Drive;
using GraphServiceClient.Shares.List.Items;
using GraphServiceClient.Shares.List.Subscriptions;
...
namespace GraphServiceClient.Shares.List {
