...
using GraphSdk.Sites.Item.Analytics.Ref;
...
namespace GraphSdk.Sites.Item.Analytics {
    ...
    public class AnalyticsRequestBuilder {
        ...
        public AnalyticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/analytics{?select,expand}";
