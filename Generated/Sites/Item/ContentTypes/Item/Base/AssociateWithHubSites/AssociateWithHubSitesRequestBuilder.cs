...
namespace GraphSdk.Sites.Item.ContentTypes.Item.Base.AssociateWithHubSites {
    ...
    public class AssociateWithHubSitesRequestBuilder {
        ...
        public AssociateWithHubSitesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/contentTypes/{contentType_id}/base/microsoft.graph.associateWithHubSites";
