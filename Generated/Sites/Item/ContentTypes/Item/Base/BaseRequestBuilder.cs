...
using GraphSdk.Sites.Item.ContentTypes.Item.Base.AssociateWithHubSites;
using GraphSdk.Sites.Item.ContentTypes.Item.Base.CopyToDefaultContentLocation;
using GraphSdk.Sites.Item.ContentTypes.Item.Base.IsPublished;
using GraphSdk.Sites.Item.ContentTypes.Item.Base.Publish;
using GraphSdk.Sites.Item.ContentTypes.Item.Base.Ref;
using GraphSdk.Sites.Item.ContentTypes.Item.Base.Unpublish;
...
namespace GraphSdk.Sites.Item.ContentTypes.Item.Base {
    ...
    public class BaseRequestBuilder {
        ...
        public BaseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/contentTypes/{contentType_id}/base{?select,expand}";
