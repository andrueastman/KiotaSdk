...
namespace GraphSdk.Sites.Item.ContentTypes.Item.Unpublish {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\contentTypes\{contentType-id}\microsoft.graph.unpublish</summary>
    public class UnpublishRequestBuilder {
        ...
        public UnpublishRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/contentTypes/{contentType_id}/microsoft.graph.unpublish";
