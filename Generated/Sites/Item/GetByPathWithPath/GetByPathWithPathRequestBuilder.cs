...
namespace ApiSdk.Sites.Item.GetByPathWithPath {
    ...
    public class GetByPathWithPathRequestBuilder {
        ...
        /// </summary>
        public GetByPathWithPathRequestBuilder(string currentPath, IHttpCore httpCore, string path = default, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<GetByPathWithPathResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<GetByPathWithPathResponse>(requestInfo, responseHandler);
        }
