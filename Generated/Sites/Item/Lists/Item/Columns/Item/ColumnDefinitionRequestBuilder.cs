...
using GraphSdk.Sites.Item.Lists.Item.Columns.Item.SourceColumn;
...
namespace GraphSdk.Sites.Item.Lists.Item.Columns.Item {
    ...
    public class ColumnDefinitionRequestBuilder {
        ...
        public ColumnDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/lists/{list_id}/columns/{columnDefinition_id}{?select,expand}";
