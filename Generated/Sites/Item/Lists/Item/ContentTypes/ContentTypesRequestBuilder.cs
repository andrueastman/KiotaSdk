...
namespace ApiSdk.Sites.Item.Lists.Item.ContentTypes {
    ...
    public class ContentTypesRequestBuilder {
        ...
        public ContentTypeRequestBuilder this[string position] { get {
            return new ContentTypeRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public ContentTypesRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
