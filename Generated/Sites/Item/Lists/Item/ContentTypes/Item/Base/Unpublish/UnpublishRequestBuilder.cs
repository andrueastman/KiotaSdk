...
namespace GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.Base.Unpublish {
    ...
    public class UnpublishRequestBuilder {
        ...
        public UnpublishRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/lists/{list_id}/contentTypes/{contentType_id}/base/microsoft.graph.unpublish";
