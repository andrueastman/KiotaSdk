using GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.ColumnPositions.Ref;
...
namespace GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.ColumnPositions {
    ...
    public class ColumnPositionsRequestBuilder {
        ...
        public ColumnPositionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/lists/{list_id}/contentTypes/{contentType_id}/columnPositions{?top,skip,search,filter,count,orderby,select,expand}";
