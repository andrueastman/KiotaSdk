...
using GraphSdk.Sites.Item.Lists.Item.Items.Item.Analytics.Ref;
...
namespace GraphSdk.Sites.Item.Lists.Item.Items.Item.Analytics {
    ...
    public class AnalyticsRequestBuilder {
        ...
        public AnalyticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/lists/{list_id}/items/{listItem_id}/analytics{?select,expand}";
