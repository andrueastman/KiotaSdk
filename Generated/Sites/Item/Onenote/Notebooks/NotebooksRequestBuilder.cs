...
using GraphSdk.Sites.Item.Onenote.Notebooks.GetNotebookFromWebUrl;
using GraphSdk.Sites.Item.Onenote.Notebooks.GetRecentNotebooksWithIncludePersonalNotebooks;
using GraphSdk.Sites.Item.Onenote.Notebooks.Item;
...
namespace GraphSdk.Sites.Item.Onenote.Notebooks {
    ...
    public class NotebooksRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.sites.item.onenote.notebooks.item collection</summary>
        ...
        public NotebooksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/notebooks{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
