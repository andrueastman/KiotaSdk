...
using GraphSdk.Sites.Item.Onenote.Pages.Item.Content;
using GraphSdk.Sites.Item.Onenote.Pages.Item.CopyToSection;
using GraphSdk.Sites.Item.Onenote.Pages.Item.OnenotePatchContent;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection;
using GraphSdk.Sites.Item.Onenote.Pages.Item.Preview;
...
namespace GraphSdk.Sites.Item.Onenote.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/pages/{onenotePage_id}{?select,expand}";
