...
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.ParentSectionGroup.ParentNotebook;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.ParentSectionGroup.SectionGroups;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.ParentSectionGroup.Sections;
...
namespace GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.ParentSectionGroup {
    ...
    public class ParentSectionGroupRequestBuilder {
        ...
        public ParentSectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/pages/{onenotePage_id}/parentNotebook/sections/{onenoteSection_id}/parentSectionGroup{?select,expand}";
