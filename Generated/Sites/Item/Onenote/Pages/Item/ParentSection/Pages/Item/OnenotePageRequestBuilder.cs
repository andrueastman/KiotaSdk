...
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection.Pages.Item.Content;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection.Pages.Item.CopyToSection;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection.Pages.Item.OnenotePatchContent;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection.Pages.Item.Preview;
...
namespace GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/pages/{onenotePage_id}/parentSection/pages/{onenotePage_id1}{?select,expand}";
