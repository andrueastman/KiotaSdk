...
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection.ParentNotebook.Sections.Item;
...
namespace GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection.ParentNotebook.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.sites.item.onenote.pages.item.parentSection.parentNotebook.sections.item collection</summary>
        ...
        public SectionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/pages/{onenotePage_id}/parentSection/parentNotebook/sections{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
