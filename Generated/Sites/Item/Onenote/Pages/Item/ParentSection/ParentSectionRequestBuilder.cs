...
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection.CopyToNotebook;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection.CopyToSectionGroup;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection.Pages;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection.ParentNotebook;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup;
...
namespace GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection {
    ...
    public class ParentSectionRequestBuilder {
        ...
        public ParentSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/pages/{onenotePage_id}/parentSection{?select,expand}";
