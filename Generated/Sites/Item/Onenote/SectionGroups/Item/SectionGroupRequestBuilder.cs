...
using GraphSdk.Sites.Item.Onenote.SectionGroups.Item.ParentNotebook;
using GraphSdk.Sites.Item.Onenote.SectionGroups.Item.ParentSectionGroup;
using GraphSdk.Sites.Item.Onenote.SectionGroups.Item.SectionGroups;
using GraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections;
...
namespace GraphSdk.Sites.Item.Onenote.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public SectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/sectionGroups/{sectionGroup_id}{?select,expand}";
