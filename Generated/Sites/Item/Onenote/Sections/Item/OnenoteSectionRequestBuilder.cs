...
using GraphSdk.Sites.Item.Onenote.Sections.Item.CopyToNotebook;
using GraphSdk.Sites.Item.Onenote.Sections.Item.CopyToSectionGroup;
using GraphSdk.Sites.Item.Onenote.Sections.Item.Pages;
using GraphSdk.Sites.Item.Onenote.Sections.Item.ParentNotebook;
using GraphSdk.Sites.Item.Onenote.Sections.Item.ParentSectionGroup;
...
namespace GraphSdk.Sites.Item.Onenote.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/sections/{onenoteSection_id}{?select,expand}";
