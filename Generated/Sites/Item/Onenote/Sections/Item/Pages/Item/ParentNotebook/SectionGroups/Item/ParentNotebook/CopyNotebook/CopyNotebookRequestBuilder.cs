...
namespace GraphSdk.Sites.Item.Onenote.Sections.Item.Pages.Item.ParentNotebook.SectionGroups.Item.ParentNotebook.CopyNotebook {
    ...
    public class CopyNotebookRequestBuilder {
        ...
        public CopyNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook/microsoft.graph.copyNotebook";
