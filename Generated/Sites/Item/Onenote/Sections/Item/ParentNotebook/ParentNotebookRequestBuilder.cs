...
using GraphSdk.Sites.Item.Onenote.Sections.Item.ParentNotebook.CopyNotebook;
using GraphSdk.Sites.Item.Onenote.Sections.Item.ParentNotebook.SectionGroups;
using GraphSdk.Sites.Item.Onenote.Sections.Item.ParentNotebook.Sections;
...
namespace GraphSdk.Sites.Item.Onenote.Sections.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public ParentNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
