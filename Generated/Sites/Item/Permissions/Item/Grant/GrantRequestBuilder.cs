...
namespace ApiSdk.Sites.Item.Permissions.Item.Grant {
    ...
    public class GrantRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<ApiSdk.Sites.Item.Permissions.Item.Grant.Grant>> PostAsync(GrantRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
