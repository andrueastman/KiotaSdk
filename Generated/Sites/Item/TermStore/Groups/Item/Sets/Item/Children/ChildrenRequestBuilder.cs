...
using GraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Children.Item;
...
namespace GraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.sites.item.termStore.groups.item.sets.item.children.item collection</summary>
        ...
        public ChildrenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/groups/{group_id}/sets/{set_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
