...
using GraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Children.Item.Relations.Item.ToTerm.Ref;
...
namespace GraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Children.Item.Relations.Item.ToTerm {
    ...
    public class ToTermRequestBuilder {
        ...
        public ToTermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/groups/{group_id}/sets/{set_id}/children/{term_id}/relations/{relation_id}/toTerm{?select,expand}";
