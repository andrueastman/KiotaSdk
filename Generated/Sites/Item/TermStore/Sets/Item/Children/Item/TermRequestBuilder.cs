...
using GraphSdk.Sites.Item.TermStore.Sets.Item.Children.Item.Children;
using GraphSdk.Sites.Item.TermStore.Sets.Item.Children.Item.Relations;
using GraphSdk.Sites.Item.TermStore.Sets.Item.Children.Item.Set;
...
namespace GraphSdk.Sites.Item.TermStore.Sets.Item.Children.Item {
    ...
    public class TermRequestBuilder {
        ...
        public TermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/sets/{set_id}/children/{term_id}{?select,expand}";
