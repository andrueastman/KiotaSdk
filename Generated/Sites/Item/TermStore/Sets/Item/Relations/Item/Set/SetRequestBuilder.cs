...
using GraphSdk.Sites.Item.TermStore.Sets.Item.Relations.Item.Set.Ref;
...
namespace GraphSdk.Sites.Item.TermStore.Sets.Item.Relations.Item.Set {
    ...
    public class SetRequestBuilder {
        ...
        public SetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/sets/{set_id}/relations/{relation_id}/set{?select,expand}";
