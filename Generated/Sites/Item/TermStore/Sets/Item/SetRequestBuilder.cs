...
using GraphSdk.Sites.Item.TermStore.Sets.Item.Children;
using GraphSdk.Sites.Item.TermStore.Sets.Item.ParentGroup;
using GraphSdk.Sites.Item.TermStore.Sets.Item.Relations;
using GraphSdk.Sites.Item.TermStore.Sets.Item.Terms;
...
namespace GraphSdk.Sites.Item.TermStore.Sets.Item {
    ...
    public class SetRequestBuilder {
        ...
        public SetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/sets/{set_id}{?select,expand}";
