...
using GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Children;
using GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Relations;
using GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Set;
...
namespace GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item {
    ...
    public class TermRequestBuilder {
        ...
        public TermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/children/{term_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Term body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
