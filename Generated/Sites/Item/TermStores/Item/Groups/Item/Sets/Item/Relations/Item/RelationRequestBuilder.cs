...
using GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Relations.Item.FromTerm;
using GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Relations.Item.Set;
using GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Relations.Item.ToTerm;
...
namespace GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Relations.Item {
    ...
    public class RelationRequestBuilder {
        ...
        public RelationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/relations/{relation_id}{?select,expand}";
