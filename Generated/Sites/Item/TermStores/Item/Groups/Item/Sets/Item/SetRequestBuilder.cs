...
using GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children;
using GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.ParentGroup;
using GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Relations;
using GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Terms;
...
namespace GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item {
    ...
    public class SetRequestBuilder {
        ...
        public SetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}{?select,expand}";
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(GraphSdk.Models.Microsoft.Graph.TermStore.Set body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(GraphSdk.Models.Microsoft.Graph.TermStore.Set body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
