...
using GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Terms.Item.Children.Item;
...
namespace GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Terms.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.sites.item.termStores.item.groups.item.sets.item.terms.item.children.item collection</summary>
        ...
        public ChildrenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/terms/{term_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
