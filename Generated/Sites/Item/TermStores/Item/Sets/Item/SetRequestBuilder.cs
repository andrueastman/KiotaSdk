...
using GraphSdk.Sites.Item.TermStores.Item.Sets.Item.Children;
using GraphSdk.Sites.Item.TermStores.Item.Sets.Item.ParentGroup;
using GraphSdk.Sites.Item.TermStores.Item.Sets.Item.Relations;
using GraphSdk.Sites.Item.TermStores.Item.Sets.Item.Terms;
...
namespace GraphSdk.Sites.Item.TermStores.Item.Sets.Item {
    ...
    public class SetRequestBuilder {
        ...
        public SetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStores/{store_id}/sets/{set_id}{?select,expand}";
