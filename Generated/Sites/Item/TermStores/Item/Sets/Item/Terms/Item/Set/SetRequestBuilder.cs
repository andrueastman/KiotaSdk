...
using GraphSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Set.Ref;
...
namespace GraphSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Set {
    ...
    public class SetRequestBuilder {
        ...
        public SetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStores/{store_id}/sets/{set_id}/terms/{term_id}/set{?select,expand}";
