using GraphServiceClient.Sites.Lists.Columns;
using GraphServiceClient.Sites.Lists.ContentTypes;
using GraphServiceClient.Sites.Lists.Drive;
using GraphServiceClient.Sites.Lists.Items;
using GraphServiceClient.Sites.Lists.Subscriptions;
...
namespace GraphServiceClient.Sites.Lists.Item {
    ...
    public class ListRequestBuilder {
        ...
        /// </summary>
        public ListRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
