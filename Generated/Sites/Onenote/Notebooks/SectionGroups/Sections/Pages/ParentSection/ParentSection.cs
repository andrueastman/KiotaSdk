...
namespace GraphServiceClient.Sites.Onenote.Notebooks.SectionGroups.Sections.Pages.ParentSection {
    public class ParentSection : OnenoteEntityHierarchyModel, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"isDefault", (o,n) => { (o as ParentSection).IsDefault = n.GetBoolValue(); } },
                {"links", (o,n) => { (o as ParentSection).Links = n.GetObjectValue<SectionLinks>(); } },
                {"pages", (o,n) => { (o as ParentSection).Pages = n.GetCollectionOfObjectValues<OnenotePage>().ToList(); } },
                {"pagesUrl", (o,n) => { (o as ParentSection).PagesUrl = n.GetStringValue(); } },
                {"parentNotebook", (o,n) => { (o as ParentSection).ParentNotebook = n.GetObjectValue<Notebook>(); } },
                {"parentSectionGroup", (o,n) => { (o as ParentSection).ParentSectionGroup = n.GetObjectValue<SectionGroup>(); } },
            };
        }
        /// <summary>
