...
namespace ApiSdk.Sites.Remove {
    ...
    public class RemoveRequestBuilder {
        ...
        /// </summary>
        public RemoveRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(RemoveRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
