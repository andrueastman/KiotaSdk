    ...
    public class Team : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"specialization", (o,n) => { (o as Team).Specialization = n.GetObjectValue<TeamSpecialization>(); } },
                {"template", (o,n) => { (o as Team).Template = n.GetObjectValue<TeamsTemplate>(); } },
                {"visibility", (o,n) => { (o as Team).Visibility = n.GetObjectValue<TeamVisibilityType>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<TeamSpecialization>("specialization", Specialization);
