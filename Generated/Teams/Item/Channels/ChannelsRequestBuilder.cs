...
using GraphSdk.Teams.Item.Channels.GetAllMessages;
using GraphSdk.Teams.Item.Channels.Item;
...
namespace GraphSdk.Teams.Item.Channels {
    ...
    public class ChannelsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.teams.item.channels.item collection</summary>
        ...
        public ChannelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/channels{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
