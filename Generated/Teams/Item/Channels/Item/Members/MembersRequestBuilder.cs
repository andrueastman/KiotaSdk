...
using GraphSdk.Teams.Item.Channels.Item.Members.Add;
using GraphSdk.Teams.Item.Channels.Item.Members.Item;
...
namespace GraphSdk.Teams.Item.Channels.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.teams.item.channels.item.members.item collection</summary>
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/channels/{channel_id}/members{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
