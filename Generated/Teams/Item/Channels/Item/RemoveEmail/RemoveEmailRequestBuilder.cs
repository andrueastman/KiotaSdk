...
namespace GraphSdk.Teams.Item.Channels.Item.RemoveEmail {
    ...
    public class RemoveEmailRequestBuilder {
        ...
        public RemoveEmailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/channels/{channel_id}/microsoft.graph.removeEmail";
