...
using GraphSdk.Teams.Item.Group.Ref;
...
namespace GraphSdk.Teams.Item.Group {
    /// <summary>Builds and executes requests for operations under \teams\{team-id}\group</summary>
    public class GroupRequestBuilder {
        ...
        public GroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/group{?select,expand}";
