...
namespace GraphSdk.Teams.Item.InstalledApps.Item.Upgrade {
    ...
    public class UpgradeRequestBuilder {
        ...
        public UpgradeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/installedApps/{teamsAppInstallation_id}/microsoft.graph.upgrade";
