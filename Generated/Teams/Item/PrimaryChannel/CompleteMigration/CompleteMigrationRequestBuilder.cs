...
namespace GraphSdk.Teams.Item.PrimaryChannel.CompleteMigration {
    ...
    public class CompleteMigrationRequestBuilder {
        ...
        public CompleteMigrationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/primaryChannel/microsoft.graph.completeMigration";
