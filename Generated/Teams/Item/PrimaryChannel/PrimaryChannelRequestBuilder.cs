...
using GraphSdk.Teams.Item.PrimaryChannel.CompleteMigration;
using GraphSdk.Teams.Item.PrimaryChannel.FilesFolder;
using GraphSdk.Teams.Item.PrimaryChannel.Members;
using GraphSdk.Teams.Item.PrimaryChannel.Messages;
using GraphSdk.Teams.Item.PrimaryChannel.ProvisionEmail;
using GraphSdk.Teams.Item.PrimaryChannel.RemoveEmail;
using GraphSdk.Teams.Item.PrimaryChannel.Tabs;
...
namespace GraphSdk.Teams.Item.PrimaryChannel {
