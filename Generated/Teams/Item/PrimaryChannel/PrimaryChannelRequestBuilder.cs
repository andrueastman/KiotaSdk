...
namespace ApiSdk.Teams.Item.PrimaryChannel {
    ...
    public class PrimaryChannelRequestBuilder {
        ...
        public FilesFolderRequestBuilder FilesFolder { get =>
            new FilesFolderRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        /// </summary>
        public PrimaryChannelRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
