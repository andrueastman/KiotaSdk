...
using GraphSdk.Teams.Item.PrimaryChannel.Tabs.Item;
...
namespace GraphSdk.Teams.Item.PrimaryChannel.Tabs {
    ...
    public class TabsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.teams.item.primaryChannel.tabs.item collection</summary>
        ...
        public TabsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/primaryChannel/tabs{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
