...
namespace ApiSdk.Teams.Item.PrimaryChannel.Tabs {
    ...
    public class TabsRequestBuilder {
        ...
        public TeamsTabRequestBuilder this[string position] { get {
            return new TeamsTabRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public TabsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
