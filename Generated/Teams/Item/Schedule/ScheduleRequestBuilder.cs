...
namespace ApiSdk.Teams.Item.Schedule {
    ...
    public class ScheduleRequestBuilder {
        ...
        public OfferShiftRequestsRequestBuilder OfferShiftRequests { get =>
            new OfferShiftRequestsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        public OpenShiftChangeRequestsRequestBuilder OpenShiftChangeRequests { get =>
            new OpenShiftChangeRequestsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        public OpenShiftsRequestBuilder OpenShifts { get =>
            new OpenShiftsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        public SchedulingGroupsRequestBuilder SchedulingGroups { get =>
            new SchedulingGroupsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        public ShareRequestBuilder Share { get =>
            new ShareRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        public ShiftsRequestBuilder Shifts { get =>
            new ShiftsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        public SwapShiftsChangeRequestsRequestBuilder SwapShiftsChangeRequests { get =>
            new SwapShiftsChangeRequestsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        public TimeOffReasonsRequestBuilder TimeOffReasons { get =>
            new TimeOffReasonsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        public TimeOffRequestsRequestBuilder TimeOffRequests { get =>
            new TimeOffRequestsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        public TimesOffRequestBuilder TimesOff { get =>
            new TimesOffRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        /// <summary>
        ...
        /// </summary>
        public ScheduleRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ApiSdk.Models.Microsoft.Graph.Schedule body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
