...
namespace ApiSdk.Teams.Item.Schedule.TimeOffReasons {
    ...
    public class TimeOffReasonsRequestBuilder {
        ...
        public TimeOffReasonRequestBuilder this[string position] { get {
            return new TimeOffReasonRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public TimeOffReasonsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
