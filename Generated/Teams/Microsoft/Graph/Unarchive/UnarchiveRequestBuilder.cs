...
namespace GraphServiceClient.Teams.Microsoft.Graph.Unarchive {
    /// <summary>Builds and executes requests for operations under \teams\{team-id}\microsoft.graph.unarchive</summary>
    public class Microsoft.graph.unarchiveRequestBuilder {
        ...
        /// </summary>
        public Microsoft.graph.unarchiveRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
            if(string.IsNullOrEmpty(currentPath)) throw new ArgumentNullException(nameof(currentPath));
            _ = httpCore ?? throw new ArgumentNullException(nameof(httpCore));
            PathSegment = "/microsoft.graph.unarchive";
            HttpCore = httpCore;
