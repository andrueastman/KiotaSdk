using GraphServiceClient.Teams.Schedule.Microsoft.Graph.Share;
using GraphServiceClient.Teams.Schedule.OfferShiftRequests;
using GraphServiceClient.Teams.Schedule.OpenShiftChangeRequests;
using GraphServiceClient.Teams.Schedule.OpenShifts;
using GraphServiceClient.Teams.Schedule.SchedulingGroups;
using GraphServiceClient.Teams.Schedule.Shifts;
using GraphServiceClient.Teams.Schedule.SwapShiftsChangeRequests;
using GraphServiceClient.Teams.Schedule.TimeOffReasons;
using GraphServiceClient.Teams.Schedule.TimeOffRequests;
using GraphServiceClient.Teams.Schedule.TimesOff;
...
namespace GraphServiceClient.Teams.Schedule {
    ...
    public class ScheduleRequestBuilder {
        ...
        public Microsoft.graph.shareRequestBuilder Microsoft.graph.share { get =>
            new Microsoft.graph.shareRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(Schedule body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Schedule> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<Schedule>(requestInfo, responseHandler);
        }
        /// <summary>
        /// The schedule of shifts for this team.
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Schedule body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
