...
namespace ApiSdk.Teams {
    ...
    public class TeamsRequestBuilder {
        ...
        /// </summary>
        public TeamsRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<TeamsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<TeamsResponse>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Add new entity to teams
        /// <param name="body"></param>
