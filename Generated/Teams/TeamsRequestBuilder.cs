...
using GraphSdk.Teams.GetAllMessages;
using GraphSdk.Teams.Item;
...
namespace GraphSdk.Teams {
    ...
    public class TeamsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.teams.item collection</summary>
        ...
        public TeamsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
