    ...
    public class TeamsAsyncOperation : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"operationType", (o,n) => { (o as TeamsAsyncOperation).OperationType = n.GetObjectValue<TeamsAsyncOperationType>(); } },
                {"status", (o,n) => { (o as TeamsAsyncOperation).Status = n.GetObjectValue<TeamsAsyncOperationStatus>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<TeamsAsyncOperationType>("operationType", OperationType);
            writer.WriteObjectValue<TeamsAsyncOperationStatus>("status", Status);
