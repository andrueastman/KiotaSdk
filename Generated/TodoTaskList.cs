    ...
    public class TodoTaskList : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"wellknownListName", (o,n) => { (o as TodoTaskList).WellknownListName = n.GetObjectValue<WellknownListName>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<WellknownListName>("wellknownListName", WellknownListName);
        }
    }
}
