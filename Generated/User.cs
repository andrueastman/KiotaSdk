    ...
    public class User : DirectoryObject, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"identities", (o,n) => { (o as User).Identities = n.GetCollectionOfPrimitiveValues<ObjectIdentity>().ToList(); } },
                ...
                {"licenseAssignmentStates", (o,n) => { (o as User).LicenseAssignmentStates = n.GetCollectionOfPrimitiveValues<LicenseAssignmentState>().ToList(); } },
                ...
                {"onPremisesProvisioningErrors", (o,n) => { (o as User).OnPremisesProvisioningErrors = n.GetCollectionOfPrimitiveValues<OnPremisesProvisioningError>().ToList(); } },
