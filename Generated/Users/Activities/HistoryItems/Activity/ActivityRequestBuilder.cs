using GraphServiceClient.Users.Activities.HistoryItems.Activity.$ref;
...
namespace GraphServiceClient.Users.Activities.HistoryItems.Activity {
    ...
    public class ActivityRequestBuilder {
        ...
        /// </summary>
        public ActivityRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
