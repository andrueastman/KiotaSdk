using GraphServiceClient.Users.Calendar.CalendarView.MultiValueExtendedProperties.Item;
...
namespace GraphServiceClient.Users.Calendar.CalendarView.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendar\calendarView\{event-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.calendar.calendarView.multiValueExtendedProperties collection</summary>
