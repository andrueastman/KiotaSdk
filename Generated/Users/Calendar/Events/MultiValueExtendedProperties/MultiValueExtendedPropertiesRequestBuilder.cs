using GraphServiceClient.Users.Calendar.Events.MultiValueExtendedProperties.Item;
...
namespace GraphServiceClient.Users.Calendar.Events.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendar\events\{event-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.calendar.events.multiValueExtendedProperties collection</summary>
