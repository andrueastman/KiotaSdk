using GraphServiceClient.Users.Calendar.Events.SingleValueExtendedProperties.Item;
...
namespace GraphServiceClient.Users.Calendar.Events.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendar\events\{event-id}\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.calendar.events.singleValueExtendedProperties collection</summary>
