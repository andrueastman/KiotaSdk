...
using System.Linq;
namespace GraphServiceClient.Users.CalendarGroups.Calendars.CalendarView.Instances.Microsoft.Graph.Delta() {
    public class Microsoft.graph.delta : OutlookItem, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"allowNewTimeProposals", (o,n) => { (o as Microsoft.graph.delta).AllowNewTimeProposals = n.GetBoolValue(); } },
                {"attachments", (o,n) => { (o as Microsoft.graph.delta).Attachments = n.GetCollectionOfObjectValues<Attachment>().ToList(); } },
                {"attendees", (o,n) => { (o as Microsoft.graph.delta).Attendees = n.GetCollectionOfPrimitiveValues<Attendee>().ToList(); } },
                {"body", (o,n) => { (o as Microsoft.graph.delta).Body = n.GetObjectValue<ItemBody>(); } },
                {"bodyPreview", (o,n) => { (o as Microsoft.graph.delta).BodyPreview = n.GetStringValue(); } },
                {"calendar", (o,n) => { (o as Microsoft.graph.delta).Calendar = n.GetObjectValue<Calendar>(); } },
                {"end", (o,n) => { (o as Microsoft.graph.delta).End = n.GetObjectValue<DateTimeTimeZone>(); } },
                {"extensions", (o,n) => { (o as Microsoft.graph.delta).Extensions = n.GetCollectionOfObjectValues<Extension>().ToList(); } },
                {"hasAttachments", (o,n) => { (o as Microsoft.graph.delta).HasAttachments = n.GetBoolValue(); } },
                {"hideAttendees", (o,n) => { (o as Microsoft.graph.delta).HideAttendees = n.GetBoolValue(); } },
                {"iCalUId", (o,n) => { (o as Microsoft.graph.delta).ICalUId = n.GetStringValue(); } },
                {"importance", (o,n) => { (o as Microsoft.graph.delta).Importance = n.GetObjectValue<Importance>(); } },
                {"instances", (o,n) => { (o as Microsoft.graph.delta).Instances = n.GetCollectionOfObjectValues<Event>().ToList(); } },
                {"isAllDay", (o,n) => { (o as Microsoft.graph.delta).IsAllDay = n.GetBoolValue(); } },
                {"isCancelled", (o,n) => { (o as Microsoft.graph.delta).IsCancelled = n.GetBoolValue(); } },
                {"isDraft", (o,n) => { (o as Microsoft.graph.delta).IsDraft = n.GetBoolValue(); } },
                {"isOnlineMeeting", (o,n) => { (o as Microsoft.graph.delta).IsOnlineMeeting = n.GetBoolValue(); } },
                {"isOrganizer", (o,n) => { (o as Microsoft.graph.delta).IsOrganizer = n.GetBoolValue(); } },
                {"isReminderOn", (o,n) => { (o as Microsoft.graph.delta).IsReminderOn = n.GetBoolValue(); } },
                {"location", (o,n) => { (o as Microsoft.graph.delta).Location = n.GetObjectValue<Location>(); } },
                {"locations", (o,n) => { (o as Microsoft.graph.delta).Locations = n.GetCollectionOfPrimitiveValues<Location>().ToList(); } },
                ...
                {"onlineMeeting", (o,n) => { (o as Microsoft.graph.delta).OnlineMeeting = n.GetObjectValue<OnlineMeetingInfo>(); } },
                {"onlineMeetingProvider", (o,n) => { (o as Microsoft.graph.delta).OnlineMeetingProvider = n.GetObjectValue<OnlineMeetingProviderType>(); } },
                {"onlineMeetingUrl", (o,n) => { (o as Microsoft.graph.delta).OnlineMeetingUrl = n.GetStringValue(); } },
                {"organizer", (o,n) => { (o as Microsoft.graph.delta).Organizer = n.GetObjectValue<Recipient>(); } },
                {"originalEndTimeZone", (o,n) => { (o as Microsoft.graph.delta).OriginalEndTimeZone = n.GetStringValue(); } },
                {"originalStart", (o,n) => { (o as Microsoft.graph.delta).OriginalStart = n.GetDateTimeOffsetValue(); } },
                {"originalStartTimeZone", (o,n) => { (o as Microsoft.graph.delta).OriginalStartTimeZone = n.GetStringValue(); } },
                {"recurrence", (o,n) => { (o as Microsoft.graph.delta).Recurrence = n.GetObjectValue<PatternedRecurrence>(); } },
                {"reminderMinutesBeforeStart", (o,n) => { (o as Microsoft.graph.delta).ReminderMinutesBeforeStart = n.GetIntValue(); } },
                {"responseRequested", (o,n) => { (o as Microsoft.graph.delta).ResponseRequested = n.GetBoolValue(); } },
                {"responseStatus", (o,n) => { (o as Microsoft.graph.delta).ResponseStatus = n.GetObjectValue<ResponseStatus>(); } },
                {"sensitivity", (o,n) => { (o as Microsoft.graph.delta).Sensitivity = n.GetObjectValue<Sensitivity>(); } },
                {"seriesMasterId", (o,n) => { (o as Microsoft.graph.delta).SeriesMasterId = n.GetStringValue(); } },
                {"showAs", (o,n) => { (o as Microsoft.graph.delta).ShowAs = n.GetObjectValue<FreeBusyStatus>(); } },
                ...
                {"start", (o,n) => { (o as Microsoft.graph.delta).Start = n.GetObjectValue<DateTimeTimeZone>(); } },
                {"subject", (o,n) => { (o as Microsoft.graph.delta).Subject = n.GetStringValue(); } },
                {"transactionId", (o,n) => { (o as Microsoft.graph.delta).TransactionId = n.GetStringValue(); } },
                {"type", (o,n) => { (o as Microsoft.graph.delta).Type = n.GetObjectValue<EventType>(); } },
                {"webLink", (o,n) => { (o as Microsoft.graph.delta).WebLink = n.GetStringValue(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfPrimitiveValues<Attendee>("attendees", Attendees);
            ...
            writer.WriteCollectionOfPrimitiveValues<Location>("locations", Locations);
            writer.WriteCollectionOfObjectValues<MultiValueLegacyExtendedProperty>("multiValueExtendedProperties", MultiValueExtendedProperties);
            writer.WriteObjectValue<OnlineMeetingInfo>("onlineMeeting", OnlineMeeting);
            writer.WriteObjectValue<OnlineMeetingProviderType>("onlineMeetingProvider", OnlineMeetingProvider);
            ...
            writer.WriteObjectValue<FreeBusyStatus>("showAs", ShowAs);
            ...
            writer.WriteObjectValue<EventType>("type", Type);
