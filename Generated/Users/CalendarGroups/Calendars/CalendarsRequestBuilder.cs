...
using GraphServiceClient.Users.CalendarGroups.Calendars.Item;
...
namespace GraphServiceClient.Users.CalendarGroups.Calendars {
    ...
    public class CalendarsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.calendarGroups.calendars collection</summary>
        ...
        /// </summary>
        public CalendarsRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<CalendarsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<CalendarsResponse>(requestInfo, responseHandler);
        }
        /// <summary>
        /// The calendars in the calendar group. Navigation property. Read-only. Nullable.
        /// <param name="body"></param>
