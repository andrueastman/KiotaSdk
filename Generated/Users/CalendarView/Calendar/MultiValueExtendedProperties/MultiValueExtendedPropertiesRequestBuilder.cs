using GraphServiceClient.Users.CalendarView.Calendar.MultiValueExtendedProperties.Item;
...
namespace GraphServiceClient.Users.CalendarView.Calendar.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendarView\{event-id}\calendar\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.calendarView.calendar.multiValueExtendedProperties collection</summary>
