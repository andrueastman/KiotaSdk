using GraphServiceClient.Users.CalendarView.Calendar.SingleValueExtendedProperties.Item;
...
namespace GraphServiceClient.Users.CalendarView.Calendar.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendarView\{event-id}\calendar\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.calendarView.calendar.singleValueExtendedProperties collection</summary>
