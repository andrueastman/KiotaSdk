using GraphServiceClient.Users.CalendarView.MultiValueExtendedProperties.Item;
...
namespace GraphServiceClient.Users.CalendarView.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendarView\{event-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.calendarView.multiValueExtendedProperties collection</summary>
