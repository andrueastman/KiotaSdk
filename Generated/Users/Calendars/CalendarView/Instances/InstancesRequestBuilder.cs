using GraphServiceClient.Users.Calendars.CalendarView.Instances.Item;
...
namespace GraphServiceClient.Users.Calendars.CalendarView.Instances {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\calendarView\{event-id}\instances</summary>
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.calendars.calendarView.instances collection</summary>
