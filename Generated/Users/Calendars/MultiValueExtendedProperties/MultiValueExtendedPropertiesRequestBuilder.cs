using GraphServiceClient.Users.Calendars.MultiValueExtendedProperties.Item;
...
namespace GraphServiceClient.Users.Calendars.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.calendars.multiValueExtendedProperties collection</summary>
