    ...
    public class Microsoft.graph.delta : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"childFolders", (o,n) => { (o as Microsoft.graph.delta).ChildFolders = n.GetCollectionOfObjectValues<ContactFolder>().ToList(); } },
                {"contacts", (o,n) => { (o as Microsoft.graph.delta).Contacts = n.GetCollectionOfObjectValues<Contact>().ToList(); } },
