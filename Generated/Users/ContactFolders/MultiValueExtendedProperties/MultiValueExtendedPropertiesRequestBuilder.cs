using GraphServiceClient.Users.ContactFolders.MultiValueExtendedProperties.Item;
...
namespace GraphServiceClient.Users.ContactFolders.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\contactFolders\{contactFolder-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.contactFolders.multiValueExtendedProperties collection</summary>
