using GraphServiceClient.Users.Contacts.MultiValueExtendedProperties.Item;
...
namespace GraphServiceClient.Users.Contacts.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\contacts\{contact-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.contacts.multiValueExtendedProperties collection</summary>
