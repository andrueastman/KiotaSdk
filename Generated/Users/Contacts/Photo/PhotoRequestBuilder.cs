...
using GraphServiceClient.Users.Contacts.Photo.Content;
...
namespace GraphServiceClient.Users.Contacts.Photo {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\contacts\{contact-id}\photo</summary>
    public class PhotoRequestBuilder {
        ...
        /// </summary>
        public PhotoRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ProfilePhoto> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
