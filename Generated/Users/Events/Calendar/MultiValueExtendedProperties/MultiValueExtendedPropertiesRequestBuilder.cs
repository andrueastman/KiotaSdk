using GraphServiceClient.Users.Events.Calendar.MultiValueExtendedProperties.Item;
...
namespace GraphServiceClient.Users.Events.Calendar.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\events\{event-id}\calendar\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.events.calendar.multiValueExtendedProperties collection</summary>
