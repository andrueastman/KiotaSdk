using GraphServiceClient.Users.Events.Calendar.SingleValueExtendedProperties.Item;
...
namespace GraphServiceClient.Users.Events.Calendar.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\events\{event-id}\calendar\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.events.calendar.singleValueExtendedProperties collection</summary>
