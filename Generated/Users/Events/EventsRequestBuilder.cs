using GraphServiceClient.Users.Events.Item;
...
namespace GraphServiceClient.Users.Events {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\events</summary>
    public class EventsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.events collection</summary>
