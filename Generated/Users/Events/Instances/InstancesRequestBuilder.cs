using GraphServiceClient.Users.Events.Instances.Item;
...
namespace GraphServiceClient.Users.Events.Instances {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\events\{event-id}\instances</summary>
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.events.instances collection</summary>
