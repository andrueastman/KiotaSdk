using GraphServiceClient.Users.Events.SingleValueExtendedProperties.Item;
...
namespace GraphServiceClient.Users.Events.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\events\{event-id}\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.events.singleValueExtendedProperties collection</summary>
