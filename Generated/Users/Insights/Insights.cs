...
namespace GraphServiceClient.Users.Insights {
    public class Insights : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"shared", (o,n) => { (o as Insights).Shared = n.GetCollectionOfObjectValues<SharedInsight>().ToList(); } },
                {"trending", (o,n) => { (o as Insights).Trending = n.GetCollectionOfObjectValues<Trending>().ToList(); } },
                {"used", (o,n) => { (o as Insights).Used = n.GetCollectionOfObjectValues<UsedInsight>().ToList(); } },
            };
        }
        /// <summary>
