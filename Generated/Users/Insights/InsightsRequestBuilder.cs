...
namespace GraphServiceClient.Users.Insights {
    ...
    public class InsightsRequestBuilder {
        ...
        public SharedRequestBuilder Shared { get =>
            new SharedRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        public TrendingRequestBuilder Trending { get =>
            new TrendingRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        public UsedRequestBuilder Used { get =>
            new UsedRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        /// <summary>
        ...
        /// </summary>
        public InsightsRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OfficeGraphInsights> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<OfficeGraphInsights>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Read-only. Nullable.
        /// <param name="body"></param>
