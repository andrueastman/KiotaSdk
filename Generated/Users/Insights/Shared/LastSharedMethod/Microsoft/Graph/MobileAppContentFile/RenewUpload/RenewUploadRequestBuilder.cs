...
namespace GraphServiceClient.Users.Insights.Shared.LastSharedMethod.Microsoft.Graph.MobileAppContentFile.Microsoft.Graph.RenewUpload {
    ...
    public class Microsoft.graph.renewUploadRequestBuilder {
        ...
        /// </summary>
        public Microsoft.graph.renewUploadRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
            if(string.IsNullOrEmpty(currentPath)) throw new ArgumentNullException(nameof(currentPath));
            _ = httpCore ?? throw new ArgumentNullException(nameof(httpCore));
            PathSegment = "/microsoft.graph.renewUpload";
            HttpCore = httpCore;
