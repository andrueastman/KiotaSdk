...
using GraphSdk.Users.Item.Activities.Item.HistoryItems.Item;
...
namespace GraphSdk.Users.Item.Activities.Item.HistoryItems {
    ...
    public class HistoryItemsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.users.item.activities.item.historyItems.item collection</summary>
        ...
        /// </summary>
        public HistoryItemsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/activities/{userActivity_id}/historyItems{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public HistoryItemsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ActivityHistoryItem body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
