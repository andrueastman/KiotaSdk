...
namespace ApiSdk.Users.Item.Activities.Item {
    ...
    public class UserActivityRequestBuilder {
        ...
        public HistoryItemsRequestBuilder HistoryItems { get =>
            new HistoryItemsRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        /// </summary>
        public UserActivityRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
