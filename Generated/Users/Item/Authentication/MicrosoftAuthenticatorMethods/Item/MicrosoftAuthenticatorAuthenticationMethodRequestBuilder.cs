...
using GraphSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device;
...
namespace GraphSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item {
    ...
    public class MicrosoftAuthenticatorAuthenticationMethodRequestBuilder {
        ...
        public MicrosoftAuthenticatorAuthenticationMethodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MicrosoftAuthenticatorAuthenticationMethod body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
