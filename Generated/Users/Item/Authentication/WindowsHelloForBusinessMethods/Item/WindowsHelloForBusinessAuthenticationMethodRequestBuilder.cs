...
namespace ApiSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item {
    ...
    public class WindowsHelloForBusinessAuthenticationMethodRequestBuilder {
        ...
        public DeviceRequestBuilder Device { get =>
            new DeviceRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        /// </summary>
        public WindowsHelloForBusinessAuthenticationMethodRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
