...
using GraphSdk.Users.Item.Calendar.CalendarView.Delta;
using GraphSdk.Users.Item.Calendar.CalendarView.Item;
...
namespace GraphSdk.Users.Item.Calendar.CalendarView {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendar\calendarView</summary>
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.users.item.calendar.calendarView.item collection</summary>
        ...
        public CalendarViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendar/calendarView{?startDateTime,endDateTime,top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
