...
using GraphSdk.Users.Item.Calendar.Events.Item.Accept;
using GraphSdk.Users.Item.Calendar.Events.Item.Attachments;
using GraphSdk.Users.Item.Calendar.Events.Item.Calendar;
using GraphSdk.Users.Item.Calendar.Events.Item.Cancel;
using GraphSdk.Users.Item.Calendar.Events.Item.Decline;
using GraphSdk.Users.Item.Calendar.Events.Item.DismissReminder;
using GraphSdk.Users.Item.Calendar.Events.Item.Extensions;
using GraphSdk.Users.Item.Calendar.Events.Item.Forward;
using GraphSdk.Users.Item.Calendar.Events.Item.Instances;
using GraphSdk.Users.Item.Calendar.Events.Item.MultiValueExtendedProperties;
using GraphSdk.Users.Item.Calendar.Events.Item.SingleValueExtendedProperties;
using GraphSdk.Users.Item.Calendar.Events.Item.SnoozeReminder;
using GraphSdk.Users.Item.Calendar.Events.Item.TentativelyAccept;
...
namespace GraphSdk.Users.Item.Calendar.Events.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendar/events/{event_id}{?select}";
