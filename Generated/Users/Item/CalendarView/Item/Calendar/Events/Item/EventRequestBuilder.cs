...
using ApiSdk.Users.Item.CalendarView.Item.Calendar.Events.Item.Accept;
using ApiSdk.Users.Item.CalendarView.Item.Calendar.Events.Item.Cancel;
using ApiSdk.Users.Item.CalendarView.Item.Calendar.Events.Item.Decline;
using ApiSdk.Users.Item.CalendarView.Item.Calendar.Events.Item.DismissReminder;
using ApiSdk.Users.Item.CalendarView.Item.Calendar.Events.Item.Forward;
using ApiSdk.Users.Item.CalendarView.Item.Calendar.Events.Item.SnoozeReminder;
using ApiSdk.Users.Item.CalendarView.Item.Calendar.Events.Item.TentativelyAccept;
...
namespace ApiSdk.Users.Item.CalendarView.Item.Calendar.Events.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendarView\{event-id}\calendar\events\{event-id1}</summary>
