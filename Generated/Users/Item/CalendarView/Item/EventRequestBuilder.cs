...
using GraphSdk.Users.Item.CalendarView.Item.Accept;
using GraphSdk.Users.Item.CalendarView.Item.Attachments;
using GraphSdk.Users.Item.CalendarView.Item.Calendar;
using GraphSdk.Users.Item.CalendarView.Item.Cancel;
using GraphSdk.Users.Item.CalendarView.Item.Decline;
using GraphSdk.Users.Item.CalendarView.Item.DismissReminder;
using GraphSdk.Users.Item.CalendarView.Item.Extensions;
using GraphSdk.Users.Item.CalendarView.Item.Forward;
using GraphSdk.Users.Item.CalendarView.Item.Instances;
using GraphSdk.Users.Item.CalendarView.Item.MultiValueExtendedProperties;
using GraphSdk.Users.Item.CalendarView.Item.SingleValueExtendedProperties;
using GraphSdk.Users.Item.CalendarView.Item.SnoozeReminder;
using GraphSdk.Users.Item.CalendarView.Item.TentativelyAccept;
...
namespace GraphSdk.Users.Item.CalendarView.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendarView/{event_id}{?startDateTime,endDateTime,select}";
