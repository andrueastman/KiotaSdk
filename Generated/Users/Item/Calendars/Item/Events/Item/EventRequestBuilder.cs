...
using GraphSdk.Users.Item.Calendars.Item.Events.Item.Cancel;
using GraphSdk.Users.Item.Calendars.Item.Events.Item.Decline;
using GraphSdk.Users.Item.Calendars.Item.Events.Item.DismissReminder;
using GraphSdk.Users.Item.Calendars.Item.Events.Item.Extensions;
using GraphSdk.Users.Item.Calendars.Item.Events.Item.Forward;
using GraphSdk.Users.Item.Calendars.Item.Events.Item.Instances;
using GraphSdk.Users.Item.Calendars.Item.Events.Item.MultiValueExtendedProperties;
...
namespace GraphSdk.Users.Item.Calendars.Item.Events.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendars/{calendar_id}/events/{event_id}{?select}";
