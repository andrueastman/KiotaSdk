...
using GraphSdk.Users.Item.ContactFolders.Item.Contacts.Item.MultiValueExtendedProperties.Item;
...
namespace GraphSdk.Users.Item.ContactFolders.Item.Contacts.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.users.item.contactFolders.item.contacts.item.multiValueExtendedProperties.item collection</summary>
        ...
        public MultiValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/contactFolders/{contactFolder_id}/contacts/{contact_id}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
