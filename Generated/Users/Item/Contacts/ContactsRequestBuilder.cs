...
using GraphSdk.Users.Item.Contacts.Delta;
using GraphSdk.Users.Item.Contacts.Item;
...
namespace GraphSdk.Users.Item.Contacts {
    ...
    public class ContactsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.users.item.contacts.item collection</summary>
        ...
        public ContactsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/contacts{?top,skip,search,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
