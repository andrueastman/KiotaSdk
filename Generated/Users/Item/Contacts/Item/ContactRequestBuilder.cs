...
using GraphSdk.Users.Item.Contacts.Item.Extensions;
using GraphSdk.Users.Item.Contacts.Item.MultiValueExtendedProperties;
using GraphSdk.Users.Item.Contacts.Item.Photo;
using GraphSdk.Users.Item.Contacts.Item.SingleValueExtendedProperties;
...
namespace GraphSdk.Users.Item.Contacts.Item {
    ...
    public class ContactRequestBuilder {
        ...
        public ContactRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/contacts/{contact_id}{?select}";
