...
namespace GraphSdk.Users.Item.Contacts.Item.Photo.Value {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\contacts\{contact-id}\photo\$value</summary>
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/contacts/{contact_id}/photo/$value";
