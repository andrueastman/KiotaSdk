...
using GraphSdk.Users.Item.Events.Item.Calendar.CalendarView.Item.DismissReminder;
using GraphSdk.Users.Item.Events.Item.Calendar.CalendarView.Item.Forward;
using GraphSdk.Users.Item.Events.Item.Calendar.CalendarView.Item.SnoozeReminder;
using GraphSdk.Users.Item.Events.Item.Calendar.CalendarView.Item.TentativelyAccept;
...
namespace GraphSdk.Users.Item.Events.Item.Calendar.CalendarView.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/events/{event_id}/calendar/calendarView/{event_id1}{?select}";
