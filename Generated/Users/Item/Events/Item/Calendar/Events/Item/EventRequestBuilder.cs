...
using GraphSdk.Users.Item.Events.Item.Calendar.Events.Item.Accept;
using GraphSdk.Users.Item.Events.Item.Calendar.Events.Item.Cancel;
using GraphSdk.Users.Item.Events.Item.Calendar.Events.Item.Decline;
using GraphSdk.Users.Item.Events.Item.Calendar.Events.Item.DismissReminder;
using GraphSdk.Users.Item.Events.Item.Calendar.Events.Item.Forward;
using GraphSdk.Users.Item.Events.Item.Calendar.Events.Item.SnoozeReminder;
using GraphSdk.Users.Item.Events.Item.Calendar.Events.Item.TentativelyAccept;
...
namespace GraphSdk.Users.Item.Events.Item.Calendar.Events.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/events/{event_id}/calendar/events/{event_id1}{?select}";
