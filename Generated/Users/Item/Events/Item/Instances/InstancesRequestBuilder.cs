...
using GraphSdk.Users.Item.Events.Item.Instances.Delta;
using GraphSdk.Users.Item.Events.Item.Instances.Item;
...
namespace GraphSdk.Users.Item.Events.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.users.item.events.item.instances.item collection</summary>
        ...
        public InstancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/events/{event_id}/instances{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
