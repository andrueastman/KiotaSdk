...
namespace ApiSdk.Users.Item.GetManagedAppPolicies {
    ...
    public class GetManagedAppPoliciesRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<ApiSdk.Users.Item.GetManagedAppPolicies.GetManagedAppPolicies>> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendCollectionAsync<ApiSdk.Users.Item.GetManagedAppPolicies.GetManagedAppPolicies>(requestInfo, responseHandler);
        }
    }
}
