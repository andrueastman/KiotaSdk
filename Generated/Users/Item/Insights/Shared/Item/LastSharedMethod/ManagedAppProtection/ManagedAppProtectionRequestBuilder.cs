using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.ManagedAppProtection.TargetApps;
...
namespace GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.ManagedAppProtection {
    ...
    public class ManagedAppProtectionRequestBuilder {
        ...
        public ManagedAppProtectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.managedAppProtection";
