...
namespace ApiSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.PrintJob.Start {
    ...
    public class StartRequestBuilder {
        ...
        /// </summary>
        public StartRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<StartResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(h, o);
            return await HttpCore.SendAsync<StartResponse>(requestInfo, responseHandler);
        }
