using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.ScheduleChangeRequest.Approve;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.ScheduleChangeRequest.Decline;
...
namespace GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.ScheduleChangeRequest {
    ...
    public class ScheduleChangeRequestRequestBuilder {
        ...
        public ScheduleChangeRequestRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.scheduleChangeRequest";
