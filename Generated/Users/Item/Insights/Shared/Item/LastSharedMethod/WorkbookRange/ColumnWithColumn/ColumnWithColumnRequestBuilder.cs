...
namespace ApiSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnWithColumn {
    ...
    public class ColumnWithColumnRequestBuilder {
        ...
        /// </summary>
        public ColumnWithColumnRequestBuilder(string currentPath, IHttpCore httpCore, int? column = default, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<ColumnWithColumnResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<ColumnWithColumnResponse>(requestInfo, responseHandler);
        }
