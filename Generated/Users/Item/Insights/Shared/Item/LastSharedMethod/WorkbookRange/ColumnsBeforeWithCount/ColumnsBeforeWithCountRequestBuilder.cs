...
namespace ApiSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnsBeforeWithCount {
    ...
    public class ColumnsBeforeWithCountRequestBuilder {
        ...
        /// </summary>
        public ColumnsBeforeWithCountRequestBuilder(string currentPath, IHttpCore httpCore, int? count = default, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<ColumnsBeforeWithCountResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<ColumnsBeforeWithCountResponse>(requestInfo, responseHandler);
        }
