...
namespace ApiSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.IntersectionWithAnotherRange {
    ...
    public class IntersectionWithAnotherRangeRequestBuilder {
        ...
        /// </summary>
        public IntersectionWithAnotherRangeRequestBuilder(string currentPath, IHttpCore httpCore, string anotherRange = default, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<IntersectionWithAnotherRangeResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<IntersectionWithAnotherRangeResponse>(requestInfo, responseHandler);
        }
