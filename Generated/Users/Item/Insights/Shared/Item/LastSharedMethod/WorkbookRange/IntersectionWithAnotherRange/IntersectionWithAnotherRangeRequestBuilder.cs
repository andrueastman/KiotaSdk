...
namespace GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.IntersectionWithAnotherRange {
    ...
    public class IntersectionWithAnotherRangeRequestBuilder {
        ...
        public IntersectionWithAnotherRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string anotherRange = default) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.workbookRange/microsoft.graph.intersection(anotherRange='{anotherRange}')";
        ...
        /// </summary>
        public async Task<IntersectionWithAnotherRangeResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await RequestAdapter.SendAsync<IntersectionWithAnotherRangeResponse>(requestInfo, responseHandler);
        }
        ...
        public class IntersectionWithAnotherRangeResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookRange", (o,n) => { (o as IntersectionWithAnotherRangeResponse).WorkbookRange = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.WorkbookRange>(); } },
                };
            }
            /// <summary>
