using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRangeFormat.AutofitColumns;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRangeFormat.AutofitRows;
...
namespace GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRangeFormat {
    ...
    public class WorkbookRangeFormatRequestBuilder {
        ...
        public WorkbookRangeFormatRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.workbookRangeFormat";
