...
using GraphSdk.Users.Item.Insights.Shared.Item.Resource.PrintJob;
using GraphSdk.Users.Item.Insights.Shared.Item.Resource.Ref;
using GraphSdk.Users.Item.Insights.Shared.Item.Resource.ScheduleChangeRequest;
using GraphSdk.Users.Item.Insights.Shared.Item.Resource.TargetedManagedAppProtection;
using GraphSdk.Users.Item.Insights.Shared.Item.Resource.WindowsInformationProtection;
using GraphSdk.Users.Item.Insights.Shared.Item.Resource.WorkbookRange;
using GraphSdk.Users.Item.Insights.Shared.Item.Resource.WorkbookRangeFill;
using GraphSdk.Users.Item.Insights.Shared.Item.Resource.WorkbookRangeFormat;
using GraphSdk.Users.Item.Insights.Shared.Item.Resource.WorkbookRangeSort;
using GraphSdk.Users.Item.Insights.Shared.Item.Resource.WorkbookRangeView;
...
namespace GraphSdk.Users.Item.Insights.Shared.Item.Resource {
    ...
    public class ResourceRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/shared/{sharedInsight_id}/resource{?select,expand}";
