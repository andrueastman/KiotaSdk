...
namespace GraphSdk.Users.Item.Insights.Shared.Item.Resource.ScheduleChangeRequest.Approve {
    ...
    public class ApproveRequestBuilder {
        ...
        public ApproveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/shared/{sharedInsight_id}/resource/microsoft.graph.scheduleChangeRequest/microsoft.graph.approve";
