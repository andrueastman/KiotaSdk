...
namespace ApiSdk.Users.Item.Insights.Shared.Item.Resource.WorkbookRange.ColumnsAfterWithCount {
    ...
    public class ColumnsAfterWithCountRequestBuilder {
        ...
        /// </summary>
        public ColumnsAfterWithCountRequestBuilder(string currentPath, IHttpCore httpCore, int? count = default, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<ColumnsAfterWithCountResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<ColumnsAfterWithCountResponse>(requestInfo, responseHandler);
        }
