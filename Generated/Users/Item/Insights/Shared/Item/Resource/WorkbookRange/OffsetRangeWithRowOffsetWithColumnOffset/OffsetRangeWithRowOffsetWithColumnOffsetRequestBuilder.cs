...
namespace ApiSdk.Users.Item.Insights.Shared.Item.Resource.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset {
    ...
    public class OffsetRangeWithRowOffsetWithColumnOffsetRequestBuilder {
        ...
        /// </summary>
        public OffsetRangeWithRowOffsetWithColumnOffsetRequestBuilder(string currentPath, IHttpCore httpCore, int? rowOffset = default, int? columnOffset = default, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<OffsetRangeWithRowOffsetWithColumnOffsetResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<OffsetRangeWithRowOffsetWithColumnOffsetResponse>(requestInfo, responseHandler);
        }
