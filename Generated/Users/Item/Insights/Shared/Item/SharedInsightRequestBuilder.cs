...
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod;
using GraphSdk.Users.Item.Insights.Shared.Item.Resource;
...
namespace GraphSdk.Users.Item.Insights.Shared.Item {
    ...
    public class SharedInsightRequestBuilder {
        ...
        public SharedInsightRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/shared/{sharedInsight_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SharedInsight body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
