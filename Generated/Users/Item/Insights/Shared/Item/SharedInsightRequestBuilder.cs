...
namespace ApiSdk.Users.Item.Insights.Shared.Item {
    ...
    public class SharedInsightRequestBuilder {
        ...
        public LastSharedMethodRequestBuilder LastSharedMethod { get =>
            new LastSharedMethodRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        /// </summary>
        public SharedInsightRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
