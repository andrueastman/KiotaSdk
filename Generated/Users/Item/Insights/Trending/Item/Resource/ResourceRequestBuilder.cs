...
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.PrintJob;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.Ref;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.ScheduleChangeRequest;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.TargetedManagedAppProtection;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WindowsInformationProtection;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRangeFill;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRangeFormat;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRangeSort;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRangeView;
...
namespace GraphSdk.Users.Item.Insights.Trending.Item.Resource {
    ...
    public class ResourceRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/trending/{trending_id}/resource{?select,expand}";
