...
namespace ApiSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.BoundingRectWithAnotherRange {
    ...
    public class BoundingRectWithAnotherRangeRequestBuilder {
        ...
        /// </summary>
        public BoundingRectWithAnotherRangeRequestBuilder(string currentPath, IHttpCore httpCore, string anotherRange = default, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<BoundingRectWithAnotherRangeResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<BoundingRectWithAnotherRangeResponse>(requestInfo, responseHandler);
        }
