...
namespace GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.ColumnsBeforeWithCount {
    ...
    public class ColumnsBeforeWithCountRequestBuilder {
        ...
        public ColumnsBeforeWithCountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? count = default) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/trending/{trending_id}/resource/microsoft.graph.workbookRange/microsoft.graph.columnsBefore(count={count})";
