using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.BoundingRectWithAnotherRange;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.CellWithRowWithColumn;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.Clear;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.ColumnsAfter;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.ColumnsAfterWithCount;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.ColumnsBefore;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.ColumnsBeforeWithCount;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.ColumnWithColumn;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.Delete;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.EntireColumn;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.EntireRow;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.Insert;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.IntersectionWithAnotherRange;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.LastCell;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.LastColumn;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.LastRow;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.Merge;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.ResizedRangeWithDeltaRowsWithDeltaColumns;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.RowsAbove;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.RowsAboveWithCount;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.RowsBelow;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.RowsBelowWithCount;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.RowWithRow;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.Unmerge;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.UsedRange;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.UsedRangeWithValuesOnly;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.VisibleView;
...
namespace GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange {
    ...
    public class WorkbookRangeRequestBuilder {
        ...
        public WorkbookRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/trending/{trending_id}/resource/microsoft.graph.workbookRange";
