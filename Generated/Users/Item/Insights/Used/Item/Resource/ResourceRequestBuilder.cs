...
using GraphSdk.Users.Item.Insights.Used.Item.Resource.CalendarSharingMessage;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.ManagedAppProtection;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.MobileAppContentFile;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.PrintDocument;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.PrintJob;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.Ref;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.ScheduleChangeRequest;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.TargetedManagedAppProtection;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WindowsInformationProtection;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRangeFill;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRangeFormat;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRangeSort;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRangeView;
...
namespace GraphSdk.Users.Item.Insights.Used.Item.Resource {
    ...
    public class ResourceRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/used/{usedInsight_id}/resource{?select,expand}";
