using GraphSdk.Users.Item.Insights.Used.Item.Resource.ScheduleChangeRequest.Approve;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.ScheduleChangeRequest.Decline;
...
namespace GraphSdk.Users.Item.Insights.Used.Item.Resource.ScheduleChangeRequest {
    ...
    public class ScheduleChangeRequestRequestBuilder {
        ...
        public ScheduleChangeRequestRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/used/{usedInsight_id}/resource/microsoft.graph.scheduleChangeRequest";
