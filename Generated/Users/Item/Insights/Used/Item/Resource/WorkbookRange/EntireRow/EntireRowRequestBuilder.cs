...
namespace GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.EntireRow {
    ...
    public class EntireRowRequestBuilder {
        ...
        public EntireRowRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/used/{usedInsight_id}/resource/microsoft.graph.workbookRange/microsoft.graph.entireRow()";
