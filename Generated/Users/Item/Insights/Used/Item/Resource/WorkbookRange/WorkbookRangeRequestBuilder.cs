using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.BoundingRectWithAnotherRange;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.CellWithRowWithColumn;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.Clear;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnsAfter;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnsAfterWithCount;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnsBefore;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnsBeforeWithCount;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnWithColumn;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.Delete;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.EntireColumn;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.EntireRow;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.Insert;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.IntersectionWithAnotherRange;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.LastCell;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.LastColumn;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.LastRow;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.Merge;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ResizedRangeWithDeltaRowsWithDeltaColumns;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.RowsAbove;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.RowsAboveWithCount;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.RowsBelow;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.RowsBelowWithCount;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.RowWithRow;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.Unmerge;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.UsedRange;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.UsedRangeWithValuesOnly;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.VisibleView;
...
namespace GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange {
    ...
    public class WorkbookRangeRequestBuilder {
        ...
        public WorkbookRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/used/{usedInsight_id}/resource/microsoft.graph.workbookRange";
