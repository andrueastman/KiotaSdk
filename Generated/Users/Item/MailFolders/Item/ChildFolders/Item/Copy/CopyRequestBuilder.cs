...
namespace GraphSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Copy {
    ...
    public class CopyRequestBuilder {
        ...
        public CopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/mailFolders/{mailFolder_id}/childFolders/{mailFolder_id1}/microsoft.graph.copy";
        ...
        /// </summary>
        public async Task<CopyResponse> PostAsync(CopyRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendAsync<CopyResponse>(requestInfo, responseHandler);
        }
