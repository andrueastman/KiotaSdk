using GraphSdk.Users.Item.MailFolders.Item.Messages.Item.CalendarSharingMessage.Accept;
...
namespace GraphSdk.Users.Item.MailFolders.Item.Messages.Item.CalendarSharingMessage {
    ...
    public class CalendarSharingMessageRequestBuilder {
        ...
        public CalendarSharingMessageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/mailFolders/{mailFolder_id}/messages/{message_id}/microsoft.graph.calendarSharingMessage";
