...
namespace GraphSdk.Users.Item.MailFolders.Item.Move {
    ...
    public class MoveRequestBuilder {
        ...
        public MoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/mailFolders/{mailFolder_id}/microsoft.graph.move";
