...
using GraphSdk.Users.Item.MailFolders.Delta;
using GraphSdk.Users.Item.MailFolders.Item;
...
namespace GraphSdk.Users.Item.MailFolders {
    ...
    public class MailFoldersRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.users.item.mailFolders.item collection</summary>
        ...
        public MailFoldersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/mailFolders{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public async Task<MailFoldersResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<MailFoldersResponse>(requestInfo, responseHandler);
        }
        /// <summary>
        /// The user's mail folders. Read-only. Nullable.
        /// <param name="body"></param>
