using GraphSdk.Users.Item.ManagedAppRegistrations.GetUserIdsWithFlaggedAppRegistration;
using GraphSdk.Users.Item.ManagedAppRegistrations.Ref;
...
namespace GraphSdk.Users.Item.ManagedAppRegistrations {
    ...
    public class ManagedAppRegistrationsRequestBuilder {
        ...
        public ManagedAppRegistrationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/managedAppRegistrations{?top,skip,search,filter,count,orderby,select,expand}";
