...
using GraphSdk.Users.Item.ManagedDevices.Item.BypassActivationLock;
using GraphSdk.Users.Item.ManagedDevices.Item.CleanWindowsDevice;
using GraphSdk.Users.Item.ManagedDevices.Item.DeleteUserFromSharedAppleDevice;
using GraphSdk.Users.Item.ManagedDevices.Item.DeviceCategory;
using GraphSdk.Users.Item.ManagedDevices.Item.DeviceCompliancePolicyStates;
using GraphSdk.Users.Item.ManagedDevices.Item.DeviceConfigurationStates;
using GraphSdk.Users.Item.ManagedDevices.Item.DisableLostMode;
using GraphSdk.Users.Item.ManagedDevices.Item.LocateDevice;
using GraphSdk.Users.Item.ManagedDevices.Item.LogoutSharedAppleDeviceActiveUser;
using GraphSdk.Users.Item.ManagedDevices.Item.RebootNow;
using GraphSdk.Users.Item.ManagedDevices.Item.RecoverPasscode;
using GraphSdk.Users.Item.ManagedDevices.Item.RemoteLock;
using GraphSdk.Users.Item.ManagedDevices.Item.RequestRemoteAssistance;
using GraphSdk.Users.Item.ManagedDevices.Item.ResetPasscode;
using GraphSdk.Users.Item.ManagedDevices.Item.Retire;
using GraphSdk.Users.Item.ManagedDevices.Item.ShutDown;
using GraphSdk.Users.Item.ManagedDevices.Item.SyncDevice;
using GraphSdk.Users.Item.ManagedDevices.Item.UpdateWindowsDeviceAccount;
using GraphSdk.Users.Item.ManagedDevices.Item.WindowsDefenderScan;
using GraphSdk.Users.Item.ManagedDevices.Item.WindowsDefenderUpdateSignatures;
using GraphSdk.Users.Item.ManagedDevices.Item.Wipe;
...
namespace GraphSdk.Users.Item.ManagedDevices.Item {
    ...
    public class ManagedDeviceRequestBuilder {
        ...
        public ManagedDeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/managedDevices/{managedDevice_id}{?select,expand}";
