...
namespace GraphSdk.Users.Item.ManagedDevices.Item.ResetPasscode {
    ...
    public class ResetPasscodeRequestBuilder {
        ...
        public ResetPasscodeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/managedDevices/{managedDevice_id}/microsoft.graph.resetPasscode";
