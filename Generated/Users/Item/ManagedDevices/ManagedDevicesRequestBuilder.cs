...
using GraphSdk.Users.Item.ManagedDevices.Item;
...
namespace GraphSdk.Users.Item.ManagedDevices {
    ...
    public class ManagedDevicesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.users.item.managedDevices.item collection</summary>
        ...
        public ManagedDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/managedDevices{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
