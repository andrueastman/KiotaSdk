...
namespace GraphSdk.Users.Item.Messages.Item.Attachments.CreateUploadSession {
    ...
    public class CreateUploadSessionRequestBuilder {
        ...
        public CreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/messages/{message_id}/attachments/microsoft.graph.createUploadSession";
