...
namespace GraphSdk.Users.Item.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.users.item.messages.item collection</summary>
        ...
        public MessagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/messages{?top,skip,search,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
