using GraphSdk.Users.Item.Oauth2PermissionGrants.Ref;
...
namespace GraphSdk.Users.Item.Oauth2PermissionGrants {
    ...
    public class Oauth2PermissionGrantsRequestBuilder {
        ...
        public Oauth2PermissionGrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/oauth2PermissionGrants{?top,skip,search,filter,count,orderby,select,expand}";
