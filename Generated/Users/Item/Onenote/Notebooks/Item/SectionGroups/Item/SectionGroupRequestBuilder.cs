...
using GraphSdk.Users.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentNotebook;
using GraphSdk.Users.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentSectionGroup;
using GraphSdk.Users.Item.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups;
using GraphSdk.Users.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections;
...
namespace GraphSdk.Users.Item.Onenote.Notebooks.Item.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public SectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}{?select,expand}";
