...
namespace GraphSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item.ParentNotebook.CopyNotebook {
    ...
    public class CopyNotebookRequestBuilder {
        ...
        public CopyNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/parentNotebook/microsoft.graph.copyNotebook";
