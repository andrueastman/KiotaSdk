...
namespace GraphSdk.Users.Item.Onenote.Pages.Item.ParentSection.Pages.Item.OnenotePatchContent {
    ...
    public class OnenotePatchContentRequestBuilder {
        ...
        public OnenotePatchContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/pages/{onenotePage_id}/parentSection/pages/{onenotePage_id1}/microsoft.graph.onenotePatchContent";
