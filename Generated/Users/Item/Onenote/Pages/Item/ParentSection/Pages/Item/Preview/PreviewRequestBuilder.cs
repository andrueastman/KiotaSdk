...
namespace GraphSdk.Users.Item.Onenote.Pages.Item.ParentSection.Pages.Item.Preview {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\onenote\pages\{onenotePage-id}\parentSection\pages\{onenotePage-id1}\microsoft.graph.preview()</summary>
    public class PreviewRequestBuilder {
        ...
        public PreviewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/pages/{onenotePage_id}/parentSection/pages/{onenotePage_id1}/microsoft.graph.preview()";
