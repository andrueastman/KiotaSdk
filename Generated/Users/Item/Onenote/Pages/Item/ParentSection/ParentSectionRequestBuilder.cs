...
using GraphSdk.Users.Item.Onenote.Pages.Item.ParentSection.CopyToNotebook;
using GraphSdk.Users.Item.Onenote.Pages.Item.ParentSection.CopyToSectionGroup;
using GraphSdk.Users.Item.Onenote.Pages.Item.ParentSection.Pages;
using GraphSdk.Users.Item.Onenote.Pages.Item.ParentSection.ParentNotebook;
using GraphSdk.Users.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup;
...
namespace GraphSdk.Users.Item.Onenote.Pages.Item.ParentSection {
    ...
    public class ParentSectionRequestBuilder {
        ...
        public ParentSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/pages/{onenotePage_id}/parentSection{?select,expand}";
