...
using GraphSdk.Users.Item.Onenote.SectionGroups.Item.ParentNotebook.Sections.Item.ParentNotebook.CopyNotebook;
...
namespace GraphSdk.Users.Item.Onenote.SectionGroups.Item.ParentNotebook.Sections.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public ParentNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/sectionGroups/{sectionGroup_id}/parentNotebook/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
