...
using GraphSdk.Users.Item.Onenote.Sections.Item.CopyToNotebook;
using GraphSdk.Users.Item.Onenote.Sections.Item.CopyToSectionGroup;
using GraphSdk.Users.Item.Onenote.Sections.Item.Pages;
using GraphSdk.Users.Item.Onenote.Sections.Item.ParentNotebook;
using GraphSdk.Users.Item.Onenote.Sections.Item.ParentSectionGroup;
...
namespace GraphSdk.Users.Item.Onenote.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/sections/{onenoteSection_id}{?select,expand}";
