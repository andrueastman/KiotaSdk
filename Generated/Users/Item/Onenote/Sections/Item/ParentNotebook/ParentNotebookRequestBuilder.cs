...
using GraphSdk.Users.Item.Onenote.Sections.Item.ParentNotebook.CopyNotebook;
using GraphSdk.Users.Item.Onenote.Sections.Item.ParentNotebook.SectionGroups;
using GraphSdk.Users.Item.Onenote.Sections.Item.ParentNotebook.Sections;
...
namespace GraphSdk.Users.Item.Onenote.Sections.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public ParentNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
