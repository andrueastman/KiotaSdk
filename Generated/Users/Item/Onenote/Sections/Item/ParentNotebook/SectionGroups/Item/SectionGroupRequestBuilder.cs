...
using ApiSdk.Users.Item.Onenote.Sections.Item.ParentNotebook.SectionGroups.Item.ParentNotebook;
...
namespace ApiSdk.Users.Item.Onenote.Sections.Item.ParentNotebook.SectionGroups.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\onenote\sections\{onenoteSection-id}\parentNotebook\sectionGroups\{sectionGroup-id}</summary>
