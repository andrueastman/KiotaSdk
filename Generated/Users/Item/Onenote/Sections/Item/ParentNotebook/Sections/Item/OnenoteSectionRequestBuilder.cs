...
using GraphSdk.Users.Item.Onenote.Sections.Item.ParentNotebook.Sections.Item.CopyToNotebook;
using GraphSdk.Users.Item.Onenote.Sections.Item.ParentNotebook.Sections.Item.CopyToSectionGroup;
...
namespace GraphSdk.Users.Item.Onenote.Sections.Item.ParentNotebook.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/sections/{onenoteSection_id}/parentNotebook/sections/{onenoteSection_id1}{?select,expand}";
