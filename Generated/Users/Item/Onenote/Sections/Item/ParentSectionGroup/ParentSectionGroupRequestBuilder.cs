...
using GraphSdk.Users.Item.Onenote.Sections.Item.ParentSectionGroup.ParentNotebook;
using GraphSdk.Users.Item.Onenote.Sections.Item.ParentSectionGroup.SectionGroups;
using GraphSdk.Users.Item.Onenote.Sections.Item.ParentSectionGroup.Sections;
...
namespace GraphSdk.Users.Item.Onenote.Sections.Item.ParentSectionGroup {
    ...
    public class ParentSectionGroupRequestBuilder {
        ...
        public ParentSectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/sections/{onenoteSection_id}/parentSectionGroup{?select,expand}";
