...
namespace GraphSdk.Users.Item.OnlineMeetings.Item.AttendeeReport {
    ...
    public class AttendeeReportRequestBuilder {
        ...
        public AttendeeReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onlineMeetings/{onlineMeeting_id}/attendeeReport";
