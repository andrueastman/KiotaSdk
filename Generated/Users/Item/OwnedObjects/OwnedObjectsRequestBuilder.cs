using GraphSdk.Users.Item.OwnedObjects.Ref;
...
namespace GraphSdk.Users.Item.OwnedObjects {
    ...
    public class OwnedObjectsRequestBuilder {
        ...
        public OwnedObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/ownedObjects{?top,skip,search,filter,count,orderby,select,expand}";
