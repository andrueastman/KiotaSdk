...
using GraphSdk.Users.Item.Photos.Item.Value;
...
namespace GraphSdk.Users.Item.Photos.Item {
    ...
    public class ProfilePhotoRequestBuilder {
        ...
        public ProfilePhotoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/photos/{profilePhoto_id}{?select}";
