...
namespace ApiSdk.Users.Item.Planner.Plans.Item.Buckets {
    ...
    public class BucketsRequestBuilder {
        ...
        public PlannerBucketRequestBuilder this[string position] { get {
            return new PlannerBucketRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public BucketsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
