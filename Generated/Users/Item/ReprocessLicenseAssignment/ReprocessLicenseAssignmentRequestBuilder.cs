...
namespace ApiSdk.Users.Item.ReprocessLicenseAssignment {
    ...
    public class ReprocessLicenseAssignmentRequestBuilder {
        ...
        /// </summary>
        public ReprocessLicenseAssignmentRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<ReprocessLicenseAssignmentResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(h, o);
            return await HttpCore.SendAsync<ReprocessLicenseAssignmentResponse>(requestInfo, responseHandler);
        }
