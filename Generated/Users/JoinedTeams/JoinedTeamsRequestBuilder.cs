using GraphServiceClient.Users.JoinedTeams.Item;
...
namespace GraphServiceClient.Users.JoinedTeams {
    ...
    public class JoinedTeamsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.joinedTeams collection</summary>
        ...
        /// </summary>
        public JoinedTeamsRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<JoinedTeamsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<JoinedTeamsResponse>(requestInfo, responseHandler);
        }
        /// <summary>
        /// The Microsoft Teams teams that the user is a member of. Read-only. Nullable.
        /// <param name="body"></param>
