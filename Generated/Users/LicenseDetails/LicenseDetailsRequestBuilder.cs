...
namespace GraphServiceClient.Users.LicenseDetails {
    ...
    public class LicenseDetailsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.licenseDetails collection</summary>
        ...
        /// </summary>
        public async Task<LicenseDetailsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<LicenseDetailsResponse>(requestInfo, responseHandler);
        }
        /// <summary>
        /// A collection of this user's license details. Read-only.
        /// <param name="body"></param>
