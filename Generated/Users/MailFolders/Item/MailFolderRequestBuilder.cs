using GraphServiceClient.Users.MailFolders.ChildFolders;
using GraphServiceClient.Users.MailFolders.MessageRules;
using GraphServiceClient.Users.MailFolders.Messages;
using GraphServiceClient.Users.MailFolders.Microsoft.Graph.Copy;
using GraphServiceClient.Users.MailFolders.Microsoft.Graph.Move;
using GraphServiceClient.Users.MailFolders.MultiValueExtendedProperties;
using GraphServiceClient.Users.MailFolders.SingleValueExtendedProperties;
...
namespace GraphServiceClient.Users.MailFolders.Item {
    ...
    public class MailFolderRequestBuilder {
        ...
        public MessageRulesRequestBuilder MessageRules { get =>
            new MessageRulesRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        ...
        /// </summary>
        public MailFolderRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MailFolder body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
