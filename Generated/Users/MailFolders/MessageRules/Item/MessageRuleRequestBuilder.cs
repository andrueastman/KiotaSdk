...
namespace GraphServiceClient.Users.MailFolders.MessageRules.Item {
    ...
    public class MessageRuleRequestBuilder {
        ...
        /// </summary>
        public MessageRuleRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MessageRule body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
