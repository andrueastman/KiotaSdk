...
using GraphServiceClient.Users.MailFolders.MessageRules.Item;
...
namespace GraphServiceClient.Users.MailFolders.MessageRules {
    ...
    public class MessageRulesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.mailFolders.messageRules collection</summary>
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MessageRule body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
