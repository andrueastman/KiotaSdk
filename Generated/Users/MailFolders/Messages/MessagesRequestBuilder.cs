using GraphServiceClient.Users.MailFolders.Messages.Item;
...
namespace GraphServiceClient.Users.MailFolders.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users.mailFolders.messages collection</summary>
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Message body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
