...
using System.Linq;
namespace GraphServiceClient.Users.MailFolders.Messages.Microsoft.Graph.Delta() {
    public class Microsoft.graph.delta : OutlookItem, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"bccRecipients", (o,n) => { (o as Microsoft.graph.delta).BccRecipients = n.GetCollectionOfObjectValues<Recipient>().ToList(); } },
                ...
                {"ccRecipients", (o,n) => { (o as Microsoft.graph.delta).CcRecipients = n.GetCollectionOfObjectValues<Recipient>().ToList(); } },
                {"conversationId", (o,n) => { (o as Microsoft.graph.delta).ConversationId = n.GetStringValue(); } },
                {"conversationIndex", (o,n) => { (o as Microsoft.graph.delta).ConversationIndex = n.GetObjectValue<Byte[]>(); } },
                {"extensions", (o,n) => { (o as Microsoft.graph.delta).Extensions = n.GetCollectionOfObjectValues<Extension>().ToList(); } },
                {"flag", (o,n) => { (o as Microsoft.graph.delta).Flag = n.GetObjectValue<FollowupFlag>(); } },
                {"from", (o,n) => { (o as Microsoft.graph.delta).From = n.GetObjectValue<Recipient>(); } },
                ...
                {"inferenceClassification", (o,n) => { (o as Microsoft.graph.delta).InferenceClassification = n.GetObjectValue<InferenceClassificationType>(); } },
                {"internetMessageHeaders", (o,n) => { (o as Microsoft.graph.delta).InternetMessageHeaders = n.GetCollectionOfPrimitiveValues<InternetMessageHeader>().ToList(); } },
                {"internetMessageId", (o,n) => { (o as Microsoft.graph.delta).InternetMessageId = n.GetStringValue(); } },
                {"isDeliveryReceiptRequested", (o,n) => { (o as Microsoft.graph.delta).IsDeliveryReceiptRequested = n.GetBoolValue(); } },
                {"isDraft", (o,n) => { (o as Microsoft.graph.delta).IsDraft = n.GetBoolValue(); } },
                {"isRead", (o,n) => { (o as Microsoft.graph.delta).IsRead = n.GetBoolValue(); } },
                {"isReadReceiptRequested", (o,n) => { (o as Microsoft.graph.delta).IsReadReceiptRequested = n.GetBoolValue(); } },
                ...
                {"receivedDateTime", (o,n) => { (o as Microsoft.graph.delta).ReceivedDateTime = n.GetDateTimeOffsetValue(); } },
                {"replyTo", (o,n) => { (o as Microsoft.graph.delta).ReplyTo = n.GetCollectionOfObjectValues<Recipient>().ToList(); } },
                {"sender", (o,n) => { (o as Microsoft.graph.delta).Sender = n.GetObjectValue<Recipient>(); } },
                {"sentDateTime", (o,n) => { (o as Microsoft.graph.delta).SentDateTime = n.GetDateTimeOffsetValue(); } },
                ...
                {"toRecipients", (o,n) => { (o as Microsoft.graph.delta).ToRecipients = n.GetCollectionOfObjectValues<Recipient>().ToList(); } },
                {"uniqueBody", (o,n) => { (o as Microsoft.graph.delta).UniqueBody = n.GetObjectValue<ItemBody>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Byte[]>("conversationIndex", ConversationIndex);
            ...
            writer.WriteCollectionOfPrimitiveValues<InternetMessageHeader>("internetMessageHeaders", InternetMessageHeaders);
