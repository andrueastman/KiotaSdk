...
using System.Linq;
namespace GraphServiceClient.Users.Microsoft.Graph.GetMailTips {
    public class Microsoft.graph.getMailTips : IParsable {
        ...
        /// <summary>
        /// Instantiates a new Microsoft.graph.getMailTips and sets the default values.
        /// </summary>
        public Microsoft.graph.getMailTips() {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"automaticReplies", (o,n) => { (o as Microsoft.graph.getMailTips).AutomaticReplies = n.GetObjectValue<AutomaticRepliesMailTips>(); } },
                {"customMailTip", (o,n) => { (o as Microsoft.graph.getMailTips).CustomMailTip = n.GetStringValue(); } },
                {"deliveryRestricted", (o,n) => { (o as Microsoft.graph.getMailTips).DeliveryRestricted = n.GetBoolValue(); } },
                {"emailAddress", (o,n) => { (o as Microsoft.graph.getMailTips).EmailAddress = n.GetObjectValue<EmailAddress>(); } },
                {"error", (o,n) => { (o as Microsoft.graph.getMailTips).Error = n.GetObjectValue<MailTipsError>(); } },
                {"externalMemberCount", (o,n) => { (o as Microsoft.graph.getMailTips).ExternalMemberCount = n.GetIntValue(); } },
                {"isModerated", (o,n) => { (o as Microsoft.graph.getMailTips).IsModerated = n.GetBoolValue(); } },
                {"mailboxFull", (o,n) => { (o as Microsoft.graph.getMailTips).MailboxFull = n.GetBoolValue(); } },
                {"maxMessageSize", (o,n) => { (o as Microsoft.graph.getMailTips).MaxMessageSize = n.GetIntValue(); } },
                {"recipientScope", (o,n) => { (o as Microsoft.graph.getMailTips).RecipientScope = n.GetObjectValue<RecipientScopeType>(); } },
                {"recipientSuggestions", (o,n) => { (o as Microsoft.graph.getMailTips).RecipientSuggestions = n.GetCollectionOfObjectValues<Recipient>().ToList(); } },
                {"totalMemberCount", (o,n) => { (o as Microsoft.graph.getMailTips).TotalMemberCount = n.GetIntValue(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<RecipientScopeType>("recipientScope", RecipientScope);
