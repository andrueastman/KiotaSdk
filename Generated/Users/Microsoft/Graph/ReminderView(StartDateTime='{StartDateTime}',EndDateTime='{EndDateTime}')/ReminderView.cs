...
using System.Linq;
namespace GraphServiceClient.Users.Microsoft.Graph.ReminderView(StartDateTime='{StartDateTime}',EndDateTime='{EndDateTime}') {
    public class Microsoft.graph.reminderView : IParsable {
        ...
        /// </summary>
        public Microsoft.graph.reminderView() {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"changeKey", (o,n) => { (o as Microsoft.graph.reminderView).ChangeKey = n.GetStringValue(); } },
                {"eventEndTime", (o,n) => { (o as Microsoft.graph.reminderView).EventEndTime = n.GetObjectValue<DateTimeTimeZone>(); } },
                {"eventId", (o,n) => { (o as Microsoft.graph.reminderView).EventId = n.GetStringValue(); } },
                {"eventLocation", (o,n) => { (o as Microsoft.graph.reminderView).EventLocation = n.GetObjectValue<Location>(); } },
                {"eventStartTime", (o,n) => { (o as Microsoft.graph.reminderView).EventStartTime = n.GetObjectValue<DateTimeTimeZone>(); } },
                {"eventSubject", (o,n) => { (o as Microsoft.graph.reminderView).EventSubject = n.GetStringValue(); } },
                {"eventWebLink", (o,n) => { (o as Microsoft.graph.reminderView).EventWebLink = n.GetStringValue(); } },
                {"reminderFireTime", (o,n) => { (o as Microsoft.graph.reminderView).ReminderFireTime = n.GetObjectValue<DateTimeTimeZone>(); } },
            };
        }
        /// <summary>
