using GraphServiceClient.Users.Outlook.MasterCategories;
...
namespace GraphServiceClient.Users.Outlook {
    ...
    public class OutlookRequestBuilder {
        ...
        public MasterCategoriesRequestBuilder MasterCategories { get =>
            new MasterCategoriesRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        ...
        /// </summary>
        public OutlookRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OutlookUser> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<OutlookUser>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Selective Outlook services available to the user. Read-only. Nullable.
        /// <param name="body"></param>
