...
using GraphServiceClient.Users.Photo.Content;
...
namespace GraphServiceClient.Users.Photo {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\photo</summary>
