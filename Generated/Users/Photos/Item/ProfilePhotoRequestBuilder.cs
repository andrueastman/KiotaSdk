using GraphServiceClient.Users.Photos.Content;
...
namespace GraphServiceClient.Users.Photos.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\photos\{profilePhoto-id}</summary>
    public class ProfilePhotoRequestBuilder {
        ...
        /// </summary>
        public ProfilePhotoRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
