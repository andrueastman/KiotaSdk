...
namespace GraphServiceClient.Users.ScopedRoleMemberOf {
    public class ScopedRoleMemberOfResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ScopedRoleMemberOfResponse).Value = n.GetCollectionOfObjectValues<ScopedRoleMembership>().ToList(); } },
            };
        }
        /// <summary>
