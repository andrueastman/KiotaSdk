...
using GraphServiceClient.Users.Teamwork.InstalledApps;
using GraphServiceClient.Users.Teamwork.Microsoft.Graph.SendActivityNotification;
...
namespace GraphServiceClient.Users.Teamwork {
    ...
    public class TeamworkRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UserTeamwork> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await HttpCore.SendAsync<UserTeamwork>(requestInfo, responseHandler);
        }
        /// <summary>
        /// A container for Microsoft Teams features available for the user. Read-only. Nullable.
        /// <param name="body"></param>
