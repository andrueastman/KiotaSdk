...
using GraphServiceClient.Users.Microsoft.Graph.ValidateProperties;
...
namespace GraphServiceClient.Users {
    ...
    public class UsersRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.users collection</summary>
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(User body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<User> PostAsync(User body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
