...
namespace ApiSdk.Workbooks.Item.Follow {
    ...
    public class FollowRequestBuilder {
        ...
        /// </summary>
        public FollowRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<FollowResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(h, o);
            return await HttpCore.SendAsync<FollowResponse>(requestInfo, responseHandler);
        }
        ...
        public class FollowResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"driveItem", (o,n) => { (o as FollowResponse).DriveItem = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.DriveItem>(); } },
                };
            }
            /// <summary>
