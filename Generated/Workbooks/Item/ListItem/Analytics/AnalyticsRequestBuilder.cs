...
using GraphSdk.Workbooks.Item.ListItem.Analytics.Ref;
...
namespace GraphSdk.Workbooks.Item.ListItem.Analytics {
    ...
    public class AnalyticsRequestBuilder {
        ...
        public AnalyticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/listItem/analytics{?select,expand}";
