...
namespace GraphSdk.Workbooks.Item.Workbook.CloseSession {
    ...
    public class CloseSessionRequestBuilder {
        ...
        public CloseSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/microsoft.graph.closeSession";
