...
namespace ApiSdk.Workbooks.Item.Workbook.CloseSession {
    ...
    public class CloseSessionRequestBuilder {
        ...
        /// </summary>
        public CloseSessionRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
