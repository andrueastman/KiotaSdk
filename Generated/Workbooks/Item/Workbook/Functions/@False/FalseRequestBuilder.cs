...
namespace ApiSdk.Workbooks.Item.Workbook.Functions.@False {
    ...
    public class FalseRequestBuilder {
        ...
        /// </summary>
        public FalseRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<FalseResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(h, o);
            return await HttpCore.SendAsync<FalseResponse>(requestInfo, responseHandler);
        }
