...
namespace ApiSdk.Workbooks.Item.Workbook.Functions.@True {
    ...
    public class TrueRequestBuilder {
        ...
        /// </summary>
        public TrueRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<TrueResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(h, o);
            return await HttpCore.SendAsync<TrueResponse>(requestInfo, responseHandler);
        }
        ...
        public class TrueResponse : IParsable {
            ...
            /// <summary>
            /// Instantiates a new trueResponse and sets the default values.
            /// </summary>
            public TrueResponse() {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookFunctionResult", (o,n) => { (o as TrueResponse).WorkbookFunctionResult = n.GetObjectValue<WorkbookFunctionResult>(); } },
                };
            }
            /// <summary>
