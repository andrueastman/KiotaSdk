...
namespace GraphSdk.Workbooks.Item.Workbook.Functions.False {
    ...
    public class FalseRequestBuilder {
        ...
        public FalseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.false";
        ...
        /// </summary>
        public async Task<FalseResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(h, o);
            return await RequestAdapter.SendAsync<FalseResponse>(requestInfo, responseHandler);
        }
