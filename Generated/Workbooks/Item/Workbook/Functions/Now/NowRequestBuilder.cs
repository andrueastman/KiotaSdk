...
namespace ApiSdk.Workbooks.Item.Workbook.Functions.Now {
    ...
    public class NowRequestBuilder {
        ...
        /// </summary>
        public NowRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<NowResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreatePostRequestInformation(h, o);
            return await HttpCore.SendAsync<NowResponse>(requestInfo, responseHandler);
        }
