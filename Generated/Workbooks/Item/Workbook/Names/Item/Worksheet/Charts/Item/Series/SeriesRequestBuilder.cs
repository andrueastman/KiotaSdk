...
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Series.Count;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Series.Item;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Series.ItemAtWithIndex;
...
namespace GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Series {
    ...
    public class SeriesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.workbooks.item.workbook.names.item.worksheet.charts.item.series.item collection</summary>
        ...
        public SeriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/series{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
