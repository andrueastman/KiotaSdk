...
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Axes;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.DataLabels;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Format;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Image;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.ImageWithWidth;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.ImageWithWidthWithHeight;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.ImageWithWidthWithHeightWithFittingMode;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Legend;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Series;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.SetData;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.SetPosition;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Title;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Worksheet;
...
namespace GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item {
    ...
    public class WorkbookChartRequestBuilder {
        ...
        public WorkbookChartRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}{?select,expand}";
