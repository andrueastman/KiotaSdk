...
namespace GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.ItemWithName {
    ...
    public class ItemWithNameRequestBuilder {
        ...
        public ItemWithNameRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string name = default) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/microsoft.graph.item(name='{name}')";
