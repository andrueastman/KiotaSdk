...
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Worksheet.CellWithRowWithColumn;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Worksheet.Range;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Worksheet.RangeWithAddress;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Worksheet.UsedRange;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Worksheet.UsedRangeWithValuesOnly;
...
namespace GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Worksheet {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\names\{workbookNamedItem-id}\worksheet\tables\{workbookTable-id}\worksheet</summary>
    public class WorksheetRequestBuilder {
        ...
        public WorksheetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/tables/{workbookTable_id}/worksheet{?select,expand}";
