...
namespace GraphSdk.Workbooks.Item.Workbook.SessionInfoResourceWithKey {
    ...
    public class SessionInfoResourceWithKeyRequestBuilder {
        ...
        public SessionInfoResourceWithKeyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string key = default) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/microsoft.graph.sessionInfoResource(key='{key}')";
