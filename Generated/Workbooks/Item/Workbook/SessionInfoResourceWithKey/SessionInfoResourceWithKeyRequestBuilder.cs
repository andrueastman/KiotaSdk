...
namespace ApiSdk.Workbooks.Item.Workbook.SessionInfoResourceWithKey {
    ...
    public class SessionInfoResourceWithKeyRequestBuilder {
        ...
        /// </summary>
        public SessionInfoResourceWithKeyRequestBuilder(string currentPath, IHttpCore httpCore, string key = default, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<SessionInfoResourceWithKeyResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<SessionInfoResourceWithKeyResponse>(requestInfo, responseHandler);
        }
