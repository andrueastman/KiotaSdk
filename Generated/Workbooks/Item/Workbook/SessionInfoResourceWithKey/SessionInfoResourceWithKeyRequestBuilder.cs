...
namespace ApiSdk.Workbooks.Item.Workbook.SessionInfoResourceWithKey {
    ...
    public class SessionInfoResourceWithKeyRequestBuilder {
        ...
        /// </summary>
        public SessionInfoResourceWithKeyRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string key = default, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<SessionInfoResourceWithKeyResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await RequestAdapter.SendAsync<SessionInfoResourceWithKeyResponse>(requestInfo, responseHandler);
        }
