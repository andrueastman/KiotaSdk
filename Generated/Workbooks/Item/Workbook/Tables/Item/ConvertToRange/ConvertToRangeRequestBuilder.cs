...
namespace GraphSdk.Workbooks.Item.Workbook.Tables.Item.ConvertToRange {
    ...
    public class ConvertToRangeRequestBuilder {
        ...
        public ConvertToRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/microsoft.graph.convertToRange";
