...
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Rows.Add;
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Rows.Count;
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Rows.Item;
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Rows.ItemAtWithIndex;
...
namespace GraphSdk.Workbooks.Item.Workbook.Tables.Item.Rows {
    ...
    public class RowsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.workbooks.item.workbook.tables.item.rows.item collection</summary>
        ...
        public RowsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/rows{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
