...
using ApiSdk.Workbooks.Item.Workbook.Tables.Item.Rows.Add;
using ApiSdk.Workbooks.Item.Workbook.Tables.Item.Rows.Count;
using ApiSdk.Workbooks.Item.Workbook.Tables.Item.Rows.Item;
using ApiSdk.Workbooks.Item.Workbook.Tables.Item.Rows.ItemAtWithIndex;
...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Rows {
    ...
    public class RowsRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.workbooks.item.workbook.tables.item.rows.item collection</summary>
