...
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Add;
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Count;
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item;
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.ItemAtWithIndex;
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.ItemWithName;
...
namespace GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts {
    ...
    public class ChartsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.workbooks.item.workbook.tables.item.worksheet.charts.item collection</summary>
        ...
        public ChartsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
