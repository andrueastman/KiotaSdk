...
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Axes.ValueAxis.Format.Font;
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Axes.ValueAxis.Format.Line;
...
namespace GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Axes.ValueAxis.Format {
    ...
    public class FormatRequestBuilder {
        ...
        public FormatRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/valueAxis/format{?select,expand}";
