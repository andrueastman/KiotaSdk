...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.ImageWithWidthWithHeightWithFittingMode {
    ...
    public class ImageWithWidthWithHeightWithFittingModeRequestBuilder {
        ...
        /// </summary>
        public ImageWithWidthWithHeightWithFittingModeRequestBuilder(string currentPath, IRequestAdapter requestAdapter, int? width = default, int? height = default, string fittingMode = default, bool isRawUrl = true) {
