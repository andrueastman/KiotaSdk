...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Worksheet.UsedRangeWithValuesOnly {
    ...
    public class UsedRangeWithValuesOnlyRequestBuilder {
        ...
        /// </summary>
        public UsedRangeWithValuesOnlyRequestBuilder(string currentPath, IHttpCore httpCore, bool? valuesOnly = default, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<UsedRangeWithValuesOnlyResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<UsedRangeWithValuesOnlyResponse>(requestInfo, responseHandler);
        }
