...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.ItemWithName {
    ...
    public class ItemWithNameRequestBuilder {
        ...
        /// </summary>
        public ItemWithNameRequestBuilder(string currentPath, IRequestAdapter requestAdapter, string name = default, bool isRawUrl = true) {
