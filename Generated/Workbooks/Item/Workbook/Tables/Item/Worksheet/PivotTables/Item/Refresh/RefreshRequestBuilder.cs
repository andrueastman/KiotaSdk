...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.PivotTables.Item.Refresh {
    ...
    public class RefreshRequestBuilder {
        ...
        /// </summary>
        public RefreshRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
