...
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.PivotTables.Item.Refresh;
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.PivotTables.Item.Worksheet;
...
namespace GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.PivotTables.Item {
    ...
    public class WorkbookPivotTableRequestBuilder {
        ...
        public WorkbookPivotTableRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/pivotTables/{workbookPivotTable_id}{?select,expand}";
