...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.PivotTables.Item {
    ...
    public class WorkbookPivotTableRequestBuilder {
        ...
        public RefreshRequestBuilder Refresh { get =>
            new RefreshRequestBuilder(CurrentPath + PathSegment , RequestAdapter, false);
        }
        ...
        /// </summary>
        public WorkbookPivotTableRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(WorkbookPivotTable body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
