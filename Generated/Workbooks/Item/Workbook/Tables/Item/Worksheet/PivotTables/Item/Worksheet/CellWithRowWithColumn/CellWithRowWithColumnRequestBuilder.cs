...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.PivotTables.Item.Worksheet.CellWithRowWithColumn {
    ...
    public class CellWithRowWithColumnRequestBuilder {
        ...
        /// </summary>
        public CellWithRowWithColumnRequestBuilder(string currentPath, IHttpCore httpCore, int? row = default, int? column = default, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<CellWithRowWithColumnResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<CellWithRowWithColumnResponse>(requestInfo, responseHandler);
        }
