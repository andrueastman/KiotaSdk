...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.PivotTables.Item.Worksheet.RangeWithAddress {
    ...
    public class RangeWithAddressRequestBuilder {
        ...
        /// </summary>
        public RangeWithAddressRequestBuilder(string currentPath, IHttpCore httpCore, string address = default, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<RangeWithAddressResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await HttpCore.SendAsync<RangeWithAddressResponse>(requestInfo, responseHandler);
        }
