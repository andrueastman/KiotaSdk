...
using ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Tables.Add;
using ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Tables.Count;
using ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Tables.Item;
using ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Tables.ItemAtWithIndex;
...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Tables {
    ...
    public class TablesRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.workbooks.item.workbook.tables.item.worksheet.tables.item collection</summary>
        public WorkbookTableRequestBuilder this[string position] { get {
            return new WorkbookTableRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public TablesRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
        ...
        /// </summary>
        public async Task<TablesResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<TablesResponse>(requestInfo, responseHandler);
        }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<WorkbookTable> PostAsync(WorkbookTable body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
