...
using ApiSdk.Workbooks.Item.Workbook.Tables.Add;
using ApiSdk.Workbooks.Item.Workbook.Tables.Count;
using ApiSdk.Workbooks.Item.Workbook.Tables.Item;
using ApiSdk.Workbooks.Item.Workbook.Tables.ItemAtWithIndex;
...
namespace ApiSdk.Workbooks.Item.Workbook.Tables {
    ...
    public class TablesRequestBuilder {
        ...
        /// <summary>Gets an item from the ApiSdk.workbooks.item.workbook.tables.item collection</summary>
