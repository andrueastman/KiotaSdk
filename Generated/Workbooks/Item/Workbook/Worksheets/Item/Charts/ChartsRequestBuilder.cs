...
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Add;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Count;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.ItemAtWithIndex;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.ItemWithName;
...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts {
    ...
    public class ChartsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.workbooks.item.workbook.worksheets.item.charts.item collection</summary>
        ...
        public ChartsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
