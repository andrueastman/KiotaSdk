...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Format.Fill.SetSolidColor {
    ...
    public class SetSolidColorRequestBuilder {
        ...
        public SetSolidColorRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/format/fill/microsoft.graph.setSolidColor";
