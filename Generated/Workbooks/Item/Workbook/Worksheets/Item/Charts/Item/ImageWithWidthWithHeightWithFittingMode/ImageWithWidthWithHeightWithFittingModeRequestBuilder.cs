...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.ImageWithWidthWithHeightWithFittingMode {
    ...
    public class ImageWithWidthWithHeightWithFittingModeRequestBuilder {
        ...
        /// </summary>
        public ImageWithWidthWithHeightWithFittingModeRequestBuilder(string currentPath, IHttpCore httpCore, int? width = default, int? height = default, string fittingMode = default, bool isRawUrl = true) {
