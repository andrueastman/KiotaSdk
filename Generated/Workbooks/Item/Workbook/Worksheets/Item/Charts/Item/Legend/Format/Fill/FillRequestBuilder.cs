...
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Legend.Format.Fill.Clear;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Legend.Format.Fill.SetSolidColor;
...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Legend.Format.Fill {
    ...
    public class FillRequestBuilder {
        ...
        public FillRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/legend/format/fill{?select,expand}";
