...
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Axes;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.DataLabels;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Format;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Image;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.ImageWithWidth;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.ImageWithWidthWithHeight;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.ImageWithWidthWithHeightWithFittingMode;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Legend;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Series;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.SetData;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.SetPosition;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Title;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Worksheet;
...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item {
    ...
    public class WorkbookChartRequestBuilder {
        ...
        public WorkbookChartRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}{?select,expand}";
