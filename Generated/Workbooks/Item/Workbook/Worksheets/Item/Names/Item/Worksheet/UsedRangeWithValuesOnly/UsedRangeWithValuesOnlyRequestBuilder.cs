...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Names.Item.Worksheet.UsedRangeWithValuesOnly {
    ...
    public class UsedRangeWithValuesOnlyRequestBuilder {
        ...
        public UsedRangeWithValuesOnlyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, bool? valuesOnly = default) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/names/{workbookNamedItem_id}/worksheet/microsoft.graph.usedRange(valuesOnly={valuesOnly})";
