...
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Worksheet.CellWithRowWithColumn;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Worksheet.Range;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Worksheet.RangeWithAddress;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Worksheet.UsedRange;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Worksheet.UsedRangeWithValuesOnly;
...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Worksheet {
    ...
    public class WorksheetRequestBuilder {
        ...
        public WorksheetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/pivotTables/{workbookPivotTable_id}/worksheet{?select,expand}";
