...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.ConvertToRange {
    ...
    public class ConvertToRangeRequestBuilder {
        ...
        /// </summary>
        public ConvertToRangeRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
