...
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Rows.Add;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Rows.Count;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Rows.Item;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Rows.ItemAtWithIndex;
...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Rows {
    ...
    public class RowsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.workbooks.item.workbook.worksheets.item.tables.item.rows.item collection</summary>
        ...
        public RowsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/tables/{workbookTable_id}/rows{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
