...
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Worksheet.CellWithRowWithColumn;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Worksheet.Range;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Worksheet.RangeWithAddress;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Worksheet.UsedRange;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Worksheet.UsedRangeWithValuesOnly;
...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Worksheet {
    ...
    public class WorksheetRequestBuilder {
        ...
        public WorksheetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/tables/{workbookTable_id}/worksheet{?select,expand}";
