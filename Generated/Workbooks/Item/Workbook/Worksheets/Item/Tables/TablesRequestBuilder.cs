...
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Add;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Count;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.ItemAtWithIndex;
...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables {
    ...
    public class TablesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.workbooks.item.workbook.worksheets.item.tables.item collection</summary>
        ...
        public TablesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/tables{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
