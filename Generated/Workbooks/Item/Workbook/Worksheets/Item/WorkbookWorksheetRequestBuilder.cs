...
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.CellWithRowWithColumn;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Names;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Protection;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Range;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.RangeWithAddress;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.UsedRange;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.UsedRangeWithValuesOnly;
...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item {
    ...
    public class WorkbookWorksheetRequestBuilder {
        ...
        public WorkbookWorksheetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}{?select,expand}";
