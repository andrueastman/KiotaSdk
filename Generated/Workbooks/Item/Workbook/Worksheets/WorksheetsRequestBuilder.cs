...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets {
    ...
    public class WorksheetsRequestBuilder {
        ...
        public WorkbookWorksheetRequestBuilder this[string position] { get {
            return new WorkbookWorksheetRequestBuilder(CurrentPath + PathSegment  + "/" + position, RequestAdapter, false);
        } }
        /// <summary>
        ...
        /// </summary>
        public WorksheetsRequestBuilder(string currentPath, IRequestAdapter requestAdapter, bool isRawUrl = true) {
