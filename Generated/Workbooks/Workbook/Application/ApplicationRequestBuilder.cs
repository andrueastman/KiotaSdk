using GraphServiceClient.Workbooks.Workbook.Application.Microsoft.Graph.Calculate;
...
namespace GraphServiceClient.Workbooks.Workbook.Application {
    ...
    public class ApplicationRequestBuilder {
        ...
        public Microsoft.graph.calculateRequestBuilder Microsoft.graph.calculate { get =>
            new Microsoft.graph.calculateRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
