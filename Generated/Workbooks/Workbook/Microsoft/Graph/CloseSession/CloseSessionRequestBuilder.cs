...
namespace GraphServiceClient.Workbooks.Workbook.Microsoft.Graph.CloseSession {
    ...
    public class Microsoft.graph.closeSessionRequestBuilder {
        ...
        /// <summary>
        /// Instantiates a new Microsoft.graph.closeSessionRequestBuilder and sets the default values.
        /// <param name="currentPath">Current path for the request</param>
        /// <param name="httpCore">The http core service to use to execute the requests.</param>
        /// <param name="isRawUrl">Whether the current path is a raw URL</param>
        /// </summary>
        public Microsoft.graph.closeSessionRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
            if(string.IsNullOrEmpty(currentPath)) throw new ArgumentNullException(nameof(currentPath));
            _ = httpCore ?? throw new ArgumentNullException(nameof(httpCore));
            PathSegment = "/microsoft.graph.closeSession";
            HttpCore = httpCore;
