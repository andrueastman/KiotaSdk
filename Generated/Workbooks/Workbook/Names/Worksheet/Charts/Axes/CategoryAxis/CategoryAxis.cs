...
namespace GraphServiceClient.Workbooks.Workbook.Names.Worksheet.Charts.Axes.CategoryAxis {
    public class CategoryAxis : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"format", (o,n) => { (o as CategoryAxis).Format = n.GetObjectValue<WorkbookChartAxisFormat>(); } },
                {"majorGridlines", (o,n) => { (o as CategoryAxis).MajorGridlines = n.GetObjectValue<WorkbookChartGridlines>(); } },
                {"majorUnit", (o,n) => { (o as CategoryAxis).MajorUnit = n.GetObjectValue<Json>(); } },
                {"maximum", (o,n) => { (o as CategoryAxis).Maximum = n.GetObjectValue<Json>(); } },
                {"minimum", (o,n) => { (o as CategoryAxis).Minimum = n.GetObjectValue<Json>(); } },
                {"minorGridlines", (o,n) => { (o as CategoryAxis).MinorGridlines = n.GetObjectValue<WorkbookChartGridlines>(); } },
                {"minorUnit", (o,n) => { (o as CategoryAxis).MinorUnit = n.GetObjectValue<Json>(); } },
                {"title", (o,n) => { (o as CategoryAxis).Title = n.GetObjectValue<WorkbookChartAxisTitle>(); } },
            };
        }
        /// <summary>
