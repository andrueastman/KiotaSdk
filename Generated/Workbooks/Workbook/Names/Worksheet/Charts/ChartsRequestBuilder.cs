using GraphServiceClient.Workbooks.Workbook.Names.Worksheet.Charts.Item;
using GraphServiceClient.Workbooks.Workbook.Names.Worksheet.Charts.Microsoft.Graph.Add;
...
namespace GraphServiceClient.Workbooks.Workbook.Names.Worksheet.Charts {
    ...
    public class ChartsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.workbooks.workbook.names.worksheet.charts collection</summary>
