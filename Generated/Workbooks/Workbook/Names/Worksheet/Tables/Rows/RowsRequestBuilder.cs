using GraphServiceClient.Workbooks.Workbook.Names.Worksheet.Tables.Rows.Item;
using GraphServiceClient.Workbooks.Workbook.Names.Worksheet.Tables.Rows.Microsoft.Graph.Add;
...
namespace GraphServiceClient.Workbooks.Workbook.Names.Worksheet.Tables.Rows {
    ...
    public class RowsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.workbooks.workbook.names.worksheet.tables.rows collection</summary>
