using GraphServiceClient.Workbooks.Workbook.Names.Worksheet.Tables.Item;
using GraphServiceClient.Workbooks.Workbook.Names.Worksheet.Tables.Microsoft.Graph.Add;
...
namespace GraphServiceClient.Workbooks.Workbook.Names.Worksheet.Tables {
    ...
    public class TablesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.workbooks.workbook.names.worksheet.tables collection</summary>
