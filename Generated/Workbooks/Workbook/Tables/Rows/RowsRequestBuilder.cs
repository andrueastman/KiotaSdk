using GraphServiceClient.Workbooks.Workbook.Tables.Rows.Item;
using GraphServiceClient.Workbooks.Workbook.Tables.Rows.Microsoft.Graph.Add;
...
namespace GraphServiceClient.Workbooks.Workbook.Tables.Rows {
    ...
    public class RowsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.workbooks.workbook.tables.rows collection</summary>
