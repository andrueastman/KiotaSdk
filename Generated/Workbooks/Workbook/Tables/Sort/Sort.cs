...
namespace GraphServiceClient.Workbooks.Workbook.Tables.Sort {
    public class Sort : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"fields", (o,n) => { (o as Sort).Fields = n.GetCollectionOfPrimitiveValues<WorkbookSortField>().ToList(); } },
                {"matchCase", (o,n) => { (o as Sort).MatchCase = n.GetBoolValue(); } },
                {"method", (o,n) => { (o as Sort).Method = n.GetStringValue(); } },
            };
        }
        /// <summary>
