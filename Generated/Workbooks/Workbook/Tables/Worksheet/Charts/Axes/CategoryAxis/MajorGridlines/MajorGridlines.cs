...
namespace GraphServiceClient.Workbooks.Workbook.Tables.Worksheet.Charts.Axes.CategoryAxis.MajorGridlines {
    public class MajorGridlines : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"format", (o,n) => { (o as MajorGridlines).Format = n.GetObjectValue<WorkbookChartGridlinesFormat>(); } },
                {"visible", (o,n) => { (o as MajorGridlines).Visible = n.GetBoolValue(); } },
            };
        }
        /// <summary>
