...
namespace GraphServiceClient.Workbooks.Workbook.Tables.Worksheet.Charts.Axes.SeriesAxis {
    public class SeriesAxis : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"format", (o,n) => { (o as SeriesAxis).Format = n.GetObjectValue<WorkbookChartAxisFormat>(); } },
                {"majorGridlines", (o,n) => { (o as SeriesAxis).MajorGridlines = n.GetObjectValue<WorkbookChartGridlines>(); } },
                {"majorUnit", (o,n) => { (o as SeriesAxis).MajorUnit = n.GetObjectValue<Json>(); } },
                {"maximum", (o,n) => { (o as SeriesAxis).Maximum = n.GetObjectValue<Json>(); } },
                {"minimum", (o,n) => { (o as SeriesAxis).Minimum = n.GetObjectValue<Json>(); } },
                {"minorGridlines", (o,n) => { (o as SeriesAxis).MinorGridlines = n.GetObjectValue<WorkbookChartGridlines>(); } },
                {"minorUnit", (o,n) => { (o as SeriesAxis).MinorUnit = n.GetObjectValue<Json>(); } },
                {"title", (o,n) => { (o as SeriesAxis).Title = n.GetObjectValue<WorkbookChartAxisTitle>(); } },
            };
        }
        /// <summary>
