...
namespace GraphServiceClient.Workbooks.Workbook.Tables.Worksheet.Charts.Legend {
    public class Legend : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"format", (o,n) => { (o as Legend).Format = n.GetObjectValue<WorkbookChartLegendFormat>(); } },
                {"overlay", (o,n) => { (o as Legend).Overlay = n.GetBoolValue(); } },
                {"position", (o,n) => { (o as Legend).Position = n.GetStringValue(); } },
                {"visible", (o,n) => { (o as Legend).Visible = n.GetBoolValue(); } },
            };
        }
        /// <summary>
