    ...
    public class WorkbookChartTitleFormat : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"fill", (o,n) => { (o as WorkbookChartTitleFormat).Fill = n.GetObjectValue<WorkbookChartFill>(); } },
                {"font", (o,n) => { (o as WorkbookChartTitleFormat).Font = n.GetObjectValue<WorkbookChartFont>(); } },
            };
        }
        /// <summary>
