...
namespace GraphServiceClient.Workbooks.Workbook.Tables.Worksheet.Charts.Title {
    public class Title : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"format", (o,n) => { (o as Title).Format = n.GetObjectValue<WorkbookChartTitleFormat>(); } },
                {"overlay", (o,n) => { (o as Title).Overlay = n.GetBoolValue(); } },
                {"text", (o,n) => { (o as Title).Text = n.GetStringValue(); } },
                {"visible", (o,n) => { (o as Title).Visible = n.GetBoolValue(); } },
            };
        }
        /// <summary>
