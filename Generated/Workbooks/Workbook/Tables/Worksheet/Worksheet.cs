...
using System.Linq;
namespace GraphServiceClient.Workbooks.Workbook.Tables.Worksheet {
    public class Worksheet : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"charts", (o,n) => { (o as Worksheet).Charts = n.GetCollectionOfObjectValues<WorkbookChart>().ToList(); } },
                {"name", (o,n) => { (o as Worksheet).Name = n.GetStringValue(); } },
                {"names", (o,n) => { (o as Worksheet).Names = n.GetCollectionOfObjectValues<WorkbookNamedItem>().ToList(); } },
                {"pivotTables", (o,n) => { (o as Worksheet).PivotTables = n.GetCollectionOfObjectValues<WorkbookPivotTable>().ToList(); } },
                {"position", (o,n) => { (o as Worksheet).Position = n.GetIntValue(); } },
                {"protection", (o,n) => { (o as Worksheet).Protection = n.GetObjectValue<WorkbookWorksheetProtection>(); } },
                {"tables", (o,n) => { (o as Worksheet).Tables = n.GetCollectionOfObjectValues<WorkbookTable>().ToList(); } },
                {"visibility", (o,n) => { (o as Worksheet).Visibility = n.GetStringValue(); } },
            };
        }
        /// <summary>
