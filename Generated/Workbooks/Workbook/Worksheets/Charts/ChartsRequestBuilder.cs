using GraphServiceClient.Workbooks.Workbook.Worksheets.Charts.Item;
using GraphServiceClient.Workbooks.Workbook.Worksheets.Charts.Microsoft.Graph.Add;
...
namespace GraphServiceClient.Workbooks.Workbook.Worksheets.Charts {
    ...
    public class ChartsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.workbooks.workbook.worksheets.charts collection</summary>
