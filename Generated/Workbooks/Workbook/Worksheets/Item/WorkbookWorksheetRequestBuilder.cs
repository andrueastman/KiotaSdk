...
using GraphServiceClient.Workbooks.Workbook.Worksheets.Names;
using GraphServiceClient.Workbooks.Workbook.Worksheets.PivotTables;
using GraphServiceClient.Workbooks.Workbook.Worksheets.Protection;
using GraphServiceClient.Workbooks.Workbook.Worksheets.Tables;
...
namespace GraphServiceClient.Workbooks.Workbook.Worksheets.Item {
    ...
    public class WorkbookWorksheetRequestBuilder {
        ...
        /// </summary>
        public WorkbookWorksheetRequestBuilder(string currentPath, IHttpCore httpCore, bool isRawUrl = true) {
