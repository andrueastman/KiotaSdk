using GraphServiceClient.Workbooks.Workbook.Worksheets.Tables.Rows.Item;
using GraphServiceClient.Workbooks.Workbook.Worksheets.Tables.Rows.Microsoft.Graph.Add;
...
namespace GraphServiceClient.Workbooks.Workbook.Worksheets.Tables.Rows {
    ...
    public class RowsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphServiceClient.workbooks.workbook.worksheets.tables.rows collection</summary>
