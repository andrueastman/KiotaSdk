...
namespace GraphSdk.Workbooks {
    ...
    public class WorkbooksRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.workbooks.item collection</summary>
        ...
        public WorkbooksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
