using GraphSdk.Admin.ServiceAnnouncement.HealthOverviews.Item;
...
namespace GraphSdk.Admin.ServiceAnnouncement.HealthOverviews {
    ...
    public class HealthOverviewsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.admin.serviceAnnouncement.healthOverviews.item collection</summary>
        ...
        public HealthOverviewsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/admin/serviceAnnouncement/healthOverviews{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ServiceHealth> PostAsync(ServiceHealth body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
