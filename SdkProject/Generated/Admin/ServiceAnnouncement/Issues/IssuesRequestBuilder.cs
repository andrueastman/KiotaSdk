using GraphSdk.Admin.ServiceAnnouncement.Issues.Item;
...
namespace GraphSdk.Admin.ServiceAnnouncement.Issues {
    ...
    public class IssuesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.admin.serviceAnnouncement.issues.item collection</summary>
        ...
        public IssuesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/admin/serviceAnnouncement/issues{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
