...
namespace GraphSdk.Admin.ServiceAnnouncement.Issues.Item.IncidentReport {
    ...
    public class IncidentReportRequestBuilder {
        ...
        public IncidentReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/admin/serviceAnnouncement/issues/{serviceHealthIssue_id}/microsoft.graph.incidentReport()";
