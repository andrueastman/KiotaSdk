using GraphSdk.Admin.ServiceAnnouncement.Issues.Item.IncidentReport;
...
namespace GraphSdk.Admin.ServiceAnnouncement.Issues.Item {
    ...
    public class ServiceHealthIssueRequestBuilder {
        ...
        public ServiceHealthIssueRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/admin/serviceAnnouncement/issues/{serviceHealthIssue_id}{?select,expand}";
