using GraphSdk.AgreementAcceptances.Item;
...
namespace GraphSdk.AgreementAcceptances {
    ...
    public class AgreementAcceptancesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.agreementAcceptances.item collection</summary>
        ...
        public AgreementAcceptancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/agreementAcceptances{?search,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
