using GraphSdk.Agreements.Item.Acceptances.Item;
...
namespace GraphSdk.Agreements.Item.Acceptances {
    ...
    public class AcceptancesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.agreements.item.acceptances.item collection</summary>
        ...
        public AcceptancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/agreements/{agreement_id}/acceptances{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
