using GraphSdk.Agreements.Item.File.Localizations.Item.Versions;
...
namespace GraphSdk.Agreements.Item.File.Localizations.Item {
    ...
    public class AgreementFileLocalizationRequestBuilder {
        ...
        public AgreementFileLocalizationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/agreements/{agreement_id}/file/localizations/{agreementFileLocalization_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(AgreementFileLocalization body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
