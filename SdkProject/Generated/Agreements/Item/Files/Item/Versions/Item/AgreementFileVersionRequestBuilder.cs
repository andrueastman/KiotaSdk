...
namespace GraphSdk.Agreements.Item.Files.Item.Versions.Item {
    ...
    public class AgreementFileVersionRequestBuilder {
        ...
        public AgreementFileVersionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/agreements/{agreement_id}/files/{agreementFileLocalization_id}/versions/{agreementFileVersion_id}{?select,expand}";
