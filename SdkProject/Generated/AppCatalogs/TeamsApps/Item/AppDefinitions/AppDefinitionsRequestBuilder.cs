using GraphSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item;
...
namespace GraphSdk.AppCatalogs.TeamsApps.Item.AppDefinitions {
    ...
    public class AppDefinitionsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.appCatalogs.teamsApps.item.appDefinitions.item collection</summary>
        ...
        public AppDefinitionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/appCatalogs/teamsApps/{teamsApp_id}/appDefinitions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GraphSdk.Models.Microsoft.Graph.TeamsAppDefinition body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
