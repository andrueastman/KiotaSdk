using GraphSdk.Applications.Item.HomeRealmDiscoveryPolicies.Ref;
...
namespace GraphSdk.Applications.Item.HomeRealmDiscoveryPolicies {
    ...
    public class HomeRealmDiscoveryPoliciesRequestBuilder {
        ...
        public HomeRealmDiscoveryPoliciesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/applications/{application_id}/homeRealmDiscoveryPolicies{?top,skip,search,filter,count,orderby,select,expand}";
