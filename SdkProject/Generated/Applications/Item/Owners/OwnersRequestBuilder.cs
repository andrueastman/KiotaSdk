using GraphSdk.Applications.Item.Owners.Ref;
...
namespace GraphSdk.Applications.Item.Owners {
    ...
    public class OwnersRequestBuilder {
        ...
        public OwnersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/applications/{application_id}/owners{?top,skip,search,filter,count,orderby,select,expand}";
