using GraphSdk.Applications.Item.TokenIssuancePolicies.Ref;
...
namespace GraphSdk.Applications.Item.TokenIssuancePolicies {
    ...
    public class TokenIssuancePoliciesRequestBuilder {
        ...
        public TokenIssuancePoliciesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/applications/{application_id}/tokenIssuancePolicies{?top,skip,search,filter,count,orderby,select,expand}";
