...
namespace GraphSdk.Applications.Item.UnsetVerifiedPublisher {
    ...
    public class UnsetVerifiedPublisherRequestBuilder {
        ...
        public UnsetVerifiedPublisherRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/applications/{application_id}/microsoft.graph.unsetVerifiedPublisher";
