using GraphSdk.AuditLogs.RestrictedSignIns.Item;
...
namespace GraphSdk.AuditLogs.RestrictedSignIns {
    ...
    public class RestrictedSignInsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.auditLogs.restrictedSignIns.item collection</summary>
        ...
        public RestrictedSignInsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/auditLogs/restrictedSignIns{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
