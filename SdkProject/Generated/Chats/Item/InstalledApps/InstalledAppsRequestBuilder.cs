using GraphSdk.Chats.Item.InstalledApps.Item;
...
namespace GraphSdk.Chats.Item.InstalledApps {
    ...
    public class InstalledAppsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.chats.item.installedApps.item collection</summary>
        ...
        public InstalledAppsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/chats/{chat_id}/installedApps{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
