using GraphSdk.Chats.Item.InstalledApps.Item.TeamsApp;
using GraphSdk.Chats.Item.InstalledApps.Item.TeamsAppDefinition;
using GraphSdk.Chats.Item.InstalledApps.Item.Upgrade;
...
namespace GraphSdk.Chats.Item.InstalledApps.Item {
    ...
    public class TeamsAppInstallationRequestBuilder {
        ...
        public TeamsAppInstallationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/chats/{chat_id}/installedApps/{teamsAppInstallation_id}{?select,expand}";
