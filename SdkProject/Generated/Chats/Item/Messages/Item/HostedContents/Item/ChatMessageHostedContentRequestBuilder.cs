...
namespace GraphSdk.Chats.Item.Messages.Item.HostedContents.Item {
    ...
    public class ChatMessageHostedContentRequestBuilder {
        ...
        public ChatMessageHostedContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/chats/{chat_id}/messages/{chatMessage_id}/hostedContents/{chatMessageHostedContent_id}{?select,expand}";
