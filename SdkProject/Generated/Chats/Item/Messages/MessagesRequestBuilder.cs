using GraphSdk.Chats.Item.Messages.Delta;
using GraphSdk.Chats.Item.Messages.Item;
...
namespace GraphSdk.Chats.Item.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.chats.item.messages.item collection</summary>
        ...
        public MessagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/chats/{chat_id}/messages{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
