using GraphSdk.Chats.Item.Tabs.Item.TeamsApp;
...
namespace GraphSdk.Chats.Item.Tabs.Item {
    ...
    public class TeamsTabRequestBuilder {
        ...
        public TeamsTabRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/chats/{chat_id}/tabs/{teamsTab_id}{?select,expand}";
