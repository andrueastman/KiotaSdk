...
namespace GraphSdk.Communications.Calls.Item.Participants.Invite {
    ...
    public class InviteRequestBuilder {
        ...
        public InviteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/communications/calls/{call_id}/participants/microsoft.graph.invite";
        ...
        /// </summary>
        public async Task<InviteResponse> PostAsync(InviteRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendAsync<InviteResponse>(requestInfo, responseHandler);
        }
