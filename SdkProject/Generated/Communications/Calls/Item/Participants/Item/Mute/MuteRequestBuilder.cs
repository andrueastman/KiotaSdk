...
namespace GraphSdk.Communications.Calls.Item.Participants.Item.Mute {
    ...
    public class MuteRequestBuilder {
        ...
        public MuteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/communications/calls/{call_id}/participants/{participant_id}/microsoft.graph.mute";
        ...
        /// </summary>
        public async Task<MuteResponse> PostAsync(MuteRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
