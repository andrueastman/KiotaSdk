using GraphSdk.Communications.Calls.Item.Participants.Item.Mute;
using GraphSdk.Communications.Calls.Item.Participants.Item.StartHoldMusic;
using GraphSdk.Communications.Calls.Item.Participants.Item.StopHoldMusic;
...
namespace GraphSdk.Communications.Calls.Item.Participants.Item {
    ...
    public class ParticipantRequestBuilder {
        ...
        public ParticipantRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/communications/calls/{call_id}/participants/{participant_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Participant> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Participant body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
