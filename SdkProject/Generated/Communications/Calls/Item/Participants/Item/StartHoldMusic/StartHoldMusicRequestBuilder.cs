...
namespace GraphSdk.Communications.Calls.Item.Participants.Item.StartHoldMusic {
    ...
    public class StartHoldMusicRequestBuilder {
        ...
        public StartHoldMusicRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/communications/calls/{call_id}/participants/{participant_id}/microsoft.graph.startHoldMusic";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(StartHoldMusicRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// </summary>
        public async Task<StartHoldMusicResponse> PostAsync(StartHoldMusicRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendAsync<StartHoldMusicResponse>(requestInfo, responseHandler);
        }
