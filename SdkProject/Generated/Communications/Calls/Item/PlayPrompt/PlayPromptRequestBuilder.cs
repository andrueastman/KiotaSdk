...
namespace GraphSdk.Communications.Calls.Item.PlayPrompt {
    ...
    public class PlayPromptRequestBuilder {
        ...
        /// </summary>
        public PlayPromptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "https://graph.microsoft.com/v1.0/communications/calls/{call_id}/microsoft.graph.playPrompt";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public PlayPromptRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
