...
namespace GraphSdk.Communications.Calls.Item.RecordResponse {
    ...
    public class RecordResponseRequestBuilder {
        ...
        public RecordResponseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/communications/calls/{call_id}/microsoft.graph.recordResponse";
        ...
        /// </summary>
        public async Task<RecordResponseResponse> PostAsync(RecordResponseRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendAsync<RecordResponseResponse>(requestInfo, responseHandler);
        }
