using GraphSdk.Communications.OnlineMeetings.Item.AttendanceReports.Item.AttendanceRecords.Item;
...
namespace GraphSdk.Communications.OnlineMeetings.Item.AttendanceReports.Item.AttendanceRecords {
    /// <summary>Builds and executes requests for operations under \communications\onlineMeetings\{onlineMeeting-id}\attendanceReports\{meetingAttendanceReport-id}\attendanceRecords</summary>
    public class AttendanceRecordsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.communications.onlineMeetings.item.attendanceReports.item.attendanceRecords.item collection</summary>
