...
namespace GraphSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.Activate {
    ...
    public class ActivateRequestBuilder {
        ...
        public ActivateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case_id}/custodians/{custodian_id}/microsoft.graph.ediscovery.activate";
