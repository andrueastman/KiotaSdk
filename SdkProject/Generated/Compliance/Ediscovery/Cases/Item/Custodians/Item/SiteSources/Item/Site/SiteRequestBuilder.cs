using GraphSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.SiteSources.Item.Site.Ref;
...
namespace GraphSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.SiteSources.Item.Site {
    /// <summary>Builds and executes requests for operations under \compliance\ediscovery\cases\{case-id}\custodians\{custodian-id}\siteSources\{siteSource-id}\site</summary>
    public class SiteRequestBuilder {
        ...
        public SiteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case_id}/custodians/{custodian_id}/siteSources/{siteSource_id}/site{?select,expand}";
