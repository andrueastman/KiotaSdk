...
namespace GraphSdk.Compliance.Ediscovery.Cases.Item.NoncustodialDataSources.Item.UpdateIndex {
    ...
    public class UpdateIndexRequestBuilder {
        ...
        public UpdateIndexRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case_id}/noncustodialDataSources/{noncustodialDataSource_id}/microsoft.graph.ediscovery.updateIndex";
