...
namespace GraphSdk.Compliance.Ediscovery.Cases.Item.Reopen {
    ...
    public class ReopenRequestBuilder {
        ...
        public ReopenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case_id}/microsoft.graph.ediscovery.reopen";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ReopenRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
