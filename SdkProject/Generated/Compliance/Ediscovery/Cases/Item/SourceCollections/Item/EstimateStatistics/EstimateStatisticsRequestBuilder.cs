...
namespace GraphSdk.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.EstimateStatistics {
    ...
    public class EstimateStatisticsRequestBuilder {
        ...
        /// </summary>
        public EstimateStatisticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case_id}/sourceCollections/{sourceCollection_id}/microsoft.graph.ediscovery.estimateStatistics";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public EstimateStatisticsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
