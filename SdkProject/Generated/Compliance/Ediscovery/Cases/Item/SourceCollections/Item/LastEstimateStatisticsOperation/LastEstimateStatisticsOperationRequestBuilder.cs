using GraphSdk.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.LastEstimateStatisticsOperation.Ref;
...
namespace GraphSdk.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.LastEstimateStatisticsOperation {
    ...
    public class LastEstimateStatisticsOperationRequestBuilder {
        ...
        /// </summary>
        public async Task<EstimateStatisticsOperation> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<EstimateStatisticsOperation>(requestInfo, responseHandler);
        }
