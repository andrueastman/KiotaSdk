using GraphSdk.Contacts.Delta;
using GraphSdk.Contacts.GetAvailableExtensionProperties;
using GraphSdk.Contacts.GetByIds;
using GraphSdk.Contacts.Item;
using GraphSdk.Contacts.ValidateProperties;
...
namespace GraphSdk.Contacts {
    ...
    public class ContactsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.contacts.item collection</summary>
        ...
        public ContactsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/contacts{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OrgContact> PostAsync(OrgContact body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
