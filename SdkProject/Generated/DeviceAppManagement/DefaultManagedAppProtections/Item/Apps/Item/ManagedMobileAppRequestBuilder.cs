...
namespace GraphSdk.DeviceAppManagement.DefaultManagedAppProtections.Item.Apps.Item {
    ...
    public class ManagedMobileAppRequestBuilder {
        ...
        public ManagedMobileAppRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection_id}/apps/{managedMobileApp_id}{?select,expand}";
