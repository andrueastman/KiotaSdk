using GraphSdk.DeviceAppManagement.AndroidManagedAppProtections;
using GraphSdk.DeviceAppManagement.DefaultManagedAppProtections;
using GraphSdk.DeviceAppManagement.IosManagedAppProtections;
using GraphSdk.DeviceAppManagement.ManagedAppPolicies;
using GraphSdk.DeviceAppManagement.ManagedAppRegistrations;
using GraphSdk.DeviceAppManagement.ManagedAppStatuses;
using GraphSdk.DeviceAppManagement.ManagedEBooks;
using GraphSdk.DeviceAppManagement.MdmWindowsInformationProtectionPolicies;
using GraphSdk.DeviceAppManagement.MobileAppCategories;
using GraphSdk.DeviceAppManagement.MobileAppConfigurations;
using GraphSdk.DeviceAppManagement.MobileApps;
using GraphSdk.DeviceAppManagement.SyncMicrosoftStoreForBusinessApps;
using GraphSdk.DeviceAppManagement.TargetedManagedAppConfigurations;
using GraphSdk.DeviceAppManagement.VppTokens;
using GraphSdk.DeviceAppManagement.WindowsInformationProtectionPolicies;
...
namespace GraphSdk.DeviceAppManagement {
    ...
    public class DeviceAppManagementRequestBuilder {
        ...
        public DeviceAppManagementRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceAppManagement{?select,expand}";
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(GraphSdk.Models.Microsoft.Graph.DeviceAppManagement body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// </summary>
        public async Task<GraphSdk.Models.Microsoft.Graph.DeviceAppManagement> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<GraphSdk.Models.Microsoft.Graph.DeviceAppManagement>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Update deviceAppManagement
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(GraphSdk.Models.Microsoft.Graph.DeviceAppManagement body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
