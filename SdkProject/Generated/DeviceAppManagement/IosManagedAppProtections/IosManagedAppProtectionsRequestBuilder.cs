using GraphSdk.DeviceAppManagement.IosManagedAppProtections.Item;
...
namespace GraphSdk.DeviceAppManagement.IosManagedAppProtections {
    ...
    public class IosManagedAppProtectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.deviceAppManagement.iosManagedAppProtections.item collection</summary>
        ...
        public IosManagedAppProtectionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceAppManagement/iosManagedAppProtections{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<IosManagedAppProtection> PostAsync(IosManagedAppProtection body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
