using GraphSdk.DeviceAppManagement.ManagedAppRegistrations.Item.AppliedPolicies;
using GraphSdk.DeviceAppManagement.ManagedAppRegistrations.Item.IntendedPolicies;
using GraphSdk.DeviceAppManagement.ManagedAppRegistrations.Item.Operations;
...
namespace GraphSdk.DeviceAppManagement.ManagedAppRegistrations.Item {
    ...
    public class ManagedAppRegistrationRequestBuilder {
        ...
        public ManagedAppRegistrationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceAppManagement/managedAppRegistrations/{managedAppRegistration_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ManagedAppRegistration body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
