using GraphSdk.DeviceAppManagement.MobileAppConfigurations.Item.Assignments.Item;
...
namespace GraphSdk.DeviceAppManagement.MobileAppConfigurations.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.deviceAppManagement.mobileAppConfigurations.item.assignments.item collection</summary>
        ...
        public AssignmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration_id}/assignments{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ManagedDeviceMobileAppConfigurationAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ManagedDeviceMobileAppConfigurationAssignment> PostAsync(ManagedDeviceMobileAppConfigurationAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
