using GraphSdk.DeviceAppManagement.MobileApps.Item.Categories.Ref;
...
namespace GraphSdk.DeviceAppManagement.MobileApps.Item.Categories {
    ...
    public class CategoriesRequestBuilder {
        ...
        public CategoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceAppManagement/mobileApps/{mobileApp_id}/categories{?top,skip,search,filter,count,orderby,select,expand}";
