using GraphSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item.Assign;
using GraphSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item.Assignments;
using GraphSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item.SetPriority;
...
namespace GraphSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item {
    ...
    public class DeviceEnrollmentConfigurationRequestBuilder {
        ...
        public DeviceEnrollmentConfigurationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration_id}{?select,expand}";
