...
namespace GraphSdk.DeviceManagement.ManagedDevices.Item.DisableLostMode {
    ...
    public class DisableLostModeRequestBuilder {
        ...
        public DisableLostModeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceManagement/managedDevices/{managedDevice_id}/microsoft.graph.disableLostMode";
