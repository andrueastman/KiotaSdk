...
namespace GraphSdk.DeviceManagement.ManagedDevices.Item.ResetPasscode {
    ...
    public class ResetPasscodeRequestBuilder {
        ...
        public ResetPasscodeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceManagement/managedDevices/{managedDevice_id}/microsoft.graph.resetPasscode";
