...
namespace GraphSdk.DeviceManagement.WindowsAutopilotDeviceIdentities {
    public class WindowsAutopilotDeviceIdentitiesResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as WindowsAutopilotDeviceIdentitiesResponse).Value = n.GetCollectionOfObjectValues<WindowsAutopilotDeviceIdentity>().ToList(); } },
            };
        }
        /// <summary>
