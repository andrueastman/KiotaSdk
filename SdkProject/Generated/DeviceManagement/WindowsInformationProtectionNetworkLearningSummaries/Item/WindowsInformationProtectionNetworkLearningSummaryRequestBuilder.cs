...
namespace GraphSdk.DeviceManagement.WindowsInformationProtectionNetworkLearningSummaries.Item {
    ...
    public class WindowsInformationProtectionNetworkLearningSummaryRequestBuilder {
        ...
        public WindowsInformationProtectionNetworkLearningSummaryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/deviceManagement/windowsInformationProtectionNetworkLearningSummaries/{windowsInformationProtectionNetworkLearningSummary_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(WindowsInformationProtectionNetworkLearningSummary body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
