using GraphSdk.Directory.AdministrativeUnits.Delta;
using GraphSdk.Directory.AdministrativeUnits.Item;
...
namespace GraphSdk.Directory.AdministrativeUnits {
    ...
    public class AdministrativeUnitsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.directory.administrativeUnits.item collection</summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GraphSdk.Models.Microsoft.Graph.AdministrativeUnit body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        public async Task<GraphSdk.Models.Microsoft.Graph.AdministrativeUnit> PostAsync(GraphSdk.Models.Microsoft.Graph.AdministrativeUnit body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<GraphSdk.Models.Microsoft.Graph.AdministrativeUnit>(requestInfo, responseHandler, default, cancellationToken);
        }
