...
namespace GraphSdk.DirectoryRoleTemplates.GetAvailableExtensionProperties {
    ...
    public class GetAvailableExtensionPropertiesRequestBuilder {
        ...
        public GetAvailableExtensionPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/directoryRoleTemplates/microsoft.graph.getAvailableExtensionProperties";
        ...
        public async Task<IEnumerable<GraphSdk.DirectoryRoleTemplates.GetAvailableExtensionProperties.GetAvailableExtensionProperties>> PostAsync(GetAvailableExtensionPropertiesRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            ...
            return await RequestAdapter.SendCollectionAsync<GraphSdk.DirectoryRoleTemplates.GetAvailableExtensionProperties.GetAvailableExtensionProperties>(requestInfo, responseHandler);
        }
    }
}
