...
namespace GraphSdk.DirectoryRoleTemplates.GetAvailableExtensionProperties {
    ...
    public class GetAvailableExtensionPropertiesRequestBuilder {
        ...
        public async Task<IEnumerable<GraphSdk.DirectoryRoleTemplates.GetAvailableExtensionProperties.GetAvailableExtensionProperties>> PostAsync(GetAvailableExtensionPropertiesRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendCollectionAsync<GraphSdk.DirectoryRoleTemplates.GetAvailableExtensionProperties.GetAvailableExtensionProperties>(requestInfo, responseHandler, cancellationToken);
        }
    }
}
