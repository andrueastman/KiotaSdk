...
namespace GraphSdk.DirectoryRoleTemplates.Item.GetMemberObjects {
    ...
    public class GetMemberObjectsRequestBuilder {
        ...
        public GetMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/directoryRoleTemplates/{directoryRoleTemplate_id}/microsoft.graph.getMemberObjects";
