using GraphSdk.DirectoryRoles.Item.Members.Ref;
...
namespace GraphSdk.DirectoryRoles.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/directoryRoles/{directoryRole_id}/members{?top,skip,search,filter,count,orderby,select,expand}";
