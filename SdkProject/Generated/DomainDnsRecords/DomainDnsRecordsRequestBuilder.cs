using GraphSdk.DomainDnsRecords.Item;
...
namespace GraphSdk.DomainDnsRecords {
    ...
    public class DomainDnsRecordsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.domainDnsRecords.item collection</summary>
        ...
        public DomainDnsRecordsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/domainDnsRecords{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
