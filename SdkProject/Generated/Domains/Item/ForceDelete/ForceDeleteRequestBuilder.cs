...
namespace GraphSdk.Domains.Item.ForceDelete {
    ...
    public class ForceDeleteRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ForceDeleteRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
