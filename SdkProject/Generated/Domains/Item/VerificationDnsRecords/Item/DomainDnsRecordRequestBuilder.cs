...
namespace GraphSdk.Domains.Item.VerificationDnsRecords.Item {
    ...
    public class DomainDnsRecordRequestBuilder {
        ...
        public DomainDnsRecordRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/domains/{domain_id}/verificationDnsRecords/{domainDnsRecord_id}{?select,expand}";
