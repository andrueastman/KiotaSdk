using GraphSdk.Drive.Following.Item.Content;
...
namespace GraphSdk.Drive.Following.Item {
    /// <summary>Builds and executes requests for operations under \drive\following\{driveItem-id}</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/following/{driveItem_id}{?select,expand}";
