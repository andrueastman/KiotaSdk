using GraphSdk.Drive.List.Columns.Item.SourceColumn;
...
namespace GraphSdk.Drive.List.Columns.Item {
    ...
    public class ColumnDefinitionRequestBuilder {
        ...
        public ColumnDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/list/columns/{columnDefinition_id}{?select,expand}";
