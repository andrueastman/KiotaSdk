using GraphSdk.Drive.List.Columns.Item.SourceColumn.Ref;
...
namespace GraphSdk.Drive.List.Columns.Item.SourceColumn {
    ...
    public class SourceColumnRequestBuilder {
        ...
        public SourceColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/list/columns/{columnDefinition_id}/sourceColumn{?select,expand}";
