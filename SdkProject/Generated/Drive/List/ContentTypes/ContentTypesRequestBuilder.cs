using GraphSdk.Drive.List.ContentTypes.AddCopy;
using GraphSdk.Drive.List.ContentTypes.Item;
...
namespace GraphSdk.Drive.List.ContentTypes {
    ...
    public class ContentTypesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.drive.list.contentTypes.item collection</summary>
        ...
        public ContentTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/list/contentTypes{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
