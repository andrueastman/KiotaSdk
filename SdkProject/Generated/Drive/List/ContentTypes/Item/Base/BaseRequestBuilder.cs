using GraphSdk.Drive.List.ContentTypes.Item.Base.AssociateWithHubSites;
using GraphSdk.Drive.List.ContentTypes.Item.Base.CopyToDefaultContentLocation;
using GraphSdk.Drive.List.ContentTypes.Item.Base.IsPublished;
using GraphSdk.Drive.List.ContentTypes.Item.Base.Publish;
using GraphSdk.Drive.List.ContentTypes.Item.Base.Ref;
using GraphSdk.Drive.List.ContentTypes.Item.Base.Unpublish;
...
namespace GraphSdk.Drive.List.ContentTypes.Item.Base {
