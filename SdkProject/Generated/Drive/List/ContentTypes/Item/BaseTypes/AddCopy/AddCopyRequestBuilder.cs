...
namespace GraphSdk.Drive.List.ContentTypes.Item.BaseTypes.AddCopy {
    /// <summary>Builds and executes requests for operations under \drive\list\contentTypes\{contentType-id}\baseTypes\microsoft.graph.addCopy</summary>
    public class AddCopyRequestBuilder {
        ...
        public AddCopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/list/contentTypes/{contentType_id}/baseTypes/microsoft.graph.addCopy";
