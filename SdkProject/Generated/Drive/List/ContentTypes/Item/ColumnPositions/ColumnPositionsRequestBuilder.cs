using GraphSdk.Drive.List.ContentTypes.Item.ColumnPositions.Ref;
...
namespace GraphSdk.Drive.List.ContentTypes.Item.ColumnPositions {
    /// <summary>Builds and executes requests for operations under \drive\list\contentTypes\{contentType-id}\columnPositions</summary>
    public class ColumnPositionsRequestBuilder {
        ...
        public ColumnPositionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/list/contentTypes/{contentType_id}/columnPositions{?top,skip,search,filter,count,orderby,select,expand}";
