using GraphSdk.Drive.List.ContentTypes.Item.Columns.Item.SourceColumn;
...
namespace GraphSdk.Drive.List.ContentTypes.Item.Columns.Item {
    ...
    public class ColumnDefinitionRequestBuilder {
        ...
        public ColumnDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/list/contentTypes/{contentType_id}/columns/{columnDefinition_id}{?select,expand}";
