using GraphSdk.Drive.List.ContentTypes.Item.Columns.Item.SourceColumn.Ref;
...
namespace GraphSdk.Drive.List.ContentTypes.Item.Columns.Item.SourceColumn {
    /// <summary>Builds and executes requests for operations under \drive\list\contentTypes\{contentType-id}\columns\{columnDefinition-id}\sourceColumn</summary>
    public class SourceColumnRequestBuilder {
        ...
        public SourceColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/list/contentTypes/{contentType_id}/columns/{columnDefinition_id}/sourceColumn{?select,expand}";
