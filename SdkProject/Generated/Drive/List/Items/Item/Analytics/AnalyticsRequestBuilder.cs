using GraphSdk.Drive.List.Items.Item.Analytics.Ref;
...
namespace GraphSdk.Drive.List.Items.Item.Analytics {
    ...
    public class AnalyticsRequestBuilder {
        ...
        public AnalyticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/list/items/{listItem_id}/analytics{?select,expand}";
