using GraphSdk.Drive.Special.Item.Content;
...
namespace GraphSdk.Drive.Special.Item {
    /// <summary>Builds and executes requests for operations under \drive\special\{driveItem-id}</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drive/special/{driveItem_id}{?select,expand}";
