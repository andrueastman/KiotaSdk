...
namespace GraphSdk.Drives {
    ...
    public class DrivesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.drives.item collection</summary>
        ...
        public DrivesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drives{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
