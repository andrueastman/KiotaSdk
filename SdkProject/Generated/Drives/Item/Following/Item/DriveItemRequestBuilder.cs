using GraphSdk.Drives.Item.Following.Item.Content;
...
namespace GraphSdk.Drives.Item.Following.Item {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drives/{drive_id}/following/{driveItem_id}{?select,expand}";
