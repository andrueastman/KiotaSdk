using GraphSdk.Drives.Item.List.Columns.Item.SourceColumn.Ref;
...
namespace GraphSdk.Drives.Item.List.Columns.Item.SourceColumn {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\list\columns\{columnDefinition-id}\sourceColumn</summary>
    public class SourceColumnRequestBuilder {
        ...
        public SourceColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drives/{drive_id}/list/columns/{columnDefinition_id}/sourceColumn{?select,expand}";
