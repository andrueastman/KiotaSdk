using GraphSdk.Drives.Item.List.ContentTypes.Item.Base.AssociateWithHubSites;
using GraphSdk.Drives.Item.List.ContentTypes.Item.Base.CopyToDefaultContentLocation;
using GraphSdk.Drives.Item.List.ContentTypes.Item.Base.IsPublished;
using GraphSdk.Drives.Item.List.ContentTypes.Item.Base.Publish;
using GraphSdk.Drives.Item.List.ContentTypes.Item.Base.Ref;
using GraphSdk.Drives.Item.List.ContentTypes.Item.Base.Unpublish;
...
namespace GraphSdk.Drives.Item.List.ContentTypes.Item.Base {
    ...
    public class BaseRequestBuilder {
        ...
        public BaseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drives/{drive_id}/list/contentTypes/{contentType_id}/base{?select,expand}";
