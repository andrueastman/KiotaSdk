...
namespace GraphSdk.Drives.Item.List.ContentTypes.Item.Base.Unpublish {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\list\contentTypes\{contentType-id}\base\microsoft.graph.unpublish</summary>
    public class UnpublishRequestBuilder {
        ...
        public UnpublishRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drives/{drive_id}/list/contentTypes/{contentType_id}/base/microsoft.graph.unpublish";
