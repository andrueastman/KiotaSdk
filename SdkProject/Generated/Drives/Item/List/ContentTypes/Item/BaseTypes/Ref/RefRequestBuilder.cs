...
namespace GraphSdk.Drives.Item.List.ContentTypes.Item.BaseTypes.Ref {
    ...
    public class RefRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<GraphSdk.Drives.Item.List.ContentTypes.Item.BaseTypes.Ref.Ref> PostAsync(GraphSdk.Drives.Item.List.ContentTypes.Item.BaseTypes.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendAsync<GraphSdk.Drives.Item.List.ContentTypes.Item.BaseTypes.Ref.Ref>(requestInfo, responseHandler, default, cancellationToken);
        }
