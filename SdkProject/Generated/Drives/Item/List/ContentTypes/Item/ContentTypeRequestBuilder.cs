using GraphSdk.Drives.Item.List.ContentTypes.Item.AssociateWithHubSites;
using GraphSdk.Drives.Item.List.ContentTypes.Item.Base;
using GraphSdk.Drives.Item.List.ContentTypes.Item.BaseTypes;
using GraphSdk.Drives.Item.List.ContentTypes.Item.ColumnLinks;
using GraphSdk.Drives.Item.List.ContentTypes.Item.ColumnPositions;
using GraphSdk.Drives.Item.List.ContentTypes.Item.Columns;
using GraphSdk.Drives.Item.List.ContentTypes.Item.CopyToDefaultContentLocation;
using GraphSdk.Drives.Item.List.ContentTypes.Item.IsPublished;
using GraphSdk.Drives.Item.List.ContentTypes.Item.Publish;
using GraphSdk.Drives.Item.List.ContentTypes.Item.Unpublish;
...
namespace GraphSdk.Drives.Item.List.ContentTypes.Item {
    ...
    public class ContentTypeRequestBuilder {
        ...
        public ContentTypeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drives/{drive_id}/list/contentTypes/{contentType_id}{?select,expand}";
