...
namespace GraphSdk.Drives.Item.List.ContentTypes.Item.Unpublish {
    ...
    public class UnpublishRequestBuilder {
        ...
        public UnpublishRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drives/{drive_id}/list/contentTypes/{contentType_id}/microsoft.graph.unpublish";
