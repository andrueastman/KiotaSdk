...
namespace GraphSdk.Drives.Item.Root.Content {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\root\content</summary>
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drives/{drive_id}/root/content";
