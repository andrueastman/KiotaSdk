using GraphSdk.Drives.Item.Special.Item.Content;
...
namespace GraphSdk.Drives.Item.Special.Item {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/drives/{drive_id}/special/{driveItem_id}{?select,expand}";
