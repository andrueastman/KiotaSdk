using GraphSdk.Education.Classes.Item.AssignmentCategories.Item;
...
namespace GraphSdk.Education.Classes.Item.AssignmentCategories {
    ...
    public class AssignmentCategoriesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.education.classes.item.assignmentCategories.item collection</summary>
        ...
        public AssignmentCategoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/education/classes/{educationClass_id}/assignmentCategories{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
