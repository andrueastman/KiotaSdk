...
namespace GraphSdk.Education.Classes.Item.AssignmentCategories.Item {
    ...
    public class EducationCategoryRequestBuilder {
        ...
        public EducationCategoryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/education/classes/{educationClass_id}/assignmentCategories/{educationCategory_id}{?select,expand}";
