using GraphSdk.Education.Classes.Item.Group.Ref;
...
namespace GraphSdk.Education.Classes.Item.Group {
    /// <summary>Builds and executes requests for operations under \education\classes\{educationClass-id}\group</summary>
    public class GroupRequestBuilder {
        ...
        public GroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/education/classes/{educationClass_id}/group{?select,expand}";
