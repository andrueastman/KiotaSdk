using GraphSdk.Education.Classes.Item.Members.Delta;
using GraphSdk.Education.Classes.Item.Members.Ref;
...
namespace GraphSdk.Education.Classes.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/education/classes/{educationClass_id}/members{?top,skip,search,filter,count,orderby,select,expand}";
