using GraphSdk.Education.Me.Assignments.Item.Submissions.Item.Outcomes.Item;
...
namespace GraphSdk.Education.Me.Assignments.Item.Submissions.Item.Outcomes {
    /// <summary>Builds and executes requests for operations under \education\me\assignments\{educationAssignment-id}\submissions\{educationSubmission-id}\outcomes</summary>
    public class OutcomesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.education.me.assignments.item.submissions.item.outcomes.item collection</summary>
        ...
        public OutcomesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/me/assignments/{educationAssignment_id}/submissions/{educationSubmission_id}/outcomes{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
