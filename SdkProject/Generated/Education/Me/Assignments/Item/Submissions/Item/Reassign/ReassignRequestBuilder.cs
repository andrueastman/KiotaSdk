...
namespace GraphSdk.Education.Me.Assignments.Item.Submissions.Item.Reassign {
    /// <summary>Builds and executes requests for operations under \education\me\assignments\{educationAssignment-id}\submissions\{educationSubmission-id}\microsoft.graph.reassign</summary>
    public class ReassignRequestBuilder {
        ...
        public ReassignRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/me/assignments/{educationAssignment_id}/submissions/{educationSubmission_id}/microsoft.graph.reassign";
        ...
        public async Task<ReassignResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<ReassignResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
