using GraphSdk.Education.Me.Classes.Delta;
using GraphSdk.Education.Me.Classes.Ref;
...
namespace GraphSdk.Education.Me.Classes {
    ...
    public class ClassesRequestBuilder {
        ...
        public ClassesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/education/me/classes{?top,skip,search,filter,count,orderby,select,expand}";
