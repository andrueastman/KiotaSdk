using GraphSdk.Education.Me.Schools.Delta;
using GraphSdk.Education.Me.Schools.Ref;
...
namespace GraphSdk.Education.Me.Schools {
    ...
    public class SchoolsRequestBuilder {
        ...
        public SchoolsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/education/me/schools{?top,skip,search,filter,count,orderby,select,expand}";
