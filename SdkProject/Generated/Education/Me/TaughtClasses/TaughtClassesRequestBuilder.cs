using GraphSdk.Education.Me.TaughtClasses.Delta;
using GraphSdk.Education.Me.TaughtClasses.Ref;
...
namespace GraphSdk.Education.Me.TaughtClasses {
    ...
    public class TaughtClassesRequestBuilder {
        ...
        public TaughtClassesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/education/me/taughtClasses{?top,skip,search,filter,count,orderby,select,expand}";
