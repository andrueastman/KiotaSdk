using GraphSdk.Education.Users.Item.Schools.Delta;
using GraphSdk.Education.Users.Item.Schools.Ref;
...
namespace GraphSdk.Education.Users.Item.Schools {
    ...
    public class SchoolsRequestBuilder {
        ...
        public SchoolsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/education/users/{educationUser_id}/schools{?top,skip,search,filter,count,orderby,select,expand}";
