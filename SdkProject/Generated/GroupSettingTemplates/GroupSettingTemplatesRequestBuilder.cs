using GraphSdk.GroupSettingTemplates.GetAvailableExtensionProperties;
using GraphSdk.GroupSettingTemplates.GetByIds;
using GraphSdk.GroupSettingTemplates.Item;
using GraphSdk.GroupSettingTemplates.ValidateProperties;
...
namespace GraphSdk.GroupSettingTemplates {
    ...
    public class GroupSettingTemplatesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.groupSettingTemplates.item collection</summary>
        ...
        public GroupSettingTemplatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groupSettingTemplates{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<GroupSettingTemplate> PostAsync(GroupSettingTemplate body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
