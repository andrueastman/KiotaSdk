using GraphSdk.GroupSettingTemplates.Item.CheckMemberGroups;
using GraphSdk.GroupSettingTemplates.Item.CheckMemberObjects;
using GraphSdk.GroupSettingTemplates.Item.GetMemberGroups;
using GraphSdk.GroupSettingTemplates.Item.GetMemberObjects;
using GraphSdk.GroupSettingTemplates.Item.Restore;
...
namespace GraphSdk.GroupSettingTemplates.Item {
    ...
    public class GroupSettingTemplateRequestBuilder {
        ...
        public GroupSettingTemplateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groupSettingTemplates/{groupSettingTemplate_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(GroupSettingTemplate body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
