using GraphSdk.Groups.Item.AcceptedSenders.Ref;
...
namespace GraphSdk.Groups.Item.AcceptedSenders {
    ...
    public class AcceptedSendersRequestBuilder {
        ...
        public AcceptedSendersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/acceptedSenders{?top,skip,filter,count,orderby,select}";
        ...
        /// </summary>
        public async Task<AcceptedSendersResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<AcceptedSendersResponse>(requestInfo, responseHandler);
        }
