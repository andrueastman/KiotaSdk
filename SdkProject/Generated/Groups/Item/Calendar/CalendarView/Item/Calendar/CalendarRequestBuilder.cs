using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Calendar.AllowedCalendarSharingRolesWithUser;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Calendar.GetSchedule;
...
namespace GraphSdk.Groups.Item.Calendar.CalendarView.Item.Calendar {
    ...
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/calendar/calendarView/{event_id}/calendar{?select}";
