using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Accept;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Attachments;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Calendar;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Cancel;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Decline;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.DismissReminder;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Extensions;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Forward;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.Instances;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.MultiValueExtendedProperties;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.SingleValueExtendedProperties;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.SnoozeReminder;
using GraphSdk.Groups.Item.Calendar.CalendarView.Item.TentativelyAccept;
...
namespace GraphSdk.Groups.Item.Calendar.CalendarView.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/calendar/calendarView/{event_id}{?startDateTime,endDateTime,select}";
