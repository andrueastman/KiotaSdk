using GraphSdk.Groups.Item.Calendar.CalendarView.Item.MultiValueExtendedProperties.Item;
...
namespace GraphSdk.Groups.Item.Calendar.CalendarView.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.groups.item.calendar.calendarView.item.multiValueExtendedProperties.item collection</summary>
        ...
        public MultiValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/calendar/calendarView/{event_id}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
