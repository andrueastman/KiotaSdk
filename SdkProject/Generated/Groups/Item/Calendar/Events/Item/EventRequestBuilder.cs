...
using GraphSdk.Groups.Item.Calendar.Events.Item.Cancel;
using GraphSdk.Groups.Item.Calendar.Events.Item.Decline;
using GraphSdk.Groups.Item.Calendar.Events.Item.DismissReminder;
using GraphSdk.Groups.Item.Calendar.Events.Item.Extensions;
using GraphSdk.Groups.Item.Calendar.Events.Item.Forward;
using GraphSdk.Groups.Item.Calendar.Events.Item.Instances;
using GraphSdk.Groups.Item.Calendar.Events.Item.MultiValueExtendedProperties;
using GraphSdk.Groups.Item.Calendar.Events.Item.SingleValueExtendedProperties;
using GraphSdk.Groups.Item.Calendar.Events.Item.SnoozeReminder;
using GraphSdk.Groups.Item.Calendar.Events.Item.TentativelyAccept;
...
namespace GraphSdk.Groups.Item.Calendar.Events.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/calendar/events/{event_id}{?select}";
