using GraphSdk.Groups.Item.CalendarView.Item.Accept;
using GraphSdk.Groups.Item.CalendarView.Item.Attachments;
using GraphSdk.Groups.Item.CalendarView.Item.Calendar;
using GraphSdk.Groups.Item.CalendarView.Item.Cancel;
using GraphSdk.Groups.Item.CalendarView.Item.Decline;
using GraphSdk.Groups.Item.CalendarView.Item.DismissReminder;
using GraphSdk.Groups.Item.CalendarView.Item.Extensions;
using GraphSdk.Groups.Item.CalendarView.Item.Forward;
using GraphSdk.Groups.Item.CalendarView.Item.Instances;
using GraphSdk.Groups.Item.CalendarView.Item.MultiValueExtendedProperties;
using GraphSdk.Groups.Item.CalendarView.Item.SingleValueExtendedProperties;
using GraphSdk.Groups.Item.CalendarView.Item.SnoozeReminder;
using GraphSdk.Groups.Item.CalendarView.Item.TentativelyAccept;
...
namespace GraphSdk.Groups.Item.CalendarView.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/calendarView/{event_id}{?startDateTime,endDateTime,select}";
