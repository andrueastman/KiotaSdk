using GraphSdk.Groups.Item.Events.Item.Calendar.AllowedCalendarSharingRolesWithUser;
using GraphSdk.Groups.Item.Events.Item.Calendar.CalendarPermissions;
using GraphSdk.Groups.Item.Events.Item.Calendar.CalendarView;
using GraphSdk.Groups.Item.Events.Item.Calendar.Events;
using GraphSdk.Groups.Item.Events.Item.Calendar.GetSchedule;
using GraphSdk.Groups.Item.Events.Item.Calendar.MultiValueExtendedProperties;
using GraphSdk.Groups.Item.Events.Item.Calendar.SingleValueExtendedProperties;
...
namespace GraphSdk.Groups.Item.Events.Item.Calendar {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\events\{event-id}\calendar</summary>
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/events/{event_id}/calendar{?select}";
