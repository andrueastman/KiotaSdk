using GraphSdk.Groups.Item.Events.Item.Calendar.CalendarView.Delta;
using GraphSdk.Groups.Item.Events.Item.Calendar.CalendarView.Item;
...
namespace GraphSdk.Groups.Item.Events.Item.Calendar.CalendarView {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\events\{event-id}\calendar\calendarView</summary>
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.groups.item.events.item.calendar.calendarView.item collection</summary>
        ...
        public CalendarViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/events/{event_id}/calendar/calendarView{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
