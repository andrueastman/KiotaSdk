...
namespace GraphSdk.Groups.Item.Events.Item.Calendar.GetSchedule {
    ...
    public class GetScheduleRequestBuilder {
        ...
        public GetScheduleRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/events/{event_id}/calendar/microsoft.graph.getSchedule";
        ...
        /// </summary>
        public async Task<IEnumerable<GraphSdk.Groups.Item.Events.Item.Calendar.GetSchedule.GetSchedule>> PostAsync(GetScheduleRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendCollectionAsync<GraphSdk.Groups.Item.Events.Item.Calendar.GetSchedule.GetSchedule>(requestInfo, responseHandler);
        }
    }
}
