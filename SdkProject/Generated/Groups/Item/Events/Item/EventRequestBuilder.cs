using GraphSdk.Groups.Item.Events.Item.Accept;
using GraphSdk.Groups.Item.Events.Item.Attachments;
using GraphSdk.Groups.Item.Events.Item.Calendar;
using GraphSdk.Groups.Item.Events.Item.Cancel;
using GraphSdk.Groups.Item.Events.Item.Decline;
using GraphSdk.Groups.Item.Events.Item.DismissReminder;
using GraphSdk.Groups.Item.Events.Item.Extensions;
using GraphSdk.Groups.Item.Events.Item.Forward;
using GraphSdk.Groups.Item.Events.Item.Instances;
using GraphSdk.Groups.Item.Events.Item.MultiValueExtendedProperties;
using GraphSdk.Groups.Item.Events.Item.SingleValueExtendedProperties;
using GraphSdk.Groups.Item.Events.Item.SnoozeReminder;
using GraphSdk.Groups.Item.Events.Item.TentativelyAccept;
...
namespace GraphSdk.Groups.Item.Events.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/events/{event_id}{?select}";
