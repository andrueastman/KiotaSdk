...
namespace GraphSdk.Groups.Item.Events.Item.Instances.Item.DismissReminder {
    ...
    public class DismissReminderRequestBuilder {
        ...
        public DismissReminderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/events/{event_id}/instances/{event_id1}/microsoft.graph.dismissReminder";
