using GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.Content;
using GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.CopyToSection;
using GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.OnenotePatchContent;
using GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.ParentNotebook;
using GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.ParentSection;
using GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.Preview;
...
namespace GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}{?select,expand}";
