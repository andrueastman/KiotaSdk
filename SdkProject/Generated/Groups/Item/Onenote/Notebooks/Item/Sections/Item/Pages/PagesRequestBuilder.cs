using GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item;
...
namespace GraphSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.Pages {
    ...
    public class PagesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.groups.item.onenote.notebooks.item.sections.item.pages.item collection</summary>
        ...
        public PagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/pages{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
