using GraphSdk.Groups.Item.Onenote.Pages.Item.Content;
using GraphSdk.Groups.Item.Onenote.Pages.Item.CopyToSection;
using GraphSdk.Groups.Item.Onenote.Pages.Item.OnenotePatchContent;
using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentNotebook;
using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection;
using GraphSdk.Groups.Item.Onenote.Pages.Item.Preview;
...
namespace GraphSdk.Groups.Item.Onenote.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/pages/{onenotePage_id}{?select,expand}";
