using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.Pages.Item.Content;
using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.Pages.Item.CopyToSection;
using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.Pages.Item.OnenotePatchContent;
using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.Pages.Item.Preview;
...
namespace GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/pages/{onenotePage_id}/parentSection/pages/{onenotePage_id1}{?select,expand}";
