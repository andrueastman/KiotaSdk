using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.ParentNotebook;
using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.SectionGroups;
using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.Sections;
...
namespace GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup {
    ...
    public class ParentSectionGroupRequestBuilder {
        ...
        public ParentSectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/pages/{onenotePage_id}/parentSection/parentSectionGroup{?select,expand}";
