using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.CopyToNotebook;
using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.CopyToSectionGroup;
using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.Pages;
using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.ParentNotebook;
using GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup;
...
namespace GraphSdk.Groups.Item.Onenote.Pages.Item.ParentSection {
    ...
    public class ParentSectionRequestBuilder {
        ...
        public ParentSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/pages/{onenotePage_id}/parentSection{?select,expand}";
