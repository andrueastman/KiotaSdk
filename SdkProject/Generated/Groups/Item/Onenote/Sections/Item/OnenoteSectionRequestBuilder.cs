using GraphSdk.Groups.Item.Onenote.Sections.Item.CopyToNotebook;
using GraphSdk.Groups.Item.Onenote.Sections.Item.CopyToSectionGroup;
using GraphSdk.Groups.Item.Onenote.Sections.Item.Pages;
using GraphSdk.Groups.Item.Onenote.Sections.Item.ParentNotebook;
using GraphSdk.Groups.Item.Onenote.Sections.Item.ParentSectionGroup;
...
namespace GraphSdk.Groups.Item.Onenote.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/sections/{onenoteSection_id}{?select,expand}";
