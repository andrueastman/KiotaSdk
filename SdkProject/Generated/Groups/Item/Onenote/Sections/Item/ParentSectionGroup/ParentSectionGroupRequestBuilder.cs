using GraphSdk.Groups.Item.Onenote.Sections.Item.ParentSectionGroup.ParentNotebook;
using GraphSdk.Groups.Item.Onenote.Sections.Item.ParentSectionGroup.SectionGroups;
using GraphSdk.Groups.Item.Onenote.Sections.Item.ParentSectionGroup.Sections;
...
namespace GraphSdk.Groups.Item.Onenote.Sections.Item.ParentSectionGroup {
    ...
    public class ParentSectionGroupRequestBuilder {
        ...
        public ParentSectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/sections/{onenoteSection_id}/parentSectionGroup{?select,expand}";
