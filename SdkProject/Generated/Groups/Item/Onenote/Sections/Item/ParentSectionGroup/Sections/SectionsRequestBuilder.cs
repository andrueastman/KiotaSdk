using GraphSdk.Groups.Item.Onenote.Sections.Item.ParentSectionGroup.Sections.Item;
...
namespace GraphSdk.Groups.Item.Onenote.Sections.Item.ParentSectionGroup.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.groups.item.onenote.sections.item.parentSectionGroup.sections.item collection</summary>
        ...
        public SectionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/sections/{onenoteSection_id}/parentSectionGroup/sections{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
