using GraphSdk.Groups.Item.Owners.Ref;
...
namespace GraphSdk.Groups.Item.Owners {
    ...
    public class OwnersRequestBuilder {
        ...
        public OwnersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/owners{?top,skip,search,filter,count,orderby,select,expand}";
