using GraphSdk.Groups.Item.Photos.Item.Value;
...
namespace GraphSdk.Groups.Item.Photos.Item {
    ...
    public class ProfilePhotoRequestBuilder {
        ...
        public ProfilePhotoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/photos/{profilePhoto_id}{?select}";
