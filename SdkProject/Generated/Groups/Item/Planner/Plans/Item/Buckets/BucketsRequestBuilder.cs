using GraphSdk.Groups.Item.Planner.Plans.Item.Buckets.Item;
...
namespace GraphSdk.Groups.Item.Planner.Plans.Item.Buckets {
    ...
    public class BucketsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.groups.item.planner.plans.item.buckets.item collection</summary>
        ...
        public BucketsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/planner/plans/{plannerPlan_id}/buckets{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
