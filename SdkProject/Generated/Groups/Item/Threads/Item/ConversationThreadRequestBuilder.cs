using GraphSdk.Groups.Item.Threads.Item.Posts;
using GraphSdk.Groups.Item.Threads.Item.Reply;
...
namespace GraphSdk.Groups.Item.Threads.Item {
    ...
    public class ConversationThreadRequestBuilder {
        ...
        public ConversationThreadRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/threads/{conversationThread_id}{?select}";
