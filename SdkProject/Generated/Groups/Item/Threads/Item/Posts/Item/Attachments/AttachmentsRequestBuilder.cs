using GraphSdk.Groups.Item.Threads.Item.Posts.Item.Attachments.CreateUploadSession;
using GraphSdk.Groups.Item.Threads.Item.Posts.Item.Attachments.Item;
...
namespace GraphSdk.Groups.Item.Threads.Item.Posts.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.groups.item.threads.item.posts.item.attachments.item collection</summary>
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/threads/{conversationThread_id}/posts/{post_id}/attachments{?top,skip,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
