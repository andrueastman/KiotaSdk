using GraphSdk.Groups.Item.Threads.Item.Posts.Item.Extensions.Item;
...
namespace GraphSdk.Groups.Item.Threads.Item.Posts.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.groups.item.threads.item.posts.item.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/threads/{conversationThread_id}/posts/{post_id}/extensions{?top,skip,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
