using GraphSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Forward;
using GraphSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Reply;
...
namespace GraphSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo {
    ...
    public class InReplyToRequestBuilder {
        ...
        public InReplyToRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/threads/{conversationThread_id}/posts/{post_id}/inReplyTo{?select,expand}";
