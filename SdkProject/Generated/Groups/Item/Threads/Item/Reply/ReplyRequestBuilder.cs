...
namespace GraphSdk.Groups.Item.Threads.Item.Reply {
    ...
    public class ReplyRequestBuilder {
        ...
        public ReplyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/threads/{conversationThread_id}/microsoft.graph.reply";
