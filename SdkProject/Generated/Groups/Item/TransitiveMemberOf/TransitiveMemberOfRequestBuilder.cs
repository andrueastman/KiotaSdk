using GraphSdk.Groups.Item.TransitiveMemberOf.Ref;
...
namespace GraphSdk.Groups.Item.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        public TransitiveMemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/transitiveMemberOf{?top,skip,search,filter,count,orderby,select,expand}";
