using GraphSdk.Identity.B2xUserFlows.Item.Languages.Item.DefaultPages.Item.Value;
...
namespace GraphSdk.Identity.B2xUserFlows.Item.Languages.Item.DefaultPages.Item {
    ...
    public class UserFlowLanguagePageRequestBuilder {
        ...
        public UserFlowLanguagePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/identity/b2xUserFlows/{b2xIdentityUserFlow_id}/languages/{userFlowLanguageConfiguration_id}/defaultPages/{userFlowLanguagePage_id}{?select,expand}";
