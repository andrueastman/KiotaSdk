using GraphSdk.Identity.B2xUserFlows.Item.UserAttributeAssignments.GetOrder;
using GraphSdk.Identity.B2xUserFlows.Item.UserAttributeAssignments.Item;
using GraphSdk.Identity.B2xUserFlows.Item.UserAttributeAssignments.SetOrder;
...
namespace GraphSdk.Identity.B2xUserFlows.Item.UserAttributeAssignments {
    ...
    public class UserAttributeAssignmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.identity.b2xUserFlows.item.userAttributeAssignments.item collection</summary>
        ...
        public UserAttributeAssignmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/identity/b2xUserFlows/{b2xIdentityUserFlow_id}/userAttributeAssignments{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<IdentityUserFlowAttributeAssignment> PostAsync(IdentityUserFlowAttributeAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
