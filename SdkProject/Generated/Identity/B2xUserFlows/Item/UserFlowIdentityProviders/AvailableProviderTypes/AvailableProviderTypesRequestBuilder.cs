...
namespace GraphSdk.Identity.B2xUserFlows.Item.UserFlowIdentityProviders.AvailableProviderTypes {
    ...
    public class AvailableProviderTypesRequestBuilder {
        ...
        public AvailableProviderTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/identity/b2xUserFlows/{b2xIdentityUserFlow_id}/userFlowIdentityProviders/microsoft.graph.availableProviderTypes()";
