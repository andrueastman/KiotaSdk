using GraphSdk.IdentityGovernance.EntitlementManagement.AccessPackageAssignmentApprovals.FilterByCurrentUserWithOn;
using GraphSdk.IdentityGovernance.EntitlementManagement.AccessPackageAssignmentApprovals.Item;
...
namespace GraphSdk.IdentityGovernance.EntitlementManagement.AccessPackageAssignmentApprovals {
    ...
    public class AccessPackageAssignmentApprovalsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.identityGovernance.entitlementManagement.accessPackageAssignmentApprovals.item collection</summary>
        ...
        public AccessPackageAssignmentApprovalsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/identityGovernance/entitlementManagement/accessPackageAssignmentApprovals{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GraphSdk.Models.Microsoft.Graph.Approval body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
