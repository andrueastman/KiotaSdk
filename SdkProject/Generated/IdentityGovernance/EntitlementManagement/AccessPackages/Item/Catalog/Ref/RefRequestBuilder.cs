...
namespace GraphSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Item.Catalog.Ref {
    ...
    public class RefRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePutRequestInformation(GraphSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Item.Catalog.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PutAsync(GraphSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Item.Catalog.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
