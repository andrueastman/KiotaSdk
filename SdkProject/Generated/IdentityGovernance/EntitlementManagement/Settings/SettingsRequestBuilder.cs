...
namespace GraphSdk.IdentityGovernance.EntitlementManagement.Settings {
    /// <summary>Builds and executes requests for operations under \identityGovernance\entitlementManagement\settings</summary>
    public class SettingsRequestBuilder {
        ...
        public SettingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/settings{?select,expand}";
