using GraphSdk.IdentityGovernance.TermsOfUse.AgreementAcceptances.Item;
...
namespace GraphSdk.IdentityGovernance.TermsOfUse.AgreementAcceptances {
    ...
    public class AgreementAcceptancesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.identityGovernance.termsOfUse.agreementAcceptances.item collection</summary>
        ...
        public AgreementAcceptancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/identityGovernance/termsOfUse/agreementAcceptances{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public async Task<AgreementAcceptancesResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<AgreementAcceptancesResponse>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Create new navigation property to agreementAcceptances for identityGovernance
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AgreementAcceptance> PostAsync(AgreementAcceptance body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
