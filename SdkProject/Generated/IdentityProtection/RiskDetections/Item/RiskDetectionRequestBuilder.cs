...
namespace GraphSdk.IdentityProtection.RiskDetections.Item {
    /// <summary>Builds and executes requests for operations under \identityProtection\riskDetections\{riskDetection-id}</summary>
    public class RiskDetectionRequestBuilder {
        ...
        /// </summary>
        public RiskDetectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
