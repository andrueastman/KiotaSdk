using GraphSdk.IdentityProtection.RiskyUsers.ConfirmCompromised;
using GraphSdk.IdentityProtection.RiskyUsers.Dismiss;
using GraphSdk.IdentityProtection.RiskyUsers.Item;
...
namespace GraphSdk.IdentityProtection.RiskyUsers {
    ...
    public class RiskyUsersRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.identityProtection.riskyUsers.item collection</summary>
