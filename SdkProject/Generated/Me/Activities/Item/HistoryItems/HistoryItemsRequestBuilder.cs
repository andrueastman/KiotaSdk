using GraphSdk.Me.Activities.Item.HistoryItems.Item;
...
namespace GraphSdk.Me.Activities.Item.HistoryItems {
    ...
    public class HistoryItemsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.activities.item.historyItems.item collection</summary>
        ...
        public HistoryItemsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/activities/{userActivity_id}/historyItems{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
