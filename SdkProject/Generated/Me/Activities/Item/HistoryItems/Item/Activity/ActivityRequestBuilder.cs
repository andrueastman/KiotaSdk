using GraphSdk.Me.Activities.Item.HistoryItems.Item.Activity.Ref;
...
namespace GraphSdk.Me.Activities.Item.HistoryItems.Item.Activity {
    ...
    public class ActivityRequestBuilder {
        ...
        public ActivityRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/activities/{userActivity_id}/historyItems/{activityHistoryItem_id}/activity{?select,expand}";
