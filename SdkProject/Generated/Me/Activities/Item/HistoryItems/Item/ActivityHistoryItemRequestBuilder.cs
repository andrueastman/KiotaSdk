using GraphSdk.Me.Activities.Item.HistoryItems.Item.Activity;
...
namespace GraphSdk.Me.Activities.Item.HistoryItems.Item {
    ...
    public class ActivityHistoryItemRequestBuilder {
        ...
        public ActivityHistoryItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/activities/{userActivity_id}/historyItems/{activityHistoryItem_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ActivityHistoryItem body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
