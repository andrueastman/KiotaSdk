...
namespace GraphSdk.Me.Authentication.Fido2Methods.Item {
    ...
    public class Fido2AuthenticationMethodRequestBuilder {
        ...
        public Fido2AuthenticationMethodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/authentication/fido2Methods/{fido2AuthenticationMethod_id}{?select,expand}";
