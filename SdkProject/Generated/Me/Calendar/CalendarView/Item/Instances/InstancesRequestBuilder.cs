using GraphSdk.Me.Calendar.CalendarView.Item.Instances.Delta;
using GraphSdk.Me.Calendar.CalendarView.Item.Instances.Item;
...
namespace GraphSdk.Me.Calendar.CalendarView.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.calendar.calendarView.item.instances.item collection</summary>
        ...
        public InstancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendar/calendarView/{event_id}/instances{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
