using GraphSdk.Me.Calendar.Events.Item.Instances.Item.Accept;
using GraphSdk.Me.Calendar.Events.Item.Instances.Item.Cancel;
using GraphSdk.Me.Calendar.Events.Item.Instances.Item.Decline;
using GraphSdk.Me.Calendar.Events.Item.Instances.Item.DismissReminder;
using GraphSdk.Me.Calendar.Events.Item.Instances.Item.Forward;
using GraphSdk.Me.Calendar.Events.Item.Instances.Item.SnoozeReminder;
using GraphSdk.Me.Calendar.Events.Item.Instances.Item.TentativelyAccept;
...
namespace GraphSdk.Me.Calendar.Events.Item.Instances.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendar/events/{event_id}/instances/{event_id1}{?select}";
