using GraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.SingleValueExtendedProperties.Item;
...
namespace GraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.calendarGroups.item.calendars.item.events.item.singleValueExtendedProperties.item collection</summary>
        ...
        public SingleValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/events/{event_id}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
