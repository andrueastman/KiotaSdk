using GraphSdk.Me.Calendars.Item.CalendarView.Item.Calendar.AllowedCalendarSharingRolesWithUser;
using GraphSdk.Me.Calendars.Item.CalendarView.Item.Calendar.GetSchedule;
...
namespace GraphSdk.Me.Calendars.Item.CalendarView.Item.Calendar {
    /// <summary>Builds and executes requests for operations under \me\calendars\{calendar-id}\calendarView\{event-id}\calendar</summary>
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/calendars/{calendar_id}/calendarView/{event_id}/calendar{?select}";
