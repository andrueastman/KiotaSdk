...
namespace GraphSdk.Me.Calendars.Item.CalendarView.Item.Calendar.GetSchedule {
    ...
    public class GetScheduleRequestBuilder {
        ...
        public async Task<IEnumerable<GraphSdk.Me.Calendars.Item.CalendarView.Item.Calendar.GetSchedule.GetSchedule>> PostAsync(GetScheduleRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendCollectionAsync<GraphSdk.Me.Calendars.Item.CalendarView.Item.Calendar.GetSchedule.GetSchedule>(requestInfo, responseHandler, cancellationToken);
        }
    }
}
