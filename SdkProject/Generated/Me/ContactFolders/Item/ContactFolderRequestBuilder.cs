using GraphSdk.Me.ContactFolders.Item.ChildFolders;
...
namespace GraphSdk.Me.ContactFolders.Item {
    ...
    public class ContactFolderRequestBuilder {
        ...
        public ContactFolderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/contactFolders/{contactFolder_id}{?select}";
