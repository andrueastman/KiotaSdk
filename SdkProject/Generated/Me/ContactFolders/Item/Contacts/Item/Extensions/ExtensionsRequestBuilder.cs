using GraphSdk.Me.ContactFolders.Item.Contacts.Item.Extensions.Item;
...
namespace GraphSdk.Me.ContactFolders.Item.Contacts.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.contactFolders.item.contacts.item.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/contactFolders/{contactFolder_id}/contacts/{contact_id}/extensions{?top,skip,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
