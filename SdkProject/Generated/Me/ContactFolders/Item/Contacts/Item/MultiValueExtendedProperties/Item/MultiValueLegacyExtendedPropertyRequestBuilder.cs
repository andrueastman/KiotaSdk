...
namespace GraphSdk.Me.ContactFolders.Item.Contacts.Item.MultiValueExtendedProperties.Item {
    ...
    public class MultiValueLegacyExtendedPropertyRequestBuilder {
        ...
        public MultiValueLegacyExtendedPropertyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/contactFolders/{contactFolder_id}/contacts/{contact_id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty_id}{?select,expand}";
