using GraphSdk.Me.ContactFolders.Item.Contacts.Item.Photo.Value;
...
namespace GraphSdk.Me.ContactFolders.Item.Contacts.Item.Photo {
    ...
    public class PhotoRequestBuilder {
        ...
        public PhotoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/contactFolders/{contactFolder_id}/contacts/{contact_id}/photo{?select}";
