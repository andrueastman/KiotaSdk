...
namespace GraphSdk.Me.Contacts.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public ExtensionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/contacts/{contact_id}/extensions/{extension_id}{?select,expand}";
