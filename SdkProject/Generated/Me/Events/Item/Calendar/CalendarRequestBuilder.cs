using GraphSdk.Me.Events.Item.Calendar.AllowedCalendarSharingRolesWithUser;
using GraphSdk.Me.Events.Item.Calendar.CalendarPermissions;
using GraphSdk.Me.Events.Item.Calendar.CalendarView;
using GraphSdk.Me.Events.Item.Calendar.Events;
using GraphSdk.Me.Events.Item.Calendar.GetSchedule;
using GraphSdk.Me.Events.Item.Calendar.MultiValueExtendedProperties;
using GraphSdk.Me.Events.Item.Calendar.SingleValueExtendedProperties;
...
namespace GraphSdk.Me.Events.Item.Calendar {
    /// <summary>Builds and executes requests for operations under \me\events\{event-id}\calendar</summary>
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/events/{event_id}/calendar{?select}";
