using GraphSdk.Me.Events.Item.Calendar.CalendarView.Item.Accept;
using GraphSdk.Me.Events.Item.Calendar.CalendarView.Item.Cancel;
using GraphSdk.Me.Events.Item.Calendar.CalendarView.Item.Decline;
using GraphSdk.Me.Events.Item.Calendar.CalendarView.Item.DismissReminder;
using GraphSdk.Me.Events.Item.Calendar.CalendarView.Item.Forward;
using GraphSdk.Me.Events.Item.Calendar.CalendarView.Item.SnoozeReminder;
using GraphSdk.Me.Events.Item.Calendar.CalendarView.Item.TentativelyAccept;
...
namespace GraphSdk.Me.Events.Item.Calendar.CalendarView.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/events/{event_id}/calendar/calendarView/{event_id1}{?select}";
