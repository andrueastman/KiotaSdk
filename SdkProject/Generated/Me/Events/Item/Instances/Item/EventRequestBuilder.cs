using GraphSdk.Me.Events.Item.Instances.Item.Accept;
using GraphSdk.Me.Events.Item.Instances.Item.Cancel;
using GraphSdk.Me.Events.Item.Instances.Item.Decline;
using GraphSdk.Me.Events.Item.Instances.Item.DismissReminder;
using GraphSdk.Me.Events.Item.Instances.Item.Forward;
using GraphSdk.Me.Events.Item.Instances.Item.SnoozeReminder;
using GraphSdk.Me.Events.Item.Instances.Item.TentativelyAccept;
...
namespace GraphSdk.Me.Events.Item.Instances.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/events/{event_id}/instances/{event_id1}{?select}";
