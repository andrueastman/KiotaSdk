using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.CaseExportOperation.GetDownloadUrl;
...
namespace GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.CaseExportOperation {
    /// <summary>Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\lastSharedMethod\microsoft.graph.ediscovery.caseExportOperation</summary>
    public class CaseExportOperationRequestBuilder {
        ...
        public CaseExportOperationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.ediscovery.caseExportOperation";
