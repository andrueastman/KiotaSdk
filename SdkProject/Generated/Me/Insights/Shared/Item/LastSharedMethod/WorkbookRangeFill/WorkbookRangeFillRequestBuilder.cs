using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRangeFill.Clear;
...
namespace GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRangeFill {
    ...
    public class WorkbookRangeFillRequestBuilder {
        ...
        public WorkbookRangeFillRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.workbookRangeFill";
