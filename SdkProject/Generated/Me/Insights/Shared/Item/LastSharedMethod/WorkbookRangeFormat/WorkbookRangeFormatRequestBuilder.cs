using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRangeFormat.AutofitColumns;
using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRangeFormat.AutofitRows;
...
namespace GraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRangeFormat {
    ...
    public class WorkbookRangeFormatRequestBuilder {
        ...
        public WorkbookRangeFormatRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.workbookRangeFormat";
