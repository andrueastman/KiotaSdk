using GraphSdk.Me.Insights.Shared.Item.Resource.ManagedAppProtection.TargetApps;
...
namespace GraphSdk.Me.Insights.Shared.Item.Resource.ManagedAppProtection {
    ...
    public class ManagedAppProtectionRequestBuilder {
        ...
        public ManagedAppProtectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/shared/{sharedInsight_id}/resource/microsoft.graph.managedAppProtection";
