using GraphSdk.Me.Insights.Shared.Item.Resource.CalendarSharingMessage;
using GraphSdk.Me.Insights.Shared.Item.Resource.ManagedAppProtection;
using GraphSdk.Me.Insights.Shared.Item.Resource.MobileAppContentFile;
using GraphSdk.Me.Insights.Shared.Item.Resource.PrintDocument;
using GraphSdk.Me.Insights.Shared.Item.Resource.PrintJob;
using GraphSdk.Me.Insights.Shared.Item.Resource.Ref;
using GraphSdk.Me.Insights.Shared.Item.Resource.ScheduleChangeRequest;
using GraphSdk.Me.Insights.Shared.Item.Resource.TargetedManagedAppProtection;
using GraphSdk.Me.Insights.Shared.Item.Resource.WindowsInformationProtection;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRangeFill;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRangeFormat;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRangeSort;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRangeView;
...
namespace GraphSdk.Me.Insights.Shared.Item.Resource {
    ...
    public class ResourceRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/shared/{sharedInsight_id}/resource{?select,expand}";
