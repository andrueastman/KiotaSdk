using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.BoundingRectWithAnotherRange;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.CellWithRowWithColumn;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.Clear;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.ColumnsAfter;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.ColumnsAfterWithCount;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.ColumnsBefore;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.ColumnsBeforeWithCount;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.ColumnWithColumn;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.Delete;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.EntireColumn;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.EntireRow;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.Insert;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.IntersectionWithAnotherRange;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.LastCell;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.LastColumn;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.LastRow;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.Merge;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.ResizedRangeWithDeltaRowsWithDeltaColumns;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.RowsAbove;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.RowsAboveWithCount;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.RowsBelow;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.RowsBelowWithCount;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.RowWithRow;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.Unmerge;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.UsedRange;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.UsedRangeWithValuesOnly;
using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.VisibleView;
...
namespace GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange {
    ...
    public class WorkbookRangeRequestBuilder {
        ...
        public WorkbookRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/shared/{sharedInsight_id}/resource/microsoft.graph.workbookRange";
