...
namespace GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRangeFormat.AutofitRows {
    ...
    public class AutofitRowsRequestBuilder {
        ...
        public AutofitRowsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/shared/{sharedInsight_id}/resource/microsoft.graph.workbookRangeFormat/microsoft.graph.autofitRows";
