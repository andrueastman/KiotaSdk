using GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRangeSort.Apply;
...
namespace GraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRangeSort {
    ...
    public class WorkbookRangeSortRequestBuilder {
        ...
        public WorkbookRangeSortRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/shared/{sharedInsight_id}/resource/microsoft.graph.workbookRangeSort";
