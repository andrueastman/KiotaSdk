using GraphSdk.Me.Insights.Shared.Item.LastSharedMethod;
using GraphSdk.Me.Insights.Shared.Item.Resource;
...
namespace GraphSdk.Me.Insights.Shared.Item {
    ...
    public class SharedInsightRequestBuilder {
        ...
        public SharedInsightRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/shared/{sharedInsight_id}{?select,expand}";
