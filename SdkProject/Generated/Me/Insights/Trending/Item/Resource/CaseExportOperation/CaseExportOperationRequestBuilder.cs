using GraphSdk.Me.Insights.Trending.Item.Resource.CaseExportOperation.GetDownloadUrl;
...
namespace GraphSdk.Me.Insights.Trending.Item.Resource.CaseExportOperation {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trending-id}\resource\microsoft.graph.ediscovery.caseExportOperation</summary>
    public class CaseExportOperationRequestBuilder {
        ...
        public CaseExportOperationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trending_id}/resource/microsoft.graph.ediscovery.caseExportOperation";
