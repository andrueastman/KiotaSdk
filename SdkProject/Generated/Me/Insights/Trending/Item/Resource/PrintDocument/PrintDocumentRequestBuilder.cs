using GraphSdk.Me.Insights.Trending.Item.Resource.PrintDocument.CreateUploadSession;
...
namespace GraphSdk.Me.Insights.Trending.Item.Resource.PrintDocument {
    ...
    public class PrintDocumentRequestBuilder {
        ...
        public PrintDocumentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/trending/{trending_id}/resource/microsoft.graph.printDocument";
