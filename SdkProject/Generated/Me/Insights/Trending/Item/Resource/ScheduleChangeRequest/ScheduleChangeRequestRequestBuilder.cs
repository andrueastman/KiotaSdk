using GraphSdk.Me.Insights.Trending.Item.Resource.ScheduleChangeRequest.Approve;
using GraphSdk.Me.Insights.Trending.Item.Resource.ScheduleChangeRequest.Decline;
...
namespace GraphSdk.Me.Insights.Trending.Item.Resource.ScheduleChangeRequest {
    ...
    public class ScheduleChangeRequestRequestBuilder {
        ...
        public ScheduleChangeRequestRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/trending/{trending_id}/resource/microsoft.graph.scheduleChangeRequest";
