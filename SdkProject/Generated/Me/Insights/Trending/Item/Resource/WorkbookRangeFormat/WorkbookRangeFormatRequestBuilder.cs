using GraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRangeFormat.AutofitColumns;
using GraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRangeFormat.AutofitRows;
...
namespace GraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRangeFormat {
    ...
    public class WorkbookRangeFormatRequestBuilder {
        ...
        public WorkbookRangeFormatRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/trending/{trending_id}/resource/microsoft.graph.workbookRangeFormat";
