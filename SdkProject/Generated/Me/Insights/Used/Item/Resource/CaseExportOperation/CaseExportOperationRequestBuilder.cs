using GraphSdk.Me.Insights.Used.Item.Resource.CaseExportOperation.GetDownloadUrl;
...
namespace GraphSdk.Me.Insights.Used.Item.Resource.CaseExportOperation {
    /// <summary>Builds and executes requests for operations under \me\insights\used\{usedInsight-id}\resource\microsoft.graph.ediscovery.caseExportOperation</summary>
    public class CaseExportOperationRequestBuilder {
        ...
        public CaseExportOperationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/used/{usedInsight_id}/resource/microsoft.graph.ediscovery.caseExportOperation";
