...
namespace GraphSdk.Me.Insights.Used.Item.Resource.MobileAppContentFile.RenewUpload {
    ...
    public class RenewUploadRequestBuilder {
        ...
        public RenewUploadRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/used/{usedInsight_id}/resource/microsoft.graph.mobileAppContentFile/microsoft.graph.renewUpload";
