using GraphSdk.Me.Insights.Used.Item.Resource.CalendarSharingMessage;
using GraphSdk.Me.Insights.Used.Item.Resource.ManagedAppProtection;
using GraphSdk.Me.Insights.Used.Item.Resource.MobileAppContentFile;
using GraphSdk.Me.Insights.Used.Item.Resource.PrintDocument;
using GraphSdk.Me.Insights.Used.Item.Resource.PrintJob;
using GraphSdk.Me.Insights.Used.Item.Resource.Ref;
using GraphSdk.Me.Insights.Used.Item.Resource.ScheduleChangeRequest;
using GraphSdk.Me.Insights.Used.Item.Resource.TargetedManagedAppProtection;
using GraphSdk.Me.Insights.Used.Item.Resource.WindowsInformationProtection;
using GraphSdk.Me.Insights.Used.Item.Resource.WorkbookRange;
using GraphSdk.Me.Insights.Used.Item.Resource.WorkbookRangeFill;
using GraphSdk.Me.Insights.Used.Item.Resource.WorkbookRangeFormat;
using GraphSdk.Me.Insights.Used.Item.Resource.WorkbookRangeSort;
using GraphSdk.Me.Insights.Used.Item.Resource.WorkbookRangeView;
...
namespace GraphSdk.Me.Insights.Used.Item.Resource {
    ...
    public class ResourceRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/insights/used/{usedInsight_id}/resource{?select,expand}";
