using GraphSdk.Me.MailFolders.Item.ChildFolders.Item.Copy;
using GraphSdk.Me.MailFolders.Item.ChildFolders.Item.Move;
...
namespace GraphSdk.Me.MailFolders.Item.ChildFolders.Item {
    ...
    public class MailFolderRequestBuilder {
        ...
        public MailFolderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/mailFolders/{mailFolder_id}/childFolders/{mailFolder_id1}{?select,expand}";
