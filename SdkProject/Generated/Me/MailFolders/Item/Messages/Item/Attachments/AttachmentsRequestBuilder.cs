using GraphSdk.Me.MailFolders.Item.Messages.Item.Attachments.CreateUploadSession;
using GraphSdk.Me.MailFolders.Item.Messages.Item.Attachments.Item;
...
namespace GraphSdk.Me.MailFolders.Item.Messages.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.mailFolders.item.messages.item.attachments.item collection</summary>
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/mailFolders/{mailFolder_id}/messages/{message_id}/attachments{?top,skip,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
