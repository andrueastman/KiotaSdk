...
namespace GraphSdk.Me.MailFolders.Item.Messages.Item.Move {
    ...
    public class MoveRequestBuilder {
        ...
        public MoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/mailFolders/{mailFolder_id}/messages/{message_id}/microsoft.graph.move";
