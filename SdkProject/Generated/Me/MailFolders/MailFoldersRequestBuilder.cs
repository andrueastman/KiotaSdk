...
namespace GraphSdk.Me.MailFolders {
    ...
    public class MailFoldersRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.mailFolders.item collection</summary>
        ...
        public MailFoldersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/mailFolders{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
