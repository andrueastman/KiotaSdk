...
namespace GraphSdk.Me.ManagedAppRegistrations.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public RefRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/managedAppRegistrations/$ref{?top,skip,search,filter,count,orderby}";
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GraphSdk.Me.ManagedAppRegistrations.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        public async Task<GraphSdk.Me.ManagedAppRegistrations.Ref.Ref> PostAsync(GraphSdk.Me.ManagedAppRegistrations.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<GraphSdk.Me.ManagedAppRegistrations.Ref.Ref>(requestInfo, responseHandler, default, cancellationToken);
        }
