...
namespace GraphSdk.Me.ManagedDevices.Item.DisableLostMode {
    ...
    public class DisableLostModeRequestBuilder {
        ...
        public DisableLostModeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/managedDevices/{managedDevice_id}/microsoft.graph.disableLostMode";
