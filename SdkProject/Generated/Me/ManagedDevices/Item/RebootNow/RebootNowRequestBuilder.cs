...
namespace GraphSdk.Me.ManagedDevices.Item.RebootNow {
    ...
    public class RebootNowRequestBuilder {
        ...
        public RebootNowRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/managedDevices/{managedDevice_id}/microsoft.graph.rebootNow";
