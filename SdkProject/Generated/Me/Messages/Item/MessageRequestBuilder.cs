using GraphSdk.Me.Messages.Item.Attachments;
using GraphSdk.Me.Messages.Item.CalendarSharingMessage;
using GraphSdk.Me.Messages.Item.Copy;
using GraphSdk.Me.Messages.Item.CreateForward;
using GraphSdk.Me.Messages.Item.CreateReply;
using GraphSdk.Me.Messages.Item.CreateReplyAll;
using GraphSdk.Me.Messages.Item.Extensions;
using GraphSdk.Me.Messages.Item.Forward;
using GraphSdk.Me.Messages.Item.Move;
using GraphSdk.Me.Messages.Item.MultiValueExtendedProperties;
using GraphSdk.Me.Messages.Item.Reply;
using GraphSdk.Me.Messages.Item.ReplyAll;
...
namespace GraphSdk.Me.Messages.Item {
    ...
    public class MessageRequestBuilder {
        ...
        public MessageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/messages/{message_id}{?select}";
