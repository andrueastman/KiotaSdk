using GraphSdk.Me.Onenote.Notebooks.Item.CopyNotebook;
using GraphSdk.Me.Onenote.Notebooks.Item.SectionGroups;
using GraphSdk.Me.Onenote.Notebooks.Item.Sections;
...
namespace GraphSdk.Me.Onenote.Notebooks.Item {
    ...
    public class NotebookRequestBuilder {
        ...
        public NotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/notebooks/{notebook_id}{?select,expand}";
