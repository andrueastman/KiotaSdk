using GraphSdk.Me.Onenote.Notebooks.Item.Sections.Item.Pages.Item;
...
namespace GraphSdk.Me.Onenote.Notebooks.Item.Sections.Item.Pages {
    ...
    public class PagesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.onenote.notebooks.item.sections.item.pages.item collection</summary>
        ...
        public PagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/pages{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
