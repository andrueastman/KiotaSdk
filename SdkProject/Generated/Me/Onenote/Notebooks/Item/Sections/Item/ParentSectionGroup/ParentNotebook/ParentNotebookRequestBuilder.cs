using GraphSdk.Me.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup.ParentNotebook.CopyNotebook;
...
namespace GraphSdk.Me.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public ParentNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/parentSectionGroup/parentNotebook{?select,expand}";
