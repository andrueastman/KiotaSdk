using GraphSdk.Me.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup.ParentNotebook;
using GraphSdk.Me.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup.SectionGroups;
using GraphSdk.Me.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup.Sections;
...
namespace GraphSdk.Me.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup {
    ...
    public class ParentSectionGroupRequestBuilder {
        ...
        public ParentSectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/parentSectionGroup{?select,expand}";
