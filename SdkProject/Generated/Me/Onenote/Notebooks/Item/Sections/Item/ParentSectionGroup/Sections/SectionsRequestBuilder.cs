using GraphSdk.Me.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup.Sections.Item;
...
namespace GraphSdk.Me.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.onenote.notebooks.item.sections.item.parentSectionGroup.sections.item collection</summary>
        ...
        public SectionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/parentSectionGroup/sections{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
