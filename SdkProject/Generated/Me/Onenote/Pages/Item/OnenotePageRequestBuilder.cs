using GraphSdk.Me.Onenote.Pages.Item.Content;
using GraphSdk.Me.Onenote.Pages.Item.CopyToSection;
using GraphSdk.Me.Onenote.Pages.Item.OnenotePatchContent;
using GraphSdk.Me.Onenote.Pages.Item.ParentNotebook;
using GraphSdk.Me.Onenote.Pages.Item.ParentSection;
using GraphSdk.Me.Onenote.Pages.Item.Preview;
...
namespace GraphSdk.Me.Onenote.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/pages/{onenotePage_id}{?select,expand}";
