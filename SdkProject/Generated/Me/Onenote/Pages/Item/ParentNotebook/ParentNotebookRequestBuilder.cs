using GraphSdk.Me.Onenote.Pages.Item.ParentNotebook.CopyNotebook;
using GraphSdk.Me.Onenote.Pages.Item.ParentNotebook.SectionGroups;
using GraphSdk.Me.Onenote.Pages.Item.ParentNotebook.Sections;
...
namespace GraphSdk.Me.Onenote.Pages.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public ParentNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/pages/{onenotePage_id}/parentNotebook{?select,expand}";
