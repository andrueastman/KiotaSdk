...
namespace GraphSdk.Me.Onenote.Pages.Item.ParentNotebook.Sections.Item.Pages.Item.CopyToSection {
    ...
    public class CopyToSectionRequestBuilder {
        ...
        public CopyToSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/pages/{onenotePage_id}/parentNotebook/sections/{onenoteSection_id}/pages/{onenotePage_id1}/microsoft.graph.copyToSection";
