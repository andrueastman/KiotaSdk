using GraphSdk.Me.Onenote.Pages.Item.ParentNotebook.Sections.Item.ParentSectionGroup.Sections.Item.CopyToNotebook;
using GraphSdk.Me.Onenote.Pages.Item.ParentNotebook.Sections.Item.ParentSectionGroup.Sections.Item.CopyToSectionGroup;
...
namespace GraphSdk.Me.Onenote.Pages.Item.ParentNotebook.Sections.Item.ParentSectionGroup.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/pages/{onenotePage_id}/parentNotebook/sections/{onenoteSection_id}/parentSectionGroup/sections/{onenoteSection_id1}{?select,expand}";
