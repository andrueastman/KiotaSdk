using GraphSdk.Me.Onenote.Pages.Item.ParentSection.CopyToNotebook;
using GraphSdk.Me.Onenote.Pages.Item.ParentSection.CopyToSectionGroup;
using GraphSdk.Me.Onenote.Pages.Item.ParentSection.Pages;
using GraphSdk.Me.Onenote.Pages.Item.ParentSection.ParentNotebook;
using GraphSdk.Me.Onenote.Pages.Item.ParentSection.ParentSectionGroup;
...
namespace GraphSdk.Me.Onenote.Pages.Item.ParentSection {
    ...
    public class ParentSectionRequestBuilder {
        ...
        public ParentSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/pages/{onenotePage_id}/parentSection{?select,expand}";
