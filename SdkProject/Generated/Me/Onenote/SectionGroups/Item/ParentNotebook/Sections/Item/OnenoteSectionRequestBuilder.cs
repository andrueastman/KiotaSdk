using GraphSdk.Me.Onenote.SectionGroups.Item.ParentNotebook.Sections.Item.CopyToNotebook;
using GraphSdk.Me.Onenote.SectionGroups.Item.ParentNotebook.Sections.Item.CopyToSectionGroup;
using GraphSdk.Me.Onenote.SectionGroups.Item.ParentNotebook.Sections.Item.Pages;
using GraphSdk.Me.Onenote.SectionGroups.Item.ParentNotebook.Sections.Item.ParentNotebook;
using GraphSdk.Me.Onenote.SectionGroups.Item.ParentNotebook.Sections.Item.ParentSectionGroup;
...
namespace GraphSdk.Me.Onenote.SectionGroups.Item.ParentNotebook.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/sectionGroups/{sectionGroup_id}/parentNotebook/sections/{onenoteSection_id}{?select,expand}";
