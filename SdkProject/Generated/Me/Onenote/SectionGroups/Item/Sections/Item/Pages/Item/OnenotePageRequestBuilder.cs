using GraphSdk.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.Content;
using GraphSdk.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.CopyToSection;
using GraphSdk.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.OnenotePatchContent;
using GraphSdk.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.ParentNotebook;
using GraphSdk.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.ParentSection;
using GraphSdk.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.Preview;
...
namespace GraphSdk.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}{?select,expand}";
