using GraphSdk.Me.Onenote.Sections.Item.Pages.Item.ParentNotebook.SectionGroups.Item.ParentNotebook;
using GraphSdk.Me.Onenote.Sections.Item.Pages.Item.ParentNotebook.SectionGroups.Item.ParentSectionGroup;
using GraphSdk.Me.Onenote.Sections.Item.Pages.Item.ParentNotebook.SectionGroups.Item.SectionGroups;
using GraphSdk.Me.Onenote.Sections.Item.Pages.Item.ParentNotebook.SectionGroups.Item.Sections;
...
namespace GraphSdk.Me.Onenote.Sections.Item.Pages.Item.ParentNotebook.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public SectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}{?select,expand}";
