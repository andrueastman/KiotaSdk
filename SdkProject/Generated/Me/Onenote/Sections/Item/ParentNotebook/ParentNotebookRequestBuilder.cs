using GraphSdk.Me.Onenote.Sections.Item.ParentNotebook.CopyNotebook;
using GraphSdk.Me.Onenote.Sections.Item.ParentNotebook.SectionGroups;
using GraphSdk.Me.Onenote.Sections.Item.ParentNotebook.Sections;
...
namespace GraphSdk.Me.Onenote.Sections.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public ParentNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
