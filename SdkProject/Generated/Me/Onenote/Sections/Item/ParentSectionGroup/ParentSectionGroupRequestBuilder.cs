using GraphSdk.Me.Onenote.Sections.Item.ParentSectionGroup.ParentNotebook;
using GraphSdk.Me.Onenote.Sections.Item.ParentSectionGroup.SectionGroups;
using GraphSdk.Me.Onenote.Sections.Item.ParentSectionGroup.Sections;
...
namespace GraphSdk.Me.Onenote.Sections.Item.ParentSectionGroup {
    ...
    public class ParentSectionGroupRequestBuilder {
        ...
        public ParentSectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/sections/{onenoteSection_id}/parentSectionGroup{?select,expand}";
