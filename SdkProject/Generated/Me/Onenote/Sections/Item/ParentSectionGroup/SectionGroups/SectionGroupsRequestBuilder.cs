using GraphSdk.Me.Onenote.Sections.Item.ParentSectionGroup.SectionGroups.Item;
...
namespace GraphSdk.Me.Onenote.Sections.Item.ParentSectionGroup.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.onenote.sections.item.parentSectionGroup.sectionGroups.item collection</summary>
        ...
        public SectionGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/sections/{onenoteSection_id}/parentSectionGroup/sectionGroups{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
