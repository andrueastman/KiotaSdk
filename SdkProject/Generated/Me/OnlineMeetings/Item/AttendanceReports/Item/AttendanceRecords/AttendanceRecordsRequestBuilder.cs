using GraphSdk.Me.OnlineMeetings.Item.AttendanceReports.Item.AttendanceRecords.Item;
...
namespace GraphSdk.Me.OnlineMeetings.Item.AttendanceReports.Item.AttendanceRecords {
    /// <summary>Builds and executes requests for operations under \me\onlineMeetings\{onlineMeeting-id}\attendanceReports\{meetingAttendanceReport-id}\attendanceRecords</summary>
    public class AttendanceRecordsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.me.onlineMeetings.item.attendanceReports.item.attendanceRecords.item collection</summary>
        ...
        public AttendanceRecordsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onlineMeetings/{onlineMeeting_id}/attendanceReports/{meetingAttendanceReport_id}/attendanceRecords{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        public async Task<AttendanceRecordsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<AttendanceRecordsResponse>(requestInfo, responseHandler, cancellationToken);
        }
        /// <summary>
        /// List of attendance records of an attendance report. Read-only.
        /// <param name="body"></param>
