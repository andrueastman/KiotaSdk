using GraphSdk.Me.RegisteredDevices.Ref;
...
namespace GraphSdk.Me.RegisteredDevices {
    ...
    public class RegisteredDevicesRequestBuilder {
        ...
        public RegisteredDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/me/registeredDevices{?top,skip,search,filter,count,orderby,select,expand}";
