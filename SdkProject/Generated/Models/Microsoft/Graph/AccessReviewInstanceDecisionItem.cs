...
namespace GraphSdk.Models.Microsoft.Graph {
    public class AccessReviewInstanceDecisionItem : Entity, IParsable {
        ...
        public GraphSdk.Models.Microsoft.Graph.Identity Principal { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"principal", (o,n) => { (o as AccessReviewInstanceDecisionItem).Principal = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.Identity>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.Identity>("principal", Principal);
