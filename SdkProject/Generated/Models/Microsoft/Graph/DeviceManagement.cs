...
namespace GraphSdk.Models.Microsoft.Graph {
    public class DeviceManagement : Entity, IParsable {
        ...
        public GraphSdk.Models.Microsoft.Graph.ApplePushNotificationCertificate ApplePushNotificationCertificate { get; set; }
        ...
        public List<GraphSdk.Models.Microsoft.Graph.DeviceCategory> DeviceCategories { get; set; }
        ...
        public GraphSdk.Models.Microsoft.Graph.DeviceCompliancePolicyDeviceStateSummary DeviceCompliancePolicyDeviceStateSummary { get; set; }
        ...
        public GraphSdk.Models.Microsoft.Graph.ManagedDeviceOverview ManagedDeviceOverview { get; set; }
        ...
        public List<GraphSdk.Models.Microsoft.Graph.RoleDefinition> RoleDefinitions { get; set; }
        ...
        public GraphSdk.Models.Microsoft.Graph.SoftwareUpdateStatusSummary SoftwareUpdateStatusSummary { get; set; }
        ...
        public List<GraphSdk.Models.Microsoft.Graph.TermsAndConditions> TermsAndConditions { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"applePushNotificationCertificate", (o,n) => { (o as DeviceManagement).ApplePushNotificationCertificate = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.ApplePushNotificationCertificate>(); } },
                ...
                {"deviceCategories", (o,n) => { (o as DeviceManagement).DeviceCategories = n.GetCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.DeviceCategory>().ToList(); } },
                ...
                {"deviceCompliancePolicyDeviceStateSummary", (o,n) => { (o as DeviceManagement).DeviceCompliancePolicyDeviceStateSummary = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.DeviceCompliancePolicyDeviceStateSummary>(); } },
                ...
                {"managedDeviceOverview", (o,n) => { (o as DeviceManagement).ManagedDeviceOverview = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.ManagedDeviceOverview>(); } },
                ...
                {"roleDefinitions", (o,n) => { (o as DeviceManagement).RoleDefinitions = n.GetCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.RoleDefinition>().ToList(); } },
                {"settings", (o,n) => { (o as DeviceManagement).Settings = n.GetObjectValue<DeviceManagementSettings>(); } },
                {"softwareUpdateStatusSummary", (o,n) => { (o as DeviceManagement).SoftwareUpdateStatusSummary = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.SoftwareUpdateStatusSummary>(); } },
                ...
                {"termsAndConditions", (o,n) => { (o as DeviceManagement).TermsAndConditions = n.GetCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.TermsAndConditions>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.ApplePushNotificationCertificate>("applePushNotificationCertificate", ApplePushNotificationCertificate);
            ...
            writer.WriteCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.DeviceCategory>("deviceCategories", DeviceCategories);
            writer.WriteCollectionOfObjectValues<DeviceCompliancePolicy>("deviceCompliancePolicies", DeviceCompliancePolicies);
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.DeviceCompliancePolicyDeviceStateSummary>("deviceCompliancePolicyDeviceStateSummary", DeviceCompliancePolicyDeviceStateSummary);
            ...
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.ManagedDeviceOverview>("managedDeviceOverview", ManagedDeviceOverview);
            ...
            writer.WriteCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.RoleDefinition>("roleDefinitions", RoleDefinitions);
            writer.WriteObjectValue<DeviceManagementSettings>("settings", Settings);
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.SoftwareUpdateStatusSummary>("softwareUpdateStatusSummary", SoftwareUpdateStatusSummary);
            ...
            writer.WriteCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.TermsAndConditions>("termsAndConditions", TermsAndConditions);
