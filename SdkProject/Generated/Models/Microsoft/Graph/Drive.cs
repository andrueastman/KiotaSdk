...
namespace GraphSdk.Models.Microsoft.Graph {
    public class Drive : BaseItem, IParsable {
        ...
        public List<GraphSdk.Models.Microsoft.Graph.DriveItem> Bundles { get; set; }
        ...
        public List<GraphSdk.Models.Microsoft.Graph.DriveItem> Following { get; set; }
        ...
        public List<GraphSdk.Models.Microsoft.Graph.DriveItem> Special { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"bundles", (o,n) => { (o as Drive).Bundles = n.GetCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.DriveItem>().ToList(); } },
                {"driveType", (o,n) => { (o as Drive).DriveType = n.GetStringValue(); } },
                {"following", (o,n) => { (o as Drive).Following = n.GetCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.DriveItem>().ToList(); } },
                {"items", (o,n) => { (o as Drive).Items = n.GetCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.DriveItem>().ToList(); } },
                {"list", (o,n) => { (o as Drive).List = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.List>(); } },
                {"owner", (o,n) => { (o as Drive).Owner = n.GetObjectValue<IdentitySet>(); } },
                {"quota", (o,n) => { (o as Drive).Quota = n.GetObjectValue<Quota>(); } },
                {"root", (o,n) => { (o as Drive).Root = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.DriveItem>(); } },
                {"sharePointIds", (o,n) => { (o as Drive).SharePointIds = n.GetObjectValue<SharepointIds>(); } },
                {"special", (o,n) => { (o as Drive).Special = n.GetCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.DriveItem>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.DriveItem>("bundles", Bundles);
            writer.WriteStringValue("driveType", DriveType);
            writer.WriteCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.DriveItem>("following", Following);
            ...
            writer.WriteCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.DriveItem>("special", Special);
