...
namespace GraphSdk.Models.Microsoft.Graph.Ediscovery {
    public class NoncustodialDataSource : DataSourceContainer, IParsable {
        ...
        public GraphSdk.Models.Microsoft.Graph.Ediscovery.DataSource DataSource { get; set; }
        /// <summary>
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"dataSource", (o,n) => { (o as NoncustodialDataSource).DataSource = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.Ediscovery.DataSource>(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.Ediscovery.DataSource>("dataSource", DataSource);
        }
    }
}
