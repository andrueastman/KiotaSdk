...
namespace GraphSdk.Models.Microsoft.Graph.Ediscovery {
    public class SourceCollection : Entity, IParsable {
        ...
        public List<GraphSdk.Models.Microsoft.Graph.Ediscovery.DataSource> AdditionalSources { get; set; }
        /// <summary>Adds the results of the sourceCollection to the specified reviewSet.</summary>
        public GraphSdk.Models.Microsoft.Graph.Ediscovery.AddToReviewSetOperation AddToReviewSetOperation { get; set; }
        ...
        public List<GraphSdk.Models.Microsoft.Graph.Ediscovery.DataSource> CustodianSources { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"additionalSources", (o,n) => { (o as SourceCollection).AdditionalSources = n.GetCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.Ediscovery.DataSource>().ToList(); } },
                {"addToReviewSetOperation", (o,n) => { (o as SourceCollection).AddToReviewSetOperation = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.Ediscovery.AddToReviewSetOperation>(); } },
                ...
                {"custodianSources", (o,n) => { (o as SourceCollection).CustodianSources = n.GetCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.Ediscovery.DataSource>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.Ediscovery.DataSource>("additionalSources", AdditionalSources);
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.Ediscovery.AddToReviewSetOperation>("addToReviewSetOperation", AddToReviewSetOperation);
            writer.WriteStringValue("contentQuery", ContentQuery);
            writer.WriteObjectValue<IdentitySet>("createdBy", CreatedBy);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.Ediscovery.DataSource>("custodianSources", CustodianSources);
