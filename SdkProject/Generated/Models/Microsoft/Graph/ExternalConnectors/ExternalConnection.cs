...
namespace GraphSdk.Models.Microsoft.Graph.ExternalConnectors {
    public class ExternalConnection : Entity, IParsable {
        ...
        /// <summary>Read-only. Nullable.</summary>
        public GraphSdk.Models.Microsoft.Graph.ExternalConnectors.Schema Schema { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"schema", (o,n) => { (o as ExternalConnection).Schema = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.ExternalConnectors.Schema>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.ExternalConnectors.Schema>("schema", Schema);
