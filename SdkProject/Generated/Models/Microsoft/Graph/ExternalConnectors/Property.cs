...
namespace GraphSdk.Models.Microsoft.Graph.ExternalConnectors {
    public class Property : IParsable {
        ...
        /// <summary>The data type of the property. Possible values are: string, int64, double, dateTime, boolean, stringCollection, int64Collection, doubleCollection, dateTimeCollection, unknownFutureValue.</summary>
