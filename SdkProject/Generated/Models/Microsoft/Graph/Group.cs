...
namespace GraphSdk.Models.Microsoft.Graph {
    public class Group : DirectoryObject, IParsable {
        ...
        /// <summary>Users and groups that are members of this group. HTTP Methods: GET (supported for all groups), POST (supported for Microsoft 365 groups, security groups and mail-enabled security groups), DELETE (supported for Microsoft 365 groups and security groups). Nullable. Supports $expand.</summary>
        ...
        public List<GraphSdk.Models.Microsoft.Graph.Site> Sites { get; set; }
        public GraphSdk.Models.Microsoft.Graph.Team Team { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"calendar", (o,n) => { (o as Group).Calendar = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.Calendar>(); } },
                ...
                {"drive", (o,n) => { (o as Group).Drive = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.Drive>(); } },
                {"drives", (o,n) => { (o as Group).Drives = n.GetCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.Drive>().ToList(); } },
                ...
                {"onenote", (o,n) => { (o as Group).Onenote = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.Onenote>(); } },
                ...
                {"sites", (o,n) => { (o as Group).Sites = n.GetCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.Site>().ToList(); } },
                {"team", (o,n) => { (o as Group).Team = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.Team>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.Site>("sites", Sites);
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.Team>("team", Team);
