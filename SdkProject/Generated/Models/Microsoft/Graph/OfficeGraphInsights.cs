...
namespace GraphSdk.Models.Microsoft.Graph {
    public class OfficeGraphInsights : Entity, IParsable {
        ...
        /// <summary>Access this property from the derived type itemInsights.</summary>
        public List<GraphSdk.Models.Microsoft.Graph.Trending> Trending { get; set; }
        /// <summary>Access this property from the derived type itemInsights.</summary>
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"trending", (o,n) => { (o as OfficeGraphInsights).Trending = n.GetCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.Trending>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<GraphSdk.Models.Microsoft.Graph.Trending>("trending", Trending);
