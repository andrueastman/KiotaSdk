...
namespace GraphSdk.Models.Microsoft.Graph {
    public class UnifiedRoleAssignment : Entity, IParsable {
        ...
        public GraphSdk.Models.Microsoft.Graph.AppScope AppScope { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"appScope", (o,n) => { (o as UnifiedRoleAssignment).AppScope = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.AppScope>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.AppScope>("appScope", AppScope);
