    ...
    public class UnifiedRoleDefinition : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"inheritsPermissionsFrom", (o,n) => { (o as UnifiedRoleDefinition).InheritsPermissionsFrom = n.GetCollectionOfObjectValues<UnifiedRoleDefinition>().ToList(); } },
                ...
                {"rolePermissions", (o,n) => { (o as UnifiedRoleDefinition).RolePermissions = n.GetCollectionOfObjectValues<UnifiedRolePermission>().ToList(); } },
