...
namespace GraphSdk.Models.Microsoft.Graph {
    public class WindowsHelloForBusinessAuthenticationMethod : AuthenticationMethod, IParsable {
        ...
        public GraphSdk.Models.Microsoft.Graph.Device Device { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"device", (o,n) => { (o as WindowsHelloForBusinessAuthenticationMethod).Device = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.Device>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GraphSdk.Models.Microsoft.Graph.Device>("device", Device);
