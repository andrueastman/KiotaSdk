...
using GraphSdk.Oauth2PermissionGrants.Delta;
using GraphSdk.Oauth2PermissionGrants.Item;
...
namespace GraphSdk.Oauth2PermissionGrants {
    ...
    public class Oauth2PermissionGrantsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.oauth2PermissionGrants.item collection</summary>
        ...
        public Oauth2PermissionGrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/oauth2PermissionGrants{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OAuth2PermissionGrant> PostAsync(OAuth2PermissionGrant body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
