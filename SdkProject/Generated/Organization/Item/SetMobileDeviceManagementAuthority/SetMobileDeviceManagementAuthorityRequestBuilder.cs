...
namespace GraphSdk.Organization.Item.SetMobileDeviceManagementAuthority {
    ...
    public class SetMobileDeviceManagementAuthorityRequestBuilder {
        ...
        public SetMobileDeviceManagementAuthorityRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/organization/{organization_id}/microsoft.graph.setMobileDeviceManagementAuthority";
        ...
        /// </summary>
        public async Task<int?> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
