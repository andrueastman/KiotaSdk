...
using GraphSdk.Planner.Buckets.Item;
...
namespace GraphSdk.Planner.Buckets {
    ...
    public class BucketsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.planner.buckets.item collection</summary>
        ...
        public BucketsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/planner/buckets{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
