...
namespace GraphSdk.Policies.PermissionGrantPolicies.Item.Excludes.Item {
    ...
    public class PermissionGrantConditionSetRequestBuilder {
        ...
        public PermissionGrantConditionSetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/policies/permissionGrantPolicies/{permissionGrantPolicy_id}/excludes/{permissionGrantConditionSet_id}{?select,expand}";
