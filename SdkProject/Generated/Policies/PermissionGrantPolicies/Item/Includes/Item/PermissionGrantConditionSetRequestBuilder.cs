...
namespace GraphSdk.Policies.PermissionGrantPolicies.Item.Includes.Item {
    ...
    public class PermissionGrantConditionSetRequestBuilder {
        ...
        public PermissionGrantConditionSetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/policies/permissionGrantPolicies/{permissionGrantPolicy_id}/includes/{permissionGrantConditionSet_id}{?select,expand}";
