using GraphSdk.Print.Printers.Item.Shares.Ref;
...
namespace GraphSdk.Print.Printers.Item.Shares {
    ...
    public class SharesRequestBuilder {
        ...
        public SharesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/print/printers/{printer_id}/shares{?top,skip,search,filter,count,orderby,select,expand}";
