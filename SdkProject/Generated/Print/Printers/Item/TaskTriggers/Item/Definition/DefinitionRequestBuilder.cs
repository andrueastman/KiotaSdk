...
using GraphSdk.Print.Printers.Item.TaskTriggers.Item.Definition.Ref;
...
namespace GraphSdk.Print.Printers.Item.TaskTriggers.Item.Definition {
    ...
    public class DefinitionRequestBuilder {
        ...
        public DefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/print/printers/{printer_id}/taskTriggers/{printTaskTrigger_id}/definition{?select,expand}";
