...
using GraphSdk.Print.Printers.Item.TaskTriggers.Item.Definition;
...
namespace GraphSdk.Print.Printers.Item.TaskTriggers.Item {
    ...
    public class PrintTaskTriggerRequestBuilder {
        ...
        public PrintTaskTriggerRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/print/printers/{printer_id}/taskTriggers/{printTaskTrigger_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(PrintTaskTrigger body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
