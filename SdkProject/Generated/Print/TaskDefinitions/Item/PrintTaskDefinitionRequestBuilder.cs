...
using GraphSdk.Print.TaskDefinitions.Item.Tasks;
...
namespace GraphSdk.Print.TaskDefinitions.Item {
    ...
    public class PrintTaskDefinitionRequestBuilder {
        ...
        public PrintTaskDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/print/taskDefinitions/{printTaskDefinition_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(PrintTaskDefinition body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
