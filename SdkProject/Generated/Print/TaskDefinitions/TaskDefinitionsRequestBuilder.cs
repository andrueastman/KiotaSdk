...
using GraphSdk.Print.TaskDefinitions.Item;
...
namespace GraphSdk.Print.TaskDefinitions {
    ...
    public class TaskDefinitionsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.print.taskDefinitions.item collection</summary>
        ...
        public TaskDefinitionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/print/taskDefinitions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
