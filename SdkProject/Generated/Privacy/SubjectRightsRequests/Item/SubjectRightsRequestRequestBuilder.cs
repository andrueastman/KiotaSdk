...
using GraphSdk.Privacy.SubjectRightsRequests.Item.GetFinalAttachment;
using GraphSdk.Privacy.SubjectRightsRequests.Item.GetFinalReport;
using GraphSdk.Privacy.SubjectRightsRequests.Item.Notes;
using GraphSdk.Privacy.SubjectRightsRequests.Item.Team;
...
namespace GraphSdk.Privacy.SubjectRightsRequests.Item {
    ...
    public class SubjectRightsRequestRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SubjectRightsRequest body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
