...
using GraphSdk.Privacy.SubjectRightsRequests.Item;
...
namespace GraphSdk.Privacy.SubjectRightsRequests {
    ...
    public class SubjectRightsRequestsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.privacy.subjectRightsRequests.item collection</summary>
        ...
        /// </summary>
        public SubjectRightsRequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/privacy/subjectRightsRequests{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public SubjectRightsRequestsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SubjectRightsRequest body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        public async Task<SubjectRightsRequestsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<SubjectRightsRequestsResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to subjectRightsRequests for privacy
        /// <param name="body"></param>
