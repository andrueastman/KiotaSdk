...
namespace GraphSdk.Privacy.SubjectRightsRequests {
    public class SubjectRightsRequestsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as SubjectRightsRequestsResponse).Value = n.GetCollectionOfObjectValues<SubjectRightsRequest>().ToList(); } },
            };
        }
        /// <summary>
