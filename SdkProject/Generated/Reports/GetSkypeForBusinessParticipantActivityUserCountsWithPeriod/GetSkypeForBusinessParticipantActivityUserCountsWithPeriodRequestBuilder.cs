...
namespace GraphSdk.Reports.GetSkypeForBusinessParticipantActivityUserCountsWithPeriod {
    ...
    public class GetSkypeForBusinessParticipantActivityUserCountsWithPeriodRequestBuilder {
        ...
        public GetSkypeForBusinessParticipantActivityUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/reports/microsoft.graph.getSkypeForBusinessParticipantActivityUserCounts(period='{period}')";
