...
namespace GraphSdk.Reports.ManagedDeviceEnrollmentTopFailuresWithPeriod {
    ...
    public class ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder {
        ...
        public ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/reports/microsoft.graph.managedDeviceEnrollmentTopFailures(period='{period}')";
        ...
        /// </summary>
        public async Task<ManagedDeviceEnrollmentTopFailuresWithPeriodResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await RequestAdapter.SendAsync<ManagedDeviceEnrollmentTopFailuresWithPeriodResponse>(requestInfo, responseHandler);
        }
