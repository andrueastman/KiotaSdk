...
using GraphSdk.RoleManagement.Directory.RoleAssignments.Item.DirectoryScope.Ref;
...
namespace GraphSdk.RoleManagement.Directory.RoleAssignments.Item.DirectoryScope {
    ...
    public class DirectoryScopeRequestBuilder {
        ...
        public DirectoryScopeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/roleManagement/directory/roleAssignments/{unifiedRoleAssignment_id}/directoryScope{?select,expand}";
