...
using GraphSdk.RoleManagement.Directory.RoleAssignments.Item.AppScope;
using GraphSdk.RoleManagement.Directory.RoleAssignments.Item.DirectoryScope;
using GraphSdk.RoleManagement.Directory.RoleAssignments.Item.Principal;
using GraphSdk.RoleManagement.Directory.RoleAssignments.Item.RoleDefinition;
...
namespace GraphSdk.RoleManagement.Directory.RoleAssignments.Item {
    ...
    public class UnifiedRoleAssignmentRequestBuilder {
        ...
        public UnifiedRoleAssignmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/roleManagement/directory/roleAssignments/{unifiedRoleAssignment_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UnifiedRoleAssignment> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<UnifiedRoleAssignment>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Resource to grant access to users or groups.
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(UnifiedRoleAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
