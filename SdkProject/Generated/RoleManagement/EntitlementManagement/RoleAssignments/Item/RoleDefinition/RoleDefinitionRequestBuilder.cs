...
using GraphSdk.RoleManagement.EntitlementManagement.RoleAssignments.Item.RoleDefinition.Ref;
...
namespace GraphSdk.RoleManagement.EntitlementManagement.RoleAssignments.Item.RoleDefinition {
    ...
    public class RoleDefinitionRequestBuilder {
        ...
        public RoleDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleAssignments/{unifiedRoleAssignment_id}/roleDefinition{?select,expand}";
