...
namespace GraphSdk.ServicePrincipals.Item.GetMemberObjects {
    ...
    public class GetMemberObjectsRequestBuilder {
        ...
        public GetMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/servicePrincipals/{servicePrincipal_id}/microsoft.graph.getMemberObjects";
        ...
        /// </summary>
        public async Task<IEnumerable<string>> PostAsync(GetMemberObjectsRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
