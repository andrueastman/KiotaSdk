using GraphSdk.ServicePrincipals.Item.Owners.Ref;
...
namespace GraphSdk.ServicePrincipals.Item.Owners {
    ...
    public class OwnersRequestBuilder {
        ...
        public OwnersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/servicePrincipals/{servicePrincipal_id}/owners{?top,skip,search,filter,count,orderby,select,expand}";
