...
namespace GraphSdk.ServicePrincipals.Item.Owners.Ref {
    ...
    public class RefRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<GraphSdk.ServicePrincipals.Item.Owners.Ref.Ref> PostAsync(GraphSdk.ServicePrincipals.Item.Owners.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendAsync<GraphSdk.ServicePrincipals.Item.Owners.Ref.Ref>(requestInfo, responseHandler, default, cancellationToken);
        }
