...
namespace GraphSdk.Shares.Item.DriveItem.Content {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\driveItem\content</summary>
    public class ContentRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/driveItem/content";
