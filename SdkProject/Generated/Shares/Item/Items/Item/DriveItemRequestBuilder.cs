...
using GraphSdk.Shares.Item.Items.Item.Content;
...
namespace GraphSdk.Shares.Item.Items.Item {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\items\{driveItem-id}</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/items/{driveItem_id}{?select,expand}";
