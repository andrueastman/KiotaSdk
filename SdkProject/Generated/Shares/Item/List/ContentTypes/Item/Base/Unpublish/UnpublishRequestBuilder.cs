...
namespace GraphSdk.Shares.Item.List.ContentTypes.Item.Base.Unpublish {
    ...
    public class UnpublishRequestBuilder {
        ...
        public UnpublishRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/list/contentTypes/{contentType_id}/base/microsoft.graph.unpublish";
