using GraphSdk.Shares.Item.List.ContentTypes.Item.ColumnPositions.Ref;
...
namespace GraphSdk.Shares.Item.List.ContentTypes.Item.ColumnPositions {
    ...
    public class ColumnPositionsRequestBuilder {
        ...
        public ColumnPositionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/list/contentTypes/{contentType_id}/columnPositions{?top,skip,search,filter,count,orderby,select,expand}";
