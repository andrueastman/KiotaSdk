...
using GraphSdk.Shares.Item.List.ContentTypes.Item.Columns.Item.SourceColumn.Ref;
...
namespace GraphSdk.Shares.Item.List.ContentTypes.Item.Columns.Item.SourceColumn {
    ...
    public class SourceColumnRequestBuilder {
        ...
        public SourceColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/list/contentTypes/{contentType_id}/columns/{columnDefinition_id}/sourceColumn{?select,expand}";
