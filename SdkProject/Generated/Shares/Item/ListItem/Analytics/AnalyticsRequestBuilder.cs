...
using GraphSdk.Shares.Item.ListItem.Analytics.Ref;
...
namespace GraphSdk.Shares.Item.ListItem.Analytics {
    ...
    public class AnalyticsRequestBuilder {
        ...
        public AnalyticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/listItem/analytics{?select,expand}";
