...
using GraphSdk.Shares.Item.ListItem.Versions.Item.Fields;
using GraphSdk.Shares.Item.ListItem.Versions.Item.RestoreVersion;
...
namespace GraphSdk.Shares.Item.ListItem.Versions.Item {
    ...
    public class ListItemVersionRequestBuilder {
        ...
        public ListItemVersionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/listItem/versions/{listItemVersion_id}{?select,expand}";
