...
using GraphSdk.Shares.Item.Root.Content;
...
namespace GraphSdk.Shares.Item.Root {
    ...
    public class RootRequestBuilder {
        ...
        public RootRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/root{?select,expand}";
