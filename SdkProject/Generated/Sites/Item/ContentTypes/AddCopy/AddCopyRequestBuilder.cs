...
namespace GraphSdk.Sites.Item.ContentTypes.AddCopy {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\contentTypes\microsoft.graph.addCopy</summary>
    public class AddCopyRequestBuilder {
        ...
        public AddCopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/contentTypes/microsoft.graph.addCopy";
