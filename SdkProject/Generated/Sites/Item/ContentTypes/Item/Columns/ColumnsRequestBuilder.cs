...
using GraphSdk.Sites.Item.ContentTypes.Item.Columns.Item;
...
namespace GraphSdk.Sites.Item.ContentTypes.Item.Columns {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\contentTypes\{contentType-id}\columns</summary>
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.sites.item.contentTypes.item.columns.item collection</summary>
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/contentTypes/{contentType_id}/columns{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
