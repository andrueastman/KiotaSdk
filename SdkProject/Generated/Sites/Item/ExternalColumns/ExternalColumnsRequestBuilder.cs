using GraphSdk.Sites.Item.ExternalColumns.Ref;
...
namespace GraphSdk.Sites.Item.ExternalColumns {
    ...
    public class ExternalColumnsRequestBuilder {
        ...
        /// </summary>
        public ExternalColumnsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/sites/{site_id}/externalColumns{?top,skip,search,filter,count,orderby,select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ExternalColumnsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public async Task<ExternalColumnsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<ExternalColumnsResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
