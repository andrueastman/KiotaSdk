using GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.BaseTypes.AddCopy;
using GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.BaseTypes.Ref;
...
namespace GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder {
        ...
        public BaseTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/lists/{list_id}/contentTypes/{contentType_id}/baseTypes{?top,skip,search,filter,count,orderby,select,expand}";
