...
using GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.AssociateWithHubSites;
using GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.Base;
using GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.BaseTypes;
using GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.ColumnLinks;
using GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.ColumnPositions;
using GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.Columns;
using GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.CopyToDefaultContentLocation;
using GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.IsPublished;
using GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.Publish;
using GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.Unpublish;
...
namespace GraphSdk.Sites.Item.Lists.Item.ContentTypes.Item {
    ...
    public class ContentTypeRequestBuilder {
        ...
        public ContentTypeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/lists/{list_id}/contentTypes/{contentType_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ContentType body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
