...
namespace GraphSdk.Sites.Item.Lists.Item.Items.Item.GetActivitiesByInterval {
    ...
    public class GetActivitiesByIntervalRequestBuilder {
        ...
        public async Task<IEnumerable<GraphSdk.Sites.Item.Lists.Item.Items.Item.GetActivitiesByInterval.GetActivitiesByInterval>> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendCollectionAsync<GraphSdk.Sites.Item.Lists.Item.Items.Item.GetActivitiesByInterval.GetActivitiesByInterval>(requestInfo, responseHandler, cancellationToken);
        }
    }
}
