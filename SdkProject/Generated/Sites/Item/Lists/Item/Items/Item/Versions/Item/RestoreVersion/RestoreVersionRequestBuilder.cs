...
namespace GraphSdk.Sites.Item.Lists.Item.Items.Item.Versions.Item.RestoreVersion {
    ...
    public class RestoreVersionRequestBuilder {
        ...
        public RestoreVersionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/lists/{list_id}/items/{listItem_id}/versions/{listItemVersion_id}/microsoft.graph.restoreVersion";
