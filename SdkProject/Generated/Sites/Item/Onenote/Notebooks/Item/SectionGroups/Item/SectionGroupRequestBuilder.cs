...
using GraphSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentNotebook;
using GraphSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentSectionGroup;
using GraphSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups;
using GraphSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections;
...
namespace GraphSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public SectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}{?select,expand}";
