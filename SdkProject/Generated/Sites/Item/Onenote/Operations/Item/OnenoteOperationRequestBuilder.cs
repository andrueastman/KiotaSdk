...
namespace GraphSdk.Sites.Item.Onenote.Operations.Item {
    ...
    public class OnenoteOperationRequestBuilder {
        ...
        public OnenoteOperationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/operations/{onenoteOperation_id}{?select,expand}";
