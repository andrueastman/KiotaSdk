...
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.CopyNotebook;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.SectionGroups;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.Sections;
...
namespace GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public ParentNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/pages/{onenotePage_id}/parentNotebook{?select,expand}";
