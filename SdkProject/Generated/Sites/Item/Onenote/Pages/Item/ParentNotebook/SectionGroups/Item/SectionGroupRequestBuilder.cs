...
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item.ParentNotebook;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item.ParentSectionGroup;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item.SectionGroups;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item.Sections;
...
namespace GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public SectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}{?select,expand}";
