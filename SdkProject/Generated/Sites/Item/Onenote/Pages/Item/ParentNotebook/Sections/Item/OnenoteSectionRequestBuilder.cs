...
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.CopyToNotebook;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.CopyToSectionGroup;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.Pages;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.ParentNotebook;
using GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.ParentSectionGroup;
...
namespace GraphSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/pages/{onenotePage_id}/parentNotebook/sections/{onenoteSection_id}{?select,expand}";
