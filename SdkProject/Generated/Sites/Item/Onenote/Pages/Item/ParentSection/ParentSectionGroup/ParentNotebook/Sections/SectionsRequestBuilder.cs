...
namespace GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.ParentNotebook.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        public SectionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/onenote/pages/{onenotePage_id}/parentSection/parentSectionGroup/parentNotebook/sections{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
