...
namespace GraphSdk.Sites.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.ParentSectionGroup {
    ...
    public class ParentSectionGroupRequestBuilder {
        ...
        public ParentSectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/pages/{onenotePage_id}/parentSection/parentSectionGroup/parentSectionGroup{?select,expand}";
