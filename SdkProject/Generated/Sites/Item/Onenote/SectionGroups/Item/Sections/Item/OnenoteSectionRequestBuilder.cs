...
using GraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToNotebook;
using GraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToSectionGroup;
using GraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.Pages;
using GraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.ParentNotebook;
using GraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.ParentSectionGroup;
...
namespace GraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}{?select,expand}";
