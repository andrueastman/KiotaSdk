...
using GraphSdk.Sites.Item.Onenote.Sections.Item.ParentSectionGroup.ParentNotebook.SectionGroups.Item;
...
namespace GraphSdk.Sites.Item.Onenote.Sections.Item.ParentSectionGroup.ParentNotebook.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.sites.item.onenote.sections.item.parentSectionGroup.parentNotebook.sectionGroups.item collection</summary>
        ...
        public SectionGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/sections/{onenoteSection_id}/parentSectionGroup/parentNotebook/sectionGroups{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
