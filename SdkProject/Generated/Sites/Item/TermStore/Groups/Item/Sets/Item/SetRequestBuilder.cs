...
using GraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Children;
using GraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.ParentGroup;
using GraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Relations;
using GraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms;
...
namespace GraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item {
    ...
    public class SetRequestBuilder {
        ...
        public SetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/groups/{group_id}/sets/{set_id}{?select,expand}";
