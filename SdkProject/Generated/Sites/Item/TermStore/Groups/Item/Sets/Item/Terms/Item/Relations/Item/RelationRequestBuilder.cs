...
using GraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.Item.FromTerm;
using GraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.Item.Set;
using GraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.Item.ToTerm;
...
namespace GraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.Item {
    ...
    public class RelationRequestBuilder {
        ...
        public RelationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/groups/{group_id}/sets/{set_id}/terms/{term_id}/relations/{relation_id}{?select,expand}";
