...
using GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Terms.Item.Children;
using GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Terms.Item.Relations;
using GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Terms.Item.Set;
...
namespace GraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Terms.Item {
    ...
    public class TermRequestBuilder {
        ...
        public TermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/terms/{term_id}{?select,expand}";
