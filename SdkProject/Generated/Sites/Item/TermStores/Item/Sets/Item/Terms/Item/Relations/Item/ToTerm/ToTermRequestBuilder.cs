...
using GraphSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Relations.Item.ToTerm.Ref;
...
namespace GraphSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Relations.Item.ToTerm {
    ...
    public class ToTermRequestBuilder {
        ...
        public ToTermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStores/{store_id}/sets/{set_id}/terms/{term_id}/relations/{relation_id}/toTerm{?select,expand}";
