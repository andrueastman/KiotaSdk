...
using GraphSdk.Teams.Item.Channels.Item.CompleteMigration;
using GraphSdk.Teams.Item.Channels.Item.FilesFolder;
using GraphSdk.Teams.Item.Channels.Item.Members;
using GraphSdk.Teams.Item.Channels.Item.Messages;
using GraphSdk.Teams.Item.Channels.Item.ProvisionEmail;
using GraphSdk.Teams.Item.Channels.Item.RemoveEmail;
using GraphSdk.Teams.Item.Channels.Item.Tabs;
...
namespace GraphSdk.Teams.Item.Channels.Item {
    ...
    public class ChannelRequestBuilder {
        ...
        public ChannelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/channels/{channel_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Channel body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
