...
using GraphSdk.Teams.Item.Channels.Item.Tabs.Item;
...
namespace GraphSdk.Teams.Item.Channels.Item.Tabs {
    ...
    public class TabsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.teams.item.channels.item.tabs.item collection</summary>
        ...
        public TabsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/channels/{channel_id}/tabs{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TeamsTab> PostAsync(TeamsTab body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
