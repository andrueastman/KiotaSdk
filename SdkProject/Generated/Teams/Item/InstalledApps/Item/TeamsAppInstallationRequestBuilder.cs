...
using GraphSdk.Teams.Item.InstalledApps.Item.TeamsApp;
using GraphSdk.Teams.Item.InstalledApps.Item.TeamsAppDefinition;
using GraphSdk.Teams.Item.InstalledApps.Item.Upgrade;
...
namespace GraphSdk.Teams.Item.InstalledApps.Item {
    ...
    public class TeamsAppInstallationRequestBuilder {
        ...
        public TeamsAppInstallationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/installedApps/{teamsAppInstallation_id}{?select,expand}";
