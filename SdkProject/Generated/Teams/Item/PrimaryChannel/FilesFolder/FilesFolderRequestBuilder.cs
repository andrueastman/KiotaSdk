...
using GraphSdk.Teams.Item.PrimaryChannel.FilesFolder.Content;
...
namespace GraphSdk.Teams.Item.PrimaryChannel.FilesFolder {
    ...
    public class FilesFolderRequestBuilder {
        ...
        public FilesFolderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/primaryChannel/filesFolder{?select,expand}";
