...
namespace GraphSdk.Teams.Item.PrimaryChannel.Messages.Item.HostedContents.Item {
    ...
    public class ChatMessageHostedContentRequestBuilder {
        ...
        public ChatMessageHostedContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/primaryChannel/messages/{chatMessage_id}/hostedContents/{chatMessageHostedContent_id}{?select,expand}";
