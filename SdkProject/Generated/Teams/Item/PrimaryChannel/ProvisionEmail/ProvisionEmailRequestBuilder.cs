...
namespace GraphSdk.Teams.Item.PrimaryChannel.ProvisionEmail {
    ...
    public class ProvisionEmailRequestBuilder {
        ...
        public ProvisionEmailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/primaryChannel/microsoft.graph.provisionEmail";
