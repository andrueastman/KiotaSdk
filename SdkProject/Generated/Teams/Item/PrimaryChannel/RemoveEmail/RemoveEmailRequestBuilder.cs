...
namespace GraphSdk.Teams.Item.PrimaryChannel.RemoveEmail {
    ...
    public class RemoveEmailRequestBuilder {
        ...
        public RemoveEmailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/primaryChannel/microsoft.graph.removeEmail";
