...
using GraphSdk.Teams.Item.PrimaryChannel.Tabs.Item.TeamsApp;
...
namespace GraphSdk.Teams.Item.PrimaryChannel.Tabs.Item {
    ...
    public class TeamsTabRequestBuilder {
        ...
        public TeamsTabRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/primaryChannel/tabs/{teamsTab_id}{?select,expand}";
