...
using GraphSdk.Teams.Item.Schedule.OfferShiftRequests;
using GraphSdk.Teams.Item.Schedule.OpenShiftChangeRequests;
using GraphSdk.Teams.Item.Schedule.OpenShifts;
using GraphSdk.Teams.Item.Schedule.SchedulingGroups;
using GraphSdk.Teams.Item.Schedule.Share;
using GraphSdk.Teams.Item.Schedule.Shifts;
using GraphSdk.Teams.Item.Schedule.SwapShiftsChangeRequests;
using GraphSdk.Teams.Item.Schedule.TimeOffReasons;
using GraphSdk.Teams.Item.Schedule.TimeOffRequests;
using GraphSdk.Teams.Item.Schedule.TimesOff;
...
namespace GraphSdk.Teams.Item.Schedule {
    ...
    public class ScheduleRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(GraphSdk.Models.Microsoft.Graph.Schedule body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<GraphSdk.Models.Microsoft.Graph.Schedule> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<GraphSdk.Models.Microsoft.Graph.Schedule>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// The schedule of shifts for this team.
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(GraphSdk.Models.Microsoft.Graph.Schedule body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
