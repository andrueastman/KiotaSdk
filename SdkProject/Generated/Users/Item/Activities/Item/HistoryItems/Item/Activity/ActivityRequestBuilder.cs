...
using GraphSdk.Users.Item.Activities.Item.HistoryItems.Item.Activity.Ref;
...
namespace GraphSdk.Users.Item.Activities.Item.HistoryItems.Item.Activity {
    ...
    public class ActivityRequestBuilder {
        ...
        public ActivityRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/activities/{userActivity_id}/historyItems/{activityHistoryItem_id}/activity{?select,expand}";
