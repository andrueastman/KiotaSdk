...
using GraphSdk.Users.Item.Calendar.AllowedCalendarSharingRolesWithUser;
using GraphSdk.Users.Item.Calendar.CalendarPermissions;
using GraphSdk.Users.Item.Calendar.CalendarView;
using GraphSdk.Users.Item.Calendar.Events;
using GraphSdk.Users.Item.Calendar.GetSchedule;
using GraphSdk.Users.Item.Calendar.MultiValueExtendedProperties;
using GraphSdk.Users.Item.Calendar.SingleValueExtendedProperties;
...
namespace GraphSdk.Users.Item.Calendar {
    ...
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendar{?select}";
