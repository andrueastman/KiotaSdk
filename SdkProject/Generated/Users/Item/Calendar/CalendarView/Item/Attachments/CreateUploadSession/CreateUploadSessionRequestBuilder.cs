...
namespace GraphSdk.Users.Item.Calendar.CalendarView.Item.Attachments.CreateUploadSession {
    ...
    public class CreateUploadSessionRequestBuilder {
        ...
        public CreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendar/calendarView/{event_id}/attachments/microsoft.graph.createUploadSession";
