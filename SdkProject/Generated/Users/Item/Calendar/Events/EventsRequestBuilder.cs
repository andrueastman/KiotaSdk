...
using GraphSdk.Users.Item.Calendar.Events.Item;
...
namespace GraphSdk.Users.Item.Calendar.Events {
    ...
    public class EventsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.users.item.calendar.events.item collection</summary>
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendar/events{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
