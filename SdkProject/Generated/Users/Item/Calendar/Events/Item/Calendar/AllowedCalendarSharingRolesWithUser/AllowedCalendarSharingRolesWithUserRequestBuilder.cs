...
namespace GraphSdk.Users.Item.Calendar.Events.Item.Calendar.AllowedCalendarSharingRolesWithUser {
    ...
    public class AllowedCalendarSharingRolesWithUserRequestBuilder {
        ...
        public AllowedCalendarSharingRolesWithUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string user = default) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendar/events/{event_id}/calendar/microsoft.graph.allowedCalendarSharingRoles(User='{User}')";
