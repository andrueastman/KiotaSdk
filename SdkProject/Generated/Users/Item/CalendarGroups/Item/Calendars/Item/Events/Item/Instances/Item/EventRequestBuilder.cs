...
using GraphSdk.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Accept;
using GraphSdk.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Cancel;
using GraphSdk.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Decline;
using GraphSdk.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.DismissReminder;
using GraphSdk.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Forward;
using GraphSdk.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.SnoozeReminder;
using GraphSdk.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.TentativelyAccept;
...
namespace GraphSdk.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/events/{event_id}/instances/{event_id1}{?select}";
