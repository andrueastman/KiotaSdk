...
using GraphSdk.Users.Item.CalendarView.Item.Calendar.CalendarView.Delta;
using GraphSdk.Users.Item.CalendarView.Item.Calendar.CalendarView.Item;
...
namespace GraphSdk.Users.Item.CalendarView.Item.Calendar.CalendarView {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendarView\{event-id}\calendar\calendarView</summary>
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.users.item.calendarView.item.calendar.calendarView.item collection</summary>
        ...
        public CalendarViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendarView/{event_id}/calendar/calendarView{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
