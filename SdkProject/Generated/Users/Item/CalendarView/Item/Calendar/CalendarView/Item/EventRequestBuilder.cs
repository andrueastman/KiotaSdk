...
using GraphSdk.Users.Item.CalendarView.Item.Calendar.CalendarView.Item.Accept;
using GraphSdk.Users.Item.CalendarView.Item.Calendar.CalendarView.Item.Cancel;
using GraphSdk.Users.Item.CalendarView.Item.Calendar.CalendarView.Item.Decline;
using GraphSdk.Users.Item.CalendarView.Item.Calendar.CalendarView.Item.DismissReminder;
using GraphSdk.Users.Item.CalendarView.Item.Calendar.CalendarView.Item.Forward;
using GraphSdk.Users.Item.CalendarView.Item.Calendar.CalendarView.Item.SnoozeReminder;
using GraphSdk.Users.Item.CalendarView.Item.Calendar.CalendarView.Item.TentativelyAccept;
...
namespace GraphSdk.Users.Item.CalendarView.Item.Calendar.CalendarView.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendarView/{event_id}/calendar/calendarView/{event_id1}{?select}";
