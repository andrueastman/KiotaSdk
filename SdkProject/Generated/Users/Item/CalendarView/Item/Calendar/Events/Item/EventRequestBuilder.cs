...
using GraphSdk.Users.Item.CalendarView.Item.Calendar.Events.Item.DismissReminder;
using GraphSdk.Users.Item.CalendarView.Item.Calendar.Events.Item.Forward;
using GraphSdk.Users.Item.CalendarView.Item.Calendar.Events.Item.SnoozeReminder;
using GraphSdk.Users.Item.CalendarView.Item.Calendar.Events.Item.TentativelyAccept;
...
namespace GraphSdk.Users.Item.CalendarView.Item.Calendar.Events.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendarView/{event_id}/calendar/events/{event_id1}{?select}";
