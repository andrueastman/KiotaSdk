...
using GraphSdk.Users.Item.Calendars.Item.AllowedCalendarSharingRolesWithUser;
using GraphSdk.Users.Item.Calendars.Item.CalendarPermissions;
using GraphSdk.Users.Item.Calendars.Item.CalendarView;
using GraphSdk.Users.Item.Calendars.Item.Events;
using GraphSdk.Users.Item.Calendars.Item.GetSchedule;
using GraphSdk.Users.Item.Calendars.Item.MultiValueExtendedProperties;
using GraphSdk.Users.Item.Calendars.Item.SingleValueExtendedProperties;
...
namespace GraphSdk.Users.Item.Calendars.Item {
    ...
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendars/{calendar_id}{?select}";
