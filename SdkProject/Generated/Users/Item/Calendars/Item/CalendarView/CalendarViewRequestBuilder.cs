...
using GraphSdk.Users.Item.Calendars.Item.CalendarView.Delta;
using GraphSdk.Users.Item.Calendars.Item.CalendarView.Item;
...
namespace GraphSdk.Users.Item.Calendars.Item.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.users.item.calendars.item.calendarView.item collection</summary>
        ...
        public CalendarViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendars/{calendar_id}/calendarView{?startDateTime,endDateTime,top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
