...
using GraphSdk.Users.Item.Calendars.Item.Events.Item.Attachments.CreateUploadSession;
using GraphSdk.Users.Item.Calendars.Item.Events.Item.Attachments.Item;
...
namespace GraphSdk.Users.Item.Calendars.Item.Events.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.users.item.calendars.item.events.item.attachments.item collection</summary>
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendars/{calendar_id}/events/{event_id}/attachments{?top,skip,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
