...
namespace GraphSdk.Users.Item.ContactFolders.Item.ChildFolders.Item {
    ...
    public class ContactFolderRequestBuilder {
        ...
        public ContactFolderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/contactFolders/{contactFolder_id}/childFolders/{contactFolder_id1}{?select,expand}";
