...
using System.IO;
using System.Linq;
namespace GraphSdk.Users.Item.ContactFolders.Item.Contacts.Delta {
    public class Delta : OutlookItem, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"assistantName", (o,n) => { (o as Delta).AssistantName = n.GetStringValue(); } },
                {"birthday", (o,n) => { (o as Delta).Birthday = n.GetDateTimeOffsetValue(); } },
                {"businessAddress", (o,n) => { (o as Delta).BusinessAddress = n.GetObjectValue<PhysicalAddress>(); } },
                {"businessHomePage", (o,n) => { (o as Delta).BusinessHomePage = n.GetStringValue(); } },
                {"businessPhones", (o,n) => { (o as Delta).BusinessPhones = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"children", (o,n) => { (o as Delta).Children = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"companyName", (o,n) => { (o as Delta).CompanyName = n.GetStringValue(); } },
                {"department", (o,n) => { (o as Delta).Department = n.GetStringValue(); } },
                {"displayName", (o,n) => { (o as Delta).DisplayName = n.GetStringValue(); } },
                {"emailAddresses", (o,n) => { (o as Delta).EmailAddresses = n.GetCollectionOfObjectValues<EmailAddress>().ToList(); } },
                {"extensions", (o,n) => { (o as Delta).Extensions = n.GetCollectionOfObjectValues<Extension>().ToList(); } },
                {"fileAs", (o,n) => { (o as Delta).FileAs = n.GetStringValue(); } },
                {"generation", (o,n) => { (o as Delta).Generation = n.GetStringValue(); } },
                {"givenName", (o,n) => { (o as Delta).GivenName = n.GetStringValue(); } },
                {"homeAddress", (o,n) => { (o as Delta).HomeAddress = n.GetObjectValue<PhysicalAddress>(); } },
                {"homePhones", (o,n) => { (o as Delta).HomePhones = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"imAddresses", (o,n) => { (o as Delta).ImAddresses = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"initials", (o,n) => { (o as Delta).Initials = n.GetStringValue(); } },
                {"jobTitle", (o,n) => { (o as Delta).JobTitle = n.GetStringValue(); } },
                {"manager", (o,n) => { (o as Delta).Manager = n.GetStringValue(); } },
                {"middleName", (o,n) => { (o as Delta).MiddleName = n.GetStringValue(); } },
                ...
                {"nickName", (o,n) => { (o as Delta).NickName = n.GetStringValue(); } },
                {"officeLocation", (o,n) => { (o as Delta).OfficeLocation = n.GetStringValue(); } },
                {"otherAddress", (o,n) => { (o as Delta).OtherAddress = n.GetObjectValue<PhysicalAddress>(); } },
                {"parentFolderId", (o,n) => { (o as Delta).ParentFolderId = n.GetStringValue(); } },
                {"personalNotes", (o,n) => { (o as Delta).PersonalNotes = n.GetStringValue(); } },
                {"photo", (o,n) => { (o as Delta).Photo = n.GetObjectValue<ProfilePhoto>(); } },
                {"profession", (o,n) => { (o as Delta).Profession = n.GetStringValue(); } },
                ...
                {"spouseName", (o,n) => { (o as Delta).SpouseName = n.GetStringValue(); } },
                ...
                {"yomiGivenName", (o,n) => { (o as Delta).YomiGivenName = n.GetStringValue(); } },
