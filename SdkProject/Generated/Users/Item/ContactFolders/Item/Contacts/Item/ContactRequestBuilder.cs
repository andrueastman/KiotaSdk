...
using GraphSdk.Users.Item.ContactFolders.Item.Contacts.Item.Extensions;
using GraphSdk.Users.Item.ContactFolders.Item.Contacts.Item.MultiValueExtendedProperties;
using GraphSdk.Users.Item.ContactFolders.Item.Contacts.Item.Photo;
using GraphSdk.Users.Item.ContactFolders.Item.Contacts.Item.SingleValueExtendedProperties;
...
namespace GraphSdk.Users.Item.ContactFolders.Item.Contacts.Item {
    ...
    public class ContactRequestBuilder {
        ...
        public ContactRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/contactFolders/{contactFolder_id}/contacts/{contact_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Contact body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
