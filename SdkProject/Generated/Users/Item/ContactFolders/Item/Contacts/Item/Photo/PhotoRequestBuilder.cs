...
using GraphSdk.Users.Item.ContactFolders.Item.Contacts.Item.Photo.Value;
...
namespace GraphSdk.Users.Item.ContactFolders.Item.Contacts.Item.Photo {
    ...
    public class PhotoRequestBuilder {
        ...
        public PhotoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/contactFolders/{contactFolder_id}/contacts/{contact_id}/photo{?select}";
