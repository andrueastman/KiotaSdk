...
using GraphSdk.Users.Item.Events.Item.Calendar.AllowedCalendarSharingRolesWithUser;
using GraphSdk.Users.Item.Events.Item.Calendar.CalendarPermissions;
using GraphSdk.Users.Item.Events.Item.Calendar.CalendarView;
using GraphSdk.Users.Item.Events.Item.Calendar.Events;
using GraphSdk.Users.Item.Events.Item.Calendar.GetSchedule;
using GraphSdk.Users.Item.Events.Item.Calendar.MultiValueExtendedProperties;
using GraphSdk.Users.Item.Events.Item.Calendar.SingleValueExtendedProperties;
...
namespace GraphSdk.Users.Item.Events.Item.Calendar {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\events\{event-id}\calendar</summary>
    public class CalendarRequestBuilder {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/events/{event_id}/calendar{?select}";
