...
namespace GraphSdk.Users.Item.Events.Item.Calendar.Events.Item.Forward {
    ...
    public class ForwardRequestBuilder {
        ...
        public ForwardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/events/{event_id}/calendar/events/{event_id1}/microsoft.graph.forward";
