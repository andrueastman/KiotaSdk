...
using GraphSdk.Users.Item.Events.Item.Accept;
using GraphSdk.Users.Item.Events.Item.Attachments;
using GraphSdk.Users.Item.Events.Item.Calendar;
using GraphSdk.Users.Item.Events.Item.Cancel;
using GraphSdk.Users.Item.Events.Item.Decline;
using GraphSdk.Users.Item.Events.Item.DismissReminder;
using GraphSdk.Users.Item.Events.Item.Extensions;
using GraphSdk.Users.Item.Events.Item.Forward;
using GraphSdk.Users.Item.Events.Item.Instances;
using GraphSdk.Users.Item.Events.Item.MultiValueExtendedProperties;
using GraphSdk.Users.Item.Events.Item.SingleValueExtendedProperties;
using GraphSdk.Users.Item.Events.Item.SnoozeReminder;
using GraphSdk.Users.Item.Events.Item.TentativelyAccept;
...
namespace GraphSdk.Users.Item.Events.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/events/{event_id}{?select}";
