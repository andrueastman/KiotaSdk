using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.PrintJob.Abort;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.PrintJob.Cancel;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.PrintJob.Redirect;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.PrintJob.Start;
...
namespace GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.PrintJob {
    ...
    public class PrintJobRequestBuilder {
        ...
        public PrintJobRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.printJob";
