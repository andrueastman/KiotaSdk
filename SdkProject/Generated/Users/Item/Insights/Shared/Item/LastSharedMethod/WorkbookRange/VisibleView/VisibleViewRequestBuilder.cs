...
namespace GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.VisibleView {
    ...
    public class VisibleViewRequestBuilder {
        ...
        public VisibleViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.workbookRange/microsoft.graph.visibleView()";
        ...
        /// </summary>
        public async Task<VisibleViewResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await RequestAdapter.SendAsync<VisibleViewResponse>(requestInfo, responseHandler);
        }
