using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.BoundingRectWithAnotherRange;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.CellWithRowWithColumn;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.Clear;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnsAfter;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnsAfterWithCount;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnsBefore;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnsBeforeWithCount;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnWithColumn;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.Delete;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.EntireColumn;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.EntireRow;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.Insert;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.IntersectionWithAnotherRange;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.LastCell;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.LastColumn;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.LastRow;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.Merge;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ResizedRangeWithDeltaRowsWithDeltaColumns;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.RowsAbove;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.RowsAboveWithCount;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.RowsBelow;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.RowsBelowWithCount;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.RowWithRow;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.Unmerge;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.UsedRange;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.UsedRangeWithValuesOnly;
using GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.VisibleView;
...
namespace GraphSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange {
    ...
    public class WorkbookRangeRequestBuilder {
        ...
        public WorkbookRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.workbookRange";
