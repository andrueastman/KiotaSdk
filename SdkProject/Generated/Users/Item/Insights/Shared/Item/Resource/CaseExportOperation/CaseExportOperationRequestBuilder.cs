using GraphSdk.Users.Item.Insights.Shared.Item.Resource.CaseExportOperation.GetDownloadUrl;
...
namespace GraphSdk.Users.Item.Insights.Shared.Item.Resource.CaseExportOperation {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\shared\{sharedInsight-id}\resource\microsoft.graph.ediscovery.caseExportOperation</summary>
    public class CaseExportOperationRequestBuilder {
        ...
        public CaseExportOperationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/shared/{sharedInsight_id}/resource/microsoft.graph.ediscovery.caseExportOperation";
