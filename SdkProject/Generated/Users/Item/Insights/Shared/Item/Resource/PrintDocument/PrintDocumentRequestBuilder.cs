using GraphSdk.Users.Item.Insights.Shared.Item.Resource.PrintDocument.CreateUploadSession;
...
namespace GraphSdk.Users.Item.Insights.Shared.Item.Resource.PrintDocument {
    ...
    public class PrintDocumentRequestBuilder {
        ...
        public PrintDocumentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/shared/{sharedInsight_id}/resource/microsoft.graph.printDocument";
