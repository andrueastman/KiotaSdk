...
namespace GraphSdk.Users.Item.Insights.Shared.Item.Resource.WorkbookRange.LastRow {
    ...
    public class LastRowRequestBuilder {
        ...
        public LastRowRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/shared/{sharedInsight_id}/resource/microsoft.graph.workbookRange/microsoft.graph.lastRow()";
