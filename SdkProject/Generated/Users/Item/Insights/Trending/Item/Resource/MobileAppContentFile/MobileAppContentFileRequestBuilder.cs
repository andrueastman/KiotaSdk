using GraphSdk.Users.Item.Insights.Trending.Item.Resource.MobileAppContentFile.Commit;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.MobileAppContentFile.RenewUpload;
...
namespace GraphSdk.Users.Item.Insights.Trending.Item.Resource.MobileAppContentFile {
    ...
    public class MobileAppContentFileRequestBuilder {
        ...
        public MobileAppContentFileRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/trending/{trending_id}/resource/microsoft.graph.mobileAppContentFile";
