using GraphSdk.Users.Item.Insights.Trending.Item.Resource.PrintJob.Abort;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.PrintJob.Cancel;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.PrintJob.Redirect;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.PrintJob.Start;
...
namespace GraphSdk.Users.Item.Insights.Trending.Item.Resource.PrintJob {
    ...
    public class PrintJobRequestBuilder {
        ...
        public PrintJobRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/trending/{trending_id}/resource/microsoft.graph.printJob";
