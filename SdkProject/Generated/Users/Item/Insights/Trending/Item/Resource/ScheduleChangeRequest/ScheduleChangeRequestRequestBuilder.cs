using GraphSdk.Users.Item.Insights.Trending.Item.Resource.ScheduleChangeRequest.Approve;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.ScheduleChangeRequest.Decline;
...
namespace GraphSdk.Users.Item.Insights.Trending.Item.Resource.ScheduleChangeRequest {
    ...
    public class ScheduleChangeRequestRequestBuilder {
        ...
        public ScheduleChangeRequestRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/trending/{trending_id}/resource/microsoft.graph.scheduleChangeRequest";
