using GraphSdk.Users.Item.Insights.Trending.Item.Resource.TargetedManagedAppProtection.Assign;
using GraphSdk.Users.Item.Insights.Trending.Item.Resource.TargetedManagedAppProtection.TargetApps;
...
namespace GraphSdk.Users.Item.Insights.Trending.Item.Resource.TargetedManagedAppProtection {
    ...
    public class TargetedManagedAppProtectionRequestBuilder {
        ...
        public TargetedManagedAppProtectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/trending/{trending_id}/resource/microsoft.graph.targetedManagedAppProtection";
