...
namespace GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.RowsAbove {
    ...
    public class RowsAboveRequestBuilder {
        ...
        public RowsAboveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/trending/{trending_id}/resource/microsoft.graph.workbookRange/microsoft.graph.rowsAbove()";
