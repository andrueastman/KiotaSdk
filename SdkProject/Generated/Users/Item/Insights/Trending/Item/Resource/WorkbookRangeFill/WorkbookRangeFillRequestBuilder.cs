using GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRangeFill.Clear;
...
namespace GraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRangeFill {
    ...
    public class WorkbookRangeFillRequestBuilder {
        ...
        public WorkbookRangeFillRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/trending/{trending_id}/resource/microsoft.graph.workbookRangeFill";
