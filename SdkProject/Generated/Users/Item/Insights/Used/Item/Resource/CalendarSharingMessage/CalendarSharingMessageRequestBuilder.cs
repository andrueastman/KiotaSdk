using GraphSdk.Users.Item.Insights.Used.Item.Resource.CalendarSharingMessage.Accept;
...
namespace GraphSdk.Users.Item.Insights.Used.Item.Resource.CalendarSharingMessage {
    ...
    public class CalendarSharingMessageRequestBuilder {
        ...
        public CalendarSharingMessageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/used/{usedInsight_id}/resource/microsoft.graph.calendarSharingMessage";
