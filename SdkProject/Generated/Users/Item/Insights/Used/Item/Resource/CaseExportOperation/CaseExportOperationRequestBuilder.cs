using GraphSdk.Users.Item.Insights.Used.Item.Resource.CaseExportOperation.GetDownloadUrl;
...
namespace GraphSdk.Users.Item.Insights.Used.Item.Resource.CaseExportOperation {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\used\{usedInsight-id}\resource\microsoft.graph.ediscovery.caseExportOperation</summary>
    public class CaseExportOperationRequestBuilder {
        ...
        public CaseExportOperationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/used/{usedInsight_id}/resource/microsoft.graph.ediscovery.caseExportOperation";
