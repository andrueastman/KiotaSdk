using GraphSdk.Users.Item.Insights.Used.Item.Resource.PrintJob.Abort;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.PrintJob.Cancel;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.PrintJob.Redirect;
using GraphSdk.Users.Item.Insights.Used.Item.Resource.PrintJob.Start;
...
namespace GraphSdk.Users.Item.Insights.Used.Item.Resource.PrintJob {
    ...
    public class PrintJobRequestBuilder {
        ...
        public PrintJobRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/used/{usedInsight_id}/resource/microsoft.graph.printJob";
