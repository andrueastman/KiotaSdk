...
namespace GraphSdk.Users.Item.Insights.Used.Item.Resource.PrintJob.Redirect {
    ...
    public class RedirectRequestBuilder {
        ...
        public RedirectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/used/{usedInsight_id}/resource/microsoft.graph.printJob/microsoft.graph.redirect";
