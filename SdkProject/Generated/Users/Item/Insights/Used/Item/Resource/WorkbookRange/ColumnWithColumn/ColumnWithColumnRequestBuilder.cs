...
namespace GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnWithColumn {
    ...
    public class ColumnWithColumnRequestBuilder {
        ...
        public ColumnWithColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? column = default) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/used/{usedInsight_id}/resource/microsoft.graph.workbookRange/microsoft.graph.column(column={column})";
