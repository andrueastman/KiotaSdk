...
namespace GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRangeFormat.AutofitRows {
    ...
    public class AutofitRowsRequestBuilder {
        ...
        public AutofitRowsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/used/{usedInsight_id}/resource/microsoft.graph.workbookRangeFormat/microsoft.graph.autofitRows";
