using GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRangeView.Range;
...
namespace GraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRangeView {
    ...
    public class WorkbookRangeViewRequestBuilder {
        ...
        public WorkbookRangeViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/insights/used/{usedInsight_id}/resource/microsoft.graph.workbookRangeView";
