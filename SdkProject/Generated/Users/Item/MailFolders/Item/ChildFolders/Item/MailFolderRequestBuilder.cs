...
namespace GraphSdk.Users.Item.MailFolders.Item.ChildFolders.Item {
    ...
    public class MailFolderRequestBuilder {
        ...
        public MailFolderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/mailFolders/{mailFolder_id}/childFolders/{mailFolder_id1}{?select,expand}";
