...
using GraphSdk.Users.Item.MailFolders.Item.Messages;
using GraphSdk.Users.Item.MailFolders.Item.Move;
using GraphSdk.Users.Item.MailFolders.Item.MultiValueExtendedProperties;
using GraphSdk.Users.Item.MailFolders.Item.SingleValueExtendedProperties;
...
namespace GraphSdk.Users.Item.MailFolders.Item {
    ...
    public class MailFolderRequestBuilder {
        ...
        public MailFolderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/mailFolders/{mailFolder_id}{?select}";
