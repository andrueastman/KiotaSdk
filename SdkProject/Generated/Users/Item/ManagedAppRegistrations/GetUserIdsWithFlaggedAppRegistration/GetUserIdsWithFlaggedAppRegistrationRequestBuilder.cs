...
namespace GraphSdk.Users.Item.ManagedAppRegistrations.GetUserIdsWithFlaggedAppRegistration {
    ...
    public class GetUserIdsWithFlaggedAppRegistrationRequestBuilder {
        ...
        public GetUserIdsWithFlaggedAppRegistrationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/managedAppRegistrations/microsoft.graph.getUserIdsWithFlaggedAppRegistration()";
