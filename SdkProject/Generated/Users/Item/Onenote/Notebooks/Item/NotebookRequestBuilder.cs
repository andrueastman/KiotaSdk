...
using GraphSdk.Users.Item.Onenote.Notebooks.Item.CopyNotebook;
using GraphSdk.Users.Item.Onenote.Notebooks.Item.SectionGroups;
using GraphSdk.Users.Item.Onenote.Notebooks.Item.Sections;
...
namespace GraphSdk.Users.Item.Onenote.Notebooks.Item {
    ...
    public class NotebookRequestBuilder {
        ...
        public NotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/notebooks/{notebook_id}{?select,expand}";
