...
using GraphSdk.Users.Item.Onenote.Notebooks.GetNotebookFromWebUrl;
using GraphSdk.Users.Item.Onenote.Notebooks.GetRecentNotebooksWithIncludePersonalNotebooks;
using GraphSdk.Users.Item.Onenote.Notebooks.Item;
...
namespace GraphSdk.Users.Item.Onenote.Notebooks {
    ...
    public class NotebooksRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.users.item.onenote.notebooks.item collection</summary>
        ...
        public NotebooksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/notebooks{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
