...
using GraphSdk.Users.Item.Onenote.Pages.Item.Content;
using GraphSdk.Users.Item.Onenote.Pages.Item.CopyToSection;
using GraphSdk.Users.Item.Onenote.Pages.Item.OnenotePatchContent;
using GraphSdk.Users.Item.Onenote.Pages.Item.ParentNotebook;
using GraphSdk.Users.Item.Onenote.Pages.Item.ParentSection;
using GraphSdk.Users.Item.Onenote.Pages.Item.Preview;
...
namespace GraphSdk.Users.Item.Onenote.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/pages/{onenotePage_id}{?select,expand}";
