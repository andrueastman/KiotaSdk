...
using GraphSdk.Users.Item.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item.SectionGroups.Item;
...
namespace GraphSdk.Users.Item.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.users.item.onenote.pages.item.parentNotebook.sectionGroups.item.sectionGroups.item collection</summary>
        ...
        public SectionGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/sectionGroups{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
