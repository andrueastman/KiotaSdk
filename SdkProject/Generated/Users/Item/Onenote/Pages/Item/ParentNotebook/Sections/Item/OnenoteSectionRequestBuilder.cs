...
using GraphSdk.Users.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.CopyToNotebook;
using GraphSdk.Users.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.CopyToSectionGroup;
using GraphSdk.Users.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.Pages;
using GraphSdk.Users.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.ParentNotebook;
using GraphSdk.Users.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.ParentSectionGroup;
...
namespace GraphSdk.Users.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/pages/{onenotePage_id}/parentNotebook/sections/{onenoteSection_id}{?select,expand}";
