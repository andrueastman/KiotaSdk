...
using GraphSdk.Users.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.SectionGroups.Item;
...
namespace GraphSdk.Users.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.users.item.onenote.pages.item.parentSection.parentSectionGroup.sectionGroups.item collection</summary>
        ...
        public SectionGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/pages/{onenotePage_id}/parentSection/parentSectionGroup/sectionGroups{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
