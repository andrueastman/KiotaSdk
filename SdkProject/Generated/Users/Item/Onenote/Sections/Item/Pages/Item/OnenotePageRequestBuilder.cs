...
using GraphSdk.Users.Item.Onenote.Sections.Item.Pages.Item.Content;
using GraphSdk.Users.Item.Onenote.Sections.Item.Pages.Item.CopyToSection;
using GraphSdk.Users.Item.Onenote.Sections.Item.Pages.Item.OnenotePatchContent;
using GraphSdk.Users.Item.Onenote.Sections.Item.Pages.Item.ParentNotebook;
using GraphSdk.Users.Item.Onenote.Sections.Item.Pages.Item.ParentSection;
using GraphSdk.Users.Item.Onenote.Sections.Item.Pages.Item.Preview;
...
namespace GraphSdk.Users.Item.Onenote.Sections.Item.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}{?select,expand}";
