...
using GraphSdk.Users.Item.Onenote.Sections.Item.Pages.Item.ParentSection.CopyToNotebook;
using GraphSdk.Users.Item.Onenote.Sections.Item.Pages.Item.ParentSection.CopyToSectionGroup;
...
namespace GraphSdk.Users.Item.Onenote.Sections.Item.Pages.Item.ParentSection {
    ...
    public class ParentSectionRequestBuilder {
        ...
        public ParentSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentSection{?select,expand}";
