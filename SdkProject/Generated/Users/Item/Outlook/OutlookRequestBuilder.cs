...
using GraphSdk.Users.Item.Outlook.MasterCategories;
using GraphSdk.Users.Item.Outlook.SupportedLanguages;
using GraphSdk.Users.Item.Outlook.SupportedTimeZones;
using GraphSdk.Users.Item.Outlook.SupportedTimeZonesWithTimeZoneStandard;
...
namespace GraphSdk.Users.Item.Outlook {
    ...
    public class OutlookRequestBuilder {
        ...
        public OutlookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/outlook{?select}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OutlookUser> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(OutlookUser body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
