...
namespace GraphSdk.Users.Item.Outlook.SupportedTimeZonesWithTimeZoneStandard {
    ...
    public class SupportedTimeZonesWithTimeZoneStandardRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<GraphSdk.Users.Item.Outlook.SupportedTimeZonesWithTimeZoneStandard.SupportedTimeZonesWithTimeZoneStandard>> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await RequestAdapter.SendCollectionAsync<GraphSdk.Users.Item.Outlook.SupportedTimeZonesWithTimeZoneStandard.SupportedTimeZonesWithTimeZoneStandard>(requestInfo, responseHandler, cancellationToken);
        }
    }
}
