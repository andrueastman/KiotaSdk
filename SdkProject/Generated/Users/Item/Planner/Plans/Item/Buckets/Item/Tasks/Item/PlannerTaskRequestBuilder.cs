...
using GraphSdk.Users.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.AssignedToTaskBoardFormat;
using GraphSdk.Users.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.BucketTaskBoardFormat;
using GraphSdk.Users.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.Details;
using GraphSdk.Users.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.ProgressTaskBoardFormat;
...
namespace GraphSdk.Users.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item {
    ...
    public class PlannerTaskRequestBuilder {
        ...
        public PlannerTaskRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/planner/plans/{plannerPlan_id}/buckets/{plannerBucket_id}/tasks/{plannerTask_id}{?select,expand}";
