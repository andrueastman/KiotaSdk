using GraphSdk.Users.Item.RegisteredDevices.Ref;
...
namespace GraphSdk.Users.Item.RegisteredDevices {
    ...
    public class RegisteredDevicesRequestBuilder {
        ...
        public RegisteredDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/registeredDevices{?top,skip,search,filter,count,orderby,select,expand}";
