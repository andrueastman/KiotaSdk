...
using GraphSdk.Workbooks.Item.Analytics.Ref;
...
namespace GraphSdk.Workbooks.Item.Analytics {
    ...
    public class AnalyticsRequestBuilder {
        ...
        public AnalyticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/analytics{?select,expand}";
