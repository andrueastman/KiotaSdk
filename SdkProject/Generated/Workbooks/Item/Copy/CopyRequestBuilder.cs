...
namespace GraphSdk.Workbooks.Item.Copy {
    ...
    public class CopyRequestBuilder {
        ...
        public CopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/microsoft.graph.copy";
        ...
        public class CopyResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"driveItem", (o,n) => { (o as CopyResponse).DriveItem = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.DriveItem>(); } },
                };
            }
            /// <summary>
