...
namespace GraphSdk.Workbooks.Item.Follow {
    ...
    public class FollowRequestBuilder {
        ...
        public FollowRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/microsoft.graph.follow";
        ...
        public class FollowResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"driveItem", (o,n) => { (o as FollowResponse).DriveItem = n.GetObjectValue<GraphSdk.Models.Microsoft.Graph.DriveItem>(); } },
                };
            }
            /// <summary>
