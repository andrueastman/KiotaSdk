...
namespace GraphSdk.Workbooks.Item.Workbook.Functions.Bitand {
    public class BitandRequestBody : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"number1", (o,n) => { (o as BitandRequestBody).Number1 = n.GetObjectValue<Json>(); } },
                {"number2", (o,n) => { (o as BitandRequestBody).Number2 = n.GetObjectValue<Json>(); } },
            };
        }
        /// <summary>
