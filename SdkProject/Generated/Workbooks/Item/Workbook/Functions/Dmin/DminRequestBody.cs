...
namespace GraphSdk.Workbooks.Item.Workbook.Functions.Dmin {
    public class DminRequestBody : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"criteria", (o,n) => { (o as DminRequestBody).Criteria = n.GetObjectValue<Json>(); } },
                {"database", (o,n) => { (o as DminRequestBody).Database = n.GetObjectValue<Json>(); } },
                {"field", (o,n) => { (o as DminRequestBody).Field = n.GetObjectValue<Json>(); } },
            };
        }
        /// <summary>
