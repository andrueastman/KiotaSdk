...
namespace GraphSdk.Workbooks.Item.Workbook.Functions.Dproduct {
    public class DproductRequestBody : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"criteria", (o,n) => { (o as DproductRequestBody).Criteria = n.GetObjectValue<Json>(); } },
                {"database", (o,n) => { (o as DproductRequestBody).Database = n.GetObjectValue<Json>(); } },
                {"field", (o,n) => { (o as DproductRequestBody).Field = n.GetObjectValue<Json>(); } },
            };
        }
        /// <summary>
