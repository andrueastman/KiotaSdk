...
namespace GraphSdk.Workbooks.Item.Workbook.Functions.ImSub {
    public class ImSubRequestBody : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"inumber1", (o,n) => { (o as ImSubRequestBody).Inumber1 = n.GetObjectValue<Json>(); } },
                {"inumber2", (o,n) => { (o as ImSubRequestBody).Inumber2 = n.GetObjectValue<Json>(); } },
            };
        }
        /// <summary>
