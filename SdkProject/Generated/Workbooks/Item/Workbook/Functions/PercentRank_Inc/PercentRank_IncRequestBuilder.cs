...
namespace GraphSdk.Workbooks.Item.Workbook.Functions.PercentRank_Inc {
    ...
    public class PercentRank_IncRequestBuilder {
        ...
        public PercentRank_IncRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.percentRank_Inc";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(PercentRank_IncRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        public async Task<PercentRank_IncResponse> PostAsync(PercentRank_IncRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<PercentRank_IncResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
