...
namespace GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Axes.SeriesAxis.Format.Line.Clear {
    ...
    public class ClearRequestBuilder {
        ...
        public ClearRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/axes/seriesAxis/format/line/microsoft.graph.clear";
