...
namespace GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.ImageWithWidthWithHeightWithFittingMode {
    ...
    public class ImageWithWidthWithHeightWithFittingModeRequestBuilder {
        ...
        public ImageWithWidthWithHeightWithFittingModeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? width = default, int? height = default, string fittingMode = default) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/microsoft.graph.image(width={width},height={height},fittingMode='{fittingMode}')";
