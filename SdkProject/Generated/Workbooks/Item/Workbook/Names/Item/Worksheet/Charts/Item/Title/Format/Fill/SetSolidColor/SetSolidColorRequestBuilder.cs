...
namespace GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Title.Format.Fill.SetSolidColor {
    ...
    public class SetSolidColorRequestBuilder {
        ...
        public SetSolidColorRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/title/format/fill/microsoft.graph.setSolidColor";
