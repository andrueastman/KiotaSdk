...
namespace GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Protection.Protect {
    ...
    public class ProtectRequestBuilder {
        ...
        public ProtectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/protection/microsoft.graph.protect";
