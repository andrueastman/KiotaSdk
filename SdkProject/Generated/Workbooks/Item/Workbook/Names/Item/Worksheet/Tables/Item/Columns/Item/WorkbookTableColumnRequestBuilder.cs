...
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Columns.Item.DataBodyRange;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Columns.Item.Filter;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Columns.Item.HeaderRowRange;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Columns.Item.Range;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Columns.Item.TotalRowRange;
...
namespace GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Columns.Item {
    ...
    public class WorkbookTableColumnRequestBuilder {
        ...
        public WorkbookTableColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/tables/{workbookTable_id}/columns/{workbookTableColumn_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(WorkbookTableColumn body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
