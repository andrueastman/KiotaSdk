...
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.ClearFilters;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Columns;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.ConvertToRange;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.DataBodyRange;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.HeaderRowRange;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Range;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.ReapplyFilters;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Rows;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Sort;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.TotalRowRange;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Worksheet;
...
namespace GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item {
    ...
    public class WorkbookTableRequestBuilder {
        ...
        public WorkbookTableRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/tables/{workbookTable_id}{?select,expand}";
