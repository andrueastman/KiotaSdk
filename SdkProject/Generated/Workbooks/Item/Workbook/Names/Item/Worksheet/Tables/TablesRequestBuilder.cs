...
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Add;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Count;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item;
using GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.ItemAtWithIndex;
...
namespace GraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables {
    ...
    public class TablesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.workbooks.item.workbook.names.item.worksheet.tables.item collection</summary>
        ...
        public TablesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/tables{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
