...
namespace GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.ItemWithName {
    ...
    public class ItemWithNameRequestBuilder {
        ...
        public ItemWithNameRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string name = default) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/microsoft.graph.item(name='{name}')";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ItemWithNameRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
