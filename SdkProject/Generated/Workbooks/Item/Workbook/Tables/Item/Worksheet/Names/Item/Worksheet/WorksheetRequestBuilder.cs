...
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Names.Item.Worksheet.CellWithRowWithColumn;
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Names.Item.Worksheet.Range;
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Names.Item.Worksheet.RangeWithAddress;
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Names.Item.Worksheet.UsedRange;
using GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Names.Item.Worksheet.UsedRangeWithValuesOnly;
...
namespace GraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Names.Item.Worksheet {
    ...
    public class WorksheetRequestBuilder {
        ...
        public WorksheetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/names/{workbookNamedItem_id}/worksheet{?select,expand}";
