...
using GraphSdk.Workbooks.Item.Workbook.Tables.Add;
using GraphSdk.Workbooks.Item.Workbook.Tables.Count;
using GraphSdk.Workbooks.Item.Workbook.Tables.Item;
using GraphSdk.Workbooks.Item.Workbook.Tables.ItemAtWithIndex;
...
namespace GraphSdk.Workbooks.Item.Workbook.Tables {
    ...
    public class TablesRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.workbooks.item.workbook.tables.item collection</summary>
        ...
        public TablesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
