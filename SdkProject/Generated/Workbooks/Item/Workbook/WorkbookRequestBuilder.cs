...
using GraphSdk.Workbooks.Item.Workbook.Application;
using GraphSdk.Workbooks.Item.Workbook.CloseSession;
using GraphSdk.Workbooks.Item.Workbook.Comments;
using GraphSdk.Workbooks.Item.Workbook.CreateSession;
using GraphSdk.Workbooks.Item.Workbook.Functions;
using GraphSdk.Workbooks.Item.Workbook.Names;
using GraphSdk.Workbooks.Item.Workbook.Operations;
using GraphSdk.Workbooks.Item.Workbook.RefreshSession;
using GraphSdk.Workbooks.Item.Workbook.SessionInfoResourceWithKey;
using GraphSdk.Workbooks.Item.Workbook.TableRowOperationResultWithKey;
using GraphSdk.Workbooks.Item.Workbook.Tables;
using GraphSdk.Workbooks.Item.Workbook.Worksheets;
...
namespace GraphSdk.Workbooks.Item.Workbook {
    ...
    public class WorkbookRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(GraphSdk.Models.Microsoft.Graph.Workbook body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<GraphSdk.Models.Microsoft.Graph.Workbook> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<GraphSdk.Models.Microsoft.Graph.Workbook>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// For files that are Excel spreadsheets, accesses the workbook API to work with the spreadsheet's contents. Nullable.
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(GraphSdk.Models.Microsoft.Graph.Workbook body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
