...
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Series.Item.Points.Count;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Series.Item.Points.Item;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Series.Item.Points.ItemAtWithIndex;
...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Series.Item.Points {
    ...
    public class PointsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.workbooks.item.workbook.worksheets.item.charts.item.series.item.points.item collection</summary>
        ...
        public PointsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/series/{workbookChartSeries_id}/points{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
