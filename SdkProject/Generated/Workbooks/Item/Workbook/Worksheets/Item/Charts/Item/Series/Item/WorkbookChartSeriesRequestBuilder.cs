...
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Series.Item.Format;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Series.Item.Points;
...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Series.Item {
    ...
    public class WorkbookChartSeriesRequestBuilder {
        ...
        public WorkbookChartSeriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/series/{workbookChartSeries_id}{?select,expand}";
