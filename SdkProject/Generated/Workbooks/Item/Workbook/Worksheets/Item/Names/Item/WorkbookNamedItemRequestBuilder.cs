...
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Names.Item.Range;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Names.Item.Worksheet;
...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Names.Item {
    ...
    public class WorkbookNamedItemRequestBuilder {
        ...
        public WorkbookNamedItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/names/{workbookNamedItem_id}{?select,expand}";
