...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Refresh {
    ...
    public class RefreshRequestBuilder {
        ...
        public RefreshRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/pivotTables/{workbookPivotTable_id}/microsoft.graph.refresh";
