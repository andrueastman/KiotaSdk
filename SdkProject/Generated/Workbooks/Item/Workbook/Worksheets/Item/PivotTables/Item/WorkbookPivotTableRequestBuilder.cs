...
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Refresh;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Worksheet;
...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item {
    ...
    public class WorkbookPivotTableRequestBuilder {
        ...
        public WorkbookPivotTableRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/pivotTables/{workbookPivotTable_id}{?select,expand}";
