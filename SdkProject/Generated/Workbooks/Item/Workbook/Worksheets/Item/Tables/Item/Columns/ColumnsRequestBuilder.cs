...
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Add;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Count;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Columns.ItemAtWithIndex;
...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the GraphSdk.workbooks.item.workbook.worksheets.item.tables.item.columns.item collection</summary>
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/tables/{workbookTable_id}/columns{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
