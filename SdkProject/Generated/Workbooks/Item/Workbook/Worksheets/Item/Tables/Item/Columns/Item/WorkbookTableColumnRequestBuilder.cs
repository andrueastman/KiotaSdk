...
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item.DataBodyRange;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item.Filter;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item.HeaderRowRange;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item.Range;
using GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item.TotalRowRange;
...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item {
    ...
    public class WorkbookTableColumnRequestBuilder {
        ...
        public WorkbookTableColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/tables/{workbookTable_id}/columns/{workbookTableColumn_id}{?select,expand}";
