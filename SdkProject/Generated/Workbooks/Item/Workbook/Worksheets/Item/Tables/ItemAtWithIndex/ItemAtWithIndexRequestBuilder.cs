...
namespace GraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.ItemAtWithIndex {
    ...
    public class ItemAtWithIndexRequestBuilder {
        ...
        public ItemAtWithIndexRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? index = default) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/tables/microsoft.graph.itemAt(index={index})";
